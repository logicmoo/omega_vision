...
DEFAULT_WORKSPACES_ROOT = REPOSITORY_ROOT / "workspaces"
...
def legacy_catalog_view(documents: Iterable[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for document in documents:
        ...
        result.append({"id": document["id"], "label": document.get("label") or document["id"], "ports": f"{left} → {right}", "routes": routes, "definition": document, "source": "workspaces/shared_library_system/design/operations"})
