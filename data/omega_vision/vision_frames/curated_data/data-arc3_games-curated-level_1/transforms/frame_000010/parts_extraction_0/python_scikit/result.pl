...
midline(r2, [xy(296,206),xy(273,196),xy(257,185),xy(195,125),xy(190,124),xy(164,124),xy(115,178),xy(96,213),xy(90,236),xy(89,252),xy(90,413),xy(96,436),xy(108,461),xy(45,523),xy(39,525),xy(10,524),xy(5,525),xy(4,530),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(163,545),xy(133,478),xy(122,464),xy(109,461)]).
midline(r2, [xy(195,124),xy(252,68),xy(273,53),xy(295,43),xy(320,39),xy(409,39),xy(437,44),xy(449,49),xy(472,64),xy(525,114),xy(525,132),xy(477,181),xy(456,196),xy(432,207)]).
midline(r2, [xy(525,135),xy(553,164),xy(570,187),xy(582,210),xy(589,236),xy(590,497),xy(588,519),xy(582,539),xy(567,546),xy(539,550),xy(190,550),xy(164,546)]).
...
border(r2).
region(r3, '#2ecc40', 89200, centroid(357,356)).
perimeter(r3, 2620).
polygon(r3, [xy(539,500),xy(190,499),xy(190,400),xy(140,399),xy(140,250),xy(289,250),xy(290,399),xy(240,400),xy(240,449),xy(340,449),xy(340,170),xy(320,169),xy(320,80),xy(410,80),xy(410,169),xy(390,170),xy(390,250),xy(540,250),xy(539,500)]).
...
midline(r3, [xy(251,289),xy(243,284),xy(229,280),xy(211,279),xy(195,281),xy(178,288),xy(170,310),xy(170,339),xy(178,361),xy(215,375),xy(214,449),xy(219,470),xy(241,475),xy(348,474),xy(369,466),xy(390,449),xy(439,400),xy(440,353),xy(439,349),xy(381,290),xy(369,271),xy(364,249),xy(364,184),xy(345,166),xy(326,164),xy(324,159),xy(325,85),xy(404,85),xy(404,163),xy(384,166),xy(365,184)]).
midline(r3, [xy(251,288),xy(250,289)]).
midline(r3, [xy(252,290),xy(258,305),xy(260,320),xy(259,339),xy(255,353),xy(249,362),xy(216,374)]).
fillpoint(r3, xy(439,375), 100.0).
fillpoint(r3, xy(178,288), 38.8).
fillpoint(r3, xy(251,288), 38.8).
...
midline(r16, [xy(377,634),xy(126,634),xy(124,629),xy(125,605),xy(134,604),xy(547,604),xy(555,606),xy(555,632),xy(553,634),xy(378,635)]).
midline(r16, [xy(556,605),xy(577,604),xy(585,606),xy(585,631),xy(579,635),xy(555,633)]).
midline(r16, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(609,635),xy(590,635),xy(585,633)]).
...
midline(r9, [xy(314,405),xy(315,324)]).
midline(r9, [xy(314,406),xy(309,421),xy(298,424),xy(264,425)]).
...
midline(r13, [xy(99,553),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,550),xy(20,575),xy(23,580),xy(19,591),xy(21,618),xy(30,620),xy(55,619),xy(60,616),xy(60,590),xy(58,582),xy(44,579),xy(24,579)]).
midline(r13, [xy(99,554),xy(100,609),xy(98,617),xy(89,620),xy(64,619),xy(61,617)]).
...
region(r18, '#5a5a5a', 6600, centroid(384,620)).
perimeter(r18, 700).
polygon(r18, [xy(549,630),xy(220,630),xy(220,610),xy(549,610),xy(549,630)]).
midline(r18, [xy(435,620),xy(229,620)]).
midline(r18, [xy(436,620),xy(540,620)]).
fillpoint(r18, xy(229,620), 10.0).
...
midline(r4, [xy(389,142),xy(390,111),xy(389,104),xy(385,100),xy(351,99),xy(341,101),xy(339,110),xy(341,125),xy(339,139),xy(341,148),xy(364,149),xy(364,126),xy(359,124),xy(342,124)]).
...
midline(r14, [xy(80,587),xy(80,600)]).
midline(r14, [xy(80,586),xy(80,572),xy(77,561),xy(69,559),xy(39,560)]).
...
region(r17, '#2ecc40', 1800, centroid(174,620)).
perimeter(r17, 220).
polygon(r17, [xy(219,630),xy(130,630),xy(130,610),xy(219,610),xy(219,630)]).
midline(r17, [xy(151,620),xy(139,620)]).
midline(r17, [xy(152,620),xy(210,620)]).
fillpoint(r17, xy(139,620), 10.0).
region(r8, '#870c25', 1500, centroid(314,284)).
perimeter(r8, 160).
polygon(r8, [xy(339,300),xy(290,300),xy(290,270),xy(339,270),xy(339,300)]).
midline(r8, [xy(310,285),xy(304,285)]).
midline(r8, [xy(311,285),xy(325,285)]).
fillpoint(r8, xy(304,285), 15.0).
region(r7, '#bebebe', 1000, centroid(314,260)).
perimeter(r7, 140).
polygon(r7, [xy(339,270),xy(290,270),xy(290,250),xy(339,250),xy(339,270)]).
midline(r7, [xy(310,259),xy(299,260)]).
midline(r7, [xy(311,260),xy(330,260)]).
fillpoint(r7, xy(299,260), 10.0).
...
adjacent(r16, r17).
shared_edge(r16, r17, 200).
adjacent(r16, r18).
shared_edge(r16, r18, 680).
adjacent(r16, r19).
