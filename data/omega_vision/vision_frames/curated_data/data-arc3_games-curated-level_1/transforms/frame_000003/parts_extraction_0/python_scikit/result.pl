...
midline(r2, [xy(433,206),xy(449,200),xy(472,185),xy(525,134),xy(525,115),xy(472,64),xy(456,53),xy(434,43),xy(409,39),xy(320,39),xy(295,43),xy(273,53),xy(252,68),xy(194,125),xy(164,124),xy(126,164),xy(107,190),xy(96,213),xy(90,236),xy(90,413),xy(96,436),xy(108,461),xy(45,523),xy(39,525),xy(5,525),xy(4,530),xy(5,634),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(163,545),xy(133,478),xy(122,464),xy(109,461)]).
midline(r2, [xy(525,135),xy(553,164),xy(572,190),xy(582,210),xy(589,236),xy(590,499),xy(588,519),xy(581,540),xy(559,548),xy(538,550),xy(190,550),xy(164,546)]).
...
border(r2).
region(r3, '#2ecc40', 89200, centroid(358,350)).
perimeter(r3, 2620).
polygon(r3, [xy(539,500),xy(290,500),xy(290,450),xy(340,449),xy(339,300),xy(290,300),xy(290,399),xy(240,400),xy(240,499),xy(190,499),xy(190,400),xy(140,399),xy(140,250),xy(339,250),xy(340,170),xy(320,169),xy(320,80),xy(410,80),xy(410,169),xy(390,170),xy(390,250),xy(540,250),xy(539,500)]).
...
midline(r3, [xy(398,308),xy(364,274),xy(280,275),xy(270,278),xy(252,289),xy(234,281),xy(219,279),xy(195,281),xy(178,288),xy(171,305),xy(169,321),xy(170,339),xy(174,353),xy(178,361),xy(215,375),xy(215,475)]).
midline(r3, [xy(365,273),xy(365,186),xy(345,166),xy(326,164),xy(324,159),xy(325,85),xy(404,85),xy(404,163),xy(384,166),xy(365,184)]).
midline(r3, [xy(253,290),xy(258,305),xy(260,321),xy(259,339),xy(255,353),xy(249,362),xy(216,374)]).
midline(r3, [xy(399,309),xy(440,349),xy(439,400),xy(389,450),xy(372,464),xy(348,474),xy(314,475)]).
...
fillpoint(r3, xy(215,438), 25.0).
fillpoint(r3, xy(314,475), 25.0).
...
midline(r16, [xy(377,634),xy(126,634),xy(124,629),xy(124,610),xy(125,605),xy(130,604),xy(549,604),xy(554,607),xy(561,604),xy(579,604),xy(585,606),xy(585,631),xy(583,634),xy(578,635),xy(560,635),xy(555,633),xy(549,635),xy(378,635)]).
midline(r16, [xy(586,605),xy(609,604),xy(615,606),xy(615,631),xy(613,634),xy(608,635),xy(590,635),xy(585,633)]).
...
midline(r7, [xy(314,406),xy(312,416),xy(306,422),xy(289,425),xy(264,425)]).
...
region(r18, '#5a5a5a', 7800, centroid(354,620)).
perimeter(r18, 820).
polygon(r18, [xy(549,630),xy(160,630),xy(160,610),xy(549,610),xy(549,630)]).
midline(r18, [xy(334,619),xy(169,620)]).
midline(r18, [xy(335,619),xy(540,620)]).
fillpoint(r18, xy(169,620), 10.0).
...
midline(r13, [xy(19,563),xy(20,544),xy(24,540),xy(89,539),xy(98,541),xy(100,550),xy(98,577),xy(95,580),xy(70,579),xy(61,581),xy(59,592),xy(60,616),xy(55,619),xy(31,620),xy(21,617),xy(19,608),xy(20,564)]).
midline(r13, [xy(61,617),xy(72,620),xy(89,620),xy(98,617),xy(100,590),xy(97,580)]).
...
midline(r4, [xy(389,142),xy(390,113),xy(389,104),xy(385,100),xy(350,99),xy(341,101),xy(339,113),xy(341,148),xy(350,150),xy(364,149),xy(364,126),xy(342,124)]).
...
midline(r14, [xy(40,594),xy(39,571),xy(41,561),xy(51,559),xy(80,560)]).
midline(r14, [xy(40,595),xy(40,600)]).
...
region(r12, '#870c25', 1500, centroid(264,484)).
perimeter(r12, 160).
polygon(r12, [xy(289,500),xy(240,500),xy(240,470),xy(289,470),xy(289,500)]).
midline(r12, [xy(272,485),xy(254,485)]).
midline(r12, [xy(273,484),xy(275,485)]).
fillpoint(r12, xy(254,485), 15.0).
region(r11, '#bebebe', 1000, centroid(264,460)).
perimeter(r11, 140).
polygon(r11, [xy(289,470),xy(240,470),xy(240,450),xy(289,450),xy(289,470)]).
midline(r11, [xy(260,459),xy(249,460)]).
midline(r11, [xy(261,460),xy(280,460)]).
fillpoint(r11, xy(249,460), 10.0).
region(r17, '#2ecc40', 600, centroid(144,620)).
perimeter(r17, 100).
polygon(r17, [xy(159,630),xy(130,630),xy(130,610),xy(159,610),xy(159,630)]).
midline(r17, [xy(144,620),xy(139,620)]).
midline(r17, [xy(145,620),xy(150,620)]).
...
adjacent(r3, r7).
shared_edge(r3, r7, 450).
adjacent(r3, r11).
shared_edge(r3, r11, 40).
adjacent(r3, r12).
