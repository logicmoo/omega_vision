...
midline(r2, [xy(433,206),xy(456,196),xy(472,185),xy(525,134),xy(525,115),xy(472,64),xy(456,53),xy(434,43),xy(407,39),xy(325,39),xy(295,43),xy(273,53),xy(252,68),xy(195,124),xy(164,124),xy(126,164),xy(109,187),xy(97,210),xy(90,236),xy(90,413),xy(97,439),xy(108,461),xy(45,523),xy(39,525),xy(10,524),xy(5,525),xy(4,530),xy(5,634),xy(113,634),xy(115,628),xy(114,603),xy(116,594),xy(163,545),xy(133,478),xy(122,464),xy(109,461)]).
midline(r2, [xy(525,135),xy(553,164),xy(570,187),xy(582,210),xy(589,236),xy(590,498),xy(587,523),xy(581,540),xy(559,548),xy(538,550),xy(190,550),xy(164,546)]).
midline(r2, [xy(195,125),xy(240,170),xy(265,191),xy(297,207),xy(303,202),xy(302,205)]).
...
border(r2).
region(r3, '#2ecc40', 89200, centroid(360,356)).
perimeter(r3, 2720).
polygon(r3, [xy(539,500),xy(190,499),xy(190,400),xy(140,399),xy(140,250),xy(189,250),xy(190,299),xy(239,300),xy(240,250),xy(339,250),xy(340,170),xy(320,169),xy(320,80),xy(410,80),xy(410,169),xy(390,170),xy(390,250),xy(540,250),xy(539,500)]).
...
midline(r3, [xy(295,475),xy(240,475),xy(226,473),xy(218,468),xy(214,449),xy(215,377),xy(213,374),xy(180,362),xy(174,353),xy(170,339),xy(170,322),xy(165,308),xy(165,274)]).
midline(r3, [xy(179,360),xy(178,361)]).
midline(r3, [xy(215,375),xy(251,361)]).
midline(r3, [xy(296,475),xy(349,474),xy(361,470),xy(379,459),xy(440,399),xy(439,349),xy(364,274),xy(290,274),xy(273,277),xy(268,280),xy(266,286),xy(263,313),xy(258,323),xy(242,313),xy(229,310),xy(219,304),xy(206,305),xy(200,310),xy(189,312),xy(171,322)]).
midline(r3, [xy(365,273),xy(365,185),xy(345,166),xy(326,164),xy(324,159),xy(325,85),xy(404,85),xy(404,163),xy(384,166),xy(365,184)]).
midline(r3, [xy(252,359),xy(258,344),xy(259,324)]).
...
midline(r16, [xy(555,622),xy(555,607),xy(549,604),xy(130,604),xy(125,605),xy(124,613),xy(125,634),xy(130,635),xy(549,635),xy(555,632),xy(555,623)]).
midline(r16, [xy(555,606),xy(560,604),xy(576,604),xy(583,605),xy(584,607),xy(586,605),xy(608,604),xy(613,605),xy(615,611),xy(615,632),xy(613,634),xy(591,635),xy(584,633),xy(562,635),xy(555,633)]).
...
midline(r9, [xy(315,342),xy(315,398),xy(311,418),xy(306,422),xy(298,424),xy(264,425)]).
...
midline(r13, [xy(99,553),xy(98,542),xy(89,539),xy(31,539),xy(21,541),xy(19,552),xy(20,575),xy(23,579),xy(19,592),xy(21,618),xy(31,620),xy(55,619),xy(60,616),xy(60,590),xy(58,582),xy(49,579),xy(24,580)]).
midline(r13, [xy(99,554),xy(100,608),xy(98,617),xy(86,620),xy(71,620),xy(61,617)]).
...
region(r18, '#5a5a5a', 7000, centroid(374,620)).
perimeter(r18, 740).
polygon(r18, [xy(549,630),xy(200,630),xy(200,610),xy(549,610),xy(549,630)]).
midline(r18, [xy(426,620),xy(209,620)]).
midline(r18, [xy(427,619),xy(540,620)]).
fillpoint(r18, xy(209,620), 10.0).
...
midline(r4, [xy(389,142),xy(390,110),xy(389,104),xy(385,100),xy(354,99),xy(341,101),xy(339,110),xy(341,148),xy(350,150),xy(363,149),xy(365,147),xy(364,126),xy(359,124),xy(342,124)]).
...
midline(r14, [xy(80,587),xy(80,570),xy(77,561),xy(69,559),xy(39,560)]).
...
region(r8, '#870c25', 1500, centroid(214,284)).
perimeter(r8, 160).
polygon(r8, [xy(239,300),xy(190,300),xy(190,270),xy(239,270),xy(239,300)]).
midline(r8, [xy(222,285),xy(204,285)]).
midline(r8, [xy(223,285),xy(225,285)]).
fillpoint(r8, xy(204,285), 15.0).
region(r17, '#2ecc40', 1400, centroid(164,620)).
perimeter(r17, 180).
polygon(r17, [xy(199,630),xy(130,630),xy(130,610),xy(199,610),xy(199,630)]).
midline(r17, [xy(149,620),xy(139,620)]).
midline(r17, [xy(150,620),xy(190,620)]).
fillpoint(r17, xy(139,620), 10.0).
region(r7, '#bebebe', 1000, centroid(214,260)).
perimeter(r7, 140).
polygon(r7, [xy(239,270),xy(190,270),xy(190,250),xy(239,250),xy(239,270)]).
midline(r7, [xy(209,260),xy(199,260)]).
midline(r7, [xy(210,260),xy(230,260)]).
fillpoint(r7, xy(199,260), 10.0).
...
adjacent(r16, r17).
shared_edge(r16, r17, 160).
adjacent(r16, r18).
shared_edge(r16, r18, 720).
adjacent(r16, r19).
