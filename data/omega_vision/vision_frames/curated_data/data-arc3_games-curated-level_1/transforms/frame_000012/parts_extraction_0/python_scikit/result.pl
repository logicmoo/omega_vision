...
midline(r2, [xy(433,206),xy(449,200),xy(472,185),xy(525,134),xy(525,115),xy(472,64),xy(449,49),xy(434,43),xy(407,39),xy(320,39),xy(295,43),xy(273,53),xy(252,68),xy(194,125),xy(164,124),xy(126,164),xy(109,187),xy(97,210),xy(90,236),xy(90,413),xy(96,436),xy(108,461),xy(45,523),xy(39,525),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(163,545),xy(133,478),xy(122,464),xy(109,461)]).
midline(r2, [xy(525,135),xy(553,164),xy(572,190),xy(583,213),xy(589,236),xy(590,499),xy(589,513),xy(582,539),xy(563,547),xy(535,550),xy(190,550),xy(164,546)]).
...
midline(r9, [xy(214,410),xy(215,459),xy(218,469),xy(230,474),xy(348,474),xy(369,466),xy(389,450),xy(439,400),xy(440,350),xy(379,290),xy(369,283),xy(349,275),xy(281,275),xy(270,278),xy(252,289),xy(234,281),xy(218,279),xy(195,281),xy(178,288),xy(170,310),xy(169,328),xy(171,344),xy(178,361),xy(214,375),xy(215,409)]).
midline(r9, [xy(253,290),xy(258,305),xy(260,323),xy(259,339),xy(255,353),xy(249,362),xy(215,375)]).
...
midline(r17, [xy(524,635),xy(133,635),xy(126,634),xy(124,628),xy(125,605),xy(130,604),xy(545,604),xy(553,605),xy(554,607),xy(560,604),xy(579,604),xy(585,606),xy(585,632),xy(583,634),xy(525,635)]).
...
midline(r10, [xy(314,341),xy(315,399),xy(310,420),xy(299,424),xy(264,425)]).
midline(r10, [xy(315,340),xy(315,324)]).
...
midline(r14, [xy(99,553),xy(98,542),xy(89,539),xy(35,539),xy(21,541),xy(19,550),xy(20,575),xy(23,580),xy(19,591),xy(21,618),xy(31,620),xy(55,619),xy(60,616),xy(60,590),xy(58,582),xy(49,579),xy(24,580)]).
midline(r14, [xy(99,554),xy(100,608),xy(98,617),xy(84,620),xy(70,620),xy(61,617)]).
...
region(r19, '#5a5a5a', 6200, centroid(394,620)).
perimeter(r19, 660).
polygon(r19, [xy(549,630),xy(240,630),xy(240,610),xy(549,610),xy(549,630)]).
midline(r19, [xy(455,620),xy(249,620)]).
midline(r19, [xy(456,620),xy(540,620)]).
fillpoint(r19, xy(249,620), 10.0).
...
midline(r3, [xy(372,84),xy(331,84),xy(325,85),xy(324,90),xy(325,164),xy(343,165),xy(359,180),xy(370,180)]).
midline(r3, [xy(371,178),xy(386,165),xy(403,164),xy(405,153),xy(404,86),xy(373,84)]).
...
midline(r4, [xy(389,142),xy(390,110),xy(389,104),xy(385,100),xy(353,99),xy(341,101),xy(339,111),xy(341,125),xy(339,139),xy(341,148),xy(351,150),xy(364,149),xy(364,126),xy(358,124),xy(342,125)]).
...
region(r18, '#2ecc40', 2200, centroid(184,620)).
perimeter(r18, 260).
polygon(r18, [xy(239,630),xy(130,630),xy(130,610),xy(239,610),xy(239,630)]).
midline(r18, [xy(184,620),xy(139,620)]).
midline(r18, [xy(185,619),xy(230,620)]).
...
midline(r15, [xy(80,586),xy(80,570),xy(77,561),xy(67,559),xy(39,560)]).
...
midline(r8, [xy(366,234),xy(354,235)]).
midline(r8, [xy(367,235),xy(375,235)]).
...
midline(r7, [xy(359,210),xy(349,210)]).
midline(r7, [xy(360,210),xy(380,210)]).
