...
midline(r2, [xy(433,206),xy(456,196),xy(472,185),xy(525,134),xy(524,114),xy(472,64),xy(449,49),xy(434,43),xy(409,39),xy(321,39),xy(295,43),xy(273,53),xy(252,68),xy(195,124),xy(164,124),xy(126,164),xy(107,190),xy(97,210),xy(90,236),xy(90,413),xy(97,439),xy(108,461),xy(45,523),xy(39,525),xy(5,525),xy(4,531),xy(5,634),xy(113,634),xy(115,629),xy(114,606),xy(116,594),xy(163,545),xy(133,478),xy(122,464),xy(109,461)]).
midline(r2, [xy(525,135),xy(553,164),xy(572,190),xy(582,210),xy(589,236),xy(590,498),xy(589,513),xy(582,539),xy(563,547),xy(537,550),xy(191,550),xy(164,546)]).
...
border(r2).
region(r3, '#2ecc40', 89200, centroid(360,351)).
perimeter(r3, 2620).
polygon(r3, [xy(539,500),xy(190,499),xy(190,450),xy(340,449),xy(339,300),xy(290,300),xy(289,400),xy(140,399),xy(140,250),xy(340,249),xy(340,170),xy(320,169),xy(320,80),xy(410,80),xy(410,169),xy(390,170),xy(390,250),xy(540,250),xy(539,500)]).
...
midline(r3, [xy(295,475),xy(214,475)]).
midline(r3, [xy(296,475),xy(348,474),xy(359,471),xy(379,459),xy(440,399),xy(440,350),xy(364,274),xy(290,274),xy(270,278),xy(252,289),xy(229,280),xy(200,280),xy(178,288),xy(174,296),xy(170,310),xy(169,329),xy(171,344),xy(178,361),xy(195,368),xy(211,370),xy(234,368),xy(251,361)]).
...
fillpoint(r3, xy(196,368), 32.0).
fillpoint(r3, xy(233,368), 32.0).
...
fillpoint(r3, xy(202,369), 31.0).
fillpoint(r3, xy(228,369), 31.0).
fillpoint(r3, xy(211,280), 30.0).
fillpoint(r3, xy(169,325), 30.0).
fillpoint(r3, xy(259,325), 30.0).
fillpoint(r3, xy(211,370), 30.0).
...
midline(r16, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(554,607),xy(562,604),xy(578,604),xy(585,606),xy(585,632),xy(579,635),xy(560,635),xy(554,632),xy(555,608)]).
midline(r16, [xy(525,635),xy(549,635),xy(554,633)]).
midline(r16, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(609,635),xy(585,633)]).
...
midline(r7, [xy(314,342),xy(315,399),xy(311,418),xy(299,424),xy(264,425)]).
...
midline(r13, [xy(19,563),xy(20,544),xy(24,540),xy(87,539),xy(98,541),xy(100,553),xy(98,577),xy(95,580),xy(70,579),xy(61,581),xy(59,590),xy(60,612),xy(59,616),xy(55,619),xy(33,620),xy(21,617),xy(19,608),xy(20,564)]).
...
region(r18, '#5a5a5a', 7400, centroid(364,620)).
perimeter(r18, 780).
polygon(r18, [xy(549,630),xy(180,630),xy(180,610),xy(549,610),xy(549,630)]).
midline(r18, [xy(354,619),xy(189,620)]).
midline(r18, [xy(355,619),xy(540,620)]).
fillpoint(r18, xy(189,620), 10.0).
...
midline(r4, [xy(389,142),xy(390,111),xy(389,104),xy(385,100),xy(350,99),xy(341,101),xy(339,110),xy(341,125),xy(339,139),xy(341,148),xy(364,149),xy(364,126),xy(359,124),xy(342,124)]).
...
midline(r12, [xy(211,434),xy(225,435)]).
fillpoint(r12, xy(204,435), 15.0).
region(r11, '#bebebe', 1000, centroid(214,410)).
perimeter(r11, 140).
polygon(r11, [xy(239,420),xy(190,420),xy(190,400),xy(239,400),xy(239,420)]).
midline(r11, [xy(210,409),xy(199,410)]).
midline(r11, [xy(211,409),xy(230,410)]).
fillpoint(r11, xy(199,410), 10.0).
region(r17, '#2ecc40', 1000, centroid(154,620)).
perimeter(r17, 140).
polygon(r17, [xy(179,630),xy(130,630),xy(130,610),xy(179,610),xy(179,630)]).
midline(r17, [xy(149,620),xy(139,620)]).
midline(r17, [xy(150,620),xy(170,620)]).
...
adjacent(r3, r12).
shared_edge(r3, r12, 50).
adjacent(r4, r5).
shared_edge(r4, r5, 120).
adjacent(r4, r6).
shared_edge(r4, r6, 40).
adjacent(r7, r11).
shared_edge(r7, r11, 20).
adjacent(r7, r12).
