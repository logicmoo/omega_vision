...
midline(r2, [xy(590,49),xy(561,29),xy(539,24),xy(190,24),xy(176,26),xy(162,32),xy(140,50),xy(89,49)]).
midline(r2, [xy(590,51),xy(589,150),xy(604,167),xy(614,191),xy(615,298),xy(613,313),xy(604,332),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,549),xy(612,566),xy(603,573),xy(589,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,383),xy(81,363),xy(90,339),xy(90,299),xy(73,279),xy(65,258),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(245,352),xy(239,340),xy(248,308),xy(265,298),xy(265,174)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(398,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,449),xy(414,401),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,348),xy(465,251),xy(463,236),xy(459,228),xy(426,223),xy(418,219),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,625),xy(113,634),xy(6,634),xy(4,624),xy(5,525),xy(43,524),xy(81,488)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(368,262)).
perimeter(r3, 4560).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(340,150),xy(340,199),xy(389,200),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(390,449),xy(290,449),xy(290,350),xy(340,349),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(457,522),xy(447,517),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(455,524),xy(448,518)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(513,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(523,270),xy(540,249),xy(523,229),xy(516,213),xy(514,191),xy(510,178),xy(502,164),xy(489,150),xy(489,136),xy(481,109),xy(453,100),xy(340,99),xy(314,103),xy(289,99),xy(239,99),xy(206,133),xy(179,129),xy(150,129),xy(126,134),xy(121,145),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(163,224),xy(165,228),xy(165,364),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(130,465),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(206,134),xy(210,162),xy(210,189),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,470),xy(558,455),xy(550,439),xy(549,432)]).
midline(r3, [xy(314,104),xy(314,197),xy(318,219),xy(326,223),xy(348,225),xy(360,229),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
...
fillpoint(r3, xy(319,220), 29.7).
fillpoint(r3, xy(360,229), 29.7).
fillpoint(r3, xy(511,181), 29.0).
fillpoint(r3, xy(318,218), 29.0).
fillpoint(r3, xy(518,218), 29.0).
fillpoint(r3, xy(321,221), 29.0).
fillpoint(r3, xy(358,228), 29.0).
...
fillpoint(r3, xy(317,215), 28.0).
fillpoint(r3, xy(517,215), 28.0).
fillpoint(r3, xy(324,222), 28.0).
fillpoint(r3, xy(355,227), 28.0).
...
fillpoint(r3, xy(316,212), 27.0).
fillpoint(r3, xy(516,212), 27.0).
fillpoint(r3, xy(327,223), 27.0).
fillpoint(r3, xy(352,226), 27.0).
...
fillpoint(r3, xy(315,208), 26.0).
fillpoint(r3, xy(515,208), 26.0).
fillpoint(r3, xy(332,224), 26.0).
fillpoint(r3, xy(348,225), 26.0).
...
midline(r19, [xy(137,634),xy(125,633),xy(125,605),xy(131,604),xy(548,604),xy(554,607),xy(560,604),xy(578,604),xy(583,605),xy(585,609),xy(584,633),xy(579,635),xy(560,635),xy(554,632),xy(555,608)]).
midline(r19, [xy(138,634),xy(548,635),xy(554,633)]).
midline(r19, [xy(585,606),xy(590,604),xy(606,604),xy(613,605),xy(615,610),xy(613,634),xy(592,635),xy(585,633)]).
...
midline(r16, [xy(99,562),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,551),xy(19,569),xy(23,580),xy(19,591),xy(21,618),xy(31,620),xy(55,619),xy(60,614),xy(58,582),xy(47,579),xy(24,580)]).
midline(r16, [xy(99,563),xy(100,608),xy(98,617),xy(88,620),xy(73,620),xy(60,617)]).
...
midline(r21, [xy(465,620),xy(259,620)]).
midline(r21, [xy(466,620),xy(540,620)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,423)]).
...
midline(r20, [xy(185,620),xy(240,620)]).
...
midline(r17, [xy(80,587),xy(80,570),xy(77,561),xy(69,559),xy(39,560)]).
midline(r17, [xy(79,588),xy(80,600)]).
...
region(r4, '#bebebe', 1000, centroid(364,160)).
perimeter(r4, 140).
polygon(r4, [xy(389,170),xy(340,170),xy(340,150),xy(389,150),xy(389,170)]).
midline(r4, [xy(359,160),xy(349,160)]).
midline(r4, [xy(360,159),xy(380,160)]).
fillpoint(r4, xy(349,160), 10.0).
...
midline(r5, [xy(169,164),xy(155,165),xy(155,184),xy(174,183),xy(174,166),xy(170,165)]).
...
midline(r14, [xy(424,532),xy(425,520),xy(423,515),xy(405,515),xy(404,520),xy(405,534),xy(424,534)]).
...
midline(r9, [xy(155,421),xy(155,435)]).
midline(r9, [xy(155,420),xy(155,415),xy(175,415)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 260).
adjacent(r19, r21).
shared_edge(r19, r21, 620).
adjacent(r19, r22).
