...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(536,24),xy(190,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49)]).
midline(r2, [xy(590,51),xy(589,150),xy(604,167),xy(614,191),xy(615,299),xy(611,319),xy(602,335),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,545),xy(612,566),xy(603,573),xy(588,575),xy(380,574),xy(354,562),xy(313,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,380),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,259),xy(64,103),xy(68,80),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(250,381),xy(246,355),xy(239,339),xy(220,349),xy(220,351)]).
midline(r2, [xy(315,524),xy(349,491),xy(362,482),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,400),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,348),xy(465,251),xy(463,236),xy(456,227),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,628),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(240,338),xy(248,308),xy(262,301),xy(265,296),xy(265,174)]).
...
midline(r3, [xy(520,420),xy(514,386),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(513,186),xy(508,175),xy(465,175),xy(390,100),xy(362,103),xy(340,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(150,129),xy(135,131),xy(124,136),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,188),xy(210,160),xy(206,134)]).
midline(r3, [xy(391,99),xy(407,85),xy(430,75),xy(487,74),xy(509,78),xy(513,86),xy(515,100),xy(515,148),xy(513,163),xy(508,174)]).
midline(r3, [xy(340,114),xy(339,200),xy(356,220),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(365,340),xy(364,359),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(165,227),xy(165,363),xy(145,383),xy(125,385),xy(124,394),xy(125,464),xy(203,464),xy(205,454),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r17, [xy(524,635),xy(130,635),xy(125,633),xy(125,605),xy(549,604),xy(554,606),xy(555,632),xy(548,635),xy(525,634)]).
midline(r17, [xy(555,606),xy(561,604),xy(585,606),xy(585,632),xy(583,634),xy(562,635),xy(555,633)]).
midline(r17, [xy(586,605),xy(613,605),xy(615,609),xy(615,632),xy(609,635),xy(585,633)]).
...
midline(r14, [xy(99,562),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,550),xy(19,609),xy(21,618),xy(49,620),xy(59,617),xy(61,581),xy(70,579),xy(95,580),xy(99,575),xy(100,563)]).
midline(r14, [xy(61,617),xy(70,620),xy(88,620),xy(98,617),xy(100,590),xy(97,580)]).
...
region(r18, '#2ecc40', 5200, centroid(260,620)).
perimeter(r18, 560).
polygon(r18, [xy(389,630),xy(130,630),xy(130,610),xy(389,610),xy(389,630)]).
midline(r18, [xy(301,620),xy(139,620)]).
midline(r18, [xy(302,619),xy(380,620)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,423)]).
...
region(r19, '#5a5a5a', 3200, centroid(470,620)).
perimeter(r19, 360).
polygon(r19, [xy(549,630),xy(390,630),xy(390,610),xy(549,610),xy(549,630)]).
midline(r19, [xy(423,619),xy(399,620)]).
midline(r19, [xy(424,620),xy(540,620)]).
fillpoint(r19, xy(399,620), 10.0).
region(r15, '#870c25', 2000, centroid(52,572)).
perimeter(r15, 240).
polygon(r15, [xy(49,610),xy(30,609),xy(30,550),xy(89,550),xy(89,570),xy(50,570),xy(49,610)]).
midline(r15, [xy(39,583),xy(40,600)]).
midline(r15, [xy(40,582),xy(39,570),xy(41,561),xy(52,559),xy(80,560)]).
...
midline(r5, [xy(472,135),xy(454,135)]).
midline(r5, [xy(473,134),xy(475,135)]).
...
midline(r4, [xy(460,109),xy(480,110)]).
...
midline(r6, [xy(169,164),xy(155,165),xy(155,184),xy(169,185),xy(174,183),xy(175,170),xy(174,166),xy(170,165)]).
...
adjacent(r17, r18).
shared_edge(r17, r18, 540).
adjacent(r17, r19).
shared_edge(r17, r19, 340).
adjacent(r17, r20).
