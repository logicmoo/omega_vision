...
midline(r2, [xy(89,49),xy(69,78),xy(64,101),xy(65,259),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(154,37),xy(168,29),xy(180,25),xy(196,24),xy(539,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(614,309),xy(610,321),xy(599,339),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,392),xy(615,549),xy(613,563),xy(609,571),xy(589,575),xy(381,574),xy(370,571),xy(354,562),xy(314,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,342),xy(235,338),xy(230,343),xy(236,341)]).
midline(r2, [xy(236,337),xy(241,335),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(349,491),xy(362,482),xy(376,476),xy(398,474),xy(410,470),xy(414,459),xy(414,402),xy(417,383),xy(420,378),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,348),xy(465,250),xy(463,236),xy(459,228),xy(426,223),xy(418,219),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 136300, centroid(368,265)).
perimeter(r3, 4540).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,472),xy(471,494),xy(477,510),xy(453,523),xy(414,525)]).
midline(r3, [xy(520,420),xy(514,388),xy(515,291),xy(522,272),xy(540,249),xy(523,229),xy(516,213),xy(514,191),xy(510,178),xy(502,164),xy(489,150),xy(488,130),xy(481,109),xy(459,101),xy(439,100),xy(419,83),xy(399,75),xy(340,74),xy(326,76),xy(310,83),xy(290,100),xy(239,99),xy(206,133),xy(177,129),xy(151,129),xy(135,131),xy(124,136),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(163,224),xy(165,228),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(290,101),xy(302,114),xy(311,130),xy(316,163),xy(323,179),xy(352,214),xy(361,230),xy(366,263),xy(373,279),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
midline(r3, [xy(341,198),xy(438,101)]).
midline(r3, [xy(206,134),xy(210,160),xy(210,187),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
...
midline(r17, [xy(524,635),xy(134,635),xy(125,633),xy(125,605),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(525,634)]).
midline(r17, [xy(556,605),xy(579,604),xy(585,606),xy(585,630),xy(583,634),xy(579,635),xy(555,633)]).
midline(r17, [xy(586,605),xy(608,604),xy(615,606),xy(615,630),xy(613,634),xy(609,635),xy(585,633)]).
...
midline(r14, [xy(99,553),xy(98,542),xy(89,539),xy(31,539),xy(21,541),xy(19,551),xy(19,609),xy(21,618),xy(49,620),xy(59,617),xy(61,581),xy(70,579),xy(96,580),xy(100,569),xy(100,554)]).
midline(r14, [xy(97,581),xy(100,590),xy(98,617),xy(87,620),xy(70,620),xy(61,617)]).
...
midline(r18, [xy(346,619),xy(420,620)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(189,426),xy(185,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(140,404),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,424)]).
...
midline(r19, [xy(484,620),xy(439,620)]).
midline(r19, [xy(485,620),xy(540,620)]).
...
midline(r15, [xy(40,585),xy(39,570),xy(41,561),xy(50,559),xy(80,560)]).
...
midline(r5, [xy(366,134),xy(354,135)]).
midline(r5, [xy(367,135),xy(375,135)]).
...
midline(r4, [xy(360,110),xy(380,110)]).
...
midline(r6, [xy(155,177),xy(155,184),xy(160,185),xy(173,184),xy(175,179),xy(174,166),xy(167,164),xy(155,165),xy(155,176)]).
