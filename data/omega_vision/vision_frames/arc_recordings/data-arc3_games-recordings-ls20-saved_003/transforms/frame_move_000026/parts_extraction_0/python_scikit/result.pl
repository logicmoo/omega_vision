...
midline(r2, [xy(590,51),xy(589,150),xy(604,167),xy(614,190),xy(615,299),xy(611,319),xy(602,335),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,549),xy(611,569),xy(603,573),xy(586,575),xy(380,574),xy(354,562),xy(312,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,467),xy(79,381),xy(83,355),xy(90,339),xy(90,299),xy(73,279),xy(65,259),xy(64,103),xy(68,80),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(398,474),xy(410,470),xy(415,449),xy(414,400),xy(418,380),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,345),xy(465,250),xy(463,236),xy(459,228),xy(426,223),xy(418,219),xy(414,198),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,625),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(91,340),xy(97,341),xy(96,343)]).
midline(r2, [xy(98,344),xy(104,346)]).
...
midline(r3, [xy(515,306),xy(515,374),xy(465,424),xy(464,424),xy(465,458),xy(470,472),xy(471,494),xy(477,510),xy(453,523),xy(414,525)]).
midline(r3, [xy(471,472),xy(489,462),xy(500,460),xy(506,455),xy(517,454),xy(523,455),xy(529,460),xy(542,463),xy(559,473),xy(559,489),xy(555,503),xy(552,509),xy(543,515),xy(529,519),xy(510,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(515,305),xy(515,291),xy(519,278),xy(527,264),xy(540,249),xy(530,239),xy(519,221),xy(515,209),xy(514,190),xy(511,180),xy(502,164),xy(489,150),xy(487,126),xy(482,110),xy(479,107),xy(453,100),xy(394,99),xy(362,103),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(140,130),xy(126,134),xy(121,145),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,189),xy(210,160),xy(206,134)]).
midline(r3, [xy(339,114),xy(339,200),xy(352,214),xy(360,228),xy(364,241),xy(366,263),xy(373,279),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(515,375),xy(530,390),xy(545,396),xy(565,414),xy(565,449),xy(560,472)]).
...
midline(r17, [xy(169,605),xy(125,605),xy(124,629),xy(125,634),xy(130,635),xy(553,634),xy(555,632),xy(555,607),xy(549,604),xy(170,605)]).
midline(r17, [xy(555,606),xy(566,604),xy(579,604),xy(584,607),xy(592,604),xy(615,606),xy(615,632),xy(613,634),xy(590,635),xy(584,633),xy(579,635),xy(560,635),xy(555,633)]).
...
midline(r14, [xy(19,563),xy(20,544),xy(24,540),xy(87,539),xy(98,541),xy(100,569),xy(97,579),xy(61,581),xy(59,590),xy(60,616),xy(55,619),xy(30,620),xy(21,617),xy(19,608),xy(20,564)]).
midline(r14, [xy(97,581),xy(100,595),xy(98,617),xy(86,620),xy(70,620),xy(61,617)]).
...
midline(r19, [xy(359,620),xy(259,620)]).
midline(r19, [xy(360,619),xy(540,620)]).
...
midline(r6, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(165,447),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,424)]).
...
midline(r18, [xy(185,619),xy(240,620)]).
...
midline(r15, [xy(40,585),xy(39,571),xy(41,561),xy(50,559),xy(80,560)]).
...
midline(r7, [xy(510,409),xy(499,410)]).
midline(r7, [xy(511,410),xy(530,410)]).
