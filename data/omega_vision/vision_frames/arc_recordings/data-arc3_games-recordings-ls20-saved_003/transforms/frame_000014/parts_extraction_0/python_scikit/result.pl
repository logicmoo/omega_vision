...
midline(r2, [xy(412,466),xy(409,471),xy(403,473),xy(380,475),xy(360,483),xy(313,525),xy(265,522),xy(241,531),xy(209,535),xy(175,535),xy(145,510),xy(124,501),xy(96,495),xy(81,486),xy(79,469),xy(79,382),xy(83,355),xy(90,339),xy(90,299),xy(75,282),xy(65,258),xy(64,100),xy(69,78),xy(89,49),xy(140,50),xy(160,33),xy(176,26),xy(190,24),xy(539,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(606,170),xy(613,186),xy(615,201),xy(615,298),xy(613,313),xy(599,339),xy(592,345),xy(584,345)]).
midline(r2, [xy(412,465),xy(415,449),xy(414,400),xy(418,380),xy(430,375),xy(449,374),xy(459,371),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(430,224),xy(418,219),xy(414,195),xy(415,174)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,338),xy(248,308),xy(265,298),xy(265,174)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,549),xy(610,570),xy(589,575),xy(380,574),xy(368,570),xy(350,559),xy(315,525)]).
...
midline(r3, [xy(124,137),xy(126,134),xy(135,131),xy(152,129),xy(177,129),xy(206,133),xy(210,160),xy(209,199),xy(203,215),xy(165,225),xy(135,218),xy(124,213),xy(120,199),xy(119,160),xy(124,138)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(326,106),xy(339,113),xy(362,103),xy(390,99),xy(453,100),xy(476,106),xy(481,108),xy(486,122),xy(489,150),xy(502,164),xy(512,183),xy(515,208),xy(519,221),xy(527,235),xy(540,250)]).
midline(r3, [xy(165,226),xy(165,363),xy(145,383),xy(125,385),xy(124,393),xy(125,464),xy(203,464),xy(205,456),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r8, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(457,522),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r8, [xy(520,420),xy(514,389),xy(515,374)]).
midline(r8, [xy(549,432),xy(550,439),xy(558,455),xy(560,470),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
...
midline(r20, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(554,607),xy(560,604),xy(578,604),xy(583,605),xy(585,609),xy(584,633),xy(560,635),xy(554,632),xy(555,608)]).
midline(r20, [xy(525,634),xy(546,635),xy(554,633)]).
midline(r20, [xy(585,606),xy(609,604),xy(613,605),xy(615,609),xy(615,632),xy(613,634),xy(592,635),xy(585,633)]).
...
midline(r17, [xy(99,553),xy(99,544),xy(95,540),xy(32,539),xy(21,541),xy(19,550),xy(19,568),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,616),xy(60,590),xy(58,582),xy(49,579),xy(24,579)]).
midline(r17, [xy(100,554),xy(100,608),xy(98,617),xy(85,620),xy(70,620),xy(61,617)]).
...
midline(r9, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,411),xy(189,424)]).
...
midline(r22, [xy(432,619),xy(540,620)]).
...
midline(r6, [xy(509,310),xy(499,310)]).
midline(r6, [xy(510,310),xy(530,310)]).
