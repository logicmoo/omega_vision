...
midline(r2, [xy(590,49),xy(561,29),xy(537,24),xy(180,25),xy(160,33),xy(140,50),xy(89,49)]).
midline(r2, [xy(589,51),xy(589,150),xy(606,170),xy(614,190),xy(615,295),xy(613,313),xy(604,332),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,548),xy(611,569),xy(603,573),xy(589,575),xy(381,574),xy(370,571),xy(354,562),xy(313,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(179,535),xy(174,534),xy(154,516),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,467),xy(79,381),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,258),xy(64,104),xy(68,80),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(250,382),xy(248,363),xy(242,344),xy(237,338),xy(224,346),xy(222,348),xy(224,348)]).
midline(r2, [xy(237,340),xy(235,342)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,447),xy(414,402),xy(417,383),xy(420,378),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,251),xy(463,236),xy(456,227),xy(426,223),xy(418,219),xy(414,198),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(238,337),xy(240,336),xy(240,339)]).
...
midline(r3, [xy(520,420),xy(514,386),xy(515,290),xy(523,270),xy(540,249),xy(523,229),xy(516,213),xy(514,190),xy(510,178),xy(502,164),xy(489,150),xy(488,130),xy(481,109),xy(453,100),xy(376,100),xy(350,107),xy(339,113),xy(326,106),xy(303,100),xy(239,99),xy(214,125),xy(140,124),xy(120,128),xy(116,136),xy(114,151),xy(114,196),xy(118,219),xy(130,224),xy(153,226),xy(163,230),xy(165,234),xy(165,363),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r3, [xy(165,231),xy(176,226),xy(203,223),xy(209,221),xy(212,216),xy(215,197),xy(214,126)]).
...
midline(r15, [xy(377,634),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(554,607),xy(561,604),xy(579,604),xy(584,606),xy(585,632),xy(579,635),xy(563,635),xy(554,632),xy(555,608)]).
midline(r15, [xy(378,634),xy(549,635),xy(554,633)]).
midline(r15, [xy(585,606),xy(590,604),xy(608,604),xy(614,607),xy(621,604),xy(635,605)]).
midline(r15, [xy(615,608),xy(615,629),xy(613,634),xy(591,635),xy(585,633)]).
...
midline(r12, [xy(99,553),xy(99,575),xy(95,580),xy(71,579),xy(61,581),xy(59,592),xy(60,611),xy(57,618),xy(49,620),xy(24,619),xy(21,617),xy(19,609),xy(19,550),xy(21,541),xy(30,539),xy(89,539),xy(98,541),xy(100,552)]).
midline(r12, [xy(97,580),xy(100,590),xy(98,617),xy(88,620),xy(71,620),xy(60,617)]).
...
midline(r6, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(178,399),xy(188,401),xy(189,423)]).
...
midline(r13, [xy(40,585),xy(39,572),xy(41,561),xy(51,559),xy(80,560)]).
...
midline(r5, [xy(167,184),xy(175,185)]).
...
midline(r4, [xy(160,160),xy(180,160)]).
