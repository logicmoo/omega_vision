...
midline(r2, [xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,466),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(162,32),xy(176,26),xy(191,24),xy(539,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(614,309),xy(606,329),xy(598,340),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,549),xy(612,566),xy(606,572),xy(587,575),xy(381,574),xy(370,571),xy(354,562),xy(314,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(250,381),xy(248,363),xy(239,339),xy(227,344),xy(225,346),xy(227,346)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,402),xy(417,383),xy(419,379),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,346),xy(465,250),xy(463,236),xy(459,228),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
midline(r2, [xy(233,343),xy(234,342)]).
...
midline(r3, [xy(186,130),xy(153,129),xy(135,131),xy(126,134),xy(121,145),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(175,221),xy(203,215),xy(208,204),xy(210,160),xy(206,134),xy(187,130)]).
midline(r3, [xy(206,133),xy(239,99),xy(303,100),xy(329,107),xy(340,113),xy(339,200),xy(357,222),xy(364,240),xy(365,259),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,112),xy(362,103),xy(391,99),xy(453,100),xy(481,108),xy(488,130),xy(489,150),xy(499,160),xy(510,178),xy(514,190),xy(516,213),xy(523,229),xy(540,249),xy(523,270),xy(515,291),xy(514,389),xy(519,415),xy(503,423),xy(480,425),xy(469,429),xy(464,450),xy(464,518),xy(449,524),xy(414,525)]).
midline(r3, [xy(520,416),xy(557,422),xy(561,430),xy(565,454),xy(565,497),xy(561,518),xy(553,523),xy(539,525),xy(490,525),xy(476,523),xy(465,518)]).
...
midline(r14, [xy(524,635),xy(132,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(554,606),xy(555,611),xy(554,633),xy(549,635),xy(525,634)]).
midline(r14, [xy(555,606),xy(574,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r14, [xy(585,606),xy(590,604),xy(609,604),xy(615,606),xy(615,632),xy(613,634),xy(596,635),xy(585,633)]).
midline(r14, [xy(616,605),xy(635,605)]).
...
border(r14).
region(r11, '#aaaaaa', 7600, centroid(61,581)).
perimeter(r11, 720).
polygon(r11, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r11, [xy(50,609),xy(50,570),xy(89,570),xy(89,550),xy(30,550),xy(30,609),xy(50,609)]).
hole(r11, [xy(90,609),xy(89,590),xy(70,590),xy(70,610),xy(90,609)]).
midline(r11, [xy(99,553),xy(100,567),xy(96,580),xy(70,579),xy(61,581),xy(59,595),xy(60,615),xy(57,618),xy(30,620),xy(22,618),xy(19,609),xy(19,551),xy(21,541),xy(31,539),xy(89,539),xy(98,541),xy(100,552)]).
midline(r11, [xy(97,581),xy(100,590),xy(100,609),xy(97,618),xy(70,620),xy(60,617)]).
fillpoint(r11, xy(97,580), 12.8).
fillpoint(r11, xy(60,617), 12.8).
...
fillpoint(r11, xy(54,619), 11.0).
fillpoint(r11, xy(65,619), 11.0).
...
midline(r6, [xy(189,442),xy(190,431),xy(189,426),xy(186,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(177,399),xy(188,401),xy(190,410),xy(189,424)]).
...
region(r12, '#870c25', 2000, centroid(52,572)).
perimeter(r12, 240).
polygon(r12, [xy(49,610),xy(30,609),xy(30,550),xy(89,550),xy(89,570),xy(50,570),xy(49,610)]).
midline(r12, [xy(39,583),xy(41,561),xy(50,559),xy(80,560)]).
midline(r12, [xy(40,584),xy(40,600)]).
fillpoint(r12, xy(42,561), 12.0).
fillpoint(r12, xy(45,560), 11.0).
fillpoint(r12, xy(40,565), 11.0).
fillpoint(r12, xy(51,560), 10.0).
fillpoint(r12, xy(39,586), 10.0).
region(r15, '#2ecc40', 2000, centroid(180,620)).
perimeter(r15, 240).
polygon(r15, [xy(229,630),xy(130,630),xy(130,610),xy(229,610),xy(229,630)]).
midline(r15, [xy(184,620),xy(139,620)]).
midline(r15, [xy(185,620),xy(220,620)]).
...
midline(r10, [xy(517,485),xy(525,485)]).
...
midline(r9, [xy(511,460),xy(530,460)]).
...
region(r13, '#870c25', 400, centroid(80,600)).
perimeter(r13, 80).
polygon(r13, [xy(89,610),xy(70,609),xy(70,590),xy(90,590),xy(89,610)]).
midline(r13, [xy(79,599),xy(80,600)]).
fillpoint(r13, xy(79,600), 10.0).
...
adjacent(r14, r15).
shared_edge(r14, r15, 220).
adjacent(r14, r16).
shared_edge(r14, r16, 660).
adjacent(r14, r17).
