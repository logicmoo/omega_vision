...
midline(r2, [xy(89,49),xy(69,78),xy(64,100),xy(65,258),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,381),xy(79,467),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,49),xy(140,50),xy(162,32),xy(176,26),xy(192,24),xy(538,24),xy(553,26),xy(572,35),xy(590,49),xy(589,150),xy(606,170),xy(613,186),xy(615,200),xy(615,299),xy(613,313),xy(599,339),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,549),xy(613,563),xy(609,571),xy(588,575),xy(381,574),xy(368,570),xy(354,562),xy(312,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
...
midline(r2, [xy(411,468),xy(415,448),xy(414,401),xy(417,383),xy(420,378),xy(426,376),xy(449,374),xy(460,370),xy(465,348),xy(465,251),xy(463,236),xy(459,228),xy(426,223),xy(418,219),xy(414,196),xy(415,174)]).
...
midline(r3, [xy(180,465),xy(130,465),xy(126,464),xy(124,459),xy(125,385),xy(145,383),xy(165,363),xy(165,227),xy(163,224),xy(135,218),xy(124,213),xy(119,188),xy(120,150),xy(124,136),xy(140,130),xy(177,129),xy(206,133),xy(209,149),xy(210,184),xy(209,199),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(340,113),xy(339,200),xy(356,220),xy(363,236),xy(365,259),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,112),xy(362,103),xy(393,99),xy(453,100),xy(481,108),xy(489,136),xy(489,150),xy(506,170),xy(514,190),xy(518,219),xy(527,235),xy(540,249),xy(523,270),xy(515,291),xy(514,388),xy(519,415),xy(503,423),xy(481,425),xy(468,430),xy(464,450),xy(464,518),xy(449,524),xy(414,525)]).
midline(r3, [xy(520,416),xy(557,422),xy(562,433),xy(565,450),xy(565,498),xy(560,520),xy(538,525),xy(490,525),xy(476,523),xy(465,518)]).
...
midline(r14, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(554,607),xy(563,604),xy(578,604),xy(585,606),xy(585,632),xy(577,635),xy(562,635),xy(554,632),xy(555,608)]).
midline(r14, [xy(586,605),xy(613,605),xy(615,632),xy(608,635),xy(585,633)]).
midline(r14, [xy(525,634),xy(549,635),xy(554,633)]).
midline(r14, [xy(615,606),xy(622,604),xy(635,605)]).
...
midline(r11, [xy(99,553),xy(99,544),xy(95,540),xy(70,539),xy(60,543),xy(55,540),xy(45,539),xy(21,541),xy(19,550),xy(19,608),xy(21,618),xy(24,619),xy(89,620),xy(95,619),xy(99,615),xy(100,596),xy(97,580),xy(70,580),xy(62,578),xy(59,568),xy(60,544)]).
midline(r11, [xy(100,554),xy(100,569),xy(97,578)]).
...
midline(r12, [xy(40,585),xy(40,559)]).
midline(r12, [xy(40,586),xy(41,598),xy(50,600),xy(80,600)]).
...
midline(r10, [xy(522,485),xy(504,485)]).
midline(r10, [xy(523,484),xy(525,485)]).
...
midline(r15, [xy(151,620),xy(180,620)]).
...
midline(r9, [xy(509,460),xy(499,460)]).
midline(r9, [xy(510,459),xy(530,460)]).
