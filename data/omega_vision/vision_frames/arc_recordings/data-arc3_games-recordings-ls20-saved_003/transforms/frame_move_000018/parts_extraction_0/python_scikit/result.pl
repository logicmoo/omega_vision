...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(538,24),xy(190,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49)]).
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,190),xy(615,297),xy(613,313),xy(606,329),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,549),xy(612,566),xy(603,573),xy(589,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,380),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,259),xy(64,100),xy(66,86),xy(72,72),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(250,380),xy(248,363),xy(239,338),xy(235,342),xy(229,343),xy(229,345)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,400),xy(418,380),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,349),xy(465,252),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(365,256)).
perimeter(r3, 4560).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(470,460),xy(470,476),xy(465,490),xy(464,509),xy(461,519),xy(457,522),xy(447,517),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r3, [xy(520,420),xy(514,386),xy(515,290),xy(523,270),xy(540,249),xy(530,239),xy(519,221),xy(515,209),xy(511,180),xy(502,164),xy(489,150),xy(487,126),xy(479,107),xy(453,100),xy(390,99),xy(362,103),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(177,129),xy(150,129),xy(126,134),xy(121,145),xy(119,162),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,189),xy(210,160),xy(206,134)]).
midline(r3, [xy(340,114),xy(339,200),xy(357,222),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(354,382),xy(340,400)]).
midline(r3, [xy(471,475),xy(471,477)]).
midline(r3, [xy(473,477),xy(481,483),xy(512,495),xy(523,494),xy(529,489),xy(535,489),xy(558,478),xy(560,476),xy(559,460),xy(549,432)]).
midline(r3, [xy(165,227),xy(165,364),xy(145,383),xy(125,385),xy(124,390),xy(125,464),xy(203,464),xy(205,455),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(560,478),xy(564,490),xy(565,525)]).
...
midline(r19, [xy(524,635),xy(130,635),xy(125,633),xy(124,610),xy(125,605),xy(132,604),xy(548,604),xy(553,605),xy(555,609),xy(555,632),xy(549,635),xy(525,635)]).
midline(r19, [xy(555,606),xy(561,604),xy(585,606),xy(585,632),xy(583,634),xy(561,635),xy(555,633)]).
midline(r19, [xy(586,605),xy(606,604),xy(613,605),xy(614,607),xy(623,604),xy(635,605)]).
midline(r19, [xy(615,608),xy(615,632),xy(613,634),xy(594,635),xy(585,633)]).
...
border(r19).
region(r16, '#aaaaaa', 7600, centroid(58,578)).
perimeter(r16, 720).
polygon(r16, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r16, [xy(90,609),xy(89,550),xy(70,550),xy(69,590),xy(30,590),xy(30,610),xy(90,609)]).
hole(r16, [xy(50,569),xy(49,550),xy(30,550),xy(30,570),xy(50,569)]).
midline(r16, [xy(99,553),xy(99,544),xy(95,540),xy(71,539),xy(60,543),xy(48,539),xy(21,541),xy(19,551),xy(20,575),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(84,620),xy(97,618),xy(100,609),xy(100,554)]).
midline(r16, [xy(60,544),xy(60,569),xy(57,578),xy(48,580),xy(24,579)]).
fillpoint(r16, xy(60,542), 12.8).
fillpoint(r16, xy(22,580), 12.8).
fillpoint(r16, xy(22,541), 12.0).
fillpoint(r16, xy(98,541), 12.0).
fillpoint(r16, xy(57,578), 12.0).
...
fillpoint(r16, xy(59,574), 11.0).
fillpoint(r16, xy(54,579), 11.0).
...
midline(r6, [xy(189,442),xy(190,430),xy(186,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,411),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,412),xy(189,424)]).
...
region(r18, '#870c25', 2000, centroid(68,588)).
perimeter(r18, 240).
polygon(r18, [xy(89,610),xy(30,609),xy(30,590),xy(70,589),xy(70,550),xy(90,550),xy(89,610)]).
midline(r18, [xy(80,587),xy(80,559)]).
midline(r18, [xy(80,588),xy(79,595),xy(75,599),xy(39,600)]).
fillpoint(r18, xy(77,598), 12.0).
fillpoint(r18, xy(79,594), 11.0).
fillpoint(r18, xy(74,599), 11.0).
fillpoint(r18, xy(79,574), 10.0).
fillpoint(r18, xy(39,600), 10.0).
region(r15, '#870c25', 1500, centroid(514,534)).
perimeter(r15, 160).
polygon(r15, [xy(539,550),xy(490,550),xy(490,520),xy(539,520),xy(539,550)]).
midline(r15, [xy(516,534),xy(504,535)]).
midline(r15, [xy(517,535),xy(525,535)]).
fillpoint(r15, xy(504,535), 15.0).
region(r21, '#5a5a5a', 1200, centroid(520,620)).
perimeter(r21, 160).
polygon(r21, [xy(549,630),xy(490,630),xy(490,610),xy(549,610),xy(549,630)]).
midline(r21, [xy(511,620),xy(499,620)]).
midline(r21, [xy(512,620),xy(540,620)]).
fillpoint(r21, xy(499,620), 10.0).
region(r12, '#bebebe', 1000, centroid(514,510)).
perimeter(r12, 140).
polygon(r12, [xy(539,520),xy(490,520),xy(490,500),xy(539,500),xy(539,520)]).
midline(r12, [xy(510,509),xy(499,510)]).
midline(r12, [xy(511,509),xy(530,510)]).
fillpoint(r12, xy(499,510), 10.0).
...
midline(r7, [xy(171,414),xy(155,415),xy(155,435)]).
midline(r7, [xy(172,415),xy(175,415)]).
fillpoint(r7, xy(156,415), 6.0).
fillpoint(r7, xy(161,415), 5.0).
fillpoint(r7, xy(155,428), 5.0).
region(r17, '#870c25', 400, centroid(40,560)).
perimeter(r17, 80).
polygon(r17, [xy(49,570),xy(30,569),xy(30,550),xy(50,550),xy(49,570)]).
midline(r17, [xy(39,559),xy(40,560)]).
...
adjacent(r12, r15).
shared_edge(r12, r15, 50).
adjacent(r13, r14).
shared_edge(r13, r14, 40).
adjacent(r16, r17).
shared_edge(r16, r17, 80).
adjacent(r16, r18).
shared_edge(r16, r18, 240).
adjacent(r19, r20).
shared_edge(r19, r20, 740).
adjacent(r19, r21).
shared_edge(r19, r21, 140).
adjacent(r19, r22).
