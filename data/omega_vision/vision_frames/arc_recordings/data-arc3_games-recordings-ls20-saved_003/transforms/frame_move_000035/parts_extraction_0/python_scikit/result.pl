...
midline(r2, [xy(89,49),xy(69,78),xy(64,100),xy(65,259),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(12,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,49),xy(140,50),xy(160,33),xy(176,26),xy(191,24),xy(537,24),xy(553,26),xy(572,35),xy(590,49),xy(589,150),xy(602,164),xy(611,180),xy(615,206),xy(614,309),xy(606,329),xy(598,340),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,549),xy(613,563),xy(609,571),xy(587,575),xy(381,574),xy(370,571),xy(354,562),xy(314,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
...
midline(r2, [xy(411,468),xy(415,448),xy(414,402),xy(418,380),xy(426,376),xy(448,374),xy(460,370),xy(465,349),xy(465,253),xy(463,236),xy(456,227),xy(430,224),xy(418,219),xy(414,196),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(453,523),xy(414,525)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(480,108),xy(459,101),xy(439,100),xy(422,85),xy(399,75),xy(340,74),xy(326,76),xy(312,82),xy(290,100),xy(239,99),xy(206,133),xy(179,129),xy(153,129),xy(126,134),xy(121,145),xy(119,163),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,188),xy(210,160),xy(206,134)]).
midline(r3, [xy(290,101),xy(302,114),xy(310,128),xy(314,141),xy(316,163),xy(322,177),xy(352,214),xy(360,228),xy(364,241),xy(366,263),xy(373,279),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,198),xy(438,101)]).
midline(r3, [xy(165,227),xy(165,363),xy(145,383),xy(125,385),xy(124,391),xy(125,464),xy(203,464),xy(205,459),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r17, [xy(377,634),xy(126,634),xy(124,629),xy(125,605),xy(134,604),xy(547,604),xy(553,605),xy(555,610),xy(555,630),xy(553,634),xy(549,635),xy(378,635)]).
midline(r17, [xy(555,606),xy(562,604),xy(585,606),xy(585,628),xy(583,634),xy(560,635),xy(555,633)]).
midline(r17, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(608,635),xy(585,633)]).
...
midline(r14, [xy(84,580),xy(61,581),xy(59,593),xy(60,615),xy(57,618),xy(48,620),xy(22,618),xy(19,608),xy(19,551),xy(21,541),xy(30,539),xy(88,539),xy(98,541),xy(100,551),xy(99,575),xy(96,580),xy(85,580)]).
midline(r14, [xy(97,581),xy(100,590),xy(100,608),xy(97,618),xy(74,620),xy(60,617)]).
...
midline(r18, [xy(319,619),xy(139,620)]).
midline(r18, [xy(320,620),xy(420,620)]).
...
midline(r8, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r19, [xy(452,619),xy(540,620)]).
...
midline(r5, [xy(360,135),xy(354,135)]).
midline(r5, [xy(361,135),xy(375,135)]).
...
midline(r4, [xy(360,109),xy(349,110)]).
midline(r4, [xy(361,109),xy(380,110)]).
