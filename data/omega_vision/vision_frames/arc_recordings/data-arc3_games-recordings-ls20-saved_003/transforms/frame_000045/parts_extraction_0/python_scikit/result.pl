...
midline(r2, [xy(112,25),xy(80,24),xy(66,26),xy(60,42),xy(59,97),xy(61,111),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,24),xy(389,24),xy(403,26),xy(414,32),xy(426,26),xy(440,24),xy(519,25),xy(540,19),xy(588,19),xy(601,21),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,482),xy(625,568),xy(622,581),xy(608,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(403,573),xy(388,575),xy(230,574),xy(207,564),xy(189,549),xy(160,549)]).
...
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,383),xy(213,380),xy(203,376),xy(173,372),xy(168,368),xy(165,359),xy(165,140),xy(170,128),xy(181,125),xy(265,125)]).
...
midline(r2, [xy(466,429),xy(468,428),xy(493,441),xy(496,440),xy(495,442)]).
...
midline(r5, [xy(274,234),xy(286,220),xy(314,177),xy(315,82),xy(313,80),xy(303,76),xy(288,74),xy(142,74),xy(130,75),xy(118,80),xy(114,100),xy(115,408),xy(120,421),xy(149,425),xy(160,429),xy(164,440),xy(165,475)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(314,179),xy(317,177),xy(315,176)]).
midline(r5, [xy(278,233),xy(272,239),xy(261,244),xy(239,260),xy(196,304),xy(194,310),xy(195,344),xy(228,345),xy(235,343),xy(279,300),xy(288,287),xy(307,268),xy(276,236)]).
midline(r5, [xy(470,118),xy(471,105),xy(479,89)]).
midline(r5, [xy(480,87),xy(495,81),xy(514,79),xy(534,81),xy(551,88),xy(559,110),xy(560,128),xy(558,144),xy(551,161),xy(544,165),xy(518,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(560,178),xy(564,191),xy(565,248),xy(561,269),xy(552,285),xy(539,300),xy(390,300),xy(370,298),xy(337,286),xy(317,276),xy(308,268),xy(330,248)]).
midline(r5, [xy(540,301),xy(556,320),xy(564,341),xy(565,459),xy(564,465),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(314,275),xy(315,421),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,486),xy(274,513),xy(285,518),xy(329,520),xy(344,518),xy(355,513),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(332,246),xy(383,195),xy(385,188),xy(385,162),xy(384,156),xy(379,154),xy(350,154),xy(344,156),xy(330,168),xy(319,172),xy(316,174),xy(318,176),xy(321,173)]).
midline(r5, [xy(329,169),xy(325,171)]).
midline(r5, [xy(325,173),xy(323,172)]).
...
midline(r24, [xy(524,635),xy(130,635),xy(125,633),xy(125,605),xy(547,604),xy(553,605),xy(555,609),xy(555,632),xy(549,635),xy(525,634)]).
midline(r24, [xy(555,606),xy(561,604),xy(585,606),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r24, [xy(586,605),xy(608,604),xy(615,606),xy(615,630),xy(613,634),xy(608,635),xy(590,635),xy(585,633)]).
...
midline(r25, [xy(304,619),xy(139,620)]).
midline(r25, [xy(305,619),xy(540,620)]).
...
midline(r20, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(552,499),xy(541,501),xy(539,511),xy(541,548),xy(550,550),xy(578,550),xy(587,548),xy(589,543)]).
midline(r20, [xy(589,523),xy(590,510),xy(588,502),xy(578,499),xy(566,500)]).
...
midline(r13, [xy(109,460),xy(99,460)]).
midline(r13, [xy(110,459),xy(130,460)]).
...
midline(r9, [xy(374,182),xy(375,172),xy(373,165),xy(355,165),xy(354,172),xy(355,184),xy(374,184)]).
...
midline(r21, [xy(555,521),xy(555,534),xy(575,535)]).
midline(r21, [xy(555,520),xy(555,514)]).
