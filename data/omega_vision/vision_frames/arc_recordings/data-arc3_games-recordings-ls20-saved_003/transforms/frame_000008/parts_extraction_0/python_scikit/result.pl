...
midline(r2, [xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,339),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(162,32),xy(176,26),xy(191,24),xy(539,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,202),xy(614,309),xy(610,321),xy(599,339),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,391),xy(615,549),xy(611,569),xy(606,572),xy(589,575),xy(380,574),xy(354,562),xy(314,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(250,380),xy(248,363),xy(238,338),xy(234,342),xy(228,343),xy(226,345),xy(228,345)]).
midline(r2, [xy(238,340),xy(237,341)]).
midline(r2, [xy(315,524),xy(349,491),xy(362,482),xy(376,476),xy(398,474),xy(411,469),xy(415,449),xy(414,401),xy(417,383),xy(420,378),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(430,224),xy(418,218),xy(414,195),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(367,263)).
perimeter(r3, 4560).
...
midline(r3, [xy(490,99),xy(472,85),xy(453,76),xy(439,74),xy(381,75),xy(357,85),xy(331,108),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(151,129),xy(126,134),xy(121,145),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,188),xy(210,160),xy(206,134)]).
midline(r3, [xy(489,101),xy(489,150),xy(502,164),xy(510,178),xy(514,191),xy(516,213),xy(523,229),xy(540,249),xy(523,270),xy(515,291),xy(514,384),xy(520,421),xy(478,438),xy(474,446),xy(470,460),xy(469,479),xy(471,494),xy(476,507),xy(475,512),xy(457,521),xy(448,517),xy(433,505),xy(400,504),xy(395,505),xy(394,513),xy(395,544),xy(400,545),xy(433,544),xy(457,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(165,227),xy(165,362),xy(145,383),xy(125,385),xy(124,390),xy(125,464),xy(203,464),xy(205,459),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,479),xy(559,460),xy(555,446),xy(547,430),xy(521,422)]).
midline(r3, [xy(331,109),xy(339,136),xy(339,200),xy(349,210),xy(360,228),xy(364,240),xy(366,263),xy(373,279),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(356,379),xy(340,400)]).
...
midline(r19, [xy(524,635),xy(132,635),xy(126,634),xy(124,629),xy(125,605),xy(544,604),xy(555,606),xy(555,632),xy(548,635),xy(525,634)]).
midline(r19, [xy(556,605),xy(579,604),xy(585,606),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r19, [xy(586,605),xy(606,604),xy(615,606),xy(615,632),xy(607,635),xy(585,633)]).
...
midline(r16, [xy(19,563),xy(20,544),xy(24,540),xy(88,539),xy(98,541),xy(100,550),xy(100,609),xy(99,615),xy(95,619),xy(70,620),xy(59,616),xy(55,619),xy(46,620),xy(22,618),xy(19,605),xy(19,590),xy(23,579),xy(20,575),xy(20,564)]).
midline(r16, [xy(60,615),xy(58,582),xy(46,579),xy(24,579)]).
...
midline(r21, [xy(451,619),xy(540,620)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(165,445),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(179,399),xy(188,401),xy(190,412),xy(189,424)]).
...
midline(r20, [xy(174,619),xy(139,620)]).
midline(r20, [xy(175,620),xy(280,620)]).
...
midline(r5, [xy(410,135),xy(404,135)]).
midline(r5, [xy(411,135),xy(425,135)]).
...
midline(r4, [xy(409,110),xy(399,110)]).
midline(r4, [xy(410,109),xy(430,110)]).
...
midline(r6, [xy(169,164),xy(155,165),xy(155,184),xy(168,185),xy(174,183),xy(175,170),xy(174,166),xy(170,165)]).
...
midline(r14, [xy(424,532),xy(425,521),xy(423,515),xy(405,515),xy(404,521),xy(405,534),xy(424,534)]).
