...
midline(r2, [xy(590,49),xy(561,29),xy(538,24),xy(192,24),xy(170,28),xy(154,37),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,382),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,602),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,535),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(250,381),xy(246,355),xy(239,339),xy(223,349),xy(221,348),xy(219,350),xy(221,350)]).
midline(r2, [xy(240,338),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(266,523),xy(290,525),xy(315,524),xy(350,559),xy(370,571),xy(381,574),xy(587,575),xy(610,570),xy(614,559),xy(615,545),xy(614,380),xy(611,370),xy(599,350),xy(593,344),xy(584,345)]).
midline(r2, [xy(590,51),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(614,309),xy(607,327),xy(594,344)]).
midline(r2, [xy(91,340),xy(95,341)]).
midline(r2, [xy(316,523),xy(340,499),xy(360,483),xy(376,476),xy(398,474),xy(410,470),xy(415,449),xy(414,400),xy(418,380),xy(430,375),xy(456,372),xy(461,369),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(456,227),xy(426,223),xy(418,219),xy(414,199),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(461,520),xy(454,521),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(512,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(511,180),xy(502,164),xy(489,150),xy(489,136),xy(481,109),xy(463,102),xy(439,100),xy(419,83),xy(398,75),xy(331,75),xy(310,83),xy(290,100),xy(239,99),xy(206,133),xy(179,129),xy(150,129),xy(135,131),xy(124,136),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(165,225),xy(164,365),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(130,465),xy(196,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,189),xy(210,160),xy(206,134)]).
midline(r3, [xy(290,101),xy(302,114),xy(311,130),xy(316,163),xy(323,179),xy(352,214),xy(361,230),xy(366,263),xy(373,279),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(356,379),xy(340,400)]).
midline(r3, [xy(341,198),xy(438,101)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,471),xy(558,455),xy(550,439),xy(549,432)]).
...
midline(r19, [xy(377,634),xy(126,634),xy(124,610),xy(125,605),xy(132,604),xy(549,604),xy(554,607),xy(561,604),xy(576,604),xy(583,605),xy(585,610),xy(585,631),xy(579,635),xy(560,635),xy(555,633),xy(548,635),xy(378,635)]).
midline(r19, [xy(585,606),xy(590,604),xy(615,606),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
midline(r19, [xy(616,605),xy(635,605)]).
midline(r19, [xy(555,608),xy(555,632)]).
...
midline(r16, [xy(19,563),xy(20,544),xy(24,540),xy(88,539),xy(98,541),xy(100,553),xy(100,609),xy(99,615),xy(95,619),xy(71,620),xy(59,616),xy(49,620),xy(22,618),xy(19,608),xy(19,590),xy(23,579),xy(20,575),xy(20,564)]).
midline(r16, [xy(60,615),xy(60,594),xy(57,581),xy(48,579),xy(24,580)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(189,426),xy(185,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,411),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,424)]).
...
midline(r20, [xy(185,619),xy(260,620)]).
...
midline(r17, [xy(41,559),xy(39,560)]).
midline(r17, [xy(42,559),xy(78,561),xy(80,570),xy(80,600)]).
...
midline(r5, [xy(373,134),xy(375,135)]).
...
midline(r4, [xy(359,110),xy(349,110)]).
midline(r4, [xy(360,109),xy(380,110)]).
...
midline(r6, [xy(155,177),xy(155,165),xy(174,165),xy(174,183),xy(168,185),xy(156,184),xy(154,178)]).
...
midline(r14, [xy(405,527),xy(405,515),xy(424,515),xy(425,520),xy(423,534),xy(406,534),xy(405,528)]).
...
midline(r9, [xy(155,421),xy(155,415),xy(175,415)]).
midline(r9, [xy(154,422),xy(155,435)]).
