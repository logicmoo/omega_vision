...
midline(r2, [xy(508,25),xy(195,24),xy(170,28),xy(154,37),xy(140,50),xy(89,49),xy(69,78),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,601),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(509,25),xy(538,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(604,167),xy(614,190),xy(615,299),xy(611,319),xy(602,335),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,546),xy(613,563),xy(609,571),xy(589,575),xy(381,574),xy(370,571),xy(354,562),xy(314,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(244,349),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,448),xy(414,403),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,348),xy(465,251),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,197),xy(415,174)]).
...
midline(r3, [xy(124,137),xy(126,134),xy(135,131),xy(150,129),xy(176,129),xy(206,133),xy(210,160),xy(209,199),xy(203,215),xy(165,225),xy(135,218),xy(124,213),xy(120,199),xy(119,160),xy(124,138)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(340,113),xy(339,200),xy(352,214),xy(360,228),xy(364,241),xy(366,263),xy(373,279),xy(390,299),xy(377,314),xy(369,328),xy(365,340),xy(364,359),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,112),xy(362,103),xy(390,99),xy(453,100),xy(481,108),xy(488,130),xy(489,150),xy(506,170),xy(514,190),xy(518,219),xy(527,235),xy(540,249),xy(525,267),xy(516,286),xy(514,302),xy(515,325)]).
midline(r3, [xy(164,226),xy(165,363),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(131,465),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r9, [xy(433,544),xy(402,545),xy(395,543),xy(395,505),xy(429,504),xy(454,519),xy(457,522),xy(434,543)]).
midline(r9, [xy(458,521),xy(476,511),xy(470,489),xy(469,470),xy(471,455),xy(479,439)]).
midline(r9, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r9, [xy(552,509),xy(558,494),xy(560,470),xy(558,455),xy(550,439),xy(551,437),xy(534,431),xy(519,429),xy(495,431),xy(480,437)]).
midline(r9, [xy(551,436),xy(560,421),xy(561,417),xy(557,409),xy(560,410)]).
...
midline(r20, [xy(418,635),xy(133,635),xy(126,634),xy(124,629),xy(125,605),xy(131,604),xy(547,604),xy(555,606),xy(555,630),xy(553,634),xy(549,635),xy(419,635)]).
midline(r20, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r20, [xy(585,606),xy(590,604),xy(609,604),xy(614,607),xy(620,604),xy(635,605)]).
...
midline(r17, [xy(99,553),xy(100,609),xy(97,618),xy(70,620),xy(60,616),xy(48,620),xy(30,620),xy(22,618),xy(19,609),xy(19,591),xy(23,579),xy(20,575),xy(19,566),xy(21,541),xy(33,539),xy(89,539),xy(98,541),xy(100,552)]).
midline(r17, [xy(60,615),xy(58,582),xy(49,579),xy(24,579)]).
...
midline(r21, [xy(305,619),xy(420,620)]).
...
midline(r8, [xy(189,442),xy(188,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(176,399),xy(188,401),xy(190,411),xy(189,423)]).
...
midline(r22, [xy(451,620),xy(439,620)]).
midline(r22, [xy(452,620),xy(540,620)]).
...
midline(r6, [xy(511,360),xy(499,360)]).
midline(r6, [xy(512,360),xy(530,360)]).
...
midline(r15, [xy(424,532),xy(425,521),xy(423,515),xy(405,515),xy(404,520),xy(405,534),xy(424,534)]).
