...
midline(r2, [xy(590,49),xy(561,29),xy(549,25),xy(535,24),xy(190,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49)]).
midline(r2, [xy(590,51),xy(589,150),xy(604,167),xy(614,191),xy(615,298),xy(613,313),xy(606,329),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,549),xy(612,566),xy(603,573),xy(586,575),xy(380,574),xy(354,562),xy(314,524),xy(292,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,467),xy(79,381),xy(83,355),xy(90,339),xy(90,299),xy(75,282),xy(65,259),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(244,349),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(399,474),xy(411,469),xy(415,448),xy(414,400),xy(417,383),xy(420,378),xy(426,376),xy(459,371),xy(463,363),xy(465,347),xy(465,251),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,199),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,471),xy(471,494),xy(477,510),xy(469,516),xy(449,524),xy(414,525)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,470),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(512,183),xy(502,164),xy(489,150),xy(486,122),xy(482,110),xy(476,106),xy(453,100),xy(390,99),xy(362,103),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(164,174),xy(165,275)]).
...
midline(r16, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(555,606),xy(555,632),xy(548,635),xy(525,634)]).
midline(r16, [xy(556,605),xy(579,604),xy(585,606),xy(585,629),xy(583,634),xy(578,635),xy(560,635),xy(555,633)]).
midline(r16, [xy(586,605),xy(609,604),xy(614,607),xy(626,604),xy(635,605)]).
midline(r16, [xy(615,608),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r13, [xy(99,553),xy(100,568),xy(96,580),xy(70,579),xy(61,581),xy(59,590),xy(60,613),xy(57,618),xy(30,620),xy(22,618),xy(19,609),xy(19,550),xy(21,541),xy(33,539),xy(89,539),xy(98,541),xy(100,552)]).
midline(r13, [xy(97,581),xy(100,590),xy(100,609),xy(97,618),xy(70,620),xy(60,617)]).
...
midline(r18, [xy(406,620),xy(540,620)]).
fillpoint(r18, xy(199,620), 10.0).
region(r6, '#2ecc40', 4700, centroid(164,405)).
perimeter(r6, 700).
polygon(r6, [xy(209,470),xy(120,469),xy(120,380),xy(140,379),xy(140,350),xy(189,350),xy(190,379),xy(210,380),xy(209,470)]).
hole(r6, [xy(200,459),xy(199,390),xy(130,390),xy(130,460),xy(200,459)]).
midline(r6, [xy(157,372),xy(143,384),xy(125,385),xy(125,464),xy(203,464),xy(205,457),xy(204,386),xy(186,384),xy(169,369),xy(159,369),xy(158,371)]).
fillpoint(r6, xy(159,370), 20.0).
...
midline(r7, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,445),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r14, [xy(39,586),xy(41,561),xy(51,559),xy(80,560)]).
...
region(r5, '#870c25', 1500, centroid(164,334)).
perimeter(r5, 160).
polygon(r5, [xy(189,350),xy(140,350),xy(140,320),xy(189,320),xy(189,350)]).
midline(r5, [xy(166,334),xy(154,335)]).
midline(r5, [xy(167,335),xy(175,335)]).
fillpoint(r5, xy(154,335), 15.0).
region(r17, '#2ecc40', 1200, centroid(160,620)).
perimeter(r17, 160).
polygon(r17, [xy(189,630),xy(130,630),xy(130,610),xy(189,610),xy(189,630)]).
midline(r17, [xy(160,620),xy(139,620)]).
midline(r17, [xy(161,620),xy(180,620)]).
fillpoint(r17, xy(139,620), 10.0).
region(r4, '#bebebe', 1000, centroid(164,310)).
perimeter(r4, 140).
polygon(r4, [xy(189,320),xy(140,320),xy(140,300),xy(189,300),xy(189,320)]).
midline(r4, [xy(170,310),xy(149,310)]).
midline(r4, [xy(171,310),xy(180,310)]).
fillpoint(r4, xy(149,310), 10.0).
...
adjacent(r2, r3).
shared_edge(r2, r3, 3350).
adjacent(r2, r4).
shared_edge(r2, r4, 40).
adjacent(r2, r5).
shared_edge(r2, r5, 60).
adjacent(r2, r6).
shared_edge(r2, r6, 370).
adjacent(r2, r13).
