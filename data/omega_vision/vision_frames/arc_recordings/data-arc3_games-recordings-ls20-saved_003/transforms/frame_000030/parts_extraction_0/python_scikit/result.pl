...
midline(r2, [xy(89,49),xy(69,78),xy(64,100),xy(65,258),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,384),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(13,635),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,49),xy(140,50),xy(162,32),xy(176,26),xy(191,24),xy(539,24),xy(553,26),xy(572,35),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(615,299),xy(613,313),xy(599,339),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,392),xy(615,549),xy(612,566),xy(606,572),xy(589,575),xy(391,575),xy(376,573),xy(360,566),xy(340,550),xy(315,525),xy(310,524),xy(293,525),xy(265,522),xy(245,530),xy(225,534),xy(175,534)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(266,299),xy(264,296),xy(265,174)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(398,474),xy(411,469),xy(415,449),xy(414,403),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,347),xy(465,253),xy(463,236),xy(459,228),xy(449,225),xy(431,224),xy(419,220),xy(414,198),xy(415,174)]).
midline(r2, [xy(267,300),xy(290,300)]).
...
midline(r3, [xy(124,137),xy(126,134),xy(135,131),xy(152,129),xy(179,129),xy(206,133),xy(210,161),xy(209,199),xy(203,215),xy(165,225),xy(135,218),xy(124,213),xy(120,199),xy(119,161),xy(124,138)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(340,113),xy(339,200),xy(356,220),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(356,379),xy(340,400)]).
midline(r3, [xy(341,112),xy(350,107),xy(376,100),xy(439,99),xy(467,103),xy(482,110),xy(488,130),xy(490,150)]).
midline(r3, [xy(164,226),xy(165,363),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(133,465),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
...
region(r7, '#2ecc40', 37500, centroid(515,417)).
perimeter(r7, 1320).
...
midline(r7, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(453,523),xy(414,525)]).
midline(r7, [xy(520,420),xy(514,388),xy(515,290),xy(519,279),xy(523,277),xy(548,274),xy(560,270),xy(565,249),xy(565,224)]).
midline(r7, [xy(549,432),xy(550,439),xy(558,455),xy(560,472),xy(558,494),xy(552,509),xy(534,518),xy(518,520),xy(495,518),xy(479,510)]).
...
fillpoint(r7, xy(448,524), 26.0).
fillpoint(r7, xy(565,236), 25.0).
fillpoint(r7, xy(514,345), 25.0).
fillpoint(r7, xy(414,525), 25.0).
...
midline(r18, [xy(524,635),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(548,604),xy(555,606),xy(555,632),xy(547,635),xy(525,634)]).
midline(r18, [xy(556,605),xy(579,604),xy(584,607),xy(590,604),xy(613,605),xy(615,606),xy(615,632),xy(609,635),xy(590,635),xy(585,633),xy(579,635),xy(560,635),xy(555,633)]).
midline(r18, [xy(616,605),xy(635,605)]).
midline(r18, [xy(585,608),xy(585,632)]).
...
midline(r15, [xy(99,553),xy(98,542),xy(89,539),xy(32,539),xy(21,541),xy(19,550),xy(19,608),xy(21,618),xy(31,620),xy(57,618),xy(60,615),xy(59,590),xy(61,581),xy(96,579),xy(100,569),xy(100,554)]).
midline(r15, [xy(97,580),xy(100,590),xy(98,617),xy(88,620),xy(70,620),xy(60,617)]).
...
midline(r20, [xy(504,619),xy(339,620)]).
midline(r20, [xy(505,619),xy(540,620)]).
...
midline(r9, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r16, [xy(40,585),xy(39,570),xy(41,561),xy(50,559),xy(80,560)]).
midline(r16, [xy(40,586),xy(40,600)]).
...
midline(r8, [xy(511,234),xy(525,235)]).
