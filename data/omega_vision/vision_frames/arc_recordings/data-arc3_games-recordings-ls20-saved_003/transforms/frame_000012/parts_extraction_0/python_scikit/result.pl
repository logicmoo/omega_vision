...
midline(r2, [xy(590,49),xy(561,29),xy(538,24),xy(190,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49)]).
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,191),xy(615,299),xy(612,316),xy(602,335),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,549),xy(612,566),xy(603,573),xy(586,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(292,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,468),xy(79,381),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,258),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(237,339),xy(237,341)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(398,474),xy(410,470),xy(415,449),xy(414,401),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,252),xy(463,236),xy(456,227),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,626),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(91,339),xy(96,343),xy(99,342),xy(100,345),xy(101,343)]).
midline(r2, [xy(240,339),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(102,346),xy(103,347)]).
...
border(r2).
region(r3, '#2ecc40', 98800, centroid(309,204)).
perimeter(r3, 3120).
...
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(326,106),xy(340,113),xy(339,200),xy(357,222),xy(363,236),xy(365,259),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,112),xy(350,107),xy(376,100),xy(433,99),xy(467,103),xy(481,108),xy(487,126),xy(490,150)]).
midline(r3, [xy(164,226),xy(165,363),xy(145,383),xy(125,385),xy(124,456),xy(125,464),xy(131,465),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
...
region(r7, '#2ecc40', 36600, centroid(518,414)).
perimeter(r7, 1440).
polygon(r7, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,250),xy(539,250),xy(540,200),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
hole(r7, [xy(520,489),xy(520,480),xy(529,480),xy(530,470),xy(520,470),xy(519,460),xy(510,460),xy(510,469),xy(500,470),xy(500,479),xy(509,480),xy(510,490),xy(520,489)]).
hole(r7, [xy(430,539),xy(429,510),xy(400,510),xy(400,540),xy(430,539)]).
midline(r7, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(457,522),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r7, [xy(477,511),xy(479,510),xy(495,518),xy(511,520),xy(534,518),xy(551,511)]).
midline(r7, [xy(552,509),xy(558,494),xy(560,471),xy(558,455),xy(550,439),xy(549,432)]).
midline(r7, [xy(520,420),xy(514,387),xy(515,290),xy(520,278),xy(530,275),xy(549,274),xy(561,269),xy(565,249),xy(565,224)]).
fillpoint(r7, xy(548,431), 41.0).
fillpoint(r7, xy(477,511), 39.0).
fillpoint(r7, xy(478,438), 38.8).
fillpoint(r7, xy(551,511), 38.8).
fillpoint(r7, xy(521,422), 38.1).
fillpoint(r7, xy(538,427), 38.1).
fillpoint(r7, xy(524,423), 37.3).
fillpoint(r7, xy(535,426), 37.3).
fillpoint(r7, xy(528,424), 37.0).
fillpoint(r7, xy(531,425), 37.0).
fillpoint(r7, xy(507,427), 33.1).
fillpoint(r7, xy(492,432), 33.1).
fillpoint(r7, xy(504,428), 32.6).
fillpoint(r7, xy(495,431), 32.6).
fillpoint(r7, xy(501,429), 32.3).
fillpoint(r7, xy(498,430), 32.3).
fillpoint(r7, xy(471,456), 32.0).
fillpoint(r7, xy(558,456), 32.0).
fillpoint(r7, xy(471,493), 32.0).
fillpoint(r7, xy(558,493), 32.0).
fillpoint(r7, xy(496,518), 32.0).
fillpoint(r7, xy(533,518), 32.0).
fillpoint(r7, xy(470,462), 31.0).
fillpoint(r7, xy(559,462), 31.0).
fillpoint(r7, xy(470,488), 31.0).
fillpoint(r7, xy(559,488), 31.0).
fillpoint(r7, xy(502,519), 31.0).
fillpoint(r7, xy(528,519), 31.0).
fillpoint(r7, xy(469,475), 30.0).
fillpoint(r7, xy(559,475), 30.0).
fillpoint(r7, xy(511,520), 30.0).
fillpoint(r7, xy(560,270), 29.7).
fillpoint(r7, xy(519,279), 29.7).
fillpoint(r7, xy(561,268), 29.0).
fillpoint(r7, xy(558,271), 29.0).
fillpoint(r7, xy(521,278), 29.0).
fillpoint(r7, xy(518,281), 29.0).
fillpoint(r7, xy(458,521), 29.0).
fillpoint(r7, xy(562,265), 28.0).
fillpoint(r7, xy(555,272), 28.0).
fillpoint(r7, xy(524,277), 28.0).
fillpoint(r7, xy(517,284), 28.0).
fillpoint(r7, xy(563,262), 27.0).
fillpoint(r7, xy(552,273), 27.0).
fillpoint(r7, xy(527,276), 27.0).
fillpoint(r7, xy(516,287), 27.0).
fillpoint(r7, xy(564,258), 26.0).
fillpoint(r7, xy(548,274), 26.0).
fillpoint(r7, xy(532,275), 26.0).
fillpoint(r7, xy(515,292), 26.0).
fillpoint(r7, xy(515,398), 26.0).
fillpoint(r7, xy(565,236), 25.0).
fillpoint(r7, xy(514,345), 25.0).
...
midline(r20, [xy(169,605),xy(125,605),xy(124,628),xy(125,634),xy(130,635),xy(553,634),xy(555,632),xy(555,612),xy(554,606),xy(549,604),xy(170,605)]).
midline(r20, [xy(555,606),xy(560,604),xy(585,606),xy(585,632),xy(583,634),xy(564,635),xy(555,633)]).
midline(r20, [xy(586,605),xy(608,604),xy(615,606),xy(615,632),xy(609,635),xy(590,635),xy(585,633)]).
...
midline(r17, [xy(19,563),xy(20,575),xy(23,580),xy(20,584),xy(19,596),xy(21,618),xy(49,620),xy(59,617),xy(59,584),xy(55,580),xy(24,579)]).
midline(r17, [xy(61,617),xy(71,620),xy(89,620),xy(95,619),xy(99,615),xy(100,550),xy(98,542),xy(88,539),xy(24,540),xy(20,544),xy(20,562)]).
...
midline(r21, [xy(291,619),xy(360,620)]).
...
midline(r9, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(164,449),xy(151,450),xy(142,448),xy(139,433),xy(140,404),xy(144,400),xy(177,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r22, [xy(479,620),xy(379,620)]).
midline(r22, [xy(480,620),xy(540,620)]).
...
midline(r18, [xy(52,560),xy(68,559),xy(78,561),xy(80,600)]).
...
region(r8, '#870c25', 1500, centroid(514,234)).
perimeter(r8, 160).
polygon(r8, [xy(539,250),xy(490,250),xy(490,220),xy(539,220),xy(539,250)]).
midline(r8, [xy(516,234),xy(504,235)]).
midline(r8, [xy(517,234),xy(525,235)]).
fillpoint(r8, xy(504,235), 15.0).
region(r6, '#bebebe', 1000, centroid(514,210)).
perimeter(r6, 140).
polygon(r6, [xy(539,220),xy(490,220),xy(490,200),xy(539,200),xy(539,220)]).
midline(r6, [xy(509,210),xy(499,210)]).
midline(r6, [xy(510,210),xy(530,210)]).
fillpoint(r6, xy(499,210), 10.0).
...
midline(r4, [xy(169,164),xy(155,165),xy(155,184),xy(167,185),xy(174,183),xy(175,170),xy(174,166),xy(170,165)]).
...
midline(r15, [xy(424,532),xy(425,520),xy(423,515),xy(405,515),xy(404,520),xy(405,534),xy(424,534)]).
...
midline(r10, [xy(155,421),xy(155,415),xy(175,415)]).
midline(r10, [xy(155,422),xy(155,435)]).
...
adjacent(r7, r8).
shared_edge(r7, r8, 80).
adjacent(r7, r15).
shared_edge(r7, r15, 120).
adjacent(r9, r10).
...
adjacent(r20, r21).
shared_edge(r20, r21, 500).
adjacent(r20, r22).
shared_edge(r20, r22, 380).
adjacent(r20, r23).
