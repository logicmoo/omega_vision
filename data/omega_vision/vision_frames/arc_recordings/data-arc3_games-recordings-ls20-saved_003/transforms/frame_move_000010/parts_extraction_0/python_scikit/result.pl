...
midline(r2, [xy(589,51),xy(589,150),xy(606,170),xy(614,190),xy(615,297),xy(613,313),xy(604,332),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,548),xy(612,566),xy(609,571),xy(603,573),xy(589,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(292,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,381),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,258),xy(64,100),xy(66,86),xy(72,72),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(240,340),xy(238,338),xy(234,342)]).
midline(r2, [xy(238,340),xy(237,341)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(399,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,446),xy(414,400),xy(418,380),xy(426,376),xy(448,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,347),xy(465,252),xy(463,236),xy(456,227),xy(426,223),xy(418,219),xy(414,198),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,628),xy(113,634),xy(6,634),xy(4,627),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(240,338),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(91,340),xy(99,343)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(366,262)).
perimeter(r3, 4460).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(489,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(389,450),xy(290,449),xy(290,350),xy(340,349),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(459,521),xy(447,517),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,386),xy(515,290),xy(525,267),xy(540,249),xy(527,235),xy(517,216),xy(514,198),xy(515,150),xy(513,136),xy(504,117),xy(489,99),xy(376,100),xy(353,106),xy(340,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(190,130),xy(151,129),xy(126,134),xy(121,145),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,363),xy(145,383),xy(125,385),xy(125,464),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,186),xy(210,160),xy(206,134)]).
midline(r3, [xy(339,114),xy(339,200),xy(356,220),xy(364,240),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(365,340),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,474),xy(558,455),xy(550,439),xy(549,432)]).
...
midline(r19, [xy(377,634),xy(126,634),xy(124,629),xy(124,610),xy(125,605),xy(132,604),xy(546,604),xy(553,605),xy(555,610),xy(555,631),xy(553,634),xy(548,635),xy(378,635)]).
midline(r19, [xy(555,606),xy(562,604),xy(583,605),xy(585,614),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r19, [xy(585,606),xy(591,604),xy(609,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r19, [xy(615,608),xy(615,631),xy(613,634),xy(591,635),xy(585,633)]).
...
midline(r16, [xy(43,539),xy(24,540),xy(20,544),xy(19,567),xy(20,575),xy(23,579),xy(19,590),xy(20,615),xy(21,618),xy(35,620),xy(55,619),xy(59,616),xy(60,590),xy(58,582),xy(48,579),xy(24,579)]).
midline(r16, [xy(44,539),xy(89,539),xy(98,541),xy(99,544),xy(100,609),xy(98,617),xy(88,620),xy(71,620),xy(60,617)]).
...
midline(r21, [xy(504,619),xy(339,620)]).
midline(r21, [xy(505,619),xy(540,620)]).
...
midline(r8, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(163,449),xy(144,449),xy(140,445),xy(139,437),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r20, [xy(280,619),xy(320,620)]).
...
region(r7, '#870c25', 1500, centroid(464,184)).
perimeter(r7, 160).
polygon(r7, [xy(489,200),xy(440,200),xy(440,170),xy(489,170),xy(489,200)]).
midline(r7, [xy(466,184),xy(454,185)]).
midline(r7, [xy(467,185),xy(475,185)]).
fillpoint(r7, xy(454,185), 15.0).
region(r4, '#bebebe', 1000, centroid(464,160)).
perimeter(r4, 140).
polygon(r4, [xy(489,170),xy(440,170),xy(440,150),xy(489,150),xy(489,170)]).
midline(r4, [xy(459,160),xy(449,160)]).
midline(r4, [xy(460,160),xy(480,160)]).
fillpoint(r4, xy(449,160), 10.0).
...
midline(r5, [xy(155,177),xy(155,184),xy(169,185),xy(174,183),xy(175,176),xy(174,166),xy(166,164),xy(155,165),xy(155,176)]).
...
midline(r14, [xy(405,527),xy(405,534),xy(419,535),xy(424,533),xy(425,526),xy(424,516),xy(418,514),xy(405,515),xy(405,526)]).
...
midline(r9, [xy(172,415),xy(175,415)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 420).
adjacent(r19, r21).
shared_edge(r19, r21, 460).
adjacent(r19, r22).
