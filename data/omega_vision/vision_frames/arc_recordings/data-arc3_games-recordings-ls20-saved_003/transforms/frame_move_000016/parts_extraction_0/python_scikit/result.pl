...
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,191),xy(615,296),xy(613,313),xy(604,332),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,391),xy(615,549),xy(612,566),xy(609,571),xy(603,573),xy(588,575),xy(380,574),xy(354,562),xy(315,525),xy(273,524),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(80,481),xy(79,463),xy(79,382),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,258),xy(64,104),xy(68,80),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(240,339),xy(236,339),xy(236,341)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(398,474),xy(410,470),xy(415,449),xy(414,403),xy(417,383),xy(420,378),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,347),xy(465,250),xy(463,236),xy(456,227),xy(426,223),xy(418,218),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,628),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(365,257)).
perimeter(r3, 4660).
...
midline(r3, [xy(180,465),xy(131,465),xy(126,464),xy(124,459),xy(125,385),xy(145,383),xy(165,362),xy(165,226),xy(124,213),xy(119,189),xy(120,150),xy(124,136),xy(140,130),xy(179,129),xy(206,133),xy(209,150),xy(210,189),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(326,106),xy(340,113),xy(339,200),xy(357,222),xy(364,240),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
midline(r3, [xy(341,112),xy(362,103),xy(392,99),xy(453,100),xy(481,108),xy(488,130),xy(489,150),xy(506,170),xy(513,186),xy(515,209),xy(519,221),xy(527,235),xy(540,249),xy(525,267),xy(515,290),xy(515,373),xy(514,375),xy(464,424),xy(465,459),xy(470,472),xy(471,494),xy(477,510),xy(457,522),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r3, [xy(471,472),xy(489,462),xy(500,460),xy(506,455),xy(517,454),xy(523,455),xy(529,460),xy(535,460),xy(560,474),xy(559,489),xy(555,503),xy(552,509),xy(543,515),xy(529,519),xy(512,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(560,471),xy(565,447),xy(565,415),xy(549,399),xy(534,393),xy(515,375)]).
midline(r3, [xy(181,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r19, [xy(524,635),xy(139,635),xy(125,633),xy(125,605),xy(549,604),xy(553,605),xy(555,609),xy(554,633),xy(548,635),xy(525,634)]).
midline(r19, [xy(555,606),xy(579,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(561,635),xy(555,633)]).
midline(r19, [xy(585,606),xy(590,604),xy(609,604),xy(614,607),xy(621,604),xy(635,605)]).
midline(r19, [xy(615,608),xy(615,632),xy(613,634),xy(591,635),xy(585,633)]).
...
midline(r16, [xy(99,553),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,550),xy(19,569),xy(23,579),xy(19,591),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(48,579),xy(24,580)]).
midline(r16, [xy(100,554),xy(100,609),xy(98,617),xy(89,620),xy(71,620),xy(60,617)]).
...
region(r20, '#2ecc40', 6400, centroid(290,620)).
perimeter(r20, 680).
polygon(r20, [xy(449,630),xy(130,630),xy(130,610),xy(449,610),xy(449,630)]).
midline(r20, [xy(425,619),xy(139,620)]).
midline(r20, [xy(426,620),xy(440,620)]).
...
midline(r6, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,424)]).
...
region(r21, '#5a5a5a', 2000, centroid(500,620)).
perimeter(r21, 240).
polygon(r21, [xy(549,630),xy(450,630),xy(450,610),xy(549,610),xy(549,630)]).
midline(r21, [xy(504,620),xy(459,620)]).
midline(r21, [xy(505,620),xy(540,620)]).
fillpoint(r21, xy(459,620), 10.0).
...
midline(r4, [xy(169,164),xy(155,165),xy(155,184),xy(165,185),xy(174,183),xy(175,170),xy(174,166),xy(170,165)]).
...
midline(r14, [xy(419,514),xy(405,515),xy(405,534),xy(419,535),xy(424,533),xy(424,516),xy(420,515)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 660).
adjacent(r19, r21).
shared_edge(r19, r21, 220).
adjacent(r19, r22).
