...
midline(r2, [xy(590,49),xy(561,29),xy(535,24),xy(191,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49)]).
midline(r2, [xy(590,51),xy(589,150),xy(604,167),xy(614,191),xy(615,299),xy(611,319),xy(602,335),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,549),xy(611,569),xy(603,573),xy(589,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(292,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,380),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,259),xy(64,102),xy(69,78),xy(77,64),xy(89,51)]).
...
midline(r2, [xy(411,468),xy(414,459),xy(414,400),xy(417,383),xy(420,378),xy(426,376),xy(449,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,349),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(430,224),xy(419,220),xy(414,198),xy(415,174)]).
...
midline(r3, [xy(186,130),xy(151,129),xy(135,131),xy(124,136),xy(120,150),xy(119,186),xy(124,213),xy(135,218),xy(163,224),xy(165,228),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(197,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(187,130),xy(206,133),xy(210,161),xy(208,204),xy(203,215),xy(165,225)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(339,113),xy(339,200),xy(356,220),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
midline(r3, [xy(340,112),xy(362,103),xy(391,99),xy(453,100),xy(481,108),xy(489,136),xy(489,150),xy(506,170),xy(513,186),xy(518,219),xy(527,235),xy(540,249),xy(525,267),xy(516,286),xy(514,300),xy(515,373),xy(514,375),xy(464,424),xy(465,459),xy(470,473),xy(471,494),xy(477,510),xy(457,521),xy(451,519),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523),xy(454,521)]).
midline(r3, [xy(471,472),xy(489,462),xy(500,460),xy(510,454),xy(523,455),xy(529,460),xy(535,460),xy(559,472),xy(561,469),xy(565,448),xy(564,414),xy(545,396),xy(534,393),xy(515,375)]).
midline(r3, [xy(560,473),xy(559,489),xy(555,503),xy(552,509),xy(543,515),xy(529,519),xy(512,520),xy(495,518),xy(479,510)]).
...
midline(r19, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(124,610),xy(125,605),xy(133,604),xy(549,604),xy(555,606),xy(554,633),xy(525,635)]).
midline(r19, [xy(556,605),xy(579,604),xy(584,607),xy(595,604),xy(609,604),xy(614,607),xy(621,604),xy(635,605)]).
midline(r19, [xy(585,608),xy(585,629),xy(583,634),xy(564,635),xy(555,633)]).
...
midline(r16, [xy(99,553),xy(100,608),xy(98,617),xy(89,620),xy(64,619),xy(59,615),xy(60,591),xy(57,581),xy(48,579),xy(24,580),xy(21,577),xy(19,569),xy(21,541),xy(31,539),xy(89,539),xy(98,541),xy(100,552)]).
midline(r16, [xy(22,580),xy(19,591),xy(21,618),xy(48,620),xy(59,617)]).
...
midline(r20, [xy(305,620),xy(440,620)]).
...
midline(r6, [xy(189,442),xy(189,426),xy(185,424),xy(165,425),xy(164,449),xy(152,450),xy(142,448),xy(139,436),xy(140,404),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,424)]).
...
midline(r21, [xy(471,620),xy(459,620)]).
midline(r21, [xy(472,620),xy(540,620)]).
...
midline(r9, [xy(522,435),xy(504,435)]).
midline(r9, [xy(523,435),xy(525,435)]).
...
midline(r8, [xy(154,422),xy(155,415),xy(175,415)]).
midline(r8, [xy(154,423),xy(155,435)]).
