...
midline(r2, [xy(508,25),xy(190,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49),xy(69,78),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,339),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(509,25),xy(537,24),xy(553,26),xy(572,35),xy(590,49),xy(589,150),xy(604,167),xy(614,190),xy(615,299),xy(612,316),xy(602,335),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,549),xy(613,563),xy(609,571),xy(586,575),xy(381,574),xy(368,570),xy(354,562),xy(312,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(240,340),xy(237,338),xy(231,344)]).
midline(r2, [xy(237,340),xy(235,342)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,400),xy(418,380),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,349),xy(465,251),xy(463,236),xy(456,227),xy(431,224),xy(419,220),xy(414,199),xy(415,174)]).
midline(r2, [xy(240,338),xy(238,337)]).
midline(r2, [xy(240,336),xy(248,308),xy(262,301),xy(265,295),xy(265,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(467,517),xy(449,524),xy(414,525)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,472),xy(558,494),xy(552,509),xy(534,518),xy(518,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(520,420),xy(514,388),xy(515,290),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(513,186),xy(506,170),xy(489,150),xy(488,130),xy(482,110),xy(467,103),xy(437,99),xy(376,100),xy(353,106),xy(340,113),xy(329,107),xy(303,100),xy(239,99),xy(164,174),xy(165,325)]).
midline(r3, [xy(339,114),xy(339,200),xy(356,220),xy(364,240),xy(365,259),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
...
midline(r16, [xy(377,634),xy(130,635),xy(125,633),xy(124,610),xy(125,605),xy(131,604),xy(553,605),xy(555,606),xy(555,631),xy(553,634),xy(547,635),xy(378,634)]).
midline(r16, [xy(556,605),xy(574,604),xy(585,606),xy(585,632),xy(575,635),xy(555,633)]).
midline(r16, [xy(586,605),xy(613,605),xy(615,610),xy(615,632),xy(608,635),xy(585,633)]).
midline(r16, [xy(615,606),xy(620,604),xy(635,605)]).
...
midline(r13, [xy(99,553),xy(99,544),xy(95,540),xy(33,539),xy(21,541),xy(19,550),xy(19,606),xy(21,618),xy(37,620),xy(57,618),xy(60,612),xy(59,590),xy(61,581),xy(70,579),xy(96,580),xy(100,569),xy(100,554)]).
midline(r13, [xy(97,581),xy(100,591),xy(100,608),xy(97,618),xy(70,620),xy(60,617)]).
...
midline(r18, [xy(384,619),xy(219,620)]).
midline(r18, [xy(385,619),xy(540,620)]).
fillpoint(r18, xy(219,620), 10.0).
region(r7, '#aaaaaa', 3800, centroid(165,429)).
perimeter(r7, 460).
polygon(r7, [xy(199,460),xy(130,459),xy(130,390),xy(139,390),xy(140,400),xy(189,400),xy(190,390),xy(200,390),xy(199,460)]).
...
midline(r7, [xy(189,442),xy(189,425),xy(171,424),xy(165,425),xy(165,446),xy(163,449),xy(150,450),xy(142,448),xy(139,439),xy(140,409),xy(135,403),xy(135,394)]).
midline(r7, [xy(141,409),xy(150,404),xy(179,404),xy(189,410),xy(194,403),xy(195,394)]).
midline(r7, [xy(190,411),xy(189,423)]).
...
fillpoint(r7, xy(139,424), 10.0).
fillpoint(r7, xy(189,414), 10.0).
fillpoint(r7, xy(189,435), 10.0).
fillpoint(r7, xy(151,450), 10.0).
fillpoint(r7, xy(171,450), 10.0).
fillpoint(r7, xy(166,425), 6.0).
fillpoint(r7, xy(135,396), 5.0).
fillpoint(r7, xy(195,396), 5.0).
fillpoint(r7, xy(151,405), 5.0).
fillpoint(r7, xy(171,425), 5.0).
fillpoint(r7, xy(164,435), 5.0).
region(r6, '#2ecc40', 2700, centroid(164,432)).
perimeter(r6, 560).
polygon(r6, [xy(209,470),xy(120,469),xy(120,380),xy(140,380),xy(140,389),xy(130,390),xy(130,460),xy(199,460),xy(200,390),xy(190,390),xy(190,380),xy(210,380),xy(209,470)]).
midline(r6, [xy(205,451),xy(205,391),xy(203,385),xy(194,385)]).
midline(r6, [xy(205,452),xy(204,463),xy(199,465),xy(126,464),xy(124,458),xy(124,391),xy(125,385),xy(135,385)]).
fillpoint(r6, xy(126,385), 6.0).
fillpoint(r6, xy(204,385), 6.0).
fillpoint(r6, xy(125,464), 6.0).
fillpoint(r6, xy(203,464), 6.0).
fillpoint(r6, xy(131,385), 5.0).
fillpoint(r6, xy(194,385), 5.0).
fillpoint(r6, xy(124,425), 5.0).
fillpoint(r6, xy(204,425), 5.0).
fillpoint(r6, xy(131,465), 5.0).
...
midline(r14, [xy(40,585),xy(41,561),xy(52,559),xy(80,560)]).
...
midline(r17, [xy(185,620),xy(200,620)]).
fillpoint(r17, xy(139,620), 10.0).
region(r5, '#870c25', 1500, centroid(164,384)).
perimeter(r5, 160).
polygon(r5, [xy(189,400),xy(140,400),xy(140,370),xy(189,370),xy(189,400)]).
midline(r5, [xy(172,385),xy(154,385)]).
midline(r5, [xy(173,384),xy(175,385)]).
fillpoint(r5, xy(154,385), 15.0).
region(r4, '#bebebe', 1000, centroid(164,360)).
perimeter(r4, 140).
polygon(r4, [xy(189,370),xy(140,370),xy(140,350),xy(189,350),xy(189,370)]).
midline(r4, [xy(162,359),xy(149,360)]).
midline(r4, [xy(163,359),xy(180,360)]).
fillpoint(r4, xy(149,360), 10.0).
...
adjacent(r2, r3).
shared_edge(r2, r3, 3450).
adjacent(r2, r4).
shared_edge(r2, r4, 40).
adjacent(r2, r5).
shared_edge(r2, r5, 20).
adjacent(r2, r6).
shared_edge(r2, r6, 310).
adjacent(r2, r13).
...
adjacent(r5, r7).
shared_edge(r5, r7, 70).
adjacent(r6, r7).
shared_edge(r6, r7, 230).
adjacent(r7, r8).
