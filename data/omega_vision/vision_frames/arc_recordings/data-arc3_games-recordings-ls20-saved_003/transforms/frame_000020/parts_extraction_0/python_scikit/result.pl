...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(539,24),xy(190,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49)]).
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,190),xy(615,298),xy(613,313),xy(604,332),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,392),xy(615,549),xy(612,566),xy(609,571),xy(603,573),xy(588,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(292,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,382),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,258),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(340,499),xy(362,482),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,400),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,345),xy(465,253),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,197),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,602),xy(115,628),xy(113,634),xy(6,634),xy(4,628),xy(5,525),xy(43,524),xy(81,488)]).
...
midline(r3, [xy(520,420),xy(514,388),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(513,186),xy(506,170),xy(489,150),xy(488,130),xy(482,110),xy(479,107),xy(453,100),xy(376,100),xy(350,107),xy(339,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(151,129),xy(126,134),xy(121,145),xy(119,163),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,363),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(130,465),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,186),xy(210,160),xy(206,134)]).
midline(r3, [xy(339,114),xy(339,200),xy(357,222),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(361,369),xy(352,385),xy(340,400)]).
...
midline(r17, [xy(524,635),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(548,604),xy(555,606),xy(555,632),xy(549,635),xy(525,634)]).
midline(r17, [xy(556,605),xy(578,604),xy(585,606),xy(585,632),xy(577,635),xy(560,635),xy(555,633)]).
midline(r17, [xy(586,605),xy(613,605),xy(615,609),xy(615,630),xy(613,634),xy(608,635),xy(590,635),xy(585,633)]).
...
midline(r18, [xy(305,620),xy(540,620)]).
...
midline(r14, [xy(99,553),xy(98,542),xy(89,539),xy(70,539),xy(59,543),xy(49,539),xy(21,541),xy(19,550),xy(20,575),xy(23,580),xy(19,591),xy(21,618),xy(30,620),xy(87,620),xy(97,618),xy(100,608),xy(100,554)]).
midline(r14, [xy(60,544),xy(60,569),xy(58,577),xy(45,580),xy(24,580)]).
...
midline(r6, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,424)]).
...
midline(r16, [xy(80,587),xy(80,559)]).
midline(r16, [xy(80,588),xy(79,595),xy(75,599),xy(39,600)]).
...
midline(r13, [xy(410,535),xy(404,535)]).
midline(r13, [xy(411,535),xy(425,535)]).
...
midline(r12, [xy(401,509),xy(399,510)]).
midline(r12, [xy(402,509),xy(430,510)]).
...
midline(r4, [xy(155,177),xy(155,165),xy(174,165),xy(175,171),xy(173,184),xy(156,184),xy(155,178)]).
