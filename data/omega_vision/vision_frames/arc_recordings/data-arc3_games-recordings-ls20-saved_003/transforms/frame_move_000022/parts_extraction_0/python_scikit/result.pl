...
midline(r2, [xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,258),xy(75,282),xy(90,299),xy(90,339),xy(83,355),xy(79,381),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(160,33),xy(176,26),xy(191,24),xy(535,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(606,170),xy(613,186),xy(615,200),xy(614,309),xy(606,329),xy(598,340),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,548),xy(613,563),xy(609,571),xy(581,575),xy(380,574),xy(354,562),xy(313,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(338,501),xy(360,483),xy(376,476),xy(399,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,448),xy(414,400),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,252),xy(463,236),xy(461,230),xy(456,227),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 136300, centroid(366,258)).
perimeter(r3, 4440).
...
midline(r3, [xy(549,430),xy(520,421),xy(513,425),xy(464,425)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(481,109),xy(453,100),xy(376,100),xy(350,107),xy(340,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(177,129),xy(151,129),xy(126,134),xy(121,145),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(196,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(209,199),xy(210,182),xy(210,161),xy(206,134)]).
midline(r3, [xy(340,114),xy(339,200),xy(352,214),xy(361,230),xy(364,240),xy(365,259),xy(373,279),xy(390,299),xy(377,314),xy(369,328),xy(365,340),xy(364,359),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,470),xy(559,489),xy(555,503),xy(552,509),xy(543,515),xy(529,519),xy(513,520),xy(502,500),xy(500,489),xy(495,483),xy(494,474),xy(502,449),xy(514,429),xy(513,427),xy(515,427)]).
midline(r3, [xy(511,520),xy(487,525),xy(414,525)]).
...
midline(r17, [xy(418,635),xy(131,635),xy(126,634),xy(124,628),xy(125,605),xy(130,604),xy(548,604),xy(555,606),xy(555,632),xy(553,634),xy(419,635)]).
midline(r17, [xy(556,605),xy(578,604),xy(585,606),xy(585,632),xy(579,635),xy(555,633)]).
midline(r17, [xy(586,605),xy(613,605),xy(615,609),xy(615,632),xy(608,635),xy(585,633)]).
midline(r17, [xy(615,606),xy(621,604),xy(635,605)]).
...
border(r17).
region(r14, '#aaaaaa', 7600, centroid(58,578)).
perimeter(r14, 720).
polygon(r14, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r14, [xy(90,609),xy(89,550),xy(70,550),xy(69,590),xy(30,590),xy(30,610),xy(90,609)]).
hole(r14, [xy(50,569),xy(49,550),xy(30,550),xy(30,570),xy(50,569)]).
midline(r14, [xy(19,563),xy(20,575),xy(23,580),xy(20,584),xy(19,594),xy(21,618),xy(30,620),xy(89,620),xy(97,618),xy(100,607),xy(100,550),xy(97,541),xy(72,539),xy(64,540),xy(60,543),xy(48,539),xy(24,540),xy(20,544),xy(20,562)]).
midline(r14, [xy(60,544),xy(60,569),xy(58,577),xy(49,580),xy(24,580)]).
fillpoint(r14, xy(60,542), 12.8).
fillpoint(r14, xy(22,580), 12.8).
fillpoint(r14, xy(22,541), 12.0).
fillpoint(r14, xy(98,541), 12.0).
fillpoint(r14, xy(57,578), 12.0).
fillpoint(r14, xy(21,618), 12.0).
fillpoint(r14, xy(97,618), 12.0).
fillpoint(r14, xy(25,540), 11.0).
fillpoint(r14, xy(54,540), 11.0).
fillpoint(r14, xy(65,540), 11.0).
fillpoint(r14, xy(94,540), 11.0).
fillpoint(r14, xy(20,545), 11.0).
fillpoint(r14, xy(99,545), 11.0).
fillpoint(r14, xy(20,574), 11.0).
fillpoint(r14, xy(59,574), 11.0).
fillpoint(r14, xy(54,579), 11.0).
...
fillpoint(r14, xy(71,540), 10.0).
fillpoint(r14, xy(19,560), 10.0).
fillpoint(r14, xy(59,560), 10.0).
...
midline(r6, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(164,449),xy(151,450),xy(142,448),xy(139,436),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,424)]).
...
region(r16, '#870c25', 2000, centroid(68,588)).
perimeter(r16, 240).
polygon(r16, [xy(89,610),xy(30,609),xy(30,590),xy(70,589),xy(70,550),xy(90,550),xy(89,610)]).
midline(r16, [xy(80,587),xy(79,595),xy(75,599),xy(39,600)]).
midline(r16, [xy(80,586),xy(80,559)]).
fillpoint(r16, xy(77,598), 12.0).
fillpoint(r16, xy(79,594), 11.0).
fillpoint(r16, xy(74,599), 11.0).
fillpoint(r16, xy(79,574), 10.0).
fillpoint(r16, xy(39,600), 10.0).
region(r11, '#870c25', 1500, centroid(464,484)).
perimeter(r11, 160).
polygon(r11, [xy(489,500),xy(440,500),xy(440,470),xy(489,470),xy(489,500)]).
midline(r11, [xy(460,485),xy(454,485)]).
midline(r11, [xy(461,485),xy(475,485)]).
fillpoint(r11, xy(454,485), 15.0).
region(r9, '#bebebe', 1000, centroid(464,460)).
perimeter(r9, 140).
polygon(r9, [xy(489,470),xy(440,470),xy(440,450),xy(489,450),xy(489,470)]).
midline(r9, [xy(459,460),xy(449,460)]).
midline(r9, [xy(460,460),xy(480,460)]).
fillpoint(r9, xy(449,460), 10.0).
...
midline(r7, [xy(155,421),xy(155,435)]).
midline(r7, [xy(155,420),xy(155,415),xy(175,415)]).
fillpoint(r7, xy(156,415), 6.0).
fillpoint(r7, xy(161,415), 5.0).
fillpoint(r7, xy(155,428), 5.0).
region(r15, '#870c25', 400, centroid(40,560)).
perimeter(r15, 80).
polygon(r15, [xy(49,570),xy(30,569),xy(30,550),xy(50,550),xy(49,570)]).
midline(r15, [xy(39,559),xy(40,560)]).
...
adjacent(r14, r16).
shared_edge(r14, r16, 240).
adjacent(r17, r18).
shared_edge(r17, r18, 100).
adjacent(r17, r19).
shared_edge(r17, r19, 780).
adjacent(r17, r20).
