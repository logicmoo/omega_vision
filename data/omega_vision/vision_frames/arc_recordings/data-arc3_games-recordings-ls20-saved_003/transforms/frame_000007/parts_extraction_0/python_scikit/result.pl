...
midline(r2, [xy(590,49),xy(561,29),xy(538,24),xy(193,24),xy(168,29),xy(154,37),xy(140,50),xy(89,49)]).
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,190),xy(615,297),xy(613,313),xy(604,332),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,393),xy(615,548),xy(611,569),xy(603,573),xy(589,575),xy(381,574),xy(370,571),xy(354,562),xy(314,524),xy(294,525),xy(265,522),xy(245,530),xy(225,534),xy(177,535),xy(154,516),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,381),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,259),xy(64,101),xy(68,80),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(250,380),xy(248,363),xy(239,339),xy(223,347),xy(223,349)]).
midline(r2, [xy(315,524),xy(349,491),xy(362,482),xy(376,476),xy(398,474),xy(411,469),xy(415,449),xy(414,400),xy(417,383),xy(420,378),xy(426,376),xy(448,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,349),xy(464,240),xy(459,228),xy(449,225),xy(430,224),xy(418,218),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,627),xy(113,634),xy(6,634),xy(4,628),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(240,338),xy(248,308),xy(262,301),xy(265,297),xy(265,174)]).
midline(r2, [xy(91,340),xy(95,340),xy(94,342)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(368,263)).
perimeter(r3, 4660).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(440,150),xy(390,150),xy(389,100),xy(340,100),xy(340,149),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(390,449),xy(290,449),xy(290,350),xy(340,349),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,472),xy(470,489),xy(476,511),xy(461,520),xy(457,521),xy(446,516),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(512,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(522,272),xy(540,249),xy(527,235),xy(519,221),xy(511,180),xy(502,164),xy(489,150),xy(487,126),xy(479,107),xy(453,100),xy(439,100),xy(422,85),xy(399,75),xy(341,74),xy(326,76),xy(312,82),xy(290,100),xy(239,99),xy(206,133),xy(178,129),xy(152,129),xy(126,134),xy(121,145),xy(119,161),xy(120,199),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,188),xy(210,160),xy(206,134)]).
midline(r3, [xy(290,101),xy(302,114),xy(311,130),xy(316,163),xy(322,177),xy(352,214),xy(361,230),xy(365,259),xy(372,277),xy(390,299),xy(377,314),xy(369,328),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,198),xy(438,101)]).
midline(r3, [xy(165,227),xy(165,364),xy(145,383),xy(125,385),xy(124,390),xy(125,464),xy(203,464),xy(205,459),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,472),xy(558,455),xy(550,439),xy(549,432)]).
...
fillpoint(r3, xy(321,78), 29.0).
fillpoint(r3, xy(408,78), 29.0).
fillpoint(r3, xy(311,131), 29.0).
fillpoint(r3, xy(318,168), 29.0).
...
fillpoint(r3, xy(324,77), 28.0).
fillpoint(r3, xy(405,77), 28.0).
fillpoint(r3, xy(312,134), 28.0).
fillpoint(r3, xy(317,165), 28.0).
...
fillpoint(r3, xy(327,76), 27.0).
fillpoint(r3, xy(402,76), 27.0).
fillpoint(r3, xy(313,137), 27.0).
fillpoint(r3, xy(316,162), 27.0).
...
fillpoint(r3, xy(332,75), 26.0).
fillpoint(r3, xy(398,75), 26.0).
fillpoint(r3, xy(314,142), 26.0).
fillpoint(r3, xy(315,158), 26.0).
...
midline(r19, [xy(418,635),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(553,605),xy(555,609),xy(555,632),xy(549,635),xy(419,634)]).
midline(r19, [xy(555,606),xy(560,604),xy(578,604),xy(583,605),xy(585,610),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r19, [xy(585,606),xy(590,604),xy(609,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r19, [xy(615,608),xy(615,631),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r16, [xy(99,553),xy(98,542),xy(89,539),xy(30,539),xy(21,541),xy(19,550),xy(19,568),xy(23,580),xy(19,591),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(49,579),xy(24,579)]).
midline(r16, [xy(100,554),xy(100,609),xy(98,617),xy(89,620),xy(72,620),xy(60,617)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(186,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,412),xy(189,424)]).
midline(r8, [xy(166,449),xy(185,449),xy(189,443)]).
...
midline(r20, [xy(142,619),xy(260,620)]).
...
midline(r17, [xy(80,587),xy(80,572),xy(77,561),xy(69,559),xy(39,560)]).
...
region(r5, '#870c25', 1500, centroid(364,134)).
perimeter(r5, 160).
polygon(r5, [xy(389,150),xy(340,150),xy(340,120),xy(389,120),xy(389,150)]).
midline(r5, [xy(372,135),xy(354,135)]).
midline(r5, [xy(373,135),xy(375,135)]).
fillpoint(r5, xy(354,135), 15.0).
region(r4, '#bebebe', 1000, centroid(364,110)).
perimeter(r4, 140).
polygon(r4, [xy(389,120),xy(340,120),xy(340,100),xy(389,100),xy(389,120)]).
midline(r4, [xy(361,110),xy(349,110)]).
midline(r4, [xy(362,109),xy(380,110)]).
fillpoint(r4, xy(349,110), 10.0).
...
midline(r6, [xy(169,164),xy(155,165),xy(155,184),xy(169,185),xy(174,183),xy(174,166),xy(170,165)]).
...
midline(r14, [xy(419,514),xy(405,515),xy(405,534),xy(417,535),xy(424,533),xy(424,516),xy(420,515)]).
