...
midline(r2, [xy(89,49),xy(69,78),xy(64,100),xy(65,258),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,467),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(12,635),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,49),xy(140,50),xy(154,37),xy(168,29),xy(193,24),xy(538,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(602,164),xy(611,180),xy(615,203),xy(614,309),xy(606,329),xy(598,340),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,392),xy(615,549),xy(613,563),xy(609,571),xy(589,575),xy(391,575),xy(376,573),xy(360,566),xy(313,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,534)]).
...
midline(r2, [xy(411,468),xy(415,448),xy(414,401),xy(418,380),xy(430,375),xy(459,371),xy(463,363),xy(465,348),xy(465,253),xy(463,236),xy(459,228),xy(449,225),xy(431,224),xy(419,220),xy(414,199),xy(415,174)]).
...
midline(r3, [xy(124,137),xy(126,134),xy(135,131),xy(151,129),xy(179,129),xy(206,133),xy(210,163),xy(209,199),xy(203,215),xy(165,225),xy(135,218),xy(124,213),xy(120,199),xy(119,163),xy(120,150),xy(124,138)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(340,115),xy(339,200),xy(356,220),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
midline(r3, [xy(340,112),xy(353,106),xy(376,100),xy(438,99),xy(463,102),xy(465,109),xy(465,175)]).
midline(r3, [xy(465,103),xy(476,100),xy(490,100)]).
midline(r3, [xy(165,226),xy(165,364),xy(145,383),xy(125,385),xy(124,391),xy(125,464),xy(203,464),xy(205,458),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r8, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(459,521),xy(447,516),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r8, [xy(520,420),xy(514,388),xy(515,291),xy(522,272),xy(540,249)]).
midline(r8, [xy(549,432),xy(550,439),xy(558,455),xy(560,473),xy(558,494),xy(552,509),xy(534,518),xy(518,520),xy(495,518),xy(479,510)]).
...
midline(r20, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(545,604),xy(555,606),xy(554,633),xy(549,635),xy(525,634)]).
midline(r20, [xy(556,605),xy(579,604),xy(585,606),xy(585,628),xy(584,633),xy(579,635),xy(555,633)]).
midline(r20, [xy(586,605),xy(613,605),xy(615,629),xy(614,633),xy(609,635),xy(585,633)]).
...
midline(r17, [xy(19,563),xy(20,544),xy(24,540),xy(88,539),xy(98,541),xy(100,550),xy(100,609),xy(99,615),xy(95,619),xy(70,620),xy(59,616),xy(49,620),xy(22,618),xy(19,608),xy(19,590),xy(23,579),xy(20,575),xy(20,564)]).
midline(r17, [xy(59,615),xy(60,591),xy(58,582),xy(49,579),xy(24,579)]).
...
midline(r21, [xy(280,619),xy(340,620)]).
...
midline(r9, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,411),xy(141,401),xy(144,400),xy(176,399),xy(188,401),xy(190,410),xy(189,424)]).
...
midline(r22, [xy(500,619),xy(540,620)]).
...
midline(r4, [xy(510,160),xy(530,160)]).
...
midline(r5, [xy(155,177),xy(155,165),xy(174,165),xy(174,183),xy(156,184),xy(154,178)]).
...
midline(r15, [xy(419,514),xy(405,515),xy(405,534),xy(419,535),xy(424,533),xy(425,520),xy(424,516),xy(420,515)]).
