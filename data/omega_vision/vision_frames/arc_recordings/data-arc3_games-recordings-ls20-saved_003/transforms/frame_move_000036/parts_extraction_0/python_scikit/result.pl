...
midline(r2, [xy(590,49),xy(561,29),xy(539,24),xy(192,24),xy(170,28),xy(154,37),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,339),xy(83,355),xy(79,380),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,624),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,535),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(249,368),xy(245,352),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(266,523),xy(315,524),xy(350,559),xy(370,571),xy(381,574),xy(589,575),xy(609,571),xy(613,563),xy(615,548),xy(615,390),xy(611,370),xy(602,354),xy(594,345),xy(584,345)]).
midline(r2, [xy(590,51),xy(589,150),xy(607,172),xy(613,186),xy(615,201),xy(614,308),xy(606,329),xy(594,344)]).
midline(r2, [xy(91,340),xy(98,342)]).
midline(r2, [xy(316,523),xy(340,499),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,402),xy(418,380),xy(430,375),xy(449,374),xy(459,371),xy(463,363),xy(465,347),xy(465,252),xy(463,236),xy(459,228),xy(449,225),xy(430,224),xy(419,220),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 136300, centroid(369,265)).
perimeter(r3, 4540).
...
midline(r3, [xy(520,420),xy(514,385),xy(515,290),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(511,180),xy(502,164),xy(489,150),xy(487,126),xy(480,108),xy(453,100),xy(390,100),xy(372,85),xy(349,75),xy(290,74),xy(270,78),xy(254,87),xy(239,99),xy(206,133),xy(176,129),xy(150,129),xy(135,131),xy(124,136),xy(119,163),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,188),xy(209,149),xy(206,134)]).
...
midline(r3, [xy(165,227),xy(164,365),xy(145,383),xy(125,385),xy(124,390),xy(125,464),xy(203,464),xy(205,459),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,470),xy(558,455),xy(550,439),xy(549,432)]).
midline(r3, [xy(340,198),xy(356,179),xy(363,163),xy(365,141),xy(369,128),xy(377,114),xy(389,101)]).
...
midline(r17, [xy(418,635),xy(132,635),xy(126,634),xy(124,629),xy(125,605),xy(131,604),xy(546,604),xy(555,606),xy(555,631),xy(549,635),xy(419,635)]).
midline(r17, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r17, [xy(585,606),xy(590,604),xy(607,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r17, [xy(615,608),xy(615,629),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r14, [xy(99,553),xy(98,542),xy(88,539),xy(24,540),xy(21,541),xy(19,551),xy(19,609),xy(21,618),xy(30,620),xy(57,618),xy(60,614),xy(59,590),xy(61,581),xy(70,579),xy(95,580),xy(99,575),xy(100,569),xy(99,554)]).
midline(r14, [xy(97,580),xy(100,591),xy(98,617),xy(87,620),xy(70,620),xy(60,617)]).
...
midline(r18, [xy(346,620),xy(440,620)]).
...
midline(r8, [xy(189,442),xy(190,432),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(178,399),xy(188,401),xy(190,411),xy(189,424)]).
...
midline(r19, [xy(472,619),xy(459,620)]).
midline(r19, [xy(473,619),xy(540,620)]).
