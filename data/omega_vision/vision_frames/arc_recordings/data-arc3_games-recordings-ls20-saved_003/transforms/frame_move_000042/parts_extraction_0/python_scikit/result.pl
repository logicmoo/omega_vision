...
midline(r2, [xy(594,345),xy(610,368),xy(615,393),xy(615,547),xy(612,566),xy(603,573),xy(589,575),xy(381,574),xy(368,570),xy(354,562),xy(314,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,380),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,258),xy(64,101),xy(68,80),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,342),xy(238,339),xy(235,342),xy(233,341),xy(233,343)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(398,474),xy(410,470),xy(415,448),xy(414,400),xy(417,383),xy(420,378),xy(426,376),xy(459,371),xy(463,363),xy(465,347),xy(465,251),xy(463,236),xy(456,227),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(240,339),xy(248,308),xy(262,301),xy(265,295),xy(265,174)]).
midline(r2, [xy(91,340),xy(96,343),xy(98,342),xy(98,344)]).
midline(r2, [xy(100,344),xy(104,345),xy(106,349)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,474),xy(471,494),xy(477,510),xy(453,523),xy(414,525)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,471),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(522,272),xy(540,249),xy(527,235),xy(518,219),xy(512,183),xy(502,164),xy(489,150),xy(487,126),xy(482,110),xy(479,107),xy(453,100),xy(390,99),xy(362,103),xy(339,113),xy(326,106),xy(303,100),xy(239,99),xy(165,175)]).
...
midline(r16, [xy(418,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(548,604),xy(554,607),xy(560,604),xy(579,604),xy(584,607),xy(592,604),xy(608,604),xy(615,606),xy(614,633),xy(609,635),xy(585,633),xy(578,635),xy(555,633),xy(546,635),xy(419,634)]).
...
midline(r13, [xy(84,580),xy(70,579),xy(61,581),xy(59,617),xy(48,620),xy(22,618),xy(19,608),xy(19,550),xy(21,541),xy(30,539),xy(89,539),xy(98,541),xy(100,553),xy(99,575),xy(95,580),xy(85,579)]).
...
midline(r6, [xy(181,380),xy(164,364),xy(165,324)]).
midline(r6, [xy(164,365),xy(145,383),xy(125,385),xy(125,464),xy(198,465),xy(204,463),xy(204,386),xy(186,384),xy(182,381)]).
...
midline(r7, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,411),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(189,423)]).
...
midline(r5, [xy(162,285),xy(154,285)]).
midline(r5, [xy(163,285),xy(175,285)]).
...
midline(r4, [xy(159,260),xy(149,260)]).
midline(r4, [xy(160,259),xy(180,260)]).
