...
midline(r2, [xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(73,279),xy(90,299),xy(89,337),xy(91,339),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,628),xy(114,603),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(162,32),xy(176,26),xy(190,24),xy(539,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,201),xy(614,309),xy(610,321),xy(599,339),xy(592,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,392),xy(615,549),xy(611,569),xy(606,572),xy(589,575),xy(380,574),xy(368,570),xy(350,559),xy(314,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(262,301),xy(265,296),xy(265,174)]).
midline(r2, [xy(315,524),xy(340,499),xy(362,482),xy(376,476),xy(398,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,448),xy(414,406),xy(418,380),xy(430,375),xy(459,371),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(430,224),xy(418,219),xy(414,197),xy(415,174)]).
...
midline(r3, [xy(520,420),xy(514,388),xy(515,290),xy(525,267),xy(540,249),xy(523,229),xy(516,213),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(482,110),xy(476,106),xy(453,100),xy(376,100),xy(350,107),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(151,129),xy(126,134),xy(121,145),xy(119,163),xy(120,199),xy(124,213),xy(135,218),xy(163,224),xy(165,228),xy(165,355),xy(164,365),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(130,465),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(340,114),xy(339,200),xy(356,220),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
...
midline(r18, [xy(524,635),xy(130,635),xy(125,633),xy(124,612),xy(125,605),xy(132,604),xy(548,604),xy(555,606),xy(554,633),xy(549,635),xy(525,635)]).
midline(r18, [xy(556,605),xy(578,604),xy(584,607),xy(591,604),xy(608,604),xy(615,606),xy(614,633),xy(592,635),xy(584,632),xy(585,608)]).
midline(r18, [xy(616,605),xy(635,605)]).
midline(r18, [xy(584,633),xy(579,635),xy(560,635),xy(555,633)]).
...
midline(r20, [xy(510,620),xy(159,620)]).
...
midline(r15, [xy(99,562),xy(99,544),xy(95,540),xy(73,539),xy(64,540),xy(60,543),xy(48,539),xy(21,541),xy(19,550),xy(19,569),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(88,620),xy(97,618),xy(100,609),xy(100,563)]).
midline(r15, [xy(60,544),xy(60,569),xy(57,578),xy(47,580),xy(24,579)]).
...
midline(r17, [xy(56,599),xy(39,600)]).
midline(r17, [xy(57,599),xy(65,600),xy(78,597),xy(80,588),xy(80,559)]).
...
midline(r14, [xy(460,535),xy(454,535)]).
midline(r14, [xy(461,535),xy(475,535)]).
...
midline(r4, [xy(174,182),xy(175,170),xy(173,165),xy(155,165),xy(154,171),xy(155,184),xy(174,184)]).
