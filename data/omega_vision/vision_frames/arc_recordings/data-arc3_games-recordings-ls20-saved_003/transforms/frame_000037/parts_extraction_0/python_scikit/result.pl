...
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,549),xy(611,569),xy(603,573),xy(589,575),xy(380,574),xy(370,571),xy(350,559),xy(314,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,384),xy(81,363),xy(90,340),xy(90,299),xy(75,282),xy(65,258),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(265,298),xy(265,174)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(398,474),xy(411,469),xy(415,448),xy(414,401),xy(418,380),xy(426,376),xy(449,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,349),xy(465,250),xy(463,236),xy(456,227),xy(426,223),xy(418,219),xy(414,198),xy(415,174)]).
...
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(525,267),xy(540,249),xy(522,227),xy(515,209),xy(514,191),xy(510,178),xy(502,164),xy(489,150),xy(488,130),xy(482,110),xy(467,103),xy(439,99),xy(376,100),xy(348,108),xy(325,87),xy(299,75),xy(243,74),xy(226,76),xy(219,79),xy(215,90),xy(213,113),xy(203,133),xy(179,129),xy(150,129),xy(135,131),xy(124,136),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(163,224),xy(165,229),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(197,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(204,134),xy(208,145),xy(210,161),xy(210,189),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,470),xy(558,455),xy(550,439),xy(549,432)]).
midline(r3, [xy(348,109),xy(340,136),xy(339,200),xy(357,222),xy(364,240),xy(365,259),xy(368,269),xy(377,285),xy(390,300),xy(373,320),xy(366,336),xy(364,358),xy(360,371),xy(340,400)]).
...
midline(r17, [xy(377,634),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(130,604),xy(548,604),xy(553,605),xy(555,611),xy(555,631),xy(549,635),xy(378,634)]).
midline(r17, [xy(555,606),xy(560,604),xy(579,604),xy(584,607),xy(592,604),xy(615,606),xy(615,632),xy(613,634),xy(591,635),xy(584,632),xy(579,635),xy(560,635),xy(555,633)]).
...
midline(r14, [xy(99,553),xy(98,542),xy(89,539),xy(30,539),xy(21,541),xy(19,552),xy(19,607),xy(21,618),xy(49,620),xy(59,617),xy(61,581),xy(96,579),xy(100,569),xy(100,554)]).
midline(r14, [xy(61,617),xy(77,620),xy(88,620),xy(98,617),xy(100,590),xy(97,580)]).
...
midline(r18, [xy(346,620),xy(460,620)]).
...
midline(r8, [xy(189,442),xy(190,433),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,437),xy(139,410),xy(141,401),xy(144,400),xy(176,399),xy(188,401),xy(190,412),xy(189,424)]).
...
midline(r19, [xy(491,620),xy(479,620)]).
midline(r19, [xy(492,620),xy(540,620)]).
...
midline(r4, [xy(270,110),xy(249,110)]).
midline(r4, [xy(271,110),xy(280,110)]).
