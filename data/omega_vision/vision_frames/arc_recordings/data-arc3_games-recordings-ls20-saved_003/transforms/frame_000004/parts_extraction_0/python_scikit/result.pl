...
midline(r2, [xy(89,49),xy(77,64),xy(68,80),xy(64,103),xy(65,259),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(160,33),xy(176,26),xy(192,24),xy(539,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,201),xy(615,299),xy(613,313),xy(599,339),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,545),xy(613,563),xy(609,571),xy(588,575),xy(380,574),xy(354,562),xy(312,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,534)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,342),xy(236,339),xy(231,344)]).
midline(r2, [xy(237,338),xy(241,335),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,402),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,347),xy(465,250),xy(463,236),xy(459,228),xy(430,224),xy(419,220),xy(414,199),xy(415,174)]).
midline(r2, [xy(236,341),xy(235,342)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(91,340),xy(107,348)]).
...
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,474),xy(558,494),xy(552,509)]).
midline(r3, [xy(520,420),xy(514,387),xy(515,290),xy(523,270),xy(540,249),xy(523,229),xy(516,213),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(482,110),xy(476,106),xy(453,100),xy(376,100),xy(353,106),xy(340,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(151,129),xy(126,134),xy(121,145),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,363),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,186),xy(210,160),xy(206,134)]).
midline(r3, [xy(340,114),xy(340,200)]).
...
border(r1).
region(r7, '#2ecc40', 17500, centroid(364,360)).
perimeter(r7, 700).
polygon(r7, [xy(389,450),xy(290,450),xy(290,350),xy(339,350),xy(340,300),xy(389,300),xy(390,250),xy(439,250),xy(440,349),xy(390,350),xy(389,450)]).
midline(r7, [xy(395,324),xy(376,326),xy(368,330),xy(362,366),xy(354,382),xy(340,400)]).
midline(r7, [xy(396,324),xy(409,321),xy(412,316),xy(415,299),xy(415,274)]).
fillpoint(r7, xy(339,400), 50.0).
fillpoint(r7, xy(410,320), 29.7).
fillpoint(r7, xy(369,329), 29.7).
fillpoint(r7, xy(411,318), 29.0).
fillpoint(r7, xy(408,321), 29.0).
fillpoint(r7, xy(371,328), 29.0).
fillpoint(r7, xy(368,331), 29.0).
fillpoint(r7, xy(361,368), 29.0).
fillpoint(r7, xy(412,315), 28.0).
fillpoint(r7, xy(405,322), 28.0).
fillpoint(r7, xy(374,327), 28.0).
fillpoint(r7, xy(367,334), 28.0).
fillpoint(r7, xy(362,365), 28.0).
fillpoint(r7, xy(413,312), 27.0).
fillpoint(r7, xy(402,323), 27.0).
fillpoint(r7, xy(377,326), 27.0).
fillpoint(r7, xy(366,337), 27.0).
fillpoint(r7, xy(363,362), 27.0).
fillpoint(r7, xy(414,308), 26.0).
fillpoint(r7, xy(398,324), 26.0).
fillpoint(r7, xy(382,325), 26.0).
fillpoint(r7, xy(365,342), 26.0).
fillpoint(r7, xy(364,358), 26.0).
fillpoint(r7, xy(415,286), 25.0).
...
midline(r20, [xy(377,634),xy(126,634),xy(124,610),xy(125,605),xy(132,604),xy(548,604),xy(555,606),xy(555,630),xy(553,634),xy(549,635),xy(378,635)]).
midline(r20, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(578,635),xy(560,635),xy(555,633)]).
midline(r20, [xy(585,606),xy(590,604),xy(609,604),xy(615,606),xy(615,629),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r17, [xy(43,539),xy(24,540),xy(20,544),xy(19,569),xy(23,579),xy(20,584),xy(19,593),xy(20,615),xy(21,618),xy(32,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(47,579),xy(24,579)]).
midline(r17, [xy(44,539),xy(89,539),xy(98,541),xy(99,544),xy(100,606),xy(98,617),xy(87,620),xy(70,620),xy(60,617)]).
...
region(r22, '#5a5a5a', 6800, centroid(380,620)).
perimeter(r22, 720).
polygon(r22, [xy(549,630),xy(210,630),xy(210,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(384,619),xy(219,620)]).
midline(r22, [xy(385,619),xy(540,620)]).
fillpoint(r22, xy(219,620), 10.0).
...
midline(r9, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,411),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(189,423)]).
...
midline(r18, [xy(80,587),xy(80,571),xy(77,561),xy(69,559),xy(39,560)]).
midline(r18, [xy(80,588),xy(80,600)]).
...
region(r21, '#2ecc40', 1600, centroid(170,620)).
perimeter(r21, 200).
polygon(r21, [xy(209,630),xy(130,630),xy(130,610),xy(209,610),xy(209,630)]).
midline(r21, [xy(151,620),xy(139,620)]).
midline(r21, [xy(152,620),xy(200,620)]).
fillpoint(r21, xy(139,620), 10.0).
region(r8, '#870c25', 1500, centroid(364,284)).
perimeter(r8, 160).
polygon(r8, [xy(389,300),xy(340,300),xy(340,270),xy(389,270),xy(389,300)]).
midline(r8, [xy(360,285),xy(354,285)]).
midline(r8, [xy(361,284),xy(375,285)]).
fillpoint(r8, xy(354,285), 15.0).
region(r6, '#bebebe', 1000, centroid(364,260)).
perimeter(r6, 140).
polygon(r6, [xy(389,270),xy(340,270),xy(340,250),xy(389,250),xy(389,270)]).
midline(r6, [xy(370,260),xy(349,260)]).
midline(r6, [xy(371,260),xy(380,260)]).
fillpoint(r6, xy(349,260), 10.0).
...
midline(r4, [xy(169,164),xy(155,165),xy(155,184),xy(168,185),xy(174,183),xy(175,170),xy(174,166),xy(170,165)]).
...
midline(r10, [xy(155,421),xy(155,435)]).
midline(r10, [xy(155,420),xy(155,415),xy(175,415)]).
...
adjacent(r2, r3).
shared_edge(r2, r3, 3170).
adjacent(r2, r6).
shared_edge(r2, r6, 20).
adjacent(r2, r7).
shared_edge(r2, r7, 600).
adjacent(r2, r8).
...
adjacent(r20, r21).
shared_edge(r20, r21, 180).
adjacent(r20, r22).
shared_edge(r20, r22, 700).
adjacent(r20, r23).
