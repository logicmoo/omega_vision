...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(539,24),xy(193,24),xy(168,29),xy(154,37),xy(140,50),xy(89,49)]).
midline(r2, [xy(590,51),xy(589,150),xy(606,170),xy(614,191),xy(615,299),xy(612,316),xy(602,335),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,392),xy(615,546),xy(612,566),xy(603,573),xy(589,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(178,535),xy(174,534),xy(154,516),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,384),xy(81,363),xy(90,339),xy(90,299),xy(75,282),xy(65,259),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
...
midline(r2, [xy(411,468),xy(415,447),xy(414,403),xy(417,383),xy(419,379),xy(426,376),xy(448,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,348),xy(464,240),xy(461,230),xy(456,227),xy(430,224),xy(418,219),xy(414,198),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,472),xy(471,494),xy(477,510),xy(456,523),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(455,524)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(523,229),xy(516,213),xy(514,190),xy(510,178),xy(502,164),xy(489,150),xy(490,100),xy(472,85),xy(449,75),xy(392,74),xy(376,76),xy(354,87),xy(331,108),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(150,129),xy(135,131),xy(124,136),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(163,224),xy(165,230),xy(165,364),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(130,465),xy(195,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(453,522),xy(450,519)]).
midline(r3, [xy(206,134),xy(210,160),xy(210,189),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
midline(r3, [xy(331,109),xy(339,136),xy(339,200),xy(357,222),xy(364,240),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(361,369),xy(352,385),xy(340,400)]).
...
midline(r19, [xy(524,635),xy(131,635),xy(125,633),xy(125,605),xy(549,604),xy(555,606),xy(554,633),xy(546,635),xy(525,634)]).
midline(r19, [xy(556,605),xy(577,604),xy(585,606),xy(585,632),xy(576,635),xy(555,633)]).
midline(r19, [xy(586,605),xy(608,604),xy(615,606),xy(615,630),xy(613,634),xy(608,635),xy(590,635),xy(585,633)]).
...
midline(r16, [xy(99,553),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,550),xy(19,569),xy(23,580),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,616),xy(58,582),xy(48,579),xy(24,579)]).
midline(r16, [xy(99,554),xy(100,609),xy(98,617),xy(89,620),xy(70,620),xy(61,617)]).
...
midline(r21, [xy(439,620),xy(299,620)]).
midline(r21, [xy(440,619),xy(540,620)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,424)]).
...
midline(r17, [xy(53,559),xy(78,561),xy(80,600)]).
...
midline(r6, [xy(174,182),xy(175,171),xy(173,165),xy(155,165),xy(154,170),xy(155,184),xy(174,184)]).
