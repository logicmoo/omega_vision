...
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,191),xy(615,296),xy(613,313),xy(604,332),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,549),xy(611,569),xy(603,573),xy(589,575),xy(380,574),xy(354,562),xy(314,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,381),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,259),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(244,349),xy(239,340),xy(248,308),xy(265,298),xy(265,174)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(398,474),xy(411,469),xy(415,449),xy(414,400),xy(418,380),xy(430,375),xy(456,372),xy(461,369),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(459,228),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(91,337),xy(91,340),xy(93,341),xy(93,339)]).
midline(r2, [xy(94,342),xy(95,341)]).
...
midline(r3, [xy(180,465),xy(130,465),xy(125,463),xy(124,457),xy(125,385),xy(145,383),xy(165,363),xy(165,227),xy(163,224),xy(135,218),xy(124,213),xy(119,188),xy(120,150),xy(124,136),xy(140,130),xy(179,129),xy(206,133),xy(209,149),xy(210,182),xy(209,199),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
midline(r3, [xy(181,465),xy(199,465),xy(204,463),xy(205,390),xy(203,385),xy(184,383),xy(165,365)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(340,113),xy(339,200),xy(357,222),xy(364,240),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(365,340),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,112),xy(353,106),xy(376,100),xy(439,99),xy(465,103),xy(465,175)]).
...
midline(r8, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,472),xy(470,489),xy(476,511),xy(453,523),xy(414,525)]).
...
midline(r8, [xy(520,420),xy(514,388),xy(515,290),xy(523,270),xy(540,249)]).
...
midline(r18, [xy(377,634),xy(130,635),xy(125,633),xy(124,610),xy(125,605),xy(132,604),xy(549,604),xy(553,605),xy(555,609),xy(555,631),xy(549,635),xy(378,634)]).
midline(r18, [xy(555,606),xy(578,604),xy(584,607),xy(590,604),xy(608,604),xy(613,605),xy(615,609),xy(615,632),xy(613,634),xy(590,635),xy(584,633),xy(563,635),xy(555,633)]).
midline(r18, [xy(585,608),xy(585,632)]).
midline(r18, [xy(615,606),xy(622,604),xy(635,605)]).
...
midline(r15, [xy(99,553),xy(98,542),xy(87,539),xy(24,540),xy(21,541),xy(19,551),xy(20,615),xy(21,618),xy(31,620),xy(55,619),xy(59,617),xy(61,581),xy(96,579),xy(100,569),xy(99,554)]).
midline(r15, [xy(61,617),xy(70,620),xy(88,620),xy(98,617),xy(100,590),xy(97,580)]).
...
midline(r9, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(177,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r20, [xy(524,619),xy(359,620)]).
midline(r20, [xy(525,619),xy(540,620)]).
...
midline(r4, [xy(520,160),xy(499,160)]).
midline(r4, [xy(521,160),xy(530,160)]).
...
midline(r5, [xy(155,177),xy(155,184),xy(160,185),xy(173,184),xy(175,179),xy(174,166),xy(168,164),xy(155,165),xy(155,176)]).
