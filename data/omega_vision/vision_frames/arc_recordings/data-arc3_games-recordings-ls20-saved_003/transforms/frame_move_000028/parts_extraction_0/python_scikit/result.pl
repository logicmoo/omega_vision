...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(539,24),xy(194,24),xy(168,29),xy(154,37),xy(140,50),xy(89,49)]).
midline(r2, [xy(590,51),xy(589,150),xy(604,167),xy(614,191),xy(615,298),xy(613,313),xy(606,329),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,547),xy(612,566),xy(603,573),xy(589,575),xy(380,574),xy(370,571),xy(350,559),xy(314,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,465),xy(79,380),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,258),xy(64,100),xy(66,86),xy(72,72),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,342),xy(235,339),xy(230,343),xy(235,341)]).
midline(r2, [xy(236,338),xy(241,335),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(399,474),xy(411,469),xy(415,448),xy(414,400),xy(418,380),xy(430,375),xy(456,372),xy(461,369),xy(463,363),xy(465,348),xy(465,250),xy(463,236),xy(459,228),xy(430,224),xy(418,218),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,601),xy(115,629),xy(113,634),xy(6,634),xy(4,626),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(240,338),xy(240,339)]).
midline(r2, [xy(91,336),xy(95,339),xy(91,339)]).
midline(r2, [xy(94,341),xy(96,342),xy(96,340)]).
...
border(r2).
region(r3, '#2ecc40', 108800, centroid(330,209)).
perimeter(r3, 3420).
...
midline(r3, [xy(124,137),xy(126,134),xy(135,131),xy(150,129),xy(178,129),xy(206,133),xy(210,161),xy(209,199),xy(203,215),xy(165,225),xy(135,218),xy(124,213),xy(120,199),xy(119,162),xy(121,145),xy(124,138)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(340,113),xy(339,200),xy(357,222),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,112),xy(362,103),xy(391,99),xy(453,100),xy(481,108),xy(488,130),xy(489,150),xy(507,172),xy(514,190),xy(515,209),xy(518,219),xy(527,235),xy(540,250)]).
midline(r3, [xy(165,226),xy(165,362),xy(145,383),xy(125,385),xy(124,390),xy(125,464),xy(203,464),xy(205,457),xy(204,386),xy(184,383),xy(165,365)]).
...
region(r8, '#2ecc40', 27500, centroid(506,468)).
perimeter(r8, 920).
polygon(r8, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(489,400),xy(490,350),xy(539,350),xy(540,390),xy(590,390),xy(589,550)]).
...
midline(r8, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(469,516),xy(449,524),xy(414,525)]).
midline(r8, [xy(520,420),xy(515,398),xy(515,374)]).
midline(r8, [xy(549,432),xy(550,439),xy(558,455),xy(560,472),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
...
midline(r18, [xy(524,635),xy(130,635),xy(125,633),xy(124,625),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(525,635)]).
midline(r18, [xy(556,605),xy(578,604),xy(584,607),xy(590,604),xy(613,605),xy(615,610),xy(615,632),xy(607,635),xy(585,633),xy(561,635),xy(555,633)]).
...
midline(r15, [xy(99,562),xy(99,544),xy(97,541),xy(89,539),xy(30,539),xy(21,541),xy(19,550),xy(20,615),xy(21,618),xy(30,620),xy(57,618),xy(60,612),xy(59,590),xy(61,581),xy(70,579),xy(94,580),xy(99,575),xy(99,563)]).
midline(r15, [xy(97,580),xy(100,591),xy(98,617),xy(89,620),xy(70,620),xy(60,617)]).
...
region(r20, '#5a5a5a', 5200, centroid(420,620)).
perimeter(r20, 560).
polygon(r20, [xy(549,630),xy(290,630),xy(290,610),xy(549,610),xy(549,630)]).
midline(r20, [xy(439,620),xy(299,620)]).
midline(r20, [xy(440,619),xy(540,620)]).
fillpoint(r20, xy(299,620), 10.0).
...
midline(r9, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,423)]).
...
region(r19, '#2ecc40', 3200, centroid(210,620)).
perimeter(r19, 360).
polygon(r19, [xy(289,630),xy(130,630),xy(130,610),xy(289,610),xy(289,630)]).
midline(r19, [xy(279,620),xy(139,620)]).
midline(r19, [xy(280,620),xy(280,619)]).
...
midline(r16, [xy(39,586),xy(41,561),xy(50,559),xy(80,560)]).
...
region(r7, '#870c25', 1500, centroid(514,334)).
perimeter(r7, 160).
polygon(r7, [xy(539,350),xy(490,350),xy(490,320),xy(539,320),xy(539,350)]).
midline(r7, [xy(516,334),xy(504,335)]).
midline(r7, [xy(517,335),xy(525,335)]).
fillpoint(r7, xy(504,335), 15.0).
region(r6, '#bebebe', 1000, centroid(514,310)).
perimeter(r6, 140).
polygon(r6, [xy(539,320),xy(490,320),xy(490,300),xy(539,300),xy(539,320)]).
midline(r6, [xy(520,310),xy(499,310)]).
midline(r6, [xy(521,310),xy(530,310)]).
fillpoint(r6, xy(499,310), 10.0).
...
midline(r4, [xy(174,182),xy(175,170),xy(173,165),xy(155,165),xy(154,170),xy(155,184),xy(174,184)]).
...
midline(r10, [xy(155,433),xy(155,435)]).
midline(r10, [xy(155,432),xy(155,415),xy(175,415)]).
...
adjacent(r18, r19).
shared_edge(r18, r19, 340).
adjacent(r18, r20).
shared_edge(r18, r20, 540).
adjacent(r18, r21).
