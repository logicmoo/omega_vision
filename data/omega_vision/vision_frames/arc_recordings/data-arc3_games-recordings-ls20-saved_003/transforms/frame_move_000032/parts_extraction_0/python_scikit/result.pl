...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(538,24),xy(194,24),xy(168,29),xy(154,37),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,258),xy(75,282),xy(90,299),xy(90,339),xy(83,355),xy(79,380),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,534),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(249,368),xy(242,344),xy(239,340),xy(237,339),xy(237,341)]).
midline(r2, [xy(91,338),xy(91,340)]).
midline(r2, [xy(93,340),xy(97,341),xy(97,343)]).
midline(r2, [xy(266,523),xy(315,524),xy(354,562),xy(380,574),xy(588,575),xy(609,571),xy(613,563),xy(615,549),xy(615,390),xy(611,370),xy(602,354),xy(594,345),xy(584,345)]).
midline(r2, [xy(240,339),xy(248,308),xy(265,298),xy(265,174)]).
midline(r2, [xy(590,51),xy(589,150),xy(606,170),xy(613,186),xy(615,200),xy(614,309),xy(607,327),xy(594,344)]).
midline(r2, [xy(316,523),xy(340,499),xy(360,483),xy(376,476),xy(398,474),xy(411,469),xy(415,448),xy(414,401),xy(418,380),xy(426,376),xy(449,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,344),xy(465,252),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,198),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(469,516),xy(449,524),xy(414,525)]).
midline(r3, [xy(520,420),xy(514,388),xy(515,291),xy(523,270),xy(540,249),xy(530,239),xy(519,221),xy(511,180),xy(499,175),xy(480,174),xy(469,170),xy(460,128),xy(452,114),xy(439,99),xy(376,100),xy(350,107),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(177,129),xy(152,129),xy(126,134),xy(121,145),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(154,221),xy(164,225),xy(165,364),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(130,465),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(339,114),xy(339,200),xy(357,222),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(354,382),xy(340,400)]).
midline(r3, [xy(206,134),xy(210,160),xy(210,189),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,471),xy(558,494),xy(552,509),xy(534,518),xy(517,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(441,99),xy(457,85),xy(476,76),xy(491,74),xy(515,75)]).
...
fillpoint(r3, xy(469,170), 29.7).
fillpoint(r3, xy(510,179), 29.7).
fillpoint(r3, xy(471,78), 29.0).
fillpoint(r3, xy(461,131), 29.0).
fillpoint(r3, xy(468,168), 29.0).
fillpoint(r3, xy(471,171), 29.0).
fillpoint(r3, xy(508,178), 29.0).
...
fillpoint(r3, xy(474,77), 28.0).
fillpoint(r3, xy(462,134), 28.0).
fillpoint(r3, xy(467,165), 28.0).
fillpoint(r3, xy(474,172), 28.0).
fillpoint(r3, xy(505,177), 28.0).
...
fillpoint(r3, xy(477,76), 27.0).
fillpoint(r3, xy(463,137), 27.0).
fillpoint(r3, xy(466,162), 27.0).
fillpoint(r3, xy(477,173), 27.0).
fillpoint(r3, xy(502,176), 27.0).
...
fillpoint(r3, xy(482,75), 26.0).
fillpoint(r3, xy(464,142), 26.0).
fillpoint(r3, xy(465,158), 26.0).
fillpoint(r3, xy(482,174), 26.0).
fillpoint(r3, xy(498,175), 26.0).
...
midline(r17, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(525,634)]).
midline(r17, [xy(556,605),xy(578,604),xy(584,607),xy(594,604),xy(613,605),xy(615,609),xy(615,630),xy(613,634),xy(608,635),xy(590,635),xy(585,633),xy(579,635),xy(560,635),xy(555,633)]).
midline(r17, [xy(585,608),xy(585,632)]).
midline(r17, [xy(615,606),xy(620,604),xy(635,605)]).
...
midline(r14, [xy(99,553),xy(98,542),xy(89,539),xy(31,539),xy(21,541),xy(19,550),xy(19,608),xy(21,618),xy(30,620),xy(57,618),xy(60,614),xy(59,590),xy(61,581),xy(96,579),xy(99,575),xy(100,554)]).
midline(r14, [xy(97,580),xy(100,590),xy(98,617),xy(89,620),xy(72,620),xy(60,617)]).
...
region(r18, '#2ecc40', 4800, centroid(250,620)).
perimeter(r18, 520).
polygon(r18, [xy(369,630),xy(130,630),xy(130,610),xy(369,610),xy(369,630)]).
midline(r18, [xy(279,620),xy(139,620)]).
midline(r18, [xy(280,620),xy(360,620)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(165,447),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(177,399),xy(188,401),xy(190,410),xy(189,424)]).
...
region(r19, '#5a5a5a', 3600, centroid(460,620)).
perimeter(r19, 400).
polygon(r19, [xy(549,630),xy(370,630),xy(370,610),xy(549,610),xy(549,630)]).
midline(r19, [xy(424,620),xy(379,620)]).
midline(r19, [xy(425,619),xy(540,620)]).
fillpoint(r19, xy(379,620), 10.0).
region(r15, '#870c25', 2000, centroid(52,572)).
perimeter(r15, 240).
polygon(r15, [xy(49,610),xy(30,609),xy(30,550),xy(89,550),xy(89,570),xy(50,570),xy(49,610)]).
midline(r15, [xy(40,585),xy(39,570),xy(41,561),xy(51,559),xy(80,560)]).
...
region(r5, '#870c25', 1500, centroid(514,134)).
perimeter(r5, 160).
polygon(r5, [xy(539,150),xy(490,150),xy(490,120),xy(539,120),xy(539,150)]).
midline(r5, [xy(510,135),xy(504,135)]).
midline(r5, [xy(511,134),xy(525,135)]).
fillpoint(r5, xy(504,135), 15.0).
region(r4, '#bebebe', 1000, centroid(514,110)).
perimeter(r4, 140).
polygon(r4, [xy(539,120),xy(490,120),xy(490,100),xy(539,100),xy(539,120)]).
midline(r4, [xy(509,110),xy(499,110)]).
midline(r4, [xy(510,110),xy(530,110)]).
fillpoint(r4, xy(499,110), 10.0).
...
midline(r6, [xy(169,164),xy(155,165),xy(155,184),xy(167,185),xy(174,183),xy(174,166),xy(170,165)]).
...
midline(r9, [xy(170,414),xy(175,415)]).
...
adjacent(r17, r18).
shared_edge(r17, r18, 500).
adjacent(r17, r19).
shared_edge(r17, r19, 380).
adjacent(r17, r20).
