...
midline(r2, [xy(590,49),xy(561,29),xy(537,24),xy(193,24),xy(180,25),xy(168,29),xy(154,37),xy(140,50),xy(89,49),xy(69,78),xy(64,101),xy(65,259),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,382),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
...
midline(r2, [xy(594,345),xy(610,368),xy(615,392),xy(615,549),xy(610,570),xy(587,575),xy(381,574),xy(370,571),xy(354,562),xy(313,524),xy(266,523)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(399,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,447),xy(414,401),xy(417,383),xy(419,379),xy(426,376),xy(448,374),xy(460,370),xy(465,348),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,218),xy(414,199),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(457,522),xy(452,518),xy(450,519),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(519,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(519,221),xy(515,209),xy(512,183),xy(502,164),xy(489,150),xy(487,126),xy(480,108),xy(453,100),xy(392,99),xy(362,103),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(177,129),xy(150,129),xy(126,134),xy(121,145),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,186),xy(210,160),xy(206,134)]).
midline(r3, [xy(340,114),xy(339,200),xy(356,220),xy(363,236),xy(365,259),xy(369,271),xy(377,285),xy(390,300),xy(375,317),xy(365,340),xy(365,399),xy(361,419),xy(348,424),xy(314,425)]).
midline(r3, [xy(165,227),xy(164,365),xy(145,383),xy(125,385),xy(124,391),xy(125,464),xy(203,464),xy(205,459),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,475),xy(558,455),xy(550,439),xy(549,432)]).
...
midline(r19, [xy(169,605),xy(125,605),xy(125,634),xy(132,635),xy(553,634),xy(555,631),xy(555,607),xy(549,604),xy(170,605)]).
midline(r19, [xy(555,606),xy(564,604),xy(585,606),xy(585,632),xy(583,634),xy(562,635),xy(555,633)]).
midline(r19, [xy(586,605),xy(613,605),xy(615,610),xy(615,629),xy(613,634),xy(607,635),xy(590,635),xy(585,633)]).
...
midline(r21, [xy(366,619),xy(540,620)]).
...
midline(r16, [xy(99,553),xy(100,609),xy(97,618),xy(71,620),xy(59,616),xy(55,619),xy(30,620),xy(22,618),xy(19,609),xy(20,584),xy(23,579),xy(19,569),xy(21,541),xy(30,539),xy(95,540),xy(98,541),xy(100,552)]).
midline(r16, [xy(60,615),xy(58,582),xy(45,579),xy(24,579)]).
...
midline(r8, [xy(189,442),xy(190,432),xy(187,424),xy(165,425),xy(165,445),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(189,424)]).
...
midline(r6, [xy(309,360),xy(299,360)]).
midline(r6, [xy(310,360),xy(330,360)]).
...
midline(r14, [xy(419,514),xy(405,515),xy(405,534),xy(417,535),xy(424,533),xy(425,520),xy(424,516),xy(420,515)]).
