...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(539,24),xy(193,24),xy(168,29),xy(154,37),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,258),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,467),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(12,635),xy(113,634),xy(115,629),xy(114,603),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,535),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(249,368),xy(240,340),xy(236,341),xy(234,339),xy(228,344),xy(235,342)]).
midline(r2, [xy(91,338),xy(94,340),xy(91,340)]).
midline(r2, [xy(266,523),xy(290,525),xy(315,524),xy(350,559),xy(368,570),xy(381,574),xy(589,575),xy(609,571),xy(613,563),xy(615,549),xy(614,381),xy(610,368),xy(599,350),xy(593,344),xy(584,345)]).
midline(r2, [xy(590,51),xy(589,150),xy(602,164),xy(611,180),xy(615,203),xy(614,308),xy(607,327),xy(594,344)]).
midline(r2, [xy(235,338),xy(239,338),xy(241,335),xy(248,308),xy(262,301),xy(265,296),xy(265,174)]).
midline(r2, [xy(95,341),xy(103,345),xy(103,347)]).
midline(r2, [xy(316,523),xy(339,500),xy(360,483),xy(376,476),xy(398,474),xy(410,470),xy(415,449),xy(414,401),xy(418,380),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,349),xy(465,254),xy(463,236),xy(459,228),xy(426,223),xy(418,219),xy(414,198),xy(415,174)]).
...
midline(r3, [xy(520,420),xy(514,386),xy(515,291),xy(522,272),xy(540,249),xy(527,235),xy(519,221),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(480,108),xy(453,100),xy(392,99),xy(362,103),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(151,129),xy(126,134),xy(121,145),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,188),xy(210,160),xy(206,134)]).
midline(r3, [xy(340,114),xy(339,200),xy(357,222),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(356,379),xy(340,400)]).
midline(r3, [xy(165,227),xy(165,363),xy(145,383),xy(125,385),xy(124,394),xy(125,464),xy(203,464),xy(205,457),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r1, [xy(20,79),xy(20,19)]).
midline(r1, [xy(20,80),xy(20,500)]).
...
midline(r20, [xy(418,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(549,604),xy(555,606),xy(555,630),xy(553,634),xy(549,635),xy(419,634)]).
midline(r20, [xy(556,605),xy(579,604),xy(584,607),xy(590,604),xy(613,605),xy(615,606),xy(615,631),xy(609,635),xy(585,633),xy(562,635),xy(555,633)]).
midline(r20, [xy(616,605),xy(635,605)]).
midline(r20, [xy(585,608),xy(585,632)]).
...
border(r20).
region(r17, '#aaaaaa', 7600, centroid(58,578)).
perimeter(r17, 720).
polygon(r17, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r17, [xy(90,609),xy(89,550),xy(70,550),xy(69,590),xy(30,590),xy(30,610),xy(90,609)]).
hole(r17, [xy(50,569),xy(49,550),xy(30,550),xy(30,570),xy(50,569)]).
midline(r17, [xy(99,553),xy(98,542),xy(89,539),xy(64,540),xy(59,543),xy(49,539),xy(24,540),xy(21,541),xy(19,550),xy(19,569),xy(23,579),xy(19,591),xy(20,615),xy(21,618),xy(30,620),xy(89,620),xy(97,618),xy(100,608),xy(99,554)]).
midline(r17, [xy(60,544),xy(58,577),xy(49,580),xy(24,580)]).
fillpoint(r17, xy(60,542), 12.8).
fillpoint(r17, xy(22,580), 12.8).
fillpoint(r17, xy(22,541), 12.0).
fillpoint(r17, xy(98,541), 12.0).
fillpoint(r17, xy(57,578), 12.0).
fillpoint(r17, xy(21,618), 12.0).
fillpoint(r17, xy(97,618), 12.0).
fillpoint(r17, xy(25,540), 11.0).
fillpoint(r17, xy(54,540), 11.0).
fillpoint(r17, xy(65,540), 11.0).
fillpoint(r17, xy(94,540), 11.0).
fillpoint(r17, xy(20,545), 11.0).
fillpoint(r17, xy(99,545), 11.0).
fillpoint(r17, xy(20,574), 11.0).
fillpoint(r17, xy(59,574), 11.0).
fillpoint(r17, xy(54,579), 11.0).
...
fillpoint(r17, xy(71,540), 10.0).
fillpoint(r17, xy(19,560), 10.0).
fillpoint(r17, xy(59,560), 10.0).
...
midline(r21, [xy(345,620),xy(139,620)]).
midline(r21, [xy(346,620),xy(500,620)]).
...
midline(r6, [xy(189,442),xy(190,430),xy(186,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,424)]).
...
region(r19, '#870c25', 2000, centroid(68,588)).
perimeter(r19, 240).
polygon(r19, [xy(89,610),xy(30,609),xy(30,590),xy(70,589),xy(70,550),xy(90,550),xy(89,610)]).
midline(r19, [xy(80,587),xy(79,595),xy(75,599),xy(39,600)]).
midline(r19, [xy(80,586),xy(80,559)]).
...
region(r12, '#2ecc40', 1600, centroid(414,524)).
perimeter(r12, 320).
polygon(r12, [xy(439,550),xy(390,549),xy(390,500),xy(440,500),xy(439,550)]).
hole(r12, [xy(430,539),xy(429,510),xy(400,510),xy(400,540),xy(430,539)]).
midline(r12, [xy(433,544),xy(400,545),xy(395,543),xy(394,511),xy(395,505),xy(401,504),xy(434,505),xy(434,544)]).
fillpoint(r12, xy(396,505), 6.0).
fillpoint(r12, xy(434,505), 6.0).
fillpoint(r12, xy(395,544), 6.0).
fillpoint(r12, xy(433,544), 6.0).
fillpoint(r12, xy(401,505), 5.0).
fillpoint(r12, xy(394,525), 5.0).
fillpoint(r12, xy(434,525), 5.0).
fillpoint(r12, xy(401,545), 5.0).
region(r16, '#870c25', 1500, centroid(464,534)).
perimeter(r16, 160).
polygon(r16, [xy(489,550),xy(440,550),xy(440,520),xy(489,520),xy(489,550)]).
midline(r16, [xy(466,534),xy(454,535)]).
midline(r16, [xy(467,535),xy(475,535)]).
fillpoint(r16, xy(454,535), 15.0).
region(r13, '#bebebe', 1000, centroid(464,510)).
perimeter(r13, 140).
polygon(r13, [xy(489,520),xy(440,520),xy(440,500),xy(489,500),xy(489,520)]).
midline(r13, [xy(462,509),xy(449,510)]).
midline(r13, [xy(463,510),xy(480,510)]).
...
region(r18, '#870c25', 400, centroid(40,560)).
perimeter(r18, 80).
polygon(r18, [xy(49,570),xy(30,569),xy(30,550),xy(50,550),xy(49,570)]).
midline(r18, [xy(39,559),xy(40,560)]).
...
adjacent(r12, r14).
shared_edge(r12, r14, 120).
adjacent(r12, r16).
shared_edge(r12, r16, 30).
adjacent(r13, r16).
shared_edge(r13, r16, 50).
adjacent(r14, r15).
shared_edge(r14, r15, 40).
adjacent(r17, r18).
shared_edge(r17, r18, 80).
adjacent(r17, r19).
shared_edge(r17, r19, 240).
adjacent(r20, r21).
shared_edge(r20, r21, 780).
adjacent(r20, r22).
shared_edge(r20, r22, 100).
adjacent(r20, r23).
