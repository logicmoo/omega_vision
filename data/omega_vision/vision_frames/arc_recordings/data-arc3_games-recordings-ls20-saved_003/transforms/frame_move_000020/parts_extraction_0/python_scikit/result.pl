...
midline(r2, [xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,339),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,628),xy(114,602),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(162,32),xy(176,26),xy(191,24),xy(537,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,202),xy(615,296),xy(613,313),xy(607,327),xy(598,340),xy(592,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,547),xy(613,563),xy(609,571),xy(587,575),xy(381,574),xy(370,571),xy(354,562),xy(314,524),xy(294,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(265,298),xy(265,174)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,401),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,347),xy(465,251),xy(463,236),xy(456,227),xy(431,224),xy(419,220),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 136300, centroid(367,257)).
perimeter(r3, 4240).
...
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(525,267),xy(540,249),xy(522,227),xy(515,209),xy(514,190),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(481,109),xy(453,100),xy(376,100),xy(350,107),xy(339,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(151,129),xy(126,134),xy(121,145),xy(119,161),xy(120,199),xy(124,213),xy(135,218),xy(163,224),xy(165,228),xy(165,361),xy(164,365),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(339,114),xy(339,200),xy(356,220),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
...
midline(r17, [xy(418,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(549,604),xy(555,606),xy(555,632),xy(553,634),xy(419,634)]).
midline(r17, [xy(556,605),xy(578,604),xy(584,607),xy(593,604),xy(613,605),xy(615,606),xy(615,632),xy(613,634),xy(601,635),xy(585,633),xy(579,635),xy(560,635),xy(555,633)]).
...
midline(r18, [xy(305,619),xy(540,620)]).
...
midline(r14, [xy(19,563),xy(21,541),xy(46,539),xy(55,540),xy(60,543),xy(60,567),xy(57,578),xy(48,580),xy(23,579),xy(20,575),xy(19,564)]).
midline(r14, [xy(22,580),xy(19,590),xy(21,618),xy(30,620),xy(88,620),xy(97,618),xy(100,605),xy(99,544),xy(97,541),xy(89,539),xy(64,540),xy(61,542)]).
...
midline(r6, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r16, [xy(53,600),xy(39,600)]).
midline(r16, [xy(54,600),xy(68,600),xy(78,597),xy(80,588),xy(80,559)]).
...
region(r13, '#870c25', 1500, centroid(414,534)).
perimeter(r13, 160).
polygon(r13, [xy(439,550),xy(390,550),xy(390,520),xy(439,520),xy(439,550)]).
midline(r13, [xy(416,534),xy(404,535)]).
midline(r13, [xy(417,535),xy(425,535)]).
fillpoint(r13, xy(404,535), 15.0).
region(r12, '#bebebe', 1000, centroid(414,510)).
perimeter(r12, 140).
polygon(r12, [xy(439,520),xy(390,520),xy(390,500),xy(439,500),xy(439,520)]).
midline(r12, [xy(420,510),xy(399,510)]).
midline(r12, [xy(421,509),xy(430,510)]).
fillpoint(r12, xy(399,510), 10.0).
...
midline(r7, [xy(155,427),xy(155,415),xy(175,415)]).
midline(r7, [xy(155,428),xy(155,435)]).
...
adjacent(r2, r12).
shared_edge(r2, r12, 70).
adjacent(r2, r13).
shared_edge(r2, r13, 80).
adjacent(r2, r14).
...
adjacent(r3, r12).
shared_edge(r3, r12, 20).
adjacent(r3, r13).
shared_edge(r3, r13, 30).
adjacent(r4, r5).
