...
midline(r2, [xy(89,49),xy(69,78),xy(64,101),xy(65,258),xy(75,282),xy(90,299),xy(90,339),xy(83,355),xy(79,381),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(160,33),xy(176,26),xy(191,24),xy(537,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(602,164),xy(611,180),xy(615,203),xy(614,309),xy(606,329),xy(598,340),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(614,380),xy(615,395),xy(615,549),xy(612,566),xy(606,572),xy(588,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,534)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(245,352),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,446),xy(414,401),xy(418,380),xy(430,375),xy(459,371),xy(463,363),xy(465,348),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,196),xy(415,174)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(91,338),xy(92,341),xy(93,338)]).
midline(r2, [xy(95,340),xy(96,343),xy(98,342),xy(96,340)]).
midline(r2, [xy(98,344),xy(99,343)]).
...
border(r2).
region(r3, '#2ecc40', 115400, centroid(369,246)).
perimeter(r3, 3860).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,199),xy(340,200),xy(339,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(461,520),xy(454,520),xy(435,506),xy(429,504),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
...
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(525,267),xy(540,249),xy(527,235),xy(518,219),xy(512,183),xy(502,164),xy(489,150),xy(488,130),xy(481,109),xy(453,100),xy(376,100),xy(353,106),xy(339,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(151,129),xy(126,134),xy(121,145),xy(119,162),xy(120,199),xy(124,213),xy(135,218),xy(165,225),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,189),xy(210,161),xy(206,134)]).
midline(r3, [xy(340,114),xy(340,150),xy(327,164),xy(318,180),xy(314,200),xy(315,225)]).
...
border(r1).
region(r8, '#2ecc40', 20000, centroid(364,350)).
perimeter(r8, 700).
polygon(r8, [xy(389,450),xy(290,450),xy(290,350),xy(340,349),xy(340,250),xy(439,250),xy(440,349),xy(390,350),xy(389,450)]).
midline(r8, [xy(365,341),xy(361,369),xy(352,385),xy(340,400)]).
midline(r8, [xy(366,340),xy(373,320),xy(390,299)]).
fillpoint(r8, xy(389,300), 50.0).
fillpoint(r8, xy(339,400), 50.0).
fillpoint(r8, xy(368,331), 29.0).
fillpoint(r8, xy(361,368), 29.0).
fillpoint(r8, xy(367,334), 28.0).
fillpoint(r8, xy(362,365), 28.0).
fillpoint(r8, xy(366,337), 27.0).
fillpoint(r8, xy(363,362), 27.0).
fillpoint(r8, xy(365,342), 26.0).
fillpoint(r8, xy(364,358), 26.0).
...
midline(r20, [xy(377,634),xy(131,635),xy(125,633),xy(124,627),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(555,631),xy(549,635),xy(378,634)]).
midline(r20, [xy(556,605),xy(574,604),xy(585,606),xy(585,631),xy(583,634),xy(578,635),xy(555,633)]).
midline(r20, [xy(586,605),xy(607,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r20, [xy(615,608),xy(615,630),xy(613,634),xy(596,635),xy(585,633)]).
...
midline(r17, [xy(99,553),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,550),xy(19,569),xy(23,580),xy(19,590),xy(21,618),xy(31,620),xy(55,619),xy(59,616),xy(60,610),xy(58,582),xy(49,579),xy(24,579)]).
midline(r17, [xy(100,554),xy(100,608),xy(98,617),xy(89,620),xy(70,620),xy(60,617)]).
...
region(r22, '#5a5a5a', 6400, centroid(390,620)).
perimeter(r22, 680).
polygon(r22, [xy(549,630),xy(230,630),xy(230,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(404,619),xy(239,620)]).
midline(r22, [xy(405,619),xy(540,620)]).
fillpoint(r22, xy(239,620), 10.0).
...
midline(r9, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,411),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r18, [xy(80,587),xy(80,570),xy(77,561),xy(68,559),xy(39,560)]).
midline(r18, [xy(79,588),xy(80,600)]).
...
region(r21, '#2ecc40', 2000, centroid(180,620)).
perimeter(r21, 240).
polygon(r21, [xy(229,630),xy(130,630),xy(130,610),xy(229,610),xy(229,630)]).
midline(r21, [xy(151,620),xy(139,620)]).
midline(r21, [xy(152,620),xy(220,620)]).
fillpoint(r21, xy(139,620), 10.0).
region(r7, '#870c25', 1500, centroid(364,234)).
perimeter(r7, 160).
polygon(r7, [xy(389,250),xy(340,250),xy(340,220),xy(389,220),xy(389,250)]).
midline(r7, [xy(360,235),xy(354,235)]).
midline(r7, [xy(361,234),xy(375,235)]).
fillpoint(r7, xy(354,235), 15.0).
region(r6, '#bebebe', 1000, centroid(364,210)).
perimeter(r6, 140).
polygon(r6, [xy(389,220),xy(340,220),xy(340,200),xy(389,200),xy(389,220)]).
midline(r6, [xy(360,209),xy(349,210)]).
midline(r6, [xy(361,209),xy(380,210)]).
fillpoint(r6, xy(349,210), 10.0).
...
midline(r4, [xy(169,164),xy(155,165),xy(155,184),xy(166,185),xy(174,183),xy(175,170),xy(174,166),xy(170,165)]).
...
midline(r15, [xy(405,527),xy(405,515),xy(424,515),xy(424,533),xy(410,535),xy(405,533),xy(404,528)]).
...
midline(r10, [xy(155,427),xy(155,435)]).
midline(r10, [xy(155,426),xy(155,415),xy(175,415)]).
...
adjacent(r2, r3).
shared_edge(r2, r3, 3120).
adjacent(r2, r6).
shared_edge(r2, r6, 20).
adjacent(r2, r7).
shared_edge(r2, r7, 30).
adjacent(r2, r8).
shared_edge(r2, r8, 650).
adjacent(r2, r17).
...
adjacent(r20, r21).
shared_edge(r20, r21, 220).
adjacent(r20, r22).
shared_edge(r20, r22, 660).
adjacent(r20, r23).
