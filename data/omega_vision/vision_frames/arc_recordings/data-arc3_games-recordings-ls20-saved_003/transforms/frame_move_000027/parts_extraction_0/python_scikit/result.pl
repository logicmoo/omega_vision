...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(538,24),xy(193,24),xy(180,25),xy(168,29),xy(154,37),xy(140,50),xy(89,49)]).
midline(r2, [xy(590,51),xy(589,150),xy(606,170),xy(614,191),xy(615,299),xy(611,319),xy(602,335),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,391),xy(615,547),xy(611,569),xy(603,573),xy(587,575),xy(381,574),xy(368,570),xy(354,562),xy(313,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,468),xy(79,381),xy(83,355),xy(90,340),xy(90,299),xy(75,282),xy(65,258),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(242,344),xy(239,340),xy(237,339),xy(237,341)]).
midline(r2, [xy(315,524),xy(338,501),xy(360,483),xy(376,476),xy(398,474),xy(411,469),xy(415,449),xy(414,400),xy(417,383),xy(419,379),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,349),xy(465,253),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,218),xy(414,196),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,629),xy(113,634),xy(6,634),xy(4,628),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(91,338),xy(93,340)]).
midline(r2, [xy(240,339),xy(238,338)]).
midline(r2, [xy(240,336),xy(248,308),xy(265,299),xy(265,174)]).
...
midline(r3, [xy(124,137),xy(126,134),xy(135,131),xy(152,129),xy(179,129),xy(206,133),xy(210,160),xy(209,199),xy(203,215),xy(165,225),xy(135,218),xy(124,213),xy(120,199),xy(119,161),xy(124,138)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(339,113),xy(362,103),xy(391,99),xy(453,100),xy(481,108),xy(488,130),xy(489,150),xy(502,164),xy(510,178),xy(514,190),xy(516,213),xy(523,229),xy(540,249),xy(525,267),xy(516,286),xy(514,300),xy(515,325)]).
...
midline(r3, [xy(340,114),xy(339,200),xy(356,220),xy(364,240),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(361,369),xy(352,385),xy(340,400)]).
...
region(r9, '#2ecc40', 25000, centroid(506,478)).
perimeter(r9, 840).
...
midline(r9, [xy(561,418),xy(551,436),xy(529,430),xy(510,429),xy(495,431),xy(478,438),xy(471,455),xy(469,471),xy(471,494),xy(477,510),xy(467,517),xy(449,524),xy(414,525)]).
midline(r9, [xy(551,437),xy(550,439),xy(558,455),xy(560,470),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
...
fillpoint(r9, xy(455,522), 28.0).
fillpoint(r9, xy(452,523), 27.0).
fillpoint(r9, xy(448,524), 26.0).
fillpoint(r9, xy(414,525), 25.0).
...
midline(r18, [xy(377,634),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(130,604),xy(549,604),xy(554,607),xy(561,604),xy(579,604),xy(585,606),xy(585,632),xy(579,635),xy(564,635),xy(554,632),xy(555,608)]).
midline(r18, [xy(586,605),xy(613,605),xy(615,610),xy(615,632),xy(606,635),xy(585,633)]).
midline(r18, [xy(378,634),xy(546,635),xy(554,633)]).
...
midline(r15, [xy(99,553),xy(98,542),xy(89,539),xy(31,539),xy(21,541),xy(19,551),xy(19,609),xy(21,618),xy(48,620),xy(59,617),xy(61,581),xy(70,579),xy(96,580),xy(99,575),xy(100,554)]).
midline(r15, [xy(97,581),xy(100,590),xy(98,617),xy(88,620),xy(70,620),xy(61,617)]).
...
region(r20, '#5a5a5a', 5600, centroid(410,620)).
perimeter(r20, 600).
polygon(r20, [xy(549,630),xy(270,630),xy(270,610),xy(549,610),xy(549,630)]).
midline(r20, [xy(485,620),xy(279,620)]).
midline(r20, [xy(486,620),xy(540,620)]).
fillpoint(r20, xy(279,620), 10.0).
...
midline(r8, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,444),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(189,423)]).
...
region(r19, '#2ecc40', 2800, centroid(200,620)).
perimeter(r19, 320).
polygon(r19, [xy(269,630),xy(130,630),xy(130,610),xy(269,610),xy(269,630)]).
midline(r19, [xy(184,620),xy(139,620)]).
midline(r19, [xy(185,620),xy(260,620)]).
...
midline(r4, [xy(155,177),xy(155,165),xy(174,165),xy(175,172),xy(173,184),xy(156,184),xy(155,178)]).
...
adjacent(r18, r19).
shared_edge(r18, r19, 300).
adjacent(r18, r20).
shared_edge(r18, r20, 580).
adjacent(r18, r21).
