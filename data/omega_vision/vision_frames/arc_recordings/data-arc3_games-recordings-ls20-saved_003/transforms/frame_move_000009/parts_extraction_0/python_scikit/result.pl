...
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,546),xy(611,569),xy(603,573),xy(589,575),xy(380,574),xy(354,562),xy(315,525),xy(273,524),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,468),xy(79,383),xy(81,363),xy(90,339),xy(90,299),xy(73,279),xy(65,259),xy(64,101),xy(69,78),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(245,352),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(398,474),xy(410,470),xy(415,448),xy(414,401),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,348),xy(465,251),xy(463,236),xy(456,227),xy(426,223),xy(418,218),xy(414,196),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(459,521),xy(451,519),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,522)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(519,221),xy(515,209),xy(514,190),xy(508,175),xy(464,174),xy(390,100),xy(362,103),xy(340,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(150,129),xy(135,131),xy(124,136),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,189),xy(210,160),xy(206,134)]).
midline(r3, [xy(339,114),xy(339,200),xy(356,220),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(391,99),xy(407,85),xy(431,75),xy(488,74),xy(510,79),xy(515,100),xy(515,147),xy(513,163),xy(508,174)]).
...
midline(r19, [xy(524,635),xy(131,635),xy(125,633),xy(124,624),xy(125,605),xy(131,604),xy(549,604),xy(555,606),xy(554,633),xy(549,635),xy(525,635)]).
midline(r19, [xy(556,605),xy(579,604),xy(585,606),xy(585,632),xy(573,635),xy(555,633)]).
...
midline(r16, [xy(99,553),xy(98,542),xy(89,539),xy(30,539),xy(21,541),xy(19,550),xy(20,575),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,616),xy(58,582),xy(48,579),xy(24,579)]).
midline(r16, [xy(100,554),xy(100,608),xy(98,617),xy(89,620),xy(70,620),xy(61,617)]).
...
midline(r8, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,411),xy(189,423)]).
...
midline(r20, [xy(280,620),xy(300,620)]).
...
midline(r5, [xy(473,135),xy(454,135)]).
midline(r5, [xy(474,135),xy(475,135)]).
...
midline(r4, [xy(460,109),xy(449,110)]).
midline(r4, [xy(461,110),xy(480,110)]).
