...
midline(r2, [xy(590,49),xy(561,29),xy(539,24),xy(190,24),xy(176,26),xy(162,32),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,101),xy(65,259),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,382),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,627),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,534),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(250,382),xy(248,363),xy(238,338),xy(233,343),xy(228,343),xy(229,345)]).
...
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,549),xy(613,563),xy(609,571),xy(589,575),xy(380,574),xy(354,562),xy(315,525),xy(266,523)]).
midline(r2, [xy(315,524),xy(340,499),xy(362,482),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,401),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,253),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,198),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,471),xy(471,494),xy(477,510),xy(461,520),xy(453,520),xy(435,506),xy(429,504),xy(395,505),xy(395,544),xy(433,544),xy(455,524),xy(450,519)]).
midline(r3, [xy(454,521),xy(457,522)]).
midline(r3, [xy(520,420),xy(515,399),xy(514,382),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(480,108),xy(453,100),xy(390,99),xy(362,103),xy(340,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(151,129),xy(126,134),xy(121,145),xy(119,162),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,185),xy(210,160),xy(206,134)]).
midline(r3, [xy(339,114),xy(339,200),xy(357,222),xy(363,236),xy(368,269),xy(377,285),xy(390,300),xy(377,314),xy(366,336),xy(364,350),xy(365,398),xy(360,420),xy(348,424),xy(314,425)]).
...
midline(r19, [xy(524,635),xy(131,635),xy(125,633),xy(124,610),xy(125,605),xy(133,604),xy(549,604),xy(553,605),xy(555,609),xy(554,633),xy(525,635)]).
midline(r19, [xy(555,606),xy(560,604),xy(583,605),xy(585,612),xy(585,632),xy(583,634),xy(561,635),xy(555,633)]).
midline(r19, [xy(585,606),xy(590,604),xy(609,604),xy(614,607),xy(624,604),xy(635,605)]).
midline(r19, [xy(615,608),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r16, [xy(43,539),xy(24,540),xy(20,544),xy(19,566),xy(20,575),xy(23,580),xy(19,590),xy(20,615),xy(21,618),xy(31,620),xy(49,620),xy(60,616),xy(60,590),xy(58,582),xy(49,579),xy(24,579)]).
midline(r16, [xy(61,617),xy(70,620),xy(88,620),xy(98,617),xy(100,607),xy(99,544),xy(97,541),xy(89,539),xy(44,540)]).
...
midline(r8, [xy(189,442),xy(190,432),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(176,399),xy(188,401),xy(190,410),xy(189,424)]).
...
midline(r17, [xy(52,559),xy(78,561),xy(80,600)]).
...
midline(r7, [xy(322,385),xy(304,385)]).
midline(r7, [xy(323,384),xy(325,385)]).
...
midline(r6, [xy(301,359),xy(299,360)]).
midline(r6, [xy(302,360),xy(330,360)]).
