...
midline(r2, [xy(89,49),xy(69,78),xy(64,100),xy(65,258),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(160,33),xy(176,26),xy(190,24),xy(539,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(615,295),xy(613,313),xy(599,339),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,391),xy(615,548),xy(612,566),xy(606,572),xy(589,575),xy(380,574),xy(354,562),xy(313,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,534)]).
midline(r2, [xy(265,521),xy(250,461),xy(250,382),xy(248,363),xy(239,340),xy(226,345),xy(226,347)]).
midline(r2, [xy(315,524),xy(360,483),xy(376,476),xy(398,474),xy(410,470),xy(415,449),xy(414,401),xy(417,383),xy(420,378),xy(426,376),xy(459,371),xy(463,363),xy(465,346),xy(465,250),xy(463,236),xy(459,228),xy(431,224),xy(419,220),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 96300, centroid(303,205)).
perimeter(r3, 3120).
...
midline(r3, [xy(124,137),xy(126,134),xy(135,131),xy(154,129),xy(179,129),xy(206,133),xy(210,161),xy(209,199),xy(203,215),xy(165,225),xy(135,218),xy(124,213),xy(120,199),xy(119,165),xy(120,150),xy(124,138)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(329,107),xy(339,113),xy(339,200),xy(356,220),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(340,112),xy(353,106),xy(376,100),xy(438,99),xy(463,102),xy(465,107),xy(465,175)]).
midline(r3, [xy(465,103),xy(476,100),xy(490,100)]).
midline(r3, [xy(164,226),xy(165,361),xy(164,365),xy(145,383),xy(125,385),xy(124,458),xy(125,464),xy(130,465),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
...
region(r8, '#2ecc40', 39100, centroid(517,402)).
perimeter(r8, 1440).
polygon(r8, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r8, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(457,522),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r8, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r8, [xy(552,509),xy(558,494),xy(560,472),xy(558,455),xy(550,439),xy(549,432)]).
midline(r8, [xy(520,420),xy(514,386),xy(515,291),xy(523,270),xy(540,249)]).
fillpoint(r8, xy(539,250), 50.0).
...
fillpoint(r8, xy(518,281), 29.0).
fillpoint(r8, xy(458,521), 29.0).
fillpoint(r8, xy(517,284), 28.0).
fillpoint(r8, xy(516,287), 27.0).
fillpoint(r8, xy(515,292), 26.0).
fillpoint(r8, xy(515,398), 26.0).
fillpoint(r8, xy(514,345), 25.0).
...
midline(r20, [xy(377,634),xy(126,634),xy(124,610),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(555,631),xy(549,635),xy(378,635)]).
midline(r20, [xy(556,605),xy(577,604),xy(584,607),xy(592,604),xy(613,605),xy(615,609),xy(615,632),xy(606,635),xy(590,635),xy(584,632),xy(585,608)]).
midline(r20, [xy(584,633),xy(579,635),xy(555,633)]).
...
midline(r17, [xy(99,553),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,550),xy(19,569),xy(23,579),xy(19,590),xy(21,618),xy(31,620),xy(55,619),xy(60,616),xy(58,582),xy(48,579),xy(24,579)]).
midline(r17, [xy(100,554),xy(100,608),xy(98,617),xy(88,620),xy(70,620),xy(61,617)]).
...
region(r21, '#2ecc40', 4400, centroid(240,620)).
perimeter(r21, 480).
polygon(r21, [xy(349,630),xy(130,630),xy(130,610),xy(349,610),xy(349,630)]).
midline(r21, [xy(290,620),xy(139,620)]).
midline(r21, [xy(291,619),xy(340,620)]).
...
midline(r9, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,411),xy(189,424)]).
...
region(r22, '#5a5a5a', 4000, centroid(450,620)).
perimeter(r22, 440).
polygon(r22, [xy(549,630),xy(350,630),xy(350,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(499,620),xy(359,620)]).
midline(r22, [xy(500,620),xy(540,620)]).
fillpoint(r22, xy(359,620), 10.0).
region(r18, '#870c25', 2000, centroid(68,572)).
perimeter(r18, 240).
polygon(r18, [xy(89,610),xy(70,609),xy(69,570),xy(30,569),xy(30,550),xy(90,550),xy(89,610)]).
midline(r18, [xy(80,587),xy(80,571),xy(77,561),xy(68,559),xy(39,560)]).
...
region(r7, '#870c25', 1500, centroid(514,184)).
perimeter(r7, 160).
polygon(r7, [xy(539,200),xy(490,200),xy(490,170),xy(539,170),xy(539,200)]).
midline(r7, [xy(516,184),xy(504,185)]).
midline(r7, [xy(517,185),xy(525,185)]).
fillpoint(r7, xy(504,185), 15.0).
region(r4, '#bebebe', 1000, centroid(514,160)).
perimeter(r4, 140).
polygon(r4, [xy(539,170),xy(490,170),xy(490,150),xy(539,150),xy(539,170)]).
midline(r4, [xy(501,159),xy(499,160)]).
midline(r4, [xy(502,159),xy(530,160)]).
...
midline(r5, [xy(174,182),xy(175,171),xy(173,165),xy(155,165),xy(154,170),xy(155,184),xy(174,184)]).
...
adjacent(r20, r21).
shared_edge(r20, r21, 460).
adjacent(r20, r22).
shared_edge(r20, r22, 420).
adjacent(r20, r23).
