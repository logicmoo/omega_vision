...
midline(r2, [xy(590,49),xy(561,29),xy(539,24),xy(192,24),xy(170,28),xy(154,37),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,258),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,381),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,534),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(249,368),xy(244,349),xy(239,340),xy(248,308),xy(262,301),xy(265,293),xy(265,174)]).
midline(r2, [xy(266,523),xy(290,525),xy(315,524),xy(354,562),xy(370,571),xy(381,574),xy(587,575),xy(610,570)]).
midline(r2, [xy(611,568),xy(615,549),xy(614,380),xy(611,370),xy(599,350),xy(594,345),xy(584,345)]).
midline(r2, [xy(590,51),xy(589,150),xy(607,172),xy(613,186),xy(615,201),xy(614,308),xy(606,329),xy(594,344)]).
midline(r2, [xy(316,523),xy(339,500),xy(360,483),xy(376,476),xy(398,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,448),xy(414,401),xy(418,380),xy(430,375),xy(448,374),xy(460,370),xy(464,359),xy(465,344),xy(465,252),xy(463,236),xy(459,228),xy(449,225),xy(430,224),xy(418,218),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(366,263)).
perimeter(r3, 4660).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,471),xy(470,489),xy(476,511),xy(461,520),xy(451,519),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,388),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(515,209),xy(514,190),xy(508,175),xy(465,175),xy(390,100),xy(362,103),xy(340,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(150,129),xy(135,131),xy(124,136),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(165,225),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,187),xy(210,160),xy(206,134)]).
midline(r3, [xy(339,114),xy(339,200),xy(356,220),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(365,340),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(391,99),xy(410,83),xy(431,75),xy(489,74),xy(509,78),xy(514,90),xy(515,149),xy(513,163),xy(508,174)]).
...
midline(r19, [xy(524,635),xy(130,635),xy(125,633),xy(125,605),xy(547,604),xy(555,606),xy(555,632),xy(549,635),xy(525,634)]).
midline(r19, [xy(556,605),xy(575,604),xy(585,606),xy(585,628),xy(583,634),xy(560,635),xy(555,633)]).
midline(r19, [xy(586,605),xy(608,604),xy(615,606),xy(615,632),xy(605,635),xy(585,633)]).
...
midline(r16, [xy(19,563),xy(20,544),xy(24,540),xy(95,540),xy(98,541),xy(100,551),xy(100,608),xy(99,615),xy(95,619),xy(73,620),xy(64,619),xy(60,616),xy(49,620),xy(22,618),xy(19,607),xy(19,590),xy(23,579),xy(20,575),xy(19,564)]).
...
midline(r21, [xy(459,620),xy(319,620)]).
midline(r21, [xy(460,620),xy(540,620)]).
...
midline(r8, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(189,423)]).
...
midline(r20, [xy(280,619),xy(300,620)]).
...
midline(r17, [xy(80,596),xy(79,564),xy(77,561),xy(69,559),xy(39,560)]).
...
midline(r14, [xy(419,514),xy(405,515),xy(405,534),xy(418,535),xy(424,533),xy(425,520),xy(424,516),xy(420,515)]).
