...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(539,24),xy(191,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,101),xy(65,258),xy(73,279),xy(90,299),xy(90,339),xy(83,355),xy(79,382),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,535),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(249,368),xy(241,341),xy(237,339),xy(235,341)]).
midline(r2, [xy(266,523),xy(290,525),xy(315,524),xy(354,562),xy(380,574),xy(586,575),xy(609,571),xy(613,563),xy(615,549),xy(615,390),xy(612,373),xy(602,354),xy(594,345),xy(584,345)]).
midline(r2, [xy(240,339),xy(238,338)]).
midline(r2, [xy(240,337),xy(248,308),xy(262,301),xy(265,296),xy(265,174)]).
midline(r2, [xy(590,51),xy(589,150),xy(606,170),xy(613,186),xy(615,201),xy(614,309),xy(606,329),xy(594,344)]).
midline(r2, [xy(316,523),xy(350,490),xy(362,482),xy(376,476),xy(399,474),xy(410,470),xy(415,449),xy(414,401),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(459,228),xy(426,223),xy(418,218),xy(414,198),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,471),xy(470,489),xy(476,511),xy(457,522),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(511,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(525,267),xy(540,249),xy(523,229),xy(516,213),xy(511,180),xy(502,164),xy(489,150),xy(489,136),xy(481,109),xy(453,100),xy(376,100),xy(350,107),xy(340,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(150,129),xy(126,134),xy(121,145),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,188),xy(210,163),xy(206,134)]).
midline(r3, [xy(340,114),xy(339,200),xy(352,214),xy(361,230),xy(364,240),xy(365,258),xy(369,270),xy(380,274),xy(403,276),xy(411,280),xy(414,291),xy(415,325)]).
...
midline(r20, [xy(524,635),xy(136,635),xy(126,634),xy(124,629),xy(125,605),xy(131,604),xy(549,604),xy(555,606),xy(554,633),xy(549,635),xy(525,635)]).
midline(r20, [xy(556,605),xy(579,604),xy(584,607),xy(595,604),xy(613,605),xy(615,609),xy(615,632),xy(607,635),xy(590,635),xy(584,632),xy(579,635),xy(555,633)]).
midline(r20, [xy(585,631),xy(585,608)]).
...
midline(r17, [xy(99,553),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,552),xy(20,575),xy(23,579),xy(19,591),xy(21,618),xy(33,620),xy(55,619),xy(60,616),xy(60,590),xy(58,582),xy(49,579),xy(24,580)]).
midline(r17, [xy(100,554),xy(100,608),xy(98,617),xy(89,620),xy(73,620),xy(61,617)]).
...
midline(r22, [xy(485,619),xy(199,620)]).
midline(r22, [xy(486,620),xy(540,620)]).
...
midline(r9, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r18, [xy(80,586),xy(80,570),xy(77,561),xy(69,559),xy(39,560)]).
...
midline(r21, [xy(161,619),xy(180,620)]).
...
midline(r4, [xy(174,182),xy(175,172),xy(173,165),xy(155,165),xy(154,170),xy(155,184),xy(174,184)]).
...
midline(r15, [xy(405,527),xy(405,534),xy(411,535),xy(423,534),xy(425,528),xy(424,516),xy(417,514),xy(405,515),xy(405,526)]).
...
midline(r10, [xy(155,428),xy(155,435)]).
