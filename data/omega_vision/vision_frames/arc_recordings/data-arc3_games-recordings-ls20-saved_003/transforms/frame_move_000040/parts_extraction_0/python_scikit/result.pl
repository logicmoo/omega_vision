...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(539,24),xy(194,24),xy(170,28),xy(154,37),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,382),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(12,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,534),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(250,386),xy(248,363),xy(240,340),xy(236,338),xy(230,344),xy(228,343),xy(225,346),xy(228,345)]).
midline(r2, [xy(237,341),xy(234,342)]).
midline(r2, [xy(91,338),xy(92,341),xy(104,345),xy(106,349)]).
midline(r2, [xy(589,51),xy(589,150),xy(606,170),xy(614,191),xy(615,298),xy(613,313),xy(604,332),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,549),xy(613,563),xy(609,571),xy(588,575),xy(380,574),xy(368,570),xy(350,559),xy(314,524),xy(266,523)]).
midline(r2, [xy(315,524),xy(349,491),xy(362,482),xy(376,476),xy(399,474),xy(410,470),xy(415,449),xy(414,401),xy(417,383),xy(419,379),xy(426,376),xy(448,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,349),xy(464,240),xy(459,228),xy(449,225),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 137200, centroid(371,263)).
perimeter(r3, 4420).
...
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(523,270),xy(540,249),xy(527,235),xy(519,221),xy(515,209),xy(512,183),xy(502,164),xy(489,150),xy(488,130),xy(480,108),xy(453,100),xy(390,99),xy(362,103),xy(340,113),xy(326,106),xy(303,100),xy(239,99),xy(214,125),xy(140,124),xy(123,127),xy(117,133),xy(114,150),xy(114,199),xy(118,219),xy(130,224),xy(153,226),xy(164,232),xy(176,226),xy(199,224),xy(210,220)]).
midline(r3, [xy(215,126),xy(215,199),xy(211,218)]).
midline(r3, [xy(339,114),xy(339,200),xy(356,220),xy(364,240),xy(365,259),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(365,340),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,470),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(165,233),xy(164,365),xy(145,383),xy(125,385),xy(124,392),xy(125,464),xy(203,464),xy(205,454),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r15, [xy(524,635),xy(133,635),xy(126,634),xy(124,629),xy(125,605),xy(131,604),xy(548,604),xy(555,606),xy(555,632),xy(548,635),xy(525,635)]).
midline(r15, [xy(556,605),xy(578,604),xy(585,606),xy(585,632),xy(579,635),xy(555,633)]).
midline(r15, [xy(586,605),xy(609,604),xy(615,606),xy(615,631),xy(613,634),xy(608,635),xy(590,635),xy(585,633)]).
...
midline(r16, [xy(305,619),xy(540,620)]).
fillpoint(r16, xy(139,620), 10.0).
region(r12, '#aaaaaa', 7600, centroid(61,581)).
perimeter(r12, 720).
polygon(r12, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r12, [xy(50,609),xy(50,570),xy(89,570),xy(89,550),xy(30,550),xy(30,609),xy(50,609)]).
hole(r12, [xy(90,609),xy(89,590),xy(70,590),xy(70,610),xy(90,609)]).
midline(r12, [xy(19,563),xy(20,544),xy(24,540),xy(89,539),xy(98,541),xy(100,551),xy(100,569),xy(96,580),xy(70,579),xy(61,581),xy(59,591),xy(60,615),xy(55,619),xy(30,620),xy(21,617),xy(19,609),xy(19,564)]).
midline(r12, [xy(97,581),xy(100,590),xy(100,608),xy(97,618),xy(70,620),xy(60,617)]).
fillpoint(r12, xy(97,580), 12.8).
fillpoint(r12, xy(60,617), 12.8).
fillpoint(r12, xy(22,541), 12.0).
fillpoint(r12, xy(98,541), 12.0).
fillpoint(r12, xy(62,581), 12.0).
...
fillpoint(r12, xy(99,574), 11.0).
fillpoint(r12, xy(65,580), 11.0).
fillpoint(r12, xy(60,585), 11.0).
fillpoint(r12, xy(99,585), 11.0).
...
fillpoint(r12, xy(19,580), 10.0).
fillpoint(r12, xy(99,560), 10.0).
fillpoint(r12, xy(71,580), 10.0).
fillpoint(r12, xy(59,600), 10.0).
fillpoint(r12, xy(99,600), 10.0).
...
midline(r6, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,423)]).
...
region(r13, '#870c25', 2000, centroid(52,572)).
perimeter(r13, 240).
polygon(r13, [xy(49,610),xy(30,609),xy(30,550),xy(89,550),xy(89,570),xy(50,570),xy(49,610)]).
midline(r13, [xy(40,585),xy(41,561),xy(51,559),xy(80,560)]).
midline(r13, [xy(40,586),xy(40,600)]).
fillpoint(r13, xy(42,561), 12.0).
fillpoint(r13, xy(45,560), 11.0).
fillpoint(r13, xy(40,565), 11.0).
fillpoint(r13, xy(51,560), 10.0).
fillpoint(r13, xy(39,586), 10.0).
region(r5, '#870c25', 1500, centroid(164,184)).
perimeter(r5, 160).
polygon(r5, [xy(189,200),xy(140,200),xy(140,170),xy(189,170),xy(189,200)]).
midline(r5, [xy(166,184),xy(154,185)]).
midline(r5, [xy(167,185),xy(175,185)]).
...
midline(r7, [xy(172,414),xy(175,415)]).
fillpoint(r7, xy(156,415), 6.0).
fillpoint(r7, xy(161,415), 5.0).
fillpoint(r7, xy(155,428), 5.0).
region(r14, '#870c25', 400, centroid(80,600)).
perimeter(r14, 80).
polygon(r14, [xy(89,610),xy(70,609),xy(70,590),xy(90,590),xy(89,610)]).
midline(r14, [xy(79,599),xy(80,600)]).
fillpoint(r14, xy(79,600), 10.0).
