...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(538,24),xy(193,24),xy(168,29),xy(154,37),xy(140,50),xy(89,49)]).
midline(r2, [xy(590,51),xy(589,150),xy(606,170),xy(614,190),xy(615,299),xy(612,316),xy(602,335),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,392),xy(615,545),xy(611,569),xy(603,573),xy(589,575),xy(380,574),xy(354,562),xy(314,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,467),xy(79,380),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,258),xy(64,101),xy(69,78),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(245,352),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,400),xy(418,380),xy(430,375),xy(456,372),xy(461,369),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(430,224),xy(418,219),xy(414,198),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,603),xy(115,628),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(266,299),xy(290,300)]).
midline(r2, [xy(91,340),xy(97,341),xy(96,343)]).
...
midline(r3, [xy(180,465),xy(130,465),xy(126,464),xy(124,459),xy(125,385),xy(145,383),xy(165,363),xy(165,227),xy(163,224),xy(135,218),xy(124,213),xy(119,189),xy(120,150),xy(124,136),xy(140,130),xy(179,129),xy(206,133),xy(210,160),xy(210,188),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
midline(r3, [xy(207,132),xy(239,99),xy(303,100),xy(326,106),xy(340,113),xy(339,200),xy(352,214),xy(361,230),xy(365,259),xy(373,279),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
midline(r3, [xy(341,112),xy(362,103),xy(390,99),xy(453,100),xy(481,108),xy(488,130),xy(489,150),xy(502,164),xy(510,178),xy(514,190),xy(516,213),xy(523,229),xy(540,249),xy(523,270),xy(515,290),xy(514,385),xy(519,415),xy(503,423),xy(481,425),xy(468,430),xy(464,451),xy(465,517),xy(459,521),xy(451,519),xy(435,506),xy(429,504),xy(395,505),xy(395,544),xy(433,544),xy(456,523),xy(452,520)]).
midline(r3, [xy(520,416),xy(557,422),xy(561,430),xy(565,450),xy(565,499),xy(561,518),xy(553,523),xy(538,525),xy(490,525),xy(476,523),xy(465,518)]).
...
midline(r16, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(548,604),xy(555,606),xy(555,632),xy(548,635),xy(525,634)]).
midline(r16, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(578,635),xy(560,635),xy(555,633)]).
midline(r16, [xy(585,606),xy(609,604),xy(613,605),xy(615,610),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r13, [xy(99,553),xy(98,542),xy(88,539),xy(64,540),xy(59,543),xy(48,539),xy(30,539),xy(21,541),xy(19,550),xy(19,569),xy(23,579),xy(20,584),xy(19,594),xy(20,615),xy(21,618),xy(33,620),xy(89,620),xy(97,618),xy(100,609),xy(99,554)]).
midline(r13, [xy(60,544),xy(60,565),xy(57,578),xy(49,580),xy(24,579)]).
...
midline(r6, [xy(189,442),xy(190,432),xy(188,424),xy(165,425),xy(165,447),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r15, [xy(80,587),xy(79,595),xy(75,599),xy(39,600)]).
midline(r15, [xy(80,586),xy(80,559)]).
...
midline(r18, [xy(491,620),xy(479,620)]).
midline(r18, [xy(492,619),xy(540,620)]).
...
midline(r11, [xy(424,532),xy(425,520),xy(423,515),xy(405,515),xy(404,520),xy(405,534),xy(424,534)]).
