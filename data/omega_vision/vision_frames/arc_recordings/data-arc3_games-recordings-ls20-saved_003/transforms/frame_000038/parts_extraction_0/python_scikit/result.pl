...
midline(r2, [xy(89,49),xy(77,64),xy(68,80),xy(64,101),xy(65,258),xy(73,279),xy(90,299),xy(90,339),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(160,33),xy(176,26),xy(190,24),xy(532,24),xy(549,25),xy(569,33),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(615,298),xy(613,313),xy(606,329),xy(598,340),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,549),xy(611,569),xy(606,572),xy(589,575),xy(381,574),xy(370,571),xy(354,562),xy(312,524),xy(294,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(236,339),xy(233,342)]).
midline(r2, [xy(237,338),xy(239,336),xy(240,338)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(398,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,449),xy(414,405),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,253),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,218),xy(414,198),xy(415,174)]).
midline(r2, [xy(241,335),xy(248,308),xy(265,299),xy(265,174)]).
...
border(r2).
region(r3, '#2ecc40', 107500, centroid(428,272)).
perimeter(r3, 3020).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,471),xy(470,489),xy(476,511),xy(453,523),xy(414,525)]).
midline(r3, [xy(520,420),xy(514,386),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(512,183),xy(502,164),xy(489,150),xy(488,130),xy(481,109),xy(453,100),xy(390,99),xy(362,103),xy(339,113),xy(317,103),xy(289,100),xy(275,87),xy(253,76),xy(214,75)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,470),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(477,511)]).
midline(r3, [xy(340,114),xy(339,200),xy(349,210),xy(360,228),xy(364,241),xy(366,263),xy(373,279),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
...
region(r4, '#2ecc40', 28800, centroid(160,238)).
perimeter(r4, 1520).
...
hole(r4, [xy(180,189),xy(179,160),xy(150,160),xy(150,190),xy(180,189)]).
midline(r4, [xy(121,200),xy(119,187),xy(121,145),xy(124,136),xy(135,131),xy(160,129),xy(210,179),xy(209,199),xy(205,213),xy(194,218),xy(164,225),xy(126,215),xy(121,201)]).
midline(r4, [xy(164,226),xy(165,364),xy(145,383),xy(125,385),xy(124,457),xy(125,464),xy(132,465),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
fillpoint(r4, xy(125,135), 35.4).
fillpoint(r4, xy(125,214), 35.4).
fillpoint(r4, xy(204,214), 35.4).
fillpoint(r4, xy(165,225), 35.4).
fillpoint(r4, xy(136,131), 32.0).
fillpoint(r4, xy(121,146), 32.0).
fillpoint(r4, xy(121,203), 32.0).
fillpoint(r4, xy(208,203), 32.0).
fillpoint(r4, xy(136,218), 32.0).
fillpoint(r4, xy(193,218), 32.0).
fillpoint(r4, xy(153,221), 32.0).
fillpoint(r4, xy(176,221), 32.0).
fillpoint(r4, xy(141,219), 31.1).
fillpoint(r4, xy(188,219), 31.1).
fillpoint(r4, xy(148,220), 31.1).
fillpoint(r4, xy(181,220), 31.1).
fillpoint(r4, xy(142,130), 31.0).
fillpoint(r4, xy(120,152), 31.0).
fillpoint(r4, xy(120,198), 31.0).
fillpoint(r4, xy(209,198), 31.0).
fillpoint(r4, xy(151,130), 30.0).
fillpoint(r4, xy(119,175), 30.0).
fillpoint(r4, xy(209,184), 30.0).
...
midline(r18, [xy(377,634),xy(126,634),xy(124,611),xy(125,605),xy(130,604),xy(548,604),xy(555,606),xy(555,632),xy(553,634),xy(378,635)]).
midline(r18, [xy(556,605),xy(578,604),xy(585,606),xy(585,632),xy(576,635),xy(555,633)]).
midline(r18, [xy(586,605),xy(609,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r18, [xy(615,608),xy(615,632),xy(613,634),xy(595,635),xy(585,633)]).
...
midline(r15, [xy(99,553),xy(98,542),xy(89,539),xy(24,540),xy(21,541),xy(19,550),xy(19,609),xy(21,618),xy(30,620),xy(47,620),xy(59,617),xy(61,581),xy(70,579),xy(96,580),xy(100,569),xy(99,554)]).
...
region(r19, '#2ecc40', 7200, centroid(310,620)).
perimeter(r19, 760).
polygon(r19, [xy(489,630),xy(130,630),xy(130,610),xy(489,610),xy(489,630)]).
midline(r19, [xy(345,620),xy(139,620)]).
midline(r19, [xy(346,620),xy(480,620)]).
...
midline(r9, [xy(189,442),xy(189,426),xy(184,424),xy(165,425),xy(165,447),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,411),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,424)]).
...
midline(r16, [xy(39,586),xy(41,561),xy(51,559),xy(80,560)]).
midline(r16, [xy(39,587),xy(40,600)]).
...
midline(r6, [xy(211,134),xy(225,135)]).
fillpoint(r6, xy(204,135), 15.0).
region(r20, '#5a5a5a', 1200, centroid(520,620)).
perimeter(r20, 160).
polygon(r20, [xy(549,630),xy(490,630),xy(490,610),xy(549,610),xy(549,630)]).
midline(r20, [xy(520,620),xy(499,620)]).
midline(r20, [xy(521,619),xy(540,620)]).
fillpoint(r20, xy(499,620), 10.0).
...
midline(r5, [xy(210,109),xy(230,110)]).
fillpoint(r5, xy(199,110), 10.0).
region(r7, '#5a5a5a', 800, centroid(164,174)).
perimeter(r7, 160).
polygon(r7, [xy(179,190),xy(150,189),xy(150,160),xy(180,160),xy(179,190)]).
hole(r7, [xy(170,179),xy(169,170),xy(160,170),xy(160,180),xy(170,179)]).
midline(r7, [xy(169,164),xy(155,165),xy(155,184),xy(169,185),xy(174,183),xy(175,170),xy(174,166),xy(170,165)]).
fillpoint(r7, xy(156,165), 6.0).
fillpoint(r7, xy(174,165), 6.0).
fillpoint(r7, xy(155,184), 6.0).
fillpoint(r7, xy(173,184), 6.0).
fillpoint(r7, xy(161,165), 5.0).
fillpoint(r7, xy(154,175), 5.0).
fillpoint(r7, xy(174,175), 5.0).
fillpoint(r7, xy(161,185), 5.0).
...
border(r23).
region(r8, '#2ecc40', 100, centroid(164,174)).
perimeter(r8, 40).
polygon(r8, [xy(169,180),xy(160,179),xy(160,170),xy(170,170),xy(169,180)]).
midline(r8, [xy(165,175),xy(165,174)]).
fillpoint(r8, xy(164,175), 5.0).
...
adjacent(r4, r7).
shared_edge(r4, r7, 120).
adjacent(r4, r9).
shared_edge(r4, r9, 280).
adjacent(r5, r6).
...
adjacent(r18, r19).
shared_edge(r18, r19, 740).
adjacent(r18, r20).
shared_edge(r18, r20, 140).
adjacent(r18, r21).
