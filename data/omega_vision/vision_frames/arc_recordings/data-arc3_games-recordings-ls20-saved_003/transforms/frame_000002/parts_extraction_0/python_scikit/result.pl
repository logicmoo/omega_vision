...
midline(r2, [xy(89,49),xy(69,78),xy(64,102),xy(65,258),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(160,33),xy(176,26),xy(190,24),xy(539,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(599,160),xy(610,178),xy(614,190),xy(615,205),xy(614,309),xy(610,321),xy(599,339),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,392),xy(615,549),xy(612,566),xy(606,572),xy(586,575),xy(390,575),xy(376,573),xy(357,564),xy(315,525),xy(310,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,534)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(239,339),xy(235,340),xy(235,342)]).
midline(r2, [xy(315,524),xy(350,490),xy(360,483),xy(376,476),xy(398,474),xy(410,470),xy(415,449),xy(414,402),xy(417,383),xy(420,378),xy(426,376),xy(449,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,349),xy(464,240),xy(459,228),xy(426,223),xy(418,219),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 127900, centroid(370,250)).
perimeter(r3, 4160).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(340,350),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(459,521),xy(452,520),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,470),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(520,420),xy(514,388),xy(515,290),xy(525,267),xy(540,249),xy(527,235),xy(518,219),xy(512,183),xy(502,164),xy(489,150),xy(489,136),xy(481,109),xy(453,100),xy(376,100),xy(350,107),xy(340,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(177,129),xy(150,129),xy(126,134),xy(121,145),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,225),xy(165,364),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(131,465),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(340,114),xy(339,200),xy(357,222),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,300)]).
midline(r3, [xy(206,134),xy(209,150),xy(210,188),xy(205,213),xy(194,218),xy(175,221),xy(165,225)]).
...
midline(r1, [xy(20,309),xy(20,500)]).
...
midline(r20, [xy(377,634),xy(126,634),xy(124,629),xy(124,611),xy(125,605),xy(131,604),xy(549,604),xy(555,606),xy(555,632),xy(553,634),xy(378,635)]).
midline(r20, [xy(556,605),xy(577,604),xy(585,606),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r20, [xy(586,605),xy(605,604),xy(615,606),xy(615,632),xy(608,635),xy(585,633)]).
...
midline(r17, [xy(99,553),xy(99,544),xy(95,540),xy(32,539),xy(21,541),xy(19,550),xy(19,568),xy(23,579),xy(19,591),xy(21,618),xy(30,620),xy(55,619),xy(60,614),xy(58,582),xy(49,579),xy(24,580)]).
midline(r17, [xy(100,554),xy(100,608),xy(98,617),xy(84,620),xy(70,620),xy(60,617)]).
...
region(r22, '#5a5a5a', 7600, centroid(360,620)).
perimeter(r22, 800).
polygon(r22, [xy(549,630),xy(170,630),xy(170,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(385,620),xy(179,620)]).
midline(r22, [xy(386,620),xy(540,620)]).
fillpoint(r22, xy(179,620), 10.0).
region(r6, '#2ecc40', 7500, centroid(331,408)).
perimeter(r6, 400).
polygon(r6, [xy(389,450),xy(290,449),xy(290,350),xy(339,350),xy(340,399),xy(390,400),xy(389,450)]).
midline(r6, [xy(362,424),xy(331,424),xy(323,422),xy(318,418),xy(314,399),xy(315,374)]).
midline(r6, [xy(363,425),xy(365,425)]).
fillpoint(r6, xy(319,420), 29.7).
fillpoint(r6, xy(318,418), 29.0).
fillpoint(r6, xy(321,421), 29.0).
fillpoint(r6, xy(317,415), 28.0).
fillpoint(r6, xy(324,422), 28.0).
fillpoint(r6, xy(316,412), 27.0).
fillpoint(r6, xy(327,423), 27.0).
fillpoint(r6, xy(315,408), 26.0).
fillpoint(r6, xy(332,424), 26.0).
fillpoint(r6, xy(315,386), 25.0).
fillpoint(r6, xy(341,425), 25.0).
...
midline(r9, [xy(189,442),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,423)]).
...
midline(r18, [xy(52,559),xy(78,561),xy(80,570),xy(80,600)]).
...
region(r8, '#870c25', 1500, centroid(364,384)).
perimeter(r8, 160).
polygon(r8, [xy(389,400),xy(340,400),xy(340,370),xy(389,370),xy(389,400)]).
midline(r8, [xy(366,384),xy(354,385)]).
midline(r8, [xy(367,384),xy(375,385)]).
fillpoint(r8, xy(354,385), 15.0).
region(r7, '#bebebe', 1000, centroid(364,360)).
perimeter(r7, 140).
polygon(r7, [xy(389,370),xy(340,370),xy(340,350),xy(389,350),xy(389,370)]).
midline(r7, [xy(359,360),xy(349,360)]).
midline(r7, [xy(360,360),xy(380,360)]).
fillpoint(r7, xy(349,360), 10.0).
...
region(r21, '#2ecc40', 800, centroid(150,620)).
perimeter(r21, 120).
polygon(r21, [xy(169,630),xy(130,630),xy(130,610),xy(169,610),xy(169,630)]).
midline(r21, [xy(149,620),xy(139,620)]).
midline(r21, [xy(150,620),xy(160,620)]).
...
adjacent(r2, r3).
shared_edge(r2, r3, 3470).
adjacent(r2, r6).
shared_edge(r2, r6, 300).
adjacent(r2, r7).
...
adjacent(r20, r21).
shared_edge(r20, r21, 100).
adjacent(r20, r22).
shared_edge(r20, r22, 780).
adjacent(r20, r23).
