...
midline(r2, [xy(412,466),xy(409,471),xy(403,473),xy(376,476),xy(360,483),xy(340,499),xy(314,525),xy(273,524),xy(265,522),xy(241,531),xy(209,535),xy(175,535),xy(145,510),xy(124,501),xy(96,495),xy(81,486),xy(79,468),xy(79,380),xy(83,355),xy(90,339),xy(90,299),xy(73,279),xy(65,258),xy(64,101),xy(68,80),xy(77,64),xy(89,49),xy(140,50),xy(162,32),xy(176,26),xy(191,24),xy(539,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(602,164),xy(611,180),xy(615,204),xy(615,299),xy(613,313),xy(607,327),xy(598,340),xy(593,345),xy(584,345)]).
midline(r2, [xy(412,465),xy(415,445),xy(414,402),xy(418,380),xy(430,375),xy(448,374),xy(460,370)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(239,339),xy(237,341)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,549),xy(613,563),xy(608,571),xy(588,575),xy(380,574),xy(368,570),xy(350,559),xy(315,525)]).
midline(r2, [xy(461,368),xy(465,346),xy(464,240),xy(459,228),xy(426,223),xy(418,218),xy(414,197),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(369,262)).
perimeter(r3, 4560).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(390,449),xy(290,449),xy(290,350),xy(340,349),xy(340,250),xy(290,250),xy(290,200),xy(339,200),xy(340,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(477,510),xy(459,521),xy(449,518),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(522,227),xy(516,213),xy(511,180),xy(502,164),xy(489,150),xy(489,136),xy(482,110),xy(479,107),xy(453,100),xy(390,99),xy(364,103),xy(339,99),xy(239,99),xy(206,133),xy(179,129),xy(150,129),xy(126,134),xy(121,145),xy(119,161),xy(119,189),xy(124,213),xy(135,218),xy(163,224),xy(165,229),xy(165,363),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(364,104),xy(365,199),xy(361,219),xy(357,225),xy(314,225)]).
midline(r3, [xy(358,225),xy(364,240),xy(368,269),xy(377,285),xy(390,300),xy(372,322),xy(366,336),xy(361,369),xy(352,385),xy(340,400)]).
...
midline(r1, [xy(20,308),xy(20,500)]).
midline(r1, [xy(20,307),xy(20,19)]).
...
midline(r19, [xy(418,635),xy(131,635),xy(125,633),xy(125,605),xy(549,604),xy(555,606),xy(555,631),xy(549,635),xy(419,634)]).
midline(r19, [xy(556,605),xy(578,604),xy(585,606),xy(585,632),xy(578,635),xy(555,633)]).
midline(r19, [xy(586,605),xy(604,604),xy(615,606),xy(615,627),xy(613,634),xy(591,635),xy(585,633)]).
...
midline(r16, [xy(99,553),xy(100,608),xy(97,618),xy(72,620),xy(59,616),xy(55,619),xy(47,620),xy(24,619),xy(21,617),xy(19,609),xy(19,590),xy(23,579),xy(19,568),xy(21,541),xy(89,539),xy(98,541),xy(100,552)]).
midline(r16, [xy(59,615),xy(58,582),xy(49,579),xy(24,580)]).
...
midline(r8, [xy(189,442),xy(190,431),xy(189,426),xy(186,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(176,399),xy(188,401),xy(189,424)]).
...
midline(r20, [xy(152,620),xy(260,620)]).
...
midline(r17, [xy(80,587),xy(80,571),xy(77,561),xy(69,559),xy(39,560)]).
...
region(r7, '#870c25', 1500, centroid(314,184)).
perimeter(r7, 160).
polygon(r7, [xy(339,200),xy(290,200),xy(290,170),xy(339,170),xy(339,200)]).
midline(r7, [xy(316,184),xy(304,185)]).
midline(r7, [xy(317,185),xy(325,185)]).
fillpoint(r7, xy(304,185), 15.0).
region(r4, '#bebebe', 1000, centroid(314,160)).
perimeter(r4, 140).
polygon(r4, [xy(339,170),xy(290,170),xy(290,150),xy(339,150),xy(339,170)]).
midline(r4, [xy(309,160),xy(299,160)]).
midline(r4, [xy(310,160),xy(330,160)]).
fillpoint(r4, xy(299,160), 10.0).
...
midline(r14, [xy(405,527),xy(405,515),xy(424,515),xy(425,521),xy(423,534),xy(406,534),xy(405,528)]).
...
midline(r9, [xy(155,424),xy(155,435)]).
midline(r9, [xy(155,423),xy(155,415),xy(175,415)]).
