...
midline(r2, [xy(590,49),xy(561,29),xy(549,25),xy(536,24),xy(191,24),xy(176,26),xy(162,32),xy(140,50),xy(89,49)]).
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,191),xy(615,297),xy(613,313),xy(604,332),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,549),xy(611,569),xy(603,573),xy(589,575),xy(380,574),xy(354,562),xy(314,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,382),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,258),xy(64,105),xy(65,91),xy(69,78),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(245,352),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(399,474),xy(410,470),xy(415,449),xy(414,400),xy(418,380),xy(426,376),xy(456,372),xy(461,369),xy(463,363),xy(465,348),xy(465,250),xy(463,236),xy(459,228),xy(449,225),xy(431,224),xy(419,220),xy(414,198),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(369,261)).
perimeter(r3, 4460).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(390,449),xy(290,449),xy(290,350),xy(340,349),xy(340,200),xy(290,199),xy(289,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,471),xy(471,494),xy(477,510),xy(459,521),xy(451,519),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(525,267),xy(540,249),xy(527,235),xy(518,219),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(481,109),xy(453,100),xy(376,100),xy(353,106),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(150,129),xy(126,134),xy(121,145),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,362),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,186),xy(209,150),xy(206,134)]).
midline(r3, [xy(340,114),xy(339,150),xy(356,170),xy(364,191),xy(364,248),xy(366,263),xy(373,279),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(356,379),xy(340,400)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,472),xy(558,494),xy(552,509),xy(534,518),xy(517,520),xy(495,518),xy(479,510)]).
...
midline(r19, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(130,604),xy(548,604),xy(555,606),xy(555,632),xy(548,635),xy(525,635)]).
midline(r19, [xy(556,605),xy(583,605),xy(585,610),xy(585,631),xy(583,634),xy(578,635),xy(560,635),xy(555,633)]).
midline(r19, [xy(585,606),xy(590,604),xy(609,604),xy(614,607),xy(622,604),xy(635,605)]).
...
midline(r16, [xy(99,553),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,553),xy(19,569),xy(23,580),xy(19,591),xy(21,618),xy(32,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(49,579),xy(24,580)]).
midline(r16, [xy(99,554),xy(100,609),xy(98,617),xy(88,620),xy(64,619),xy(60,617)]).
...
midline(r21, [xy(424,619),xy(259,620)]).
midline(r21, [xy(425,619),xy(540,620)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(139,411),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,424)]).
...
midline(r17, [xy(52,559),xy(39,560)]).
midline(r17, [xy(53,559),xy(78,561),xy(80,570),xy(80,600)]).
...
region(r7, '#870c25', 1500, centroid(314,234)).
perimeter(r7, 160).
polygon(r7, [xy(339,250),xy(290,250),xy(290,220),xy(339,220),xy(339,250)]).
midline(r7, [xy(316,234),xy(304,235)]).
midline(r7, [xy(317,234),xy(325,235)]).
fillpoint(r7, xy(304,235), 15.0).
region(r6, '#bebebe', 1000, centroid(314,210)).
perimeter(r6, 140).
polygon(r6, [xy(339,220),xy(290,220),xy(290,200),xy(339,200),xy(339,220)]).
midline(r6, [xy(311,210),xy(299,210)]).
midline(r6, [xy(312,209),xy(330,210)]).
fillpoint(r6, xy(299,210), 10.0).
...
midline(r4, [xy(155,177),xy(155,184),xy(160,185),xy(173,184),xy(175,179),xy(174,166),xy(167,164),xy(155,165),xy(155,176)]).
