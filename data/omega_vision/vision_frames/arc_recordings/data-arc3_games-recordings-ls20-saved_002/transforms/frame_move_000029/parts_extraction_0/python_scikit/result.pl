...
midline(r2, [xy(266,523),xy(315,524),xy(350,559),xy(368,570),xy(381,574),xy(589,575),xy(609,571),xy(613,563),xy(615,548),xy(614,381),xy(610,368),xy(599,350),xy(593,344),xy(584,345)]).
midline(r2, [xy(590,51),xy(589,150),xy(607,172),xy(613,186),xy(615,201),xy(614,308),xy(606,329),xy(594,344)]).
midline(r2, [xy(316,523),xy(350,490),xy(360,483),xy(376,476),xy(398,474),xy(411,469),xy(415,447),xy(414,400),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,348),xy(465,250),xy(463,236),xy(456,227),xy(430,224),xy(418,218),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 134700, centroid(364,252)).
perimeter(r3, 4120).
...
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(522,272),xy(540,249),xy(530,239),xy(519,221),xy(515,208),xy(513,186),xy(506,170),xy(489,150),xy(489,136),xy(482,110),xy(476,106),xy(453,100),xy(376,100),xy(350,107),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(164,174),xy(165,362),xy(145,383),xy(125,385),xy(124,392),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(340,114),xy(339,200),xy(356,220),xy(363,236),xy(365,259),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
...
midline(r18, [xy(524,635),xy(130,635),xy(125,633),xy(124,613),xy(125,605),xy(132,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(525,635)]).
midline(r18, [xy(556,605),xy(579,604),xy(585,606),xy(585,631),xy(579,635),xy(560,635),xy(555,633)]).
midline(r18, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(608,635),xy(585,633)]).
...
midline(r15, [xy(99,553),xy(98,542),xy(89,539),xy(30,539),xy(21,541),xy(19,550),xy(19,569),xy(23,579),xy(19,590),xy(21,618),xy(31,620),xy(55,619),xy(60,616),xy(60,590),xy(58,582),xy(48,579),xy(24,579)]).
midline(r15, [xy(100,554),xy(100,609),xy(98,617),xy(89,620),xy(70,620),xy(61,617)]).
...
region(r19, '#2ecc40', 6800, centroid(300,620)).
perimeter(r19, 720).
polygon(r19, [xy(469,630),xy(130,630),xy(130,610),xy(469,610),xy(469,630)]).
midline(r19, [xy(345,620),xy(139,620)]).
midline(r19, [xy(346,620),xy(460,620)]).
...
midline(r4, [xy(189,442),xy(190,432),xy(189,426),xy(186,424),xy(165,425),xy(165,446),xy(163,449),xy(150,450),xy(142,448),xy(139,436),xy(139,410),xy(141,401),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,424)]).
...
midline(r16, [xy(41,559),xy(39,560)]).
midline(r16, [xy(42,560),xy(69,559),xy(78,561),xy(80,570),xy(80,600)]).
...
region(r10, '#2ecc40', 1600, centroid(414,524)).
perimeter(r10, 320).
polygon(r10, [xy(439,550),xy(390,549),xy(390,500),xy(440,500),xy(439,550)]).
hole(r10, [xy(430,539),xy(429,510),xy(400,510),xy(400,540),xy(430,539)]).
midline(r10, [xy(419,545),xy(400,545),xy(395,543),xy(395,505),xy(434,505),xy(434,543),xy(429,545),xy(420,544)]).
fillpoint(r10, xy(396,505), 6.0).
fillpoint(r10, xy(434,505), 6.0).
fillpoint(r10, xy(395,544), 6.0).
fillpoint(r10, xy(433,544), 6.0).
fillpoint(r10, xy(401,505), 5.0).
fillpoint(r10, xy(394,525), 5.0).
fillpoint(r10, xy(434,525), 5.0).
fillpoint(r10, xy(401,545), 5.0).
region(r20, '#5a5a5a', 1600, centroid(510,620)).
perimeter(r20, 200).
polygon(r20, [xy(549,630),xy(470,630),xy(470,610),xy(549,610),xy(549,630)]).
midline(r20, [xy(491,620),xy(479,620)]).
midline(r20, [xy(492,620),xy(540,620)]).
fillpoint(r20, xy(479,620), 10.0).
region(r14, '#870c25', 1500, centroid(464,534)).
perimeter(r14, 160).
polygon(r14, [xy(489,550),xy(440,550),xy(440,520),xy(489,520),xy(489,550)]).
midline(r14, [xy(466,534),xy(454,535)]).
midline(r14, [xy(467,534),xy(475,535)]).
fillpoint(r14, xy(454,535), 15.0).
region(r11, '#bebebe', 1000, centroid(464,510)).
perimeter(r11, 140).
polygon(r11, [xy(489,520),xy(440,520),xy(440,500),xy(489,500),xy(489,520)]).
midline(r11, [xy(459,510),xy(449,510)]).
midline(r11, [xy(460,510),xy(480,510)]).
fillpoint(r11, xy(449,510), 10.0).
...
midline(r12, [xy(419,514),xy(405,515),xy(405,534),xy(419,535),xy(424,533),xy(424,516),xy(420,515)]).
...
midline(r5, [xy(155,427),xy(155,415),xy(175,415)]).
midline(r5, [xy(155,428),xy(155,435)]).
...
adjacent(r18, r19).
shared_edge(r18, r19, 700).
adjacent(r18, r20).
shared_edge(r18, r20, 180).
adjacent(r18, r21).
