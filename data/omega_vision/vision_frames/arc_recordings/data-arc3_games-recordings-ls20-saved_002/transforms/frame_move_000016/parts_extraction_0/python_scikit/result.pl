...
midline(r2, [xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,381),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(160,33),xy(176,26),xy(192,24),xy(539,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(602,164),xy(611,180),xy(615,203),xy(615,299),xy(613,313),xy(599,339),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,549),xy(613,563),xy(609,571),xy(589,575),xy(390,575),xy(376,573),xy(360,566),xy(313,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,534)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(242,344),xy(239,339),xy(237,341)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(398,474),xy(410,470),xy(415,448),xy(414,404),xy(418,380),xy(430,375),xy(449,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,347),xy(464,240),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,195),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 136300, centroid(368,262)).
perimeter(r3, 4540).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(389,450),xy(290,449),xy(290,350),xy(340,349),xy(340,250),xy(290,249),xy(290,150),xy(340,149),xy(339,100),xy(290,100),xy(290,149),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(459,521),xy(447,517),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,522)]).
...
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(522,227),xy(516,213),xy(514,190),xy(510,178),xy(502,164),xy(489,150),xy(489,136),xy(483,113),xy(479,107),xy(453,100),xy(390,100),xy(369,83),xy(349,75),xy(290,74),xy(276,76),xy(262,82),xy(239,99),xy(164,174),xy(162,179),xy(165,181),xy(165,364),xy(145,383),xy(125,385),xy(124,456),xy(125,464),xy(134,465),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(241,101),xy(339,199),xy(352,214),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(365,340),xy(364,359),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(340,198),xy(352,185),xy(361,169),xy(365,140),xy(373,120),xy(389,101)]).
...
fillpoint(r3, xy(271,78), 29.0).
fillpoint(r3, xy(358,78), 29.0).
fillpoint(r3, xy(368,131), 29.0).
fillpoint(r3, xy(361,168), 29.0).
...
fillpoint(r3, xy(274,77), 28.0).
fillpoint(r3, xy(355,77), 28.0).
fillpoint(r3, xy(367,134), 28.0).
fillpoint(r3, xy(362,165), 28.0).
...
fillpoint(r3, xy(277,76), 27.0).
fillpoint(r3, xy(352,76), 27.0).
fillpoint(r3, xy(366,137), 27.0).
fillpoint(r3, xy(363,162), 27.0).
...
fillpoint(r3, xy(282,75), 26.0).
fillpoint(r3, xy(348,75), 26.0).
fillpoint(r3, xy(365,142), 26.0).
fillpoint(r3, xy(364,158), 26.0).
...
midline(r17, [xy(524,635),xy(130,635),xy(125,633),xy(125,605),xy(549,604),xy(553,605),xy(555,609),xy(555,632),xy(549,635),xy(525,634)]).
midline(r17, [xy(555,606),xy(561,604),xy(585,606),xy(585,629),xy(583,634),xy(560,635),xy(555,633)]).
midline(r17, [xy(586,605),xy(606,604),xy(613,605),xy(614,607),xy(621,604),xy(635,605)]).
midline(r17, [xy(615,608),xy(615,632),xy(613,634),xy(592,635),xy(585,633)]).
...
midline(r14, [xy(99,553),xy(99,615),xy(95,619),xy(70,620),xy(64,619),xy(59,615),xy(60,590),xy(57,581),xy(49,579),xy(26,580),xy(21,577),xy(19,569),xy(21,541),xy(30,539),xy(89,539),xy(98,541),xy(100,552)]).
midline(r14, [xy(22,580),xy(19,592),xy(21,618),xy(49,620),xy(59,617)]).
...
region(r19, '#5a5a5a', 6800, centroid(380,620)).
perimeter(r19, 720).
polygon(r19, [xy(549,630),xy(210,630),xy(210,610),xy(549,610),xy(549,630)]).
midline(r19, [xy(384,619),xy(219,620)]).
midline(r19, [xy(385,620),xy(540,620)]).
fillpoint(r19, xy(219,620), 10.0).
...
midline(r6, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(140,404),xy(144,400),xy(178,399),xy(188,401),xy(189,423)]).
...
midline(r15, [xy(80,587),xy(80,571),xy(77,561),xy(68,559),xy(39,560)]).
...
region(r18, '#2ecc40', 1600, centroid(170,620)).
perimeter(r18, 200).
polygon(r18, [xy(209,630),xy(130,630),xy(130,610),xy(209,610),xy(209,630)]).
midline(r18, [xy(151,620),xy(139,620)]).
midline(r18, [xy(152,619),xy(200,620)]).
fillpoint(r18, xy(139,620), 10.0).
region(r5, '#870c25', 1500, centroid(314,134)).
perimeter(r5, 160).
polygon(r5, [xy(339,150),xy(290,150),xy(290,120),xy(339,120),xy(339,150)]).
midline(r5, [xy(316,134),xy(304,135)]).
midline(r5, [xy(317,135),xy(325,135)]).
fillpoint(r5, xy(304,135), 15.0).
region(r4, '#bebebe', 1000, centroid(314,110)).
perimeter(r4, 140).
polygon(r4, [xy(339,120),xy(290,120),xy(290,100),xy(339,100),xy(339,120)]).
midline(r4, [xy(309,110),xy(299,110)]).
midline(r4, [xy(310,109),xy(330,110)]).
fillpoint(r4, xy(299,110), 10.0).
...
midline(r7, [xy(154,422),xy(155,435)]).
...
adjacent(r17, r18).
shared_edge(r17, r18, 180).
adjacent(r17, r19).
shared_edge(r17, r19, 700).
adjacent(r17, r20).
