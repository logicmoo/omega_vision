...
midline(r2, [xy(508,25),xy(190,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49),xy(69,78),xy(64,102),xy(65,258),xy(73,279),xy(90,299),xy(90,339),xy(83,355),xy(79,380),xy(79,467),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(12,635),xy(113,634),xy(115,628),xy(114,603),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(509,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(606,170),xy(614,191),xy(615,295),xy(613,313),xy(606,329),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(614,380),xy(615,393),xy(615,549),xy(611,569),xy(606,572),xy(589,575),xy(380,574),xy(354,562),xy(314,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(238,339),xy(241,335),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(340,499),xy(360,483),xy(376,476),xy(399,474),xy(410,470),xy(414,458),xy(414,400),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(459,228),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(369,263)).
perimeter(r3, 4660).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,472),xy(470,489),xy(476,511),xy(459,521),xy(447,517),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(512,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,388),xy(515,291),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(483,113),xy(479,107),xy(453,100),xy(389,100),xy(372,85),xy(348,75),xy(293,74),xy(273,77),xy(260,83),xy(239,99),xy(206,133),xy(179,129),xy(150,129),xy(135,131),xy(124,136),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,186),xy(210,160),xy(206,134)]).
midline(r3, [xy(241,101),xy(349,210),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(354,382),xy(340,400)]).
midline(r3, [xy(165,227),xy(165,363),xy(145,383),xy(125,385),xy(124,391),xy(125,464),xy(203,464),xy(205,457),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,470),xy(558,455),xy(550,439),xy(549,432)]).
midline(r3, [xy(340,198),xy(356,179),xy(363,163),xy(368,130),xy(377,114),xy(389,101)]).
...
midline(r19, [xy(524,635),xy(131,635),xy(125,633),xy(125,605),xy(547,604),xy(554,607),xy(560,604),xy(579,604),xy(585,606),xy(585,632),xy(583,634),xy(525,634)]).
midline(r19, [xy(586,605),xy(604,604),xy(613,605),xy(614,607),xy(620,604),xy(635,605)]).
midline(r19, [xy(555,608),xy(555,632)]).
midline(r19, [xy(615,608),xy(615,629),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r16, [xy(99,562),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,551),xy(19,568),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(49,579),xy(24,580)]).
midline(r16, [xy(100,563),xy(100,607),xy(98,617),xy(89,620),xy(70,620),xy(60,617)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(140,404),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,424)]).
...
midline(r20, [xy(280,620),xy(280,619)]).
...
midline(r17, [xy(80,587),xy(80,570),xy(77,561),xy(66,559),xy(39,560)]).
...
midline(r5, [xy(317,134),xy(325,135)]).
...
midline(r4, [xy(310,110),xy(330,110)]).
...
midline(r6, [xy(174,182),xy(175,170),xy(173,165),xy(155,165),xy(154,170),xy(155,184),xy(174,184)]).
...
midline(r14, [xy(419,514),xy(405,515),xy(405,534),xy(419,535),xy(424,533),xy(425,520),xy(424,516),xy(420,515)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 340).
adjacent(r19, r21).
shared_edge(r19, r21, 540).
adjacent(r19, r22).
