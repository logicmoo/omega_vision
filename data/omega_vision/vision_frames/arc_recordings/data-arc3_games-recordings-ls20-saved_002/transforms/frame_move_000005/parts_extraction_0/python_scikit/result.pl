...
midline(r2, [xy(412,466),xy(409,471),xy(403,473),xy(376,476),xy(360,483),xy(313,525),xy(265,522),xy(241,531),xy(209,535),xy(175,535),xy(145,510),xy(124,501),xy(96,495),xy(81,486),xy(79,469),xy(79,386),xy(81,363),xy(90,340),xy(90,299),xy(73,279),xy(65,258),xy(64,100),xy(68,80),xy(77,64),xy(89,49),xy(140,50),xy(162,32),xy(176,26),xy(190,24),xy(536,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(615,298),xy(613,313),xy(606,329),xy(598,340),xy(594,344),xy(584,345)]).
midline(r2, [xy(412,465),xy(415,449),xy(414,402),xy(418,380),xy(430,375),xy(449,374),xy(460,370)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,549),xy(613,563),xy(609,571),xy(587,575),xy(380,574),xy(370,571),xy(350,559),xy(315,525)]).
midline(r2, [xy(461,368),xy(465,347),xy(464,240),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,198),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,603),xy(115,629),xy(113,634),xy(6,634),xy(4,628),xy(5,525),xy(43,524),xy(81,488)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,471),xy(471,494),xy(477,510),xy(459,521),xy(446,516),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(453,521),xy(452,520)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,470),xy(558,494),xy(552,509),xy(534,518),xy(517,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(520,420),xy(514,386),xy(515,290),xy(525,267),xy(540,249),xy(523,229),xy(516,213),xy(514,191),xy(510,178),xy(502,164),xy(489,150),xy(489,136),xy(482,110),xy(479,107),xy(453,100),xy(376,100),xy(353,106),xy(340,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(151,129),xy(126,134),xy(121,145),xy(119,163),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,362),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,188),xy(210,160),xy(206,134)]).
midline(r3, [xy(340,114),xy(340,150),xy(327,164),xy(318,180),xy(314,203),xy(315,225)]).
...
midline(r8, [xy(365,341),xy(373,320),xy(390,299)]).
midline(r8, [xy(365,342),xy(364,359),xy(361,369),xy(352,385),xy(340,400)]).
...
midline(r20, [xy(418,635),xy(133,635),xy(125,633),xy(125,605),xy(548,604),xy(555,606),xy(555,632),xy(549,635),xy(419,634)]).
midline(r20, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r20, [xy(585,606),xy(591,604),xy(608,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r20, [xy(615,608),xy(615,632),xy(613,634),xy(591,635),xy(585,633)]).
...
midline(r17, [xy(99,553),xy(98,542),xy(89,539),xy(30,539),xy(21,541),xy(19,550),xy(20,575),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(58,582),xy(49,579),xy(24,580)]).
midline(r17, [xy(100,554),xy(100,609),xy(98,617),xy(88,620),xy(72,620),xy(60,617)]).
...
midline(r22, [xy(405,620),xy(540,620)]).
...
midline(r18, [xy(80,587),xy(80,570),xy(77,561),xy(69,559),xy(39,560)]).
...
midline(r21, [xy(141,619),xy(139,620)]).
midline(r21, [xy(142,619),xy(220,620)]).
...
midline(r7, [xy(366,234),xy(354,235)]).
midline(r7, [xy(367,234),xy(375,235)]).
...
midline(r6, [xy(361,210),xy(349,210)]).
midline(r6, [xy(362,210),xy(380,210)]).
