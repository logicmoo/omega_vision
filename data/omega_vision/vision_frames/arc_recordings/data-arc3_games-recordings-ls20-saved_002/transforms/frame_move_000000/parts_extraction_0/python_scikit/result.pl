...
midline(r2, [xy(412,466),xy(409,471),xy(403,473),xy(380,475),xy(360,483),xy(340,499),xy(315,524),xy(290,525),xy(265,522),xy(241,531),xy(209,535),xy(175,535),xy(145,510),xy(124,501),xy(96,495),xy(81,486),xy(79,469),xy(79,383),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,259),xy(64,100),xy(68,80),xy(77,64),xy(89,49),xy(140,50),xy(160,33),xy(176,26),xy(192,24),xy(539,24),xy(553,26),xy(567,32),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(614,309),xy(607,327),xy(598,340),xy(592,345),xy(584,345)]).
midline(r2, [xy(412,465),xy(415,446),xy(414,400),xy(418,380),xy(430,375),xy(448,374),xy(460,370)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(239,339),xy(235,340),xy(235,342)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,391),xy(615,548),xy(613,563),xy(608,571),xy(587,575),xy(381,574),xy(370,571),xy(354,562),xy(315,525)]).
midline(r2, [xy(461,368),xy(465,349),xy(465,251),xy(463,236),xy(456,227),xy(430,224),xy(418,218),xy(414,199),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,606),xy(115,629),xy(113,634),xy(6,634),xy(4,628),xy(5,525),xy(43,524),xy(81,488)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,473),xy(471,494),xy(477,510),xy(459,521),xy(451,519),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(520,420),xy(514,387),xy(515,290),xy(525,267),xy(540,249),xy(522,227),xy(516,213),xy(511,180),xy(502,164),xy(489,150),xy(489,136),xy(482,110),xy(476,106),xy(453,100),xy(376,100),xy(350,107),xy(340,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(151,129),xy(126,134),xy(121,145),xy(119,160),xy(120,199),xy(124,213),xy(135,218),xy(165,225),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,189),xy(210,160),xy(206,134)]).
midline(r3, [xy(339,114),xy(339,200),xy(357,222),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,300),xy(377,314),xy(369,328),xy(365,340),xy(363,363),xy(358,374),xy(314,375)]).
...
midline(r19, [xy(608,634),xy(590,635),xy(584,632),xy(585,607),xy(579,604),xy(560,604),xy(555,606),xy(549,604),xy(130,604),xy(125,605),xy(125,634),xy(548,635),xy(553,634),xy(555,631),xy(554,607)]).
midline(r19, [xy(585,606),xy(591,604),xy(615,606),xy(615,631),xy(609,635)]).
midline(r19, [xy(616,605),xy(635,605)]).
midline(r19, [xy(584,633),xy(578,635),xy(555,633)]).
...
midline(r20, [xy(305,619),xy(540,620)]).
...
midline(r16, [xy(19,563),xy(20,544),xy(24,540),xy(87,539),xy(98,541),xy(100,551),xy(100,608),xy(99,615),xy(95,619),xy(71,620),xy(62,618),xy(59,615),xy(60,590),xy(58,582),xy(48,579),xy(23,580),xy(20,575),xy(20,564)]).
midline(r16, [xy(59,617),xy(49,620),xy(22,618),xy(19,609),xy(19,591),xy(22,581)]).
...
midline(r6, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,447),xy(163,449),xy(144,449),xy(140,445),xy(139,437),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r17, [xy(52,560),xy(78,561),xy(80,600)]).
...
midline(r7, [xy(320,410),xy(299,410)]).
midline(r7, [xy(321,409),xy(330,410)]).
