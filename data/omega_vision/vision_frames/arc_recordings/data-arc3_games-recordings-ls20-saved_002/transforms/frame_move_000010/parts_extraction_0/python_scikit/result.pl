...
midline(r2, [xy(89,49),xy(69,78),xy(64,102),xy(65,259),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,381),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(162,32),xy(176,26),xy(191,24),xy(539,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(606,170),xy(613,186),xy(615,200),xy(615,299),xy(613,313),xy(606,329),xy(598,340),xy(592,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,545),xy(613,563),xy(606,572),xy(587,575),xy(381,574),xy(368,570),xy(354,562),xy(314,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(250,381),xy(248,363),xy(239,339),xy(223,347),xy(223,349)]).
midline(r2, [xy(315,524),xy(349,491),xy(362,482),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,400),xy(418,380),xy(430,375),xy(449,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,349),xy(464,240),xy(459,228),xy(430,224),xy(418,219),xy(414,198),xy(415,174)]).
...
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(525,267),xy(540,249),xy(522,227),xy(516,213),xy(514,191),xy(510,178),xy(502,164),xy(489,150),xy(489,136),xy(482,110),xy(476,106),xy(453,100),xy(390,99),xy(362,103),xy(340,113),xy(317,103),xy(289,100),xy(275,87),xy(253,76),xy(238,74),xy(214,75)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,470),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(477,511)]).
midline(r3, [xy(340,114),xy(339,200),xy(356,220),xy(363,236),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(354,382),xy(340,400)]).
...
midline(r4, [xy(165,226),xy(165,364),xy(145,383),xy(125,385),xy(124,397),xy(125,464),xy(203,464),xy(205,457),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r20, [xy(524,635),xy(132,635),xy(126,634),xy(124,629),xy(125,605),xy(130,604),xy(549,604),xy(554,607),xy(561,604),xy(578,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(525,635)]).
midline(r20, [xy(585,606),xy(590,604),xy(609,604),xy(615,606),xy(615,630),xy(613,634),xy(591,635),xy(585,633)]).
midline(r20, [xy(616,605),xy(635,605)]).
midline(r20, [xy(555,608),xy(555,632)]).
...
midline(r17, [xy(99,562),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,552),xy(20,575),xy(23,580),xy(19,591),xy(21,618),xy(30,620),xy(55,619),xy(59,616),xy(60,611),xy(58,582),xy(49,579),xy(24,580)]).
midline(r17, [xy(100,563),xy(100,608),xy(98,617),xy(88,620),xy(70,620),xy(60,617)]).
...
region(r22, '#5a5a5a', 4400, centroid(440,620)).
perimeter(r22, 480).
polygon(r22, [xy(549,630),xy(330,630),xy(330,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(479,620),xy(339,620)]).
midline(r22, [xy(480,620),xy(540,620)]).
fillpoint(r22, xy(339,620), 10.0).
...
midline(r9, [xy(189,442),xy(190,431),xy(189,426),xy(186,424),xy(165,425),xy(165,445),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,424)]).
...
region(r21, '#2ecc40', 4000, centroid(230,620)).
perimeter(r21, 440).
polygon(r21, [xy(329,630),xy(130,630),xy(130,610),xy(329,610),xy(329,630)]).
midline(r21, [xy(290,620),xy(139,620)]).
midline(r21, [xy(291,620),xy(320,620)]).
...
midline(r18, [xy(80,587),xy(80,571),xy(77,561),xy(67,559),xy(39,560)]).
...
midline(r6, [xy(216,134),xy(204,135)]).
midline(r6, [xy(217,134),xy(225,135)]).
...
midline(r7, [xy(174,182),xy(175,170),xy(173,165),xy(155,165),xy(154,170),xy(155,184),xy(174,184)]).
...
midline(r15, [xy(419,514),xy(405,515),xy(405,534),xy(417,535),xy(424,533),xy(425,520),xy(424,516),xy(420,515)]).
...
midline(r10, [xy(155,424),xy(155,415),xy(175,415)]).
midline(r10, [xy(155,425),xy(155,435)]).
...
adjacent(r20, r21).
shared_edge(r20, r21, 420).
adjacent(r20, r22).
shared_edge(r20, r22, 460).
adjacent(r20, r23).
