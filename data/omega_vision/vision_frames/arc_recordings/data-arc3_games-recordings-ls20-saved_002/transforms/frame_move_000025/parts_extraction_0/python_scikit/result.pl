...
midline(r2, [xy(590,51),xy(589,150),xy(606,170),xy(614,190),xy(615,298),xy(613,313),xy(604,332),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(614,380),xy(615,397),xy(615,549),xy(611,569),xy(603,573),xy(589,575),xy(381,574),xy(370,571),xy(354,562),xy(312,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,380),xy(83,355),xy(90,339),xy(90,299),xy(73,279),xy(65,258),xy(64,100),xy(66,86),xy(72,72),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(238,339),xy(234,342),xy(232,341),xy(232,343)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(399,474),xy(410,470),xy(415,448),xy(414,402),xy(417,383),xy(420,378),xy(426,376),xy(459,371),xy(463,363),xy(465,347),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(431,224),xy(419,220),xy(414,199),xy(415,174)]).
...
midline(r2, [xy(91,340),xy(98,344),xy(100,343),xy(100,345)]).
...
border(r2).
region(r3, '#2ecc40', 112200, centroid(333,211)).
perimeter(r3, 3400).
...
midline(r3, [xy(164,210),xy(164,174),xy(239,99),xy(303,100),xy(326,106),xy(339,113),xy(350,107),xy(376,100),xy(438,99),xy(467,103),xy(481,108),xy(489,136),xy(489,150),xy(499,160),xy(510,178),xy(514,190),xy(516,213),xy(523,229),xy(540,249),xy(525,267),xy(516,286),xy(514,300),xy(515,325)]).
midline(r3, [xy(165,211),xy(165,362),xy(145,383),xy(125,385),xy(124,390),xy(125,464),xy(203,464),xy(205,459),xy(204,386),xy(184,383),xy(165,365)]).
...
region(r7, '#2ecc40', 24100, centroid(509,476)).
perimeter(r7, 960).
polygon(r7, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(539,400),xy(540,390),xy(590,390),xy(589,550)]).
...
midline(r7, [xy(561,418),xy(550,437),xy(534,431),xy(511,429),xy(495,431),xy(478,438),xy(471,455),xy(469,471),xy(471,494),xy(477,510),xy(467,517),xy(457,522),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r7, [xy(551,438),xy(558,455),xy(560,472),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
fillpoint(r7, xy(551,437), 39.0).
fillpoint(r7, xy(477,511), 39.0).
fillpoint(r7, xy(478,438), 38.8).
fillpoint(r7, xy(551,511), 38.8).
fillpoint(r7, xy(496,431), 32.0).
fillpoint(r7, xy(533,431), 32.0).
...
fillpoint(r7, xy(502,430), 31.0).
fillpoint(r7, xy(528,430), 31.0).
...
midline(r18, [xy(169,605),xy(125,605),xy(124,629),xy(125,634),xy(130,635),xy(553,634),xy(555,632),xy(555,609),xy(553,605),xy(549,604),xy(170,605)]).
midline(r18, [xy(555,606),xy(560,604),xy(579,604),xy(585,606),xy(585,630),xy(583,634),xy(560,635),xy(555,633)]).
midline(r18, [xy(586,605),xy(609,604),xy(614,607),xy(622,604),xy(635,605)]).
...
midline(r15, [xy(99,553),xy(99,615),xy(95,619),xy(70,620),xy(64,619),xy(59,615),xy(60,592),xy(57,581),xy(49,579),xy(24,580),xy(21,577),xy(19,562),xy(21,541),xy(31,539),xy(88,539),xy(98,541),xy(100,552)]).
midline(r15, [xy(22,580),xy(19,590),xy(21,618),xy(49,620),xy(59,617)]).
...
region(r19, '#2ecc40', 5200, centroid(260,620)).
perimeter(r19, 560).
polygon(r19, [xy(389,630),xy(130,630),xy(130,610),xy(389,610),xy(389,630)]).
midline(r19, [xy(279,620),xy(139,620)]).
midline(r19, [xy(280,620),xy(380,620)]).
...
midline(r6, [xy(189,442),xy(188,424),xy(165,425),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(189,423)]).
...
region(r20, '#5a5a5a', 3200, centroid(470,620)).
perimeter(r20, 360).
polygon(r20, [xy(549,630),xy(390,630),xy(390,610),xy(549,610),xy(549,630)]).
midline(r20, [xy(539,620),xy(399,620)]).
midline(r20, [xy(540,620),xy(540,619)]).
fillpoint(r20, xy(399,620), 10.0).
region(r16, '#870c25', 2000, centroid(68,572)).
perimeter(r16, 240).
polygon(r16, [xy(89,610),xy(70,609),xy(69,570),xy(30,569),xy(30,550),xy(90,550),xy(89,610)]).
midline(r16, [xy(80,587),xy(80,571),xy(77,561),xy(69,559),xy(39,560)]).
midline(r16, [xy(79,588),xy(80,600)]).
...
region(r5, '#870c25', 1500, centroid(514,384)).
perimeter(r5, 160).
polygon(r5, [xy(539,400),xy(490,400),xy(490,370),xy(539,370),xy(539,400)]).
midline(r5, [xy(512,385),xy(504,385)]).
midline(r5, [xy(513,385),xy(525,385)]).
fillpoint(r5, xy(504,385), 15.0).
region(r4, '#bebebe', 1000, centroid(514,360)).
perimeter(r4, 140).
polygon(r4, [xy(539,370),xy(490,370),xy(490,350),xy(539,350),xy(539,370)]).
midline(r4, [xy(509,360),xy(499,360)]).
midline(r4, [xy(510,360),xy(530,360)]).
fillpoint(r4, xy(499,360), 10.0).
...
midline(r13, [xy(405,527),xy(405,534),xy(411,535),xy(423,534),xy(425,527),xy(424,516),xy(416,514),xy(405,515),xy(405,526)]).
...
midline(r8, [xy(155,424),xy(155,415),xy(175,415)]).
midline(r8, [xy(155,425),xy(155,435)]).
...
adjacent(r18, r19).
shared_edge(r18, r19, 540).
adjacent(r18, r20).
shared_edge(r18, r20, 340).
adjacent(r18, r21).
