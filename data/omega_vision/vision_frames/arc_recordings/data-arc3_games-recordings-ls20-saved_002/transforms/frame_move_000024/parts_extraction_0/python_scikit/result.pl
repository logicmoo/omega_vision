...
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,190),xy(615,299),xy(612,316),xy(602,335),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,547),xy(612,566),xy(603,573),xy(588,575),xy(380,574),xy(354,562),xy(313,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(178,535),xy(174,534),xy(154,516),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,466),xy(79,381),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,259),xy(64,100),xy(66,86),xy(72,72),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,342),xy(238,339),xy(233,343),xy(231,342),xy(231,344)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,400),xy(417,383),xy(420,378),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(459,228),xy(426,223),xy(418,219),xy(414,195),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,629),xy(113,634),xy(6,634),xy(4,622),xy(5,525),xy(43,524),xy(81,488)]).
...
border(r2).
region(r3, '#2ecc40', 109700, centroid(329,208)).
perimeter(r3, 3300).
polygon(r3, [xy(209,470),xy(120,469),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(490,300),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(389,450),xy(290,450),xy(290,350),xy(340,349),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(209,470)]).
hole(r3, [xy(200,459),xy(199,390),xy(130,390),xy(130,460),xy(200,459)]).
midline(r3, [xy(164,210),xy(164,174),xy(239,99),xy(303,100),xy(326,106),xy(340,113),xy(339,200),xy(357,222),xy(364,240),xy(365,259),xy(368,269),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(361,369),xy(352,385),xy(340,400)]).
midline(r3, [xy(341,112),xy(362,103),xy(390,99),xy(453,100),xy(481,108),xy(488,130),xy(489,150),xy(506,170),xy(513,186),xy(518,219),xy(527,235),xy(540,250)]).
midline(r3, [xy(165,211),xy(165,364),xy(145,383),xy(125,385),xy(124,392),xy(125,464),xy(203,464),xy(205,458),xy(204,386),xy(184,383),xy(165,365)]).
...
region(r6, '#2ecc40', 26600, centroid(509,467)).
perimeter(r6, 1040).
polygon(r6, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(489,400),xy(490,350),xy(539,350),xy(540,390),xy(590,390),xy(589,550)]).
hole(r6, [xy(520,489),xy(520,480),xy(529,480),xy(530,470),xy(520,470),xy(519,460),xy(510,460),xy(510,469),xy(500,470),xy(500,479),xy(509,480),xy(510,490),xy(520,489)]).
hole(r6, [xy(430,539),xy(429,510),xy(400,510),xy(400,540),xy(430,539)]).
midline(r6, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(457,522),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523),xy(452,520)]).
midline(r6, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r6, [xy(552,509),xy(558,494),xy(560,470),xy(558,455),xy(550,439),xy(549,432)]).
midline(r6, [xy(520,420),xy(515,399),xy(515,374)]).
fillpoint(r6, xy(548,431), 41.0).
fillpoint(r6, xy(477,511), 39.0).
fillpoint(r6, xy(478,438), 38.8).
fillpoint(r6, xy(551,511), 38.8).
fillpoint(r6, xy(521,422), 38.1).
fillpoint(r6, xy(538,427), 38.1).
fillpoint(r6, xy(524,423), 37.3).
fillpoint(r6, xy(535,426), 37.3).
fillpoint(r6, xy(528,424), 37.0).
fillpoint(r6, xy(531,425), 37.0).
fillpoint(r6, xy(507,427), 33.1).
fillpoint(r6, xy(492,432), 33.1).
fillpoint(r6, xy(504,428), 32.6).
fillpoint(r6, xy(495,431), 32.6).
fillpoint(r6, xy(501,429), 32.3).
fillpoint(r6, xy(498,430), 32.3).
fillpoint(r6, xy(471,456), 32.0).
fillpoint(r6, xy(558,456), 32.0).
fillpoint(r6, xy(471,493), 32.0).
fillpoint(r6, xy(558,493), 32.0).
fillpoint(r6, xy(496,518), 32.0).
fillpoint(r6, xy(533,518), 32.0).
fillpoint(r6, xy(470,462), 31.0).
fillpoint(r6, xy(559,462), 31.0).
fillpoint(r6, xy(470,488), 31.0).
fillpoint(r6, xy(559,488), 31.0).
fillpoint(r6, xy(502,519), 31.0).
fillpoint(r6, xy(528,519), 31.0).
fillpoint(r6, xy(469,475), 30.0).
fillpoint(r6, xy(559,475), 30.0).
fillpoint(r6, xy(511,520), 30.0).
fillpoint(r6, xy(458,521), 29.0).
fillpoint(r6, xy(515,398), 26.0).
fillpoint(r6, xy(515,381), 25.0).
...
midline(r18, [xy(377,634),xy(126,634),xy(124,626),xy(125,605),xy(133,604),xy(549,604),xy(554,606),xy(555,632),xy(548,635),xy(378,635)]).
midline(r18, [xy(555,606),xy(560,604),xy(579,604),xy(585,606),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r18, [xy(586,605),xy(606,604),xy(615,606),xy(615,628),xy(614,633),xy(609,635),xy(585,633)]).
...
midline(r15, [xy(19,563),xy(21,541),xy(30,539),xy(95,540),xy(98,541),xy(100,552),xy(99,615),xy(97,618),xy(89,620),xy(64,619),xy(59,616),xy(49,620),xy(22,618),xy(19,609),xy(19,590),xy(23,580),xy(20,575),xy(19,564)]).
midline(r15, [xy(60,615),xy(60,591),xy(57,581),xy(48,579),xy(24,580)]).
...
region(r19, '#2ecc40', 4800, centroid(250,620)).
perimeter(r19, 520).
polygon(r19, [xy(369,630),xy(130,630),xy(130,610),xy(369,610),xy(369,630)]).
midline(r19, [xy(279,620),xy(139,620)]).
midline(r19, [xy(280,620),xy(360,620)]).
...
midline(r7, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(164,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(179,399),xy(188,401),xy(189,424)]).
...
region(r20, '#5a5a5a', 3600, centroid(460,620)).
perimeter(r20, 400).
polygon(r20, [xy(549,630),xy(370,630),xy(370,610),xy(549,610),xy(549,630)]).
midline(r20, [xy(530,620),xy(379,620)]).
midline(r20, [xy(531,619),xy(540,620)]).
fillpoint(r20, xy(379,620), 10.0).
...
region(r5, '#870c25', 1500, centroid(514,334)).
perimeter(r5, 160).
polygon(r5, [xy(539,350),xy(490,350),xy(490,320),xy(539,320),xy(539,350)]).
midline(r5, [xy(516,334),xy(504,335)]).
midline(r5, [xy(517,335),xy(525,335)]).
fillpoint(r5, xy(504,335), 15.0).
region(r4, '#bebebe', 1000, centroid(514,310)).
perimeter(r4, 140).
polygon(r4, [xy(539,320),xy(490,320),xy(490,300),xy(539,300),xy(539,320)]).
midline(r4, [xy(509,310),xy(499,310)]).
midline(r4, [xy(510,310),xy(530,310)]).
fillpoint(r4, xy(499,310), 10.0).
...
midline(r13, [xy(419,514),xy(405,515),xy(405,534),xy(419,535),xy(424,533),xy(424,516),xy(420,515)]).
...
midline(r8, [xy(155,422),xy(155,435)]).
...
adjacent(r2, r3).
shared_edge(r2, r3, 2970).
adjacent(r2, r4).
shared_edge(r2, r4, 40).
adjacent(r2, r5).
shared_edge(r2, r5, 60).
adjacent(r2, r6).
shared_edge(r2, r6, 750).
adjacent(r2, r15).
...
adjacent(r18, r19).
shared_edge(r18, r19, 500).
adjacent(r18, r20).
shared_edge(r18, r20, 380).
adjacent(r18, r21).
