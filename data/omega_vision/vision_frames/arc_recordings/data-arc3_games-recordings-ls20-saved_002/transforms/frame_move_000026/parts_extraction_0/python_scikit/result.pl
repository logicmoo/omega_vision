...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(536,24),xy(190,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49),xy(69,78),xy(65,90),xy(64,103),xy(65,258),xy(75,282),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,468),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,622),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,534),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(249,368),xy(244,349),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(266,299),xy(290,300)]).
midline(r2, [xy(266,523),xy(315,524),xy(350,559),xy(368,570),xy(381,574),xy(589,575),xy(609,571),xy(613,563),xy(615,547),xy(614,381),xy(610,368),xy(598,349),xy(592,344),xy(584,345)]).
midline(r2, [xy(590,51),xy(589,150),xy(606,170),xy(613,186),xy(615,200),xy(614,308),xy(607,327),xy(594,344)]).
midline(r2, [xy(316,523),xy(350,490),xy(360,483),xy(376,476),xy(398,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,449),xy(414,400),xy(418,380),xy(430,375),xy(449,374),xy(459,371),xy(463,363),xy(465,348),xy(465,251),xy(463,236),xy(456,227),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 136300, centroid(364,257)).
perimeter(r3, 4540).
...
midline(r3, [xy(164,210),xy(165,364),xy(145,383),xy(125,385),xy(124,458),xy(125,464),xy(130,465),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(165,209),xy(164,174),xy(239,99),xy(303,100),xy(326,106),xy(339,113),xy(339,200),xy(357,222),xy(363,236),xy(365,259),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
midline(r3, [xy(340,112),xy(362,103),xy(390,99),xy(453,100),xy(481,108),xy(488,130),xy(489,150),xy(506,170),xy(513,186),xy(515,209),xy(519,221),xy(527,235),xy(540,249),xy(523,270),xy(516,286),xy(514,300),xy(514,375),xy(464,424),xy(465,459),xy(470,473),xy(470,489),xy(476,511),xy(459,521),xy(455,521),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(511,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(471,473),xy(485,464),xy(494,460),xy(500,460),xy(510,454),xy(523,455),xy(529,460),xy(540,462),xy(558,471),xy(560,475),xy(558,494),xy(552,509)]).
midline(r3, [xy(560,471),xy(565,447),xy(564,414),xy(545,396),xy(530,390),xy(515,375)]).
...
midline(r17, [xy(524,635),xy(135,635),xy(125,633),xy(125,605),xy(546,604),xy(553,605),xy(554,607),xy(563,604),xy(579,604),xy(585,606),xy(585,632),xy(583,634),xy(525,634)]).
midline(r17, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(609,635),xy(585,633)]).
...
midline(r14, [xy(99,553),xy(98,542),xy(89,539),xy(30,539),xy(21,541),xy(19,550),xy(20,575),xy(23,580),xy(19,590),xy(21,618),xy(32,620),xy(55,619),xy(60,616),xy(60,590),xy(58,582),xy(49,579),xy(24,580)]).
midline(r14, [xy(99,554),xy(100,608),xy(98,617),xy(88,620),xy(70,620),xy(61,617)]).
...
midline(r4, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,447),xy(163,449),xy(144,449),xy(140,445),xy(139,437),xy(139,411),xy(141,401),xy(144,400),xy(176,399),xy(188,401),xy(189,423)]).
...
midline(r19, [xy(432,620),xy(540,620)]).
...
midline(r15, [xy(52,559),xy(78,561),xy(80,600)]).
...
region(r7, '#870c25', 1500, centroid(514,434)).
perimeter(r7, 160).
polygon(r7, [xy(539,450),xy(490,450),xy(490,420),xy(539,420),xy(539,450)]).
midline(r7, [xy(514,434),xy(504,435)]).
midline(r7, [xy(515,435),xy(525,435)]).
fillpoint(r7, xy(504,435), 15.0).
region(r5, '#bebebe', 1000, centroid(514,410)).
perimeter(r5, 140).
polygon(r5, [xy(539,420),xy(490,420),xy(490,400),xy(539,400),xy(539,420)]).
midline(r5, [xy(512,409),xy(499,410)]).
midline(r5, [xy(513,410),xy(530,410)]).
fillpoint(r5, xy(499,410), 10.0).
...
midline(r12, [xy(405,527),xy(405,515),xy(424,515),xy(425,520),xy(423,534),xy(406,534),xy(405,528)]).
...
midline(r6, [xy(169,414),xy(155,415),xy(155,435)]).
midline(r6, [xy(170,414),xy(175,415)]).
...
adjacent(r3, r5).
shared_edge(r3, r5, 90).
adjacent(r3, r7).
shared_edge(r3, r7, 110).
adjacent(r3, r12).
