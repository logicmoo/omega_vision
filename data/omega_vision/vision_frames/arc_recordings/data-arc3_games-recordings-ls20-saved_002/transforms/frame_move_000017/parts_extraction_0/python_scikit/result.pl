...
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(615,548),xy(611,569),xy(603,573),xy(588,575),xy(380,574),xy(368,570),xy(350,559),xy(314,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,467),xy(79,380),xy(83,355),xy(90,339),xy(90,299),xy(73,279),xy(65,258),xy(64,100),xy(66,86),xy(73,70),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(239,339),xy(235,340),xy(235,342)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(399,474),xy(411,469),xy(415,448),xy(414,401),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,347),xy(465,252),xy(463,236),xy(456,227),xy(426,223),xy(418,218),xy(414,199),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 136300, centroid(367,262)).
perimeter(r3, 4540).
...
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249),xy(530,239),xy(519,221),xy(515,209),xy(513,186),xy(506,170),xy(489,150),xy(488,130),xy(482,110),xy(476,106),xy(459,101),xy(439,100),xy(419,83),xy(398,75),xy(330,75),xy(310,83),xy(290,100),xy(239,99),xy(164,174),xy(165,364),xy(145,383),xy(125,385),xy(124,457),xy(125,464),xy(135,465),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(290,101),xy(302,114),xy(311,130),xy(316,163),xy(322,177),xy(352,214),xy(360,228),xy(364,240),xy(365,259),xy(372,277),xy(390,299),xy(377,314),xy(369,328),xy(360,371),xy(340,400)]).
...
midline(r17, [xy(169,605),xy(125,605),xy(124,629),xy(125,634),xy(131,635),xy(553,634),xy(555,630),xy(555,608),xy(553,605),xy(547,604),xy(170,604)]).
midline(r17, [xy(555,606),xy(562,604),xy(585,606),xy(585,630),xy(583,634),xy(560,635),xy(555,633)]).
midline(r17, [xy(586,605),xy(613,605),xy(615,609),xy(615,632),xy(609,635),xy(590,635),xy(585,633)]).
midline(r17, [xy(615,606),xy(635,605)]).
...
midline(r14, [xy(19,563),xy(20,544),xy(24,540),xy(89,539),xy(98,541),xy(100,550),xy(100,607),xy(99,615),xy(95,619),xy(71,620),xy(62,618),xy(59,615),xy(60,591),xy(58,582),xy(48,579),xy(23,580),xy(20,575),xy(20,564)]).
midline(r14, [xy(59,617),xy(49,620),xy(22,618),xy(19,609),xy(19,590),xy(22,581)]).
...
midline(r6, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(165,447),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r15, [xy(80,586),xy(80,571),xy(77,561),xy(68,559),xy(39,560)]).
...
midline(r18, [xy(153,619),xy(220,620)]).
...
midline(r5, [xy(363,135),xy(354,135)]).
midline(r5, [xy(364,134),xy(375,135)]).
