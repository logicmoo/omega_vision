...
midline(r2, [xy(589,51),xy(589,150),xy(606,170),xy(614,191),xy(615,298),xy(613,313),xy(604,332),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,392),xy(615,549),xy(612,566),xy(609,571),xy(603,573),xy(588,575),xy(381,574),xy(370,571),xy(354,562),xy(312,524),xy(290,525),xy(265,522),xy(245,530),xy(225,534),xy(176,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,467),xy(79,380),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,259),xy(64,101),xy(68,80),xy(77,64),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(244,349),xy(239,340),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(399,474),xy(410,470),xy(415,448),xy(414,401),xy(418,380),xy(430,375),xy(459,371),xy(463,363),xy(465,348),xy(465,250),xy(463,236),xy(456,227),xy(430,224),xy(418,219),xy(414,199),xy(415,174)]).
...
midline(r3, [xy(520,420),xy(514,385),xy(515,290),xy(523,270),xy(540,249),xy(527,235),xy(518,219),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(480,108),xy(453,100),xy(393,99),xy(362,103),xy(339,113),xy(329,107),xy(303,100),xy(239,99),xy(164,174),xy(163,180),xy(165,180)]).
...
midline(r3, [xy(165,182),xy(165,364),xy(145,383),xy(125,385),xy(124,391),xy(125,464),xy(203,464),xy(205,458),xy(204,386),xy(184,383),xy(165,365)]).
...
midline(r16, [xy(524,635),xy(130,635),xy(125,633),xy(124,611),xy(125,605),xy(135,604),xy(548,604),xy(555,606),xy(555,632),xy(548,635),xy(525,635)]).
midline(r16, [xy(556,605),xy(579,604),xy(585,606),xy(585,631),xy(579,635),xy(560,635),xy(555,633)]).
midline(r16, [xy(586,605),xy(608,604),xy(615,606),xy(615,631),xy(609,635),xy(590,635),xy(585,633)]).
...
midline(r18, [xy(324,619),xy(159,620)]).
midline(r18, [xy(325,620),xy(540,620)]).
...
midline(r13, [xy(99,553),xy(99,544),xy(95,540),xy(32,539),xy(21,541),xy(19,553),xy(20,575),xy(23,579),xy(20,584),xy(19,593),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(47,579),xy(24,579)]).
midline(r13, [xy(99,554),xy(100,606),xy(98,617),xy(89,620),xy(70,620),xy(60,617)]).
...
midline(r4, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,446),xy(163,449),xy(151,450),xy(142,448),xy(139,435),xy(140,404),xy(144,400),xy(178,399),xy(188,401),xy(190,410),xy(189,423)]).
...
region(r10, '#2ecc40', 2500, centroid(414,524)).
perimeter(r10, 200).
polygon(r10, [xy(439,550),xy(390,549),xy(390,500),xy(440,500),xy(439,550)]).
midline(r10, [xy(414,525),xy(415,525)]).
fillpoint(r10, xy(414,525), 25.0).
region(r14, '#870c25', 2000, centroid(68,572)).
perimeter(r14, 240).
polygon(r14, [xy(89,610),xy(70,609),xy(69,570),xy(30,569),xy(30,550),xy(90,550),xy(89,610)]).
midline(r14, [xy(80,596),xy(80,600)]).
midline(r14, [xy(80,595),xy(80,570),xy(77,561),xy(68,559),xy(39,560)]).
...
region(r12, '#870c25', 1500, centroid(464,534)).
perimeter(r12, 160).
polygon(r12, [xy(489,550),xy(440,550),xy(440,520),xy(489,520),xy(489,550)]).
midline(r12, [xy(460,535),xy(454,535)]).
midline(r12, [xy(461,535),xy(475,535)]).
fillpoint(r12, xy(454,535), 15.0).
region(r11, '#bebebe', 1000, centroid(464,510)).
perimeter(r11, 140).
polygon(r11, [xy(489,520),xy(440,520),xy(440,500),xy(489,500),xy(489,520)]).
midline(r11, [xy(470,510),xy(449,510)]).
midline(r11, [xy(471,509),xy(480,510)]).
