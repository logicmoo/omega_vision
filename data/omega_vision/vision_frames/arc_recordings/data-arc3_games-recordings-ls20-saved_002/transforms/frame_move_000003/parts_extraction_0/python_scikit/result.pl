...
midline(r2, [xy(412,466),xy(409,471),xy(403,473),xy(376,476),xy(360,483),xy(313,525),xy(265,522),xy(241,531),xy(209,535),xy(176,535),xy(145,510),xy(124,501),xy(96,495),xy(81,486),xy(79,465),xy(79,380),xy(83,355),xy(90,339),xy(90,299),xy(73,279),xy(65,258),xy(64,100),xy(69,78),xy(89,49),xy(140,50),xy(162,32),xy(176,26),xy(191,24),xy(539,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(614,309),xy(611,319),xy(599,339),xy(593,345),xy(584,345)]).
midline(r2, [xy(412,465),xy(415,449),xy(414,403),xy(417,383),xy(420,378),xy(426,376),xy(449,374),xy(460,370),xy(465,348),xy(465,250),xy(463,236),xy(459,228),xy(430,224),xy(418,218),xy(414,195),xy(415,174)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,342),xy(237,339),xy(234,342)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,545),xy(614,558),xy(610,570),xy(589,575),xy(380,574),xy(368,570),xy(350,559),xy(315,525)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,600),xy(115,626),xy(113,634),xy(6,634),xy(4,625),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(240,339),xy(238,338)]).
midline(r2, [xy(240,337),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(91,340),xy(95,339),xy(93,341)]).
midline(r2, [xy(95,342),xy(98,343),xy(97,341)]).
...
border(r2).
region(r3, '#2ecc40', 125400, centroid(370,248)).
perimeter(r3, 4160).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(390,300),xy(340,300),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,473),xy(470,489),xy(476,511),xy(461,520),xy(455,521),xy(447,517),xy(435,506),xy(429,504),xy(395,505),xy(395,544),xy(433,544),xy(457,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(525,267),xy(540,249),xy(527,235),xy(519,221),xy(515,209),xy(511,180),xy(502,164),xy(489,150),xy(487,126),xy(482,110),xy(479,107),xy(453,100),xy(392,99),xy(362,103),xy(339,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(179,129),xy(151,129),xy(126,134),xy(121,145),xy(119,162),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(210,189),xy(209,149),xy(206,134)]).
midline(r3, [xy(340,114),xy(339,200),xy(349,210),xy(360,228),xy(364,240),xy(368,269),xy(380,274),xy(399,275),xy(410,279),xy(414,290),xy(415,325)]).
midline(r3, [xy(165,227),xy(165,364),xy(145,383),xy(125,385),xy(124,393),xy(125,464),xy(203,464),xy(205,458),xy(204,386),xy(184,383),xy(165,365)]).
...
fillpoint(r3, xy(369,270), 29.7).
fillpoint(r3, xy(410,279), 29.7).
fillpoint(r3, xy(511,181), 29.0).
fillpoint(r3, xy(518,218), 29.0).
fillpoint(r3, xy(361,231), 29.0).
fillpoint(r3, xy(368,268), 29.0).
fillpoint(r3, xy(371,271), 29.0).
fillpoint(r3, xy(408,278), 29.0).
fillpoint(r3, xy(411,281), 29.0).
...
fillpoint(r3, xy(374,272), 28.0).
fillpoint(r3, xy(405,277), 28.0).
fillpoint(r3, xy(412,284), 28.0).
...
fillpoint(r3, xy(377,273), 27.0).
fillpoint(r3, xy(402,276), 27.0).
fillpoint(r3, xy(413,287), 27.0).
...
fillpoint(r3, xy(382,274), 26.0).
fillpoint(r3, xy(398,275), 26.0).
fillpoint(r3, xy(414,292), 26.0).
fillpoint(r3, xy(515,292), 26.0).
fillpoint(r3, xy(515,398), 26.0).
fillpoint(r3, xy(165,308), 25.0).
fillpoint(r3, xy(415,313), 25.0).
...
midline(r20, [xy(377,634),xy(131,635),xy(126,634),xy(124,628),xy(125,605),xy(131,604),xy(547,604),xy(555,606),xy(555,632),xy(553,634),xy(378,634)]).
midline(r20, [xy(556,605),xy(578,604),xy(584,607),xy(591,604),xy(613,605),xy(615,609),xy(614,633),xy(609,635),xy(591,635),xy(584,632),xy(585,608)]).
midline(r20, [xy(584,633),xy(576,635),xy(560,635),xy(555,633)]).
...
border(r20).
region(r8, '#2ecc40', 10000, centroid(340,400)).
perimeter(r8, 400).
polygon(r8, [xy(389,450),xy(290,449),xy(290,350),xy(390,350),xy(389,450)]).
midline(r8, [xy(339,399),xy(340,400)]).
...
midline(r17, [xy(19,563),xy(21,541),xy(30,539),xy(95,540),xy(98,541),xy(100,552),xy(99,615),xy(97,618),xy(89,620),xy(64,619),xy(60,616),xy(49,620),xy(22,618),xy(19,608),xy(19,590),xy(23,580),xy(20,575),xy(19,564)]).
midline(r17, [xy(60,615),xy(60,592),xy(57,581),xy(46,579),xy(24,580)]).
...
region(r22, '#5a5a5a', 7200, centroid(370,620)).
perimeter(r22, 760).
polygon(r22, [xy(549,630),xy(190,630),xy(190,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(364,619),xy(199,620)]).
midline(r22, [xy(365,619),xy(540,620)]).
fillpoint(r22, xy(199,620), 10.0).
...
midline(r9, [xy(189,442),xy(190,431),xy(188,424),xy(165,425),xy(164,449),xy(144,449),xy(141,447),xy(139,439),xy(139,411),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(189,423)]).
...
midline(r18, [xy(52,559),xy(78,561),xy(80,600)]).
...
region(r7, '#870c25', 1500, centroid(364,334)).
perimeter(r7, 160).
polygon(r7, [xy(389,350),xy(340,350),xy(340,320),xy(389,320),xy(389,350)]).
midline(r7, [xy(366,334),xy(354,335)]).
midline(r7, [xy(367,335),xy(375,335)]).
fillpoint(r7, xy(354,335), 15.0).
region(r21, '#2ecc40', 1200, centroid(160,620)).
perimeter(r21, 160).
polygon(r21, [xy(189,630),xy(130,630),xy(130,610),xy(189,610),xy(189,630)]).
midline(r21, [xy(150,619),xy(139,620)]).
midline(r21, [xy(151,620),xy(180,620)]).
fillpoint(r21, xy(139,620), 10.0).
region(r6, '#bebebe', 1000, centroid(364,310)).
perimeter(r6, 140).
polygon(r6, [xy(389,320),xy(340,320),xy(340,300),xy(389,300),xy(389,320)]).
midline(r6, [xy(370,310),xy(349,310)]).
midline(r6, [xy(371,309),xy(380,310)]).
fillpoint(r6, xy(349,310), 10.0).
...
adjacent(r2, r3).
shared_edge(r2, r3, 3420).
adjacent(r2, r6).
shared_edge(r2, r6, 20).
adjacent(r2, r7).
shared_edge(r2, r7, 30).
adjacent(r2, r8).
shared_edge(r2, r8, 350).
adjacent(r2, r17).
...
adjacent(r20, r21).
shared_edge(r20, r21, 140).
adjacent(r20, r22).
shared_edge(r20, r22, 740).
adjacent(r20, r23).
