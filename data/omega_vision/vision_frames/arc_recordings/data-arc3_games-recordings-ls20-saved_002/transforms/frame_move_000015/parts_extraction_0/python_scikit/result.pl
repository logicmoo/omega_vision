...
midline(r2, [xy(89,49),xy(69,78),xy(64,100),xy(65,258),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,381),xy(79,467),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(91,50),xy(140,50),xy(162,32),xy(176,26),xy(190,24),xy(539,24),xy(553,26),xy(569,33),xy(590,49),xy(589,150),xy(606,170),xy(613,186),xy(615,201),xy(614,309),xy(611,319),xy(599,339),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,391),xy(615,547),xy(612,566),xy(606,572),xy(589,575),xy(380,574),xy(354,562),xy(312,524),xy(293,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(244,349),xy(239,340),xy(248,308),xy(266,299),xy(264,297),xy(265,174)]).
midline(r2, [xy(315,524),xy(350,490),xy(360,483),xy(376,476),xy(399,474),xy(411,469),xy(415,449),xy(414,400),xy(417,383),xy(419,379),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(459,228),xy(449,225),xy(430,224),xy(419,220),xy(415,209),xy(415,174)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,472),xy(471,494),xy(477,510),xy(457,522),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,523)]).
midline(r3, [xy(549,432),xy(550,439),xy(558,455),xy(560,472),xy(558,494),xy(552,509),xy(534,518),xy(518,520),xy(495,518),xy(479,510)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,290),xy(523,270),xy(540,249),xy(522,227),xy(515,209),xy(514,190),xy(511,180),xy(502,164),xy(489,150),xy(489,136),xy(481,109),xy(459,101),xy(439,99),xy(376,100),xy(348,108),xy(322,85),xy(298,75),xy(240,74),xy(220,78),xy(216,86),xy(213,113),xy(206,129),xy(190,149),xy(164,174),xy(165,363),xy(145,383),xy(125,385),xy(124,456),xy(125,464),xy(130,465),xy(199,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(348,109),xy(340,136),xy(339,200),xy(356,220),xy(363,236),xy(365,259),xy(369,271),xy(377,285),xy(390,300),xy(373,320),xy(366,336),xy(364,358),xy(360,371),xy(340,400)]).
...
midline(r17, [xy(524,635),xy(130,635),xy(125,633),xy(125,605),xy(549,604),xy(553,605),xy(555,609),xy(555,632),xy(548,635),xy(525,634)]).
midline(r17, [xy(555,606),xy(575,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(561,635),xy(555,633)]).
midline(r17, [xy(585,606),xy(590,604),xy(609,604),xy(615,606),xy(615,631),xy(613,634),xy(594,635),xy(585,633)]).
...
midline(r14, [xy(19,563),xy(20,575),xy(23,580),xy(19,591),xy(21,618),xy(30,620),xy(57,618),xy(60,610),xy(59,584),xy(55,580),xy(48,579),xy(24,580)]).
midline(r14, [xy(60,617),xy(70,620),xy(87,620),xy(98,617),xy(100,609),xy(100,550),xy(98,542),xy(88,539),xy(24,540),xy(20,544),xy(20,562)]).
...
region(r19, '#5a5a5a', 7200, centroid(370,620)).
perimeter(r19, 760).
polygon(r19, [xy(549,630),xy(190,630),xy(190,610),xy(549,610),xy(549,630)]).
midline(r19, [xy(405,620),xy(199,620)]).
midline(r19, [xy(406,619),xy(540,620)]).
fillpoint(r19, xy(199,620), 10.0).
...
midline(r6, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(165,447),xy(163,449),xy(152,450),xy(142,448),xy(139,436),xy(140,404),xy(144,400),xy(177,399),xy(188,401),xy(190,410),xy(189,423)]).
...
midline(r5, [xy(267,135),xy(275,135)]).
fillpoint(r5, xy(254,135), 15.0).
region(r18, '#2ecc40', 1200, centroid(160,620)).
perimeter(r18, 160).
polygon(r18, [xy(189,630),xy(130,630),xy(130,610),xy(189,610),xy(189,630)]).
midline(r18, [xy(160,620),xy(139,620)]).
midline(r18, [xy(161,619),xy(180,620)]).
...
midline(r12, [xy(405,527),xy(405,534),xy(411,535),xy(423,534),xy(425,529),xy(424,516),xy(418,514),xy(405,515),xy(405,526)]).
...
adjacent(r17, r18).
shared_edge(r17, r18, 140).
adjacent(r17, r19).
shared_edge(r17, r19, 740).
adjacent(r17, r20).
