...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(538,24),xy(190,24),xy(176,26),xy(162,32),xy(140,50),xy(89,49)]).
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,190),xy(615,299),xy(612,316),xy(602,335),xy(593,345),xy(584,345)]).
midline(r2, [xy(594,345),xy(602,354),xy(611,370),xy(615,390),xy(614,558),xy(611,569),xy(603,573),xy(588,575),xy(380,574),xy(354,562),xy(313,524),xy(291,525),xy(265,522),xy(245,530),xy(225,534),xy(175,535),xy(145,510),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,469),xy(79,380),xy(83,355),xy(90,340),xy(90,299),xy(73,279),xy(65,259),xy(64,100),xy(66,86),xy(72,72),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,342),xy(237,338),xy(234,341),xy(237,340)]).
midline(r2, [xy(315,524),xy(339,500),xy(360,483),xy(376,476),xy(399,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,449),xy(414,400),xy(417,383),xy(419,379),xy(426,376),xy(448,374),xy(460,370),xy(465,348),xy(465,250),xy(463,236),xy(459,228),xy(449,225),xy(430,224),xy(418,219),xy(414,197),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,603),xy(115,628),xy(113,634),xy(6,634),xy(4,625),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(238,337),xy(241,335),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(266,299),xy(290,300)]).
midline(r2, [xy(91,340),xy(94,340),xy(94,342)]).
midline(r2, [xy(96,342),xy(101,344)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(369,258)).
perimeter(r3, 4460).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(390,449),xy(290,449),xy(290,400),xy(340,399),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(459,521),xy(449,518),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(522,272),xy(540,249),xy(527,235),xy(518,219),xy(514,190),xy(506,170),xy(489,150),xy(488,130),xy(482,110),xy(479,107),xy(453,100),xy(376,100),xy(350,107),xy(340,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(178,129),xy(151,129),xy(126,134),xy(121,145),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(165,225),xy(165,363),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(131,465),xy(194,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,189),xy(210,160),xy(206,134)]).
midline(r3, [xy(340,114),xy(339,200),xy(356,220),xy(363,236),xy(368,269),xy(377,285),xy(390,300),xy(377,314),xy(366,336),xy(364,352),xy(365,398),xy(361,418),xy(349,424),xy(314,425)]).
midline(r3, [xy(451,520),xy(450,519)]).
...
fillpoint(r3, xy(361,418), 29.0).
fillpoint(r3, xy(358,421), 29.0).
...
fillpoint(r3, xy(362,415), 28.0).
fillpoint(r3, xy(355,422), 28.0).
...
fillpoint(r3, xy(363,412), 27.0).
fillpoint(r3, xy(352,423), 27.0).
...
fillpoint(r3, xy(364,408), 26.0).
fillpoint(r3, xy(348,424), 26.0).
fillpoint(r3, xy(165,308), 25.0).
fillpoint(r3, xy(514,345), 25.0).
fillpoint(r3, xy(364,375), 25.0).
fillpoint(r3, xy(314,425), 25.0).
region(r1, '#aaaaaa', 20800, centroid(20,260)).
perimeter(r1, 1120).
polygon(r1, [xy(40,0),xy(40,519),xy(0,520)]).
midline(r1, [xy(19,254),xy(20,500)]).
midline(r1, [xy(20,253),xy(20,19)]).
...
midline(r19, [xy(377,634),xy(131,635),xy(126,634),xy(124,628),xy(125,605),xy(130,604),xy(546,604),xy(555,606),xy(555,632),xy(548,635),xy(378,634)]).
midline(r19, [xy(556,605),xy(578,604),xy(585,606),xy(585,628),xy(584,633),xy(579,635),xy(560,635),xy(555,633)]).
midline(r19, [xy(586,605),xy(613,605),xy(615,609),xy(615,630),xy(613,634),xy(609,635),xy(590,635),xy(585,633)]).
midline(r19, [xy(615,606),xy(620,604),xy(635,605)]).
...
midline(r21, [xy(324,619),xy(159,620)]).
midline(r21, [xy(325,620),xy(540,620)]).
...
midline(r16, [xy(99,562),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,550),xy(19,569),xy(23,580),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,616),xy(60,590),xy(58,582),xy(48,579),xy(24,579)]).
midline(r16, [xy(100,563),xy(100,608),xy(98,617),xy(89,620),xy(70,620),xy(61,617)]).
...
midline(r8, [xy(189,442),xy(190,430),xy(187,424),xy(165,425),xy(165,446),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,412),xy(189,424)]).
...
midline(r17, [xy(52,560),xy(69,559),xy(78,561),xy(80,600)]).
...
region(r7, '#870c25', 1500, centroid(314,384)).
perimeter(r7, 160).
polygon(r7, [xy(339,400),xy(290,400),xy(290,370),xy(339,370),xy(339,400)]).
midline(r7, [xy(316,384),xy(304,385)]).
midline(r7, [xy(317,384),xy(325,385)]).
fillpoint(r7, xy(304,385), 15.0).
region(r6, '#bebebe', 1000, centroid(314,360)).
perimeter(r6, 140).
polygon(r6, [xy(339,370),xy(290,370),xy(290,350),xy(339,350),xy(339,370)]).
midline(r6, [xy(320,360),xy(299,360)]).
midline(r6, [xy(321,359),xy(330,360)]).
fillpoint(r6, xy(299,360), 10.0).
...
adjacent(r19, r20).
shared_edge(r19, r20, 60).
adjacent(r19, r21).
shared_edge(r19, r21, 820).
adjacent(r19, r22).
