...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(539,24),xy(191,24),xy(176,26),xy(160,33),xy(140,50),xy(89,49),xy(77,64),xy(68,80),xy(64,100),xy(65,259),xy(75,282),xy(90,299),xy(89,337),xy(92,338),xy(83,355),xy(79,380),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(93,337),xy(92,340),xy(95,342),xy(97,340),xy(95,339)]).
midline(r2, [xy(98,341),xy(100,343),xy(96,343)]).
midline(r2, [xy(175,535),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(249,368),xy(239,339),xy(248,308),xy(262,301),xy(265,297),xy(265,174)]).
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,191),xy(615,298),xy(613,313),xy(606,329),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,549),xy(610,570),xy(589,575),xy(381,574),xy(368,570),xy(354,562),xy(314,524),xy(266,523)]).
midline(r2, [xy(315,524),xy(350,490),xy(362,482),xy(376,476),xy(398,474),xy(410,470)]).
midline(r2, [xy(411,468),xy(415,449),xy(414,401),xy(417,383),xy(420,378),xy(426,376),xy(448,374),xy(460,370)]).
midline(r2, [xy(461,368),xy(465,349),xy(465,251),xy(463,236),xy(459,228),xy(431,224),xy(419,220),xy(414,199),xy(415,174)]).
midline(r2, [xy(100,345),xy(110,350)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(370,263)).
perimeter(r3, 4560).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,470),xy(470,489),xy(476,511),xy(461,520),xy(455,521),xy(435,506),xy(429,504),xy(395,505),xy(395,544),xy(433,544),xy(456,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(510,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,388),xy(515,291),xy(522,272),xy(540,249),xy(530,239),xy(519,221),xy(515,209),xy(514,190),xy(511,180),xy(502,164),xy(489,150),xy(488,130),xy(483,113),xy(479,107),xy(453,100),xy(390,99),xy(370,101),xy(348,108),xy(325,87),xy(303,76),xy(289,74),xy(240,74),xy(220,78),xy(216,86),xy(213,113),xy(203,133),xy(178,129),xy(152,129),xy(135,131),xy(124,136),xy(119,160),xy(119,189),xy(124,213),xy(135,218),xy(154,221),xy(164,226),xy(205,213),xy(209,199),xy(210,160),xy(204,134)]).
midline(r3, [xy(165,227),xy(165,364),xy(145,383),xy(125,385),xy(124,392),xy(125,464),xy(203,464),xy(205,458),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,470),xy(558,455),xy(550,439),xy(549,432)]).
midline(r3, [xy(348,109),xy(340,136),xy(339,200),xy(357,222),xy(363,236),xy(365,258),xy(369,271),xy(377,285),xy(390,300),xy(372,322),xy(365,340),xy(364,359),xy(361,369),xy(352,385),xy(340,400)]).
...
midline(r19, [xy(524,635),xy(133,635),xy(125,633),xy(125,605),xy(549,604),xy(554,607),xy(561,604),xy(579,604),xy(583,605),xy(585,609),xy(585,632),xy(578,635),xy(566,635),xy(554,632),xy(555,608)]).
midline(r19, [xy(525,634),xy(549,635),xy(554,633)]).
midline(r19, [xy(585,606),xy(590,604),xy(607,604),xy(613,605),xy(615,610),xy(615,631),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r16, [xy(19,563),xy(20,544),xy(24,540),xy(87,539),xy(98,541),xy(100,550),xy(100,608),xy(99,615),xy(95,619),xy(72,620),xy(64,619),xy(60,616),xy(49,620),xy(22,618),xy(19,608),xy(19,591),xy(23,579),xy(20,575),xy(20,564)]).
...
region(r21, '#5a5a5a', 4800, centroid(430,620)).
perimeter(r21, 520).
polygon(r21, [xy(549,630),xy(310,630),xy(310,610),xy(549,610),xy(549,630)]).
midline(r21, [xy(470,620),xy(319,620)]).
midline(r21, [xy(471,620),xy(540,620)]).
fillpoint(r21, xy(319,620), 10.0).
...
midline(r8, [xy(189,442),xy(190,432),xy(188,424),xy(165,425),xy(165,445),xy(163,449),xy(144,449),xy(141,447),xy(139,439),xy(139,411),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(190,411),xy(189,423)]).
...
region(r20, '#2ecc40', 3600, centroid(220,620)).
perimeter(r20, 400).
polygon(r20, [xy(309,630),xy(130,630),xy(130,610),xy(309,610),xy(309,630)]).
midline(r20, [xy(290,620),xy(139,620)]).
midline(r20, [xy(291,619),xy(300,620)]).
...
midline(r17, [xy(80,586),xy(80,570),xy(77,561),xy(67,559),xy(39,560)]).
...
midline(r5, [xy(266,134),xy(254,135)]).
midline(r5, [xy(267,134),xy(275,135)]).
...
midline(r4, [xy(260,109),xy(249,110)]).
midline(r4, [xy(261,110),xy(280,110)]).
...
midline(r6, [xy(174,182),xy(173,165),xy(155,165),xy(154,171),xy(155,184),xy(174,184)]).
...
midline(r14, [xy(419,514),xy(405,515),xy(405,534),xy(415,535),xy(424,533),xy(425,520),xy(424,516),xy(420,515)]).
...
midline(r9, [xy(155,424),xy(155,415),xy(175,415)]).
midline(r9, [xy(155,425),xy(155,435)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 380).
adjacent(r19, r21).
shared_edge(r19, r21, 500).
adjacent(r19, r22).
