...
midline(r2, [xy(590,49),xy(561,29),xy(539,24),xy(191,24),xy(176,26),xy(162,32),xy(140,50),xy(89,49)]).
midline(r2, [xy(589,51),xy(589,150),xy(604,167),xy(614,190),xy(615,299),xy(611,319),xy(602,335),xy(594,344),xy(584,345)]).
midline(r2, [xy(594,345),xy(610,368),xy(615,390),xy(615,547),xy(612,566),xy(609,571),xy(603,573),xy(588,575),xy(380,574),xy(368,570),xy(350,559),xy(315,525),xy(273,524),xy(265,522),xy(245,530),xy(225,534),xy(179,535),xy(174,534),xy(154,516),xy(133,504),xy(105,498),xy(84,489),xy(81,486),xy(79,468),xy(79,384),xy(81,363),xy(90,340),xy(90,299),xy(73,279),xy(65,259),xy(64,100),xy(66,86),xy(72,72),xy(89,51)]).
midline(r2, [xy(265,521),xy(250,461),xy(249,368),xy(241,341),xy(237,337),xy(234,340),xy(238,340)]).
midline(r2, [xy(315,524),xy(340,499),xy(362,482),xy(376,476),xy(398,474),xy(411,469),xy(415,448),xy(414,400),xy(418,380),xy(426,376),xy(459,371),xy(463,363),xy(465,348),xy(465,250),xy(463,236),xy(459,228),xy(449,225),xy(430,224),xy(418,219),xy(414,197),xy(415,174)]).
midline(r2, [xy(174,535),xy(116,594),xy(114,601),xy(115,629),xy(113,634),xy(6,634),xy(4,629),xy(5,525),xy(43,524),xy(81,488)]).
midline(r2, [xy(240,338),xy(248,308),xy(265,299),xy(265,174)]).
midline(r2, [xy(266,300),xy(290,300)]).
midline(r2, [xy(91,340),xy(94,340),xy(94,342)]).
midline(r2, [xy(96,342),xy(103,345),xy(103,347)]).
...
border(r2).
region(r3, '#2ecc40', 97200, centroid(302,205)).
perimeter(r3, 3000).
polygon(r3, [xy(209,470),xy(120,469),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,149),xy(490,150),xy(489,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(389,450),xy(290,449),xy(290,350),xy(340,349),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(209,470)]).
hole(r3, [xy(200,459),xy(199,390),xy(130,390),xy(130,460),xy(200,459)]).
midline(r3, [xy(164,210),xy(165,181),xy(162,179),xy(164,174),xy(239,99),xy(303,100),xy(326,106),xy(339,113),xy(350,107),xy(376,100),xy(438,99),xy(459,101),xy(464,104),xy(476,100),xy(490,100)]).
midline(r3, [xy(465,105),xy(465,175)]).
midline(r3, [xy(164,211),xy(165,361),xy(164,365),xy(145,383),xy(125,385),xy(124,459),xy(125,464),xy(131,465),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(340,114),xy(339,200),xy(357,222),xy(363,236),xy(365,259),xy(369,271),xy(377,285),xy(390,299),xy(377,314),xy(368,330),xy(362,366),xy(356,379),xy(340,400)]).
midline(r3, [xy(166,179),xy(165,179)]).
...
fillpoint(r3, xy(465,163), 25.0).
fillpoint(r3, xy(165,308), 25.0).
region(r6, '#2ecc40', 39100, centroid(517,402)).
perimeter(r6, 1440).
polygon(r6, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r6, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,476),xy(471,494),xy(477,510),xy(461,520),xy(453,521),xy(435,506),xy(429,504),xy(395,505),xy(395,544),xy(433,544),xy(455,524),xy(454,522)]).
midline(r6, [xy(520,420),xy(514,389),xy(515,291),xy(523,270),xy(540,249)]).
midline(r6, [xy(549,432),xy(550,439),xy(558,455),xy(560,472),xy(558,494),xy(552,509),xy(543,515),xy(519,520),xy(495,518),xy(479,510)]).
fillpoint(r6, xy(539,250), 50.0).
...
midline(r18, [xy(377,634),xy(126,634),xy(124,628),xy(125,605),xy(131,604),xy(544,604),xy(555,606),xy(555,631),xy(553,634),xy(378,635)]).
midline(r18, [xy(556,605),xy(579,604),xy(585,606),xy(585,632),xy(578,635),xy(560,635),xy(555,633)]).
midline(r18, [xy(586,605),xy(609,604),xy(614,607),xy(621,604),xy(635,605)]).
midline(r18, [xy(615,608),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r15, [xy(99,553),xy(100,605),xy(97,618),xy(70,620),xy(60,616),xy(55,619),xy(46,620),xy(24,619),xy(21,617),xy(19,609),xy(19,590),xy(23,579),xy(19,569),xy(21,541),xy(30,539),xy(95,540),xy(98,541),xy(100,552)]).
...
midline(r20, [xy(460,620),xy(540,620)]).
...
midline(r7, [xy(189,442),xy(190,430),xy(188,424),xy(165,425),xy(164,449),xy(150,450),xy(142,448),xy(139,436),xy(139,410),xy(141,401),xy(144,400),xy(179,399),xy(188,401),xy(189,423)]).
...
midline(r19, [xy(184,620),xy(139,620)]).
midline(r19, [xy(185,620),xy(300,620)]).
...
midline(r16, [xy(52,559),xy(78,561),xy(80,600)]).
...
region(r5, '#870c25', 1500, centroid(514,184)).
perimeter(r5, 160).
polygon(r5, [xy(539,200),xy(490,200),xy(490,170),xy(539,170),xy(539,200)]).
midline(r5, [xy(510,185),xy(504,185)]).
midline(r5, [xy(511,184),xy(525,185)]).
fillpoint(r5, xy(504,185), 15.0).
region(r4, '#bebebe', 1000, centroid(514,160)).
perimeter(r4, 140).
polygon(r4, [xy(539,170),xy(490,170),xy(490,150),xy(539,150),xy(539,170)]).
midline(r4, [xy(509,160),xy(499,160)]).
midline(r4, [xy(510,159),xy(530,160)]).
fillpoint(r4, xy(499,160), 10.0).
...
midline(r13, [xy(424,532),xy(425,520),xy(423,515),xy(405,515),xy(404,520),xy(405,534),xy(424,534)]).
...
adjacent(r2, r3).
shared_edge(r2, r3, 2620).
adjacent(r2, r4).
shared_edge(r2, r4, 20).
adjacent(r2, r5).
shared_edge(r2, r5, 30).
adjacent(r2, r6).
shared_edge(r2, r6, 1150).
adjacent(r2, r15).
