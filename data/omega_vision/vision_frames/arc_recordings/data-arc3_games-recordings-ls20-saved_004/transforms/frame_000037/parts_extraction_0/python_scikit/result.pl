...
midline(r2, [xy(508,25),xy(442,24),xy(426,26),xy(415,31),xy(403,26),xy(388,24),xy(80,24),xy(66,26),xy(61,38),xy(59,51),xy(59,98),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(105,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,24),xy(519,25),xy(540,19),xy(589,19),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,482),xy(625,569),xy(622,581),xy(608,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(389,575),xy(230,574),xy(207,564),xy(190,549),xy(160,550)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(165,359),xy(165,140),xy(169,129),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,97),xy(413,113),xy(409,123),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,198),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(472,429),xy(466,423)]).
midline(r2, [xy(470,429),xy(467,429),xy(466,426)]).
midline(r2, [xy(470,431),xy(473,430),xy(473,432)]).
midline(r2, [xy(475,432),xy(488,439),xy(492,439),xy(492,441)]).
midline(r2, [xy(494,441),xy(498,442),xy(498,444)]).
...
midline(r5, [xy(589,484),xy(584,483),xy(564,464),xy(564,340),xy(556,320),xy(539,300),xy(376,299),xy(350,292),xy(315,275),xy(289,250)]).
midline(r5, [xy(590,485),xy(604,485),xy(604,563),xy(599,565),xy(526,564),xy(524,558),xy(525,485),xy(545,483),xy(564,465)]).
midline(r5, [xy(540,299),xy(556,279),xy(563,263),xy(565,249),xy(565,200),xy(563,186),xy(551,163),xy(529,169),xy(511,170),xy(495,168),xy(477,159),xy(471,144),xy(470,122),xy(465,108),xy(465,74)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,128),xy(554,119),xy(535,110),xy(529,110),xy(523,105),xy(511,104),xy(471,121)]).
midline(r5, [xy(315,276),xy(315,420),xy(313,425),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(300,520),xy(329,520),xy(353,515),xy(358,504),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(290,248),xy(315,220),xy(315,82),xy(313,80),xy(299,75),xy(288,74),xy(140,74),xy(126,76),xy(118,80),xy(114,100),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(560,123),xy(558,121)]).
midline(r5, [xy(560,121),xy(565,99),xy(565,74)]).
...
fillpoint(r5, xy(468,118), 29.0).
fillpoint(r5, xy(561,118), 29.0).
...
fillpoint(r5, xy(467,115), 28.0).
fillpoint(r5, xy(562,115), 28.0).
...
fillpoint(r5, xy(466,112), 27.0).
fillpoint(r5, xy(563,112), 27.0).
...
fillpoint(r5, xy(465,108), 26.0).
fillpoint(r5, xy(564,108), 26.0).
...
midline(r22, [xy(524,635),xy(132,635),xy(126,634),xy(124,629),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(554,633),xy(548,635),xy(525,635)]).
midline(r22, [xy(556,605),xy(577,604),xy(584,607),xy(591,604),xy(608,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r22, [xy(585,608),xy(585,632),xy(583,634),xy(561,635),xy(555,633)]).
midline(r22, [xy(615,608),xy(615,632),xy(613,634),xy(591,635),xy(585,633)]).
...
border(r22).
region(r19, '#aaaaaa', 7600, centroid(58,578)).
perimeter(r19, 720).
polygon(r19, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r19, [xy(90,609),xy(89,550),xy(70,550),xy(69,590),xy(30,590),xy(30,610),xy(90,609)]).
hole(r19, [xy(50,569),xy(49,550),xy(30,550),xy(30,570),xy(50,569)]).
midline(r19, [xy(99,553),xy(98,542),xy(89,539),xy(64,540),xy(60,543),xy(49,539),xy(21,541),xy(19,550),xy(19,568),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(87,620),xy(97,618),xy(100,609),xy(100,554)]).
midline(r19, [xy(60,544),xy(58,577),xy(48,580),xy(24,580)]).
fillpoint(r19, xy(60,542), 12.8).
fillpoint(r19, xy(22,580), 12.8).
fillpoint(r19, xy(22,541), 12.0).
fillpoint(r19, xy(98,541), 12.0).
fillpoint(r19, xy(57,578), 12.0).
fillpoint(r19, xy(21,618), 12.0).
fillpoint(r19, xy(97,618), 12.0).
fillpoint(r19, xy(25,540), 11.0).
fillpoint(r19, xy(54,540), 11.0).
fillpoint(r19, xy(65,540), 11.0).
fillpoint(r19, xy(94,540), 11.0).
fillpoint(r19, xy(20,545), 11.0).
fillpoint(r19, xy(99,545), 11.0).
fillpoint(r19, xy(20,574), 11.0).
fillpoint(r19, xy(59,574), 11.0).
fillpoint(r19, xy(54,579), 11.0).
...
region(r23, '#2ecc40', 5200, centroid(260,620)).
perimeter(r23, 560).
polygon(r23, [xy(389,630),xy(130,630),xy(130,610),xy(389,610),xy(389,630)]).
midline(r23, [xy(301,620),xy(139,620)]).
midline(r23, [xy(302,619),xy(380,620)]).
...
midline(r16, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
...
region(r24, '#5a5a5a', 3200, centroid(470,620)).
perimeter(r24, 360).
polygon(r24, [xy(549,630),xy(390,630),xy(390,610),xy(549,610),xy(549,630)]).
midline(r24, [xy(539,620),xy(399,620)]).
midline(r24, [xy(540,620),xy(540,619)]).
fillpoint(r24, xy(399,620), 10.0).
region(r21, '#870c25', 2000, centroid(68,588)).
perimeter(r21, 240).
polygon(r21, [xy(89,610),xy(30,609),xy(30,590),xy(70,589),xy(70,550),xy(90,550),xy(89,610)]).
midline(r21, [xy(64,600),xy(39,600)]).
midline(r21, [xy(65,599),xy(75,599),xy(79,595),xy(80,559)]).
fillpoint(r21, xy(77,598), 12.0).
fillpoint(r21, xy(79,594), 11.0).
fillpoint(r21, xy(74,599), 11.0).
fillpoint(r21, xy(79,574), 10.0).
fillpoint(r21, xy(39,600), 10.0).
region(r7, '#870c25', 1500, centroid(514,84)).
perimeter(r7, 160).
polygon(r7, [xy(539,100),xy(490,100),xy(490,70),xy(539,70),xy(539,100)]).
midline(r7, [xy(516,84),xy(504,85)]).
midline(r7, [xy(517,85),xy(525,85)]).
fillpoint(r7, xy(504,85), 15.0).
region(r6, '#bebebe', 1000, centroid(514,60)).
perimeter(r6, 140).
polygon(r6, [xy(539,70),xy(490,70),xy(490,50),xy(539,50),xy(539,70)]).
midline(r6, [xy(523,59),xy(499,60)]).
midline(r6, [xy(524,59),xy(530,60)]).
fillpoint(r6, xy(499,60), 10.0).
...
midline(r17, [xy(565,535),xy(555,533),xy(555,514)]).
midline(r17, [xy(566,534),xy(575,535)]).
fillpoint(r17, xy(555,534), 6.0).
fillpoint(r17, xy(555,521), 5.0).
fillpoint(r17, xy(561,535), 5.0).
region(r20, '#870c25', 400, centroid(40,560)).
perimeter(r20, 80).
polygon(r20, [xy(49,570),xy(30,569),xy(30,550),xy(50,550),xy(49,570)]).
midline(r20, [xy(39,559),xy(40,560)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 80).
adjacent(r19, r21).
shared_edge(r19, r21, 240).
adjacent(r22, r23).
shared_edge(r22, r23, 540).
adjacent(r22, r24).
shared_edge(r22, r24, 340).
adjacent(r22, r25).
