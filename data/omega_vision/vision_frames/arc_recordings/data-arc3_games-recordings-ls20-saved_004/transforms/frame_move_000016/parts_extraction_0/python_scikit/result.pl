...
midline(r2, [xy(246,25),xy(80,24),xy(66,26),xy(62,35),xy(59,54),xy(59,99),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,603),xy(116,594),xy(159,549),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(160,549),xy(188,550),xy(207,527),xy(213,513),xy(215,499),xy(214,381),xy(199,375),xy(180,374),xy(170,371),xy(165,359),xy(164,153),xy(166,136),xy(169,129),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(247,24),xy(387,24),xy(403,26),xy(414,32),xy(430,25),xy(520,25),xy(528,21),xy(541,19),xy(589,19),xy(613,26),xy(615,44),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(622,581),xy(607,585),xy(522,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(429,390),xy(409,378),xy(389,374),xy(364,375)]).
...
midline(r2, [xy(466,429),xy(469,428),xy(470,431),xy(482,434),xy(482,436)]).
midline(r2, [xy(454,535),xy(422,564),xy(403,573),xy(388,575),xy(231,574),xy(212,567),xy(190,550)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(559,110),xy(560,129),xy(558,144),xy(550,163),xy(519,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(561,180),xy(564,191),xy(564,259),xy(556,279),xy(539,300),xy(390,300),xy(313,223),xy(273,225),xy(266,226),xy(252,251),xy(238,261),xy(196,304),xy(194,311),xy(194,338),xy(195,344),xy(200,345),xy(233,344),xy(260,319),xy(259,299),xy(251,253)]).
midline(r5, [xy(540,301),xy(554,317),xy(564,341),xy(565,463),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(313,222),xy(315,219),xy(315,82),xy(313,80),xy(289,74),xy(143,74),xy(126,76),xy(118,80),xy(114,100),xy(114,397),xy(118,419),xy(127,435),xy(140,450)]).
...
midline(r13, [xy(357,444),xy(353,434),xy(315,424),xy(276,434),xy(271,445),xy(269,461),xy(269,489),xy(274,513),xy(285,518),xy(301,520),xy(339,519),xy(353,515),xy(358,504),xy(360,489),xy(358,445)]).
...
midline(r23, [xy(524,635),xy(132,635),xy(126,634),xy(124,627),xy(125,605),xy(130,604),xy(549,604),xy(553,605),xy(555,610),xy(554,633),xy(549,635),xy(525,635)]).
midline(r23, [xy(555,606),xy(562,604),xy(579,604),xy(584,607),xy(592,604),xy(615,606),xy(615,632),xy(609,635),xy(590,635),xy(584,632),xy(585,608)]).
midline(r23, [xy(616,605),xy(635,605)]).
midline(r23, [xy(584,633),xy(579,635),xy(560,635),xy(555,633)]).
...
region(r25, '#5a5a5a', 6800, centroid(380,620)).
perimeter(r25, 720).
polygon(r25, [xy(549,630),xy(210,630),xy(210,610),xy(549,610),xy(549,630)]).
midline(r25, [xy(384,619),xy(219,620)]).
midline(r25, [xy(385,619),xy(540,620)]).
fillpoint(r25, xy(219,620), 10.0).
...
midline(r19, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(565,503),xy(563,500),xy(551,499),xy(541,501),xy(539,511),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r19, [xy(565,500),xy(579,499),xy(588,501),xy(589,523)]).
...
region(r24, '#2ecc40', 1600, centroid(170,620)).
perimeter(r24, 200).
polygon(r24, [xy(209,630),xy(130,630),xy(130,610),xy(209,610),xy(209,630)]).
midline(r24, [xy(141,619),xy(139,620)]).
midline(r24, [xy(142,619),xy(200,620)]).
...
midline(r12, [xy(323,335),xy(304,335)]).
midline(r12, [xy(325,335),xy(325,334)]).
...
midline(r9, [xy(320,310),xy(299,310)]).
midline(r9, [xy(321,310),xy(330,310)]).
...
adjacent(r23, r24).
shared_edge(r23, r24, 180).
adjacent(r23, r25).
shared_edge(r23, r25, 700).
adjacent(r23, r26).
