...
midline(r2, [xy(64,277),xy(65,119),xy(61,111),xy(59,98),xy(59,52),xy(61,38),xy(66,26),xy(81,24),xy(384,24),xy(403,26),xy(415,31),xy(415,99),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,198),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(426,26),xy(443,24),xy(517,24),xy(520,26)]).
midline(r2, [xy(521,24),xy(540,19),xy(587,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,483),xy(625,566),xy(622,581),xy(607,585),xy(513,584),xy(497,576),xy(455,535),xy(425,562),xy(409,571),xy(398,574),xy(231,574),xy(210,566),xy(190,549),xy(160,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(13,635),xy(113,634),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,278)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(429,390),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,428),xy(484,437),xy(486,436),xy(486,438)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,508),xy(215,382),xy(203,376),xy(170,371),xy(165,359),xy(165,141),xy(168,130),xy(181,125),xy(265,125)]).
...
midline(r5, [xy(589,484),xy(580,480),xy(564,464),xy(564,341),xy(556,320),xy(538,299),xy(376,299),xy(353,293),xy(315,275),xy(289,250)]).
midline(r5, [xy(590,485),xy(604,485),xy(604,563),xy(596,565),xy(526,564),xy(524,559),xy(525,485),xy(545,483),xy(564,465)]).
midline(r5, [xy(540,299),xy(552,285),xy(561,269),xy(565,248),xy(565,224)]).
midline(r5, [xy(290,248),xy(315,219),xy(315,82),xy(313,80),xy(303,76),xy(284,74),xy(147,74),xy(130,75),xy(118,80),xy(114,100),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(314,276),xy(315,423),xy(274,436),xy(270,450),xy(269,483),xy(271,504),xy(276,515),xy(290,519),xy(329,520),xy(344,518),xy(355,513),xy(360,488),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
midline(r23, [xy(524,635),xy(134,635),xy(125,633),xy(125,605),xy(547,604),xy(555,606),xy(555,632),xy(546,635),xy(525,634)]).
midline(r23, [xy(556,605),xy(579,604),xy(585,606),xy(585,632),xy(579,635),xy(555,633)]).
midline(r23, [xy(586,605),xy(606,604),xy(615,606),xy(615,632),xy(608,635),xy(590,635),xy(585,633)]).
...
midline(r20, [xy(99,553),xy(98,542),xy(89,539),xy(32,539),xy(21,541),xy(19,550),xy(19,568),xy(23,579),xy(19,590),xy(21,618),xy(32,620),xy(55,619),xy(60,616),xy(58,582),xy(49,579),xy(24,579)]).
midline(r20, [xy(100,554),xy(100,606),xy(98,617),xy(89,620),xy(70,620),xy(61,617)]).
...
midline(r25, [xy(480,620),xy(540,620)]).
...
midline(r17, [xy(589,542),xy(590,531),xy(588,524),xy(570,525),xy(565,523),xy(565,503),xy(563,500),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r17, [xy(565,500),xy(578,499),xy(588,501),xy(589,523)]).
...
midline(r24, [xy(280,619),xy(320,620)]).
...
midline(r21, [xy(52,560),xy(67,559),xy(78,561),xy(80,600)]).
...
midline(r11, [xy(566,184),xy(554,185)]).
midline(r11, [xy(567,184),xy(575,185)]).
...
midline(r10, [xy(570,160),xy(549,160)]).
midline(r10, [xy(571,159),xy(580,160)]).
