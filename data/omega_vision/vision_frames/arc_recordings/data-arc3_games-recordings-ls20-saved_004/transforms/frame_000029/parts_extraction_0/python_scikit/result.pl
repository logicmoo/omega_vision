...
midline(r2, [xy(64,277),xy(65,119),xy(61,111),xy(59,97),xy(59,50),xy(66,26),xy(84,24),xy(389,24),xy(403,26),xy(415,31),xy(415,98),xy(412,116),xy(407,125),xy(364,125)]).
midline(r2, [xy(64,278),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,605),xy(116,594),xy(159,549),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(408,125),xy(414,140),xy(415,209),xy(420,221),xy(442,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(440,24),xy(518,24),xy(521,27)]).
midline(r2, [xy(521,24),xy(542,19),xy(589,19),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,481),xy(625,567),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(406,572),xy(389,575),xy(230,574),xy(210,566),xy(190,549),xy(160,549)]).
...
midline(r2, [xy(468,429),xy(478,434),xy(481,433),xy(482,436),xy(485,435),xy(483,434)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,508),xy(215,382),xy(199,375),xy(173,372),xy(168,369),xy(165,359),xy(165,140),xy(170,128),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(487,437),xy(486,438)]).
midline(r2, [xy(488,438),xy(490,440)]).
midline(r2, [xy(492,440),xy(509,449),xy(509,451)]).
...
midline(r5, [xy(315,83),xy(315,220),xy(289,249),xy(315,280),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(300,520),xy(339,519),xy(353,515),xy(358,504),xy(360,484),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(316,280),xy(360,316),xy(376,323),xy(390,325),xy(449,324),xy(469,316),xy(489,299),xy(535,300),xy(539,299),xy(548,290),xy(557,277),xy(564,258),xy(565,201),xy(561,180),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
...
midline(r5, [xy(540,300),xy(554,317),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(524,558),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
fillpoint(r5, xy(289,250), 100.0).
fillpoint(r5, xy(489,300), 50.0).
...
fillpoint(r5, xy(371,321), 29.0).
fillpoint(r5, xy(458,321), 29.0).
...
fillpoint(r5, xy(374,322), 28.0).
fillpoint(r5, xy(455,322), 28.0).
...
fillpoint(r5, xy(377,323), 27.0).
fillpoint(r5, xy(452,323), 27.0).
...
fillpoint(r5, xy(382,324), 26.0).
fillpoint(r5, xy(448,324), 26.0).
...
midline(r22, [xy(418,635),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(554,606),xy(555,611),xy(555,632),xy(549,635),xy(419,634)]).
midline(r22, [xy(555,606),xy(560,604),xy(579,604),xy(585,606),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r22, [xy(586,605),xy(613,605),xy(615,609),xy(615,629),xy(614,633),xy(609,635),xy(590,635),xy(585,633)]).
midline(r22, [xy(615,606),xy(622,604),xy(635,605)]).
...
midline(r19, [xy(99,553),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,550),xy(20,575),xy(23,580),xy(19,591),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(58,582),xy(48,579),xy(24,579)]).
midline(r19, [xy(99,554),xy(100,608),xy(98,617),xy(89,620),xy(70,620),xy(60,617)]).
...
region(r24, '#5a5a5a', 6400, centroid(390,620)).
perimeter(r24, 680).
polygon(r24, [xy(549,630),xy(230,630),xy(230,610),xy(549,610),xy(549,630)]).
midline(r24, [xy(404,619),xy(239,620)]).
midline(r24, [xy(405,620),xy(540,620)]).
fillpoint(r24, xy(239,620), 10.0).
...
midline(r16, [xy(589,542),xy(590,532),xy(588,525),xy(565,523),xy(565,505),xy(563,500),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(565,500),xy(579,499),xy(588,501),xy(590,510),xy(589,524)]).
...
midline(r20, [xy(52,559),xy(78,561),xy(80,600)]).
...
region(r23, '#2ecc40', 2000, centroid(180,620)).
perimeter(r23, 240).
polygon(r23, [xy(229,630),xy(130,630),xy(130,610),xy(229,610),xy(229,630)]).
midline(r23, [xy(151,620),xy(139,620)]).
midline(r23, [xy(152,620),xy(220,620)]).
fillpoint(r23, xy(139,620), 10.0).
region(r10, '#870c25', 1500, centroid(414,284)).
perimeter(r10, 160).
polygon(r10, [xy(439,300),xy(390,300),xy(390,270),xy(439,270),xy(439,300)]).
midline(r10, [xy(416,284),xy(404,285)]).
midline(r10, [xy(417,284),xy(425,285)]).
fillpoint(r10, xy(404,285), 15.0).
region(r9, '#bebebe', 1000, centroid(414,260)).
perimeter(r9, 140).
polygon(r9, [xy(439,270),xy(390,270),xy(390,250),xy(439,250),xy(439,270)]).
midline(r9, [xy(420,260),xy(399,260)]).
midline(r9, [xy(421,259),xy(430,260)]).
fillpoint(r9, xy(399,260), 10.0).
...
adjacent(r22, r23).
shared_edge(r22, r23, 220).
adjacent(r22, r24).
shared_edge(r22, r24, 660).
adjacent(r22, r25).
