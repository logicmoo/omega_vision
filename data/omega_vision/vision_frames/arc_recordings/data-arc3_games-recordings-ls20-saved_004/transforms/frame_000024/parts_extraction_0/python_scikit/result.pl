...
midline(r2, [xy(164,215),xy(164,150),xy(169,129),xy(191,124),xy(265,125)]).
midline(r2, [xy(164,216),xy(164,347),xy(169,370),xy(181,374),xy(203,376),xy(214,382),xy(231,375),xy(265,375)]).
midline(r2, [xy(215,383),xy(214,508),xy(207,527),xy(189,550),xy(160,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,627),xy(5,634),xy(10,635),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(191,550),xy(207,564),xy(231,574),xy(389,575),xy(403,573),xy(422,564),xy(454,535),xy(455,464),xy(465,425),xy(430,391),xy(409,378),xy(385,374),xy(364,375)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,99),xy(59,51),xy(61,38),xy(66,26),xy(80,24),xy(386,24),xy(403,26),xy(414,32),xy(426,26),xy(441,24),xy(519,25),xy(540,19),xy(589,19),xy(613,26),xy(615,42),xy(614,455),xy(622,467),xy(625,481),xy(624,576),xy(621,582),xy(608,585),xy(513,584),xy(497,576),xy(455,535)]).
midline(r2, [xy(415,33),xy(415,99),xy(409,123),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(466,429),xy(494,440),xy(494,442)]).
...
midline(r5, [xy(267,227),xy(301,237),xy(315,221),xy(315,83),xy(313,80),xy(289,74),xy(141,74),xy(126,76),xy(118,80),xy(114,101),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(302,238),xy(315,274),xy(315,422),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,489),xy(274,513),xy(285,518),xy(327,520),xy(344,518),xy(355,513),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(316,275),xy(350,292),xy(376,299),xy(539,299),xy(556,320),xy(564,341),xy(565,463),xy(545,483),xy(525,485),xy(525,564),xy(592,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(540,298),xy(556,279),xy(563,263),xy(565,248),xy(565,200),xy(563,186),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,122),xy(471,105),xy(479,89)]).
...
fillpoint(r5, xy(301,237), 88.4).
fillpoint(r5, xy(303,241), 87.0).
fillpoint(r5, xy(307,252), 83.1).
fillpoint(r5, xy(308,255), 82.2).
fillpoint(r5, xy(309,258), 81.5).
fillpoint(r5, xy(280,230), 81.0).
fillpoint(r5, xy(310,261), 80.9).
fillpoint(r5, xy(311,264), 80.4).
fillpoint(r5, xy(276,229), 80.0).
fillpoint(r5, xy(312,267), 80.0).
fillpoint(r5, xy(313,270), 79.8).
fillpoint(r5, xy(314,273), 79.7).
fillpoint(r5, xy(272,228), 79.0).
fillpoint(r5, xy(268,227), 78.0).
...
midline(r22, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(525,635)]).
midline(r22, [xy(556,605),xy(583,605),xy(585,609),xy(585,630),xy(583,634),xy(578,635),xy(555,633)]).
midline(r22, [xy(585,606),xy(590,604),xy(608,604),xy(613,605),xy(615,609),xy(615,630),xy(613,634),xy(590,635),xy(585,633)]).
midline(r22, [xy(615,606),xy(620,604),xy(635,605)]).
...
border(r22).
region(r23, '#5a5a5a', 8400, centroid(340,620)).
perimeter(r23, 880).
polygon(r23, [xy(549,630),xy(130,630),xy(130,610),xy(549,610),xy(549,630)]).
midline(r23, [xy(304,619),xy(139,620)]).
midline(r23, [xy(305,619),xy(540,620)]).
...
midline(r19, [xy(99,553),xy(99,544),xy(95,540),xy(35,539),xy(21,541),xy(19,553),xy(19,569),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(58,582),xy(49,579),xy(24,579)]).
midline(r19, [xy(100,554),xy(100,606),xy(98,617),xy(89,620),xy(70,620),xy(60,617)]).
...
midline(r16, [xy(589,542),xy(590,530),xy(588,525),xy(565,523),xy(565,502),xy(563,500),xy(550,499),xy(541,501),xy(539,514),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(565,500),xy(577,499),xy(588,501),xy(590,512),xy(589,524)]).
...
midline(r20, [xy(80,587),xy(80,570),xy(77,561),xy(68,559),xy(39,560)]).
...
region(r10, '#870c25', 1500, centroid(214,334)).
perimeter(r10, 160).
polygon(r10, [xy(239,350),xy(190,350),xy(190,320),xy(239,320),xy(239,350)]).
midline(r10, [xy(216,334),xy(204,335)]).
midline(r10, [xy(217,334),xy(225,335)]).
fillpoint(r10, xy(204,335), 15.0).
region(r9, '#bebebe', 1000, centroid(214,310)).
perimeter(r9, 140).
polygon(r9, [xy(239,320),xy(190,320),xy(190,300),xy(239,300),xy(239,320)]).
midline(r9, [xy(210,309),xy(199,310)]).
midline(r9, [xy(211,309),xy(230,310)]).
fillpoint(r9, xy(199,310), 10.0).
...
adjacent(r22, r23).
shared_edge(r22, r23, 880).
adjacent(r22, r24).
shared_edge(r22, r24, 80).
adjacent(r22, r25).
shared_edge(r22, r25, 80).
adjacent(r22, r26).
shared_edge(r22, r26, 60).
