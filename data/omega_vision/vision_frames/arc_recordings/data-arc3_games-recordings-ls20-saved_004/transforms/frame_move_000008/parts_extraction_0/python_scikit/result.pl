...
midline(r2, [xy(164,215),xy(164,150),xy(169,129),xy(176,126),xy(193,124),xy(265,125)]).
midline(r2, [xy(165,216),xy(164,348),xy(166,363),xy(170,371),xy(203,376),xy(215,381),xy(215,499),xy(213,513),xy(207,527),xy(188,550),xy(160,550),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(10,524),xy(5,525),xy(4,531),xy(4,628),xy(5,634),xy(10,635),xy(113,634),xy(115,628),xy(114,602),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,120),xy(60,107),xy(59,50),xy(66,26),xy(80,24),xy(389,24),xy(403,26),xy(415,31),xy(415,98),xy(412,116),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,197),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(440,24),xy(519,25),xy(540,19),xy(587,19),xy(601,21),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,480),xy(624,576),xy(621,582),xy(608,585),xy(521,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(465,425),xy(429,390),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,428),xy(470,431),xy(474,430),xy(475,433),xy(477,432),xy(484,437),xy(487,436),xy(488,439),xy(489,437)]).
midline(r2, [xy(490,440),xy(491,439)]).
midline(r2, [xy(454,535),xy(419,566),xy(403,573),xy(388,575),xy(231,574),xy(210,566),xy(190,549)]).
...
midline(r5, [xy(203,74),xy(289,74),xy(309,78),xy(313,86),xy(315,100),xy(315,173),xy(304,193),xy(280,226),xy(279,232),xy(270,240),xy(250,250),xy(196,304),xy(194,316),xy(195,344),xy(226,345),xy(235,343),xy(278,301),xy(287,288),xy(307,268),xy(276,236)]).
midline(r5, [xy(261,245),xy(260,246)]).
midline(r5, [xy(282,226),xy(283,225)]).
midline(r5, [xy(250,252),xy(248,254)]).
midline(r5, [xy(316,174),xy(331,167),xy(346,155),xy(384,155),xy(385,189),xy(379,200),xy(341,238),xy(328,247),xy(308,267),xy(315,275),xy(315,422),xy(313,425),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(303,520),xy(339,519),xy(353,515),xy(358,504),xy(360,462),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(316,275),xy(350,292),xy(376,299),xy(539,299),xy(554,317),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(540,298),xy(556,279),xy(563,263),xy(565,249),xy(565,200),xy(563,186),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,122),xy(471,105),xy(479,89)]).
...
midline(r24, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(549,604),xy(555,606),xy(555,632),xy(548,635),xy(525,634)]).
midline(r24, [xy(556,605),xy(578,604),xy(584,607),xy(590,604),xy(613,605),xy(615,610),xy(615,632),xy(609,635),xy(585,633),xy(561,635),xy(555,633)]).
...
midline(r26, [xy(450,620),xy(299,620)]).
midline(r26, [xy(451,620),xy(540,620)]).
...
midline(r20, [xy(589,542),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,511),xy(539,539),xy(541,548),xy(550,550),xy(578,550),xy(587,548),xy(589,543)]).
...
midline(r25, [xy(184,620),xy(139,620)]).
midline(r25, [xy(185,619),xy(280,620)]).
...
midline(r7, [xy(366,84),xy(354,85)]).
midline(r7, [xy(367,85),xy(375,85)]).
...
midline(r6, [xy(370,60),xy(349,60)]).
midline(r6, [xy(371,60),xy(380,60)]).
...
midline(r11, [xy(355,177),xy(355,165),xy(374,165),xy(374,183),xy(360,185),xy(355,183),xy(354,178)]).
...
midline(r13, [xy(224,332),xy(225,320),xy(223,315),xy(205,315),xy(204,320),xy(205,334),xy(224,334)]).
...
midline(r21, [xy(554,522),xy(555,534),xy(575,535)]).
