...
midline(r2, [xy(164,215),xy(164,346),xy(168,369),xy(180,374),xy(203,376),xy(214,382),xy(230,375),xy(265,375)]).
midline(r2, [xy(165,214),xy(164,150),xy(166,136),xy(170,128),xy(192,124),xy(265,125)]).
midline(r2, [xy(215,383),xy(214,509),xy(204,532),xy(189,550),xy(159,549),xy(139,529),xy(122,517),xy(107,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,628),xy(5,634),xy(11,635),xy(113,634),xy(115,629),xy(114,602),xy(116,594),xy(159,550)]).
midline(r2, [xy(191,550),xy(210,566),xy(230,574),xy(387,575),xy(403,573),xy(419,566),xy(454,535),xy(455,464),xy(465,425),xy(430,391),xy(411,379),xy(388,374),xy(364,375)]).
midline(r2, [xy(466,426),xy(468,430),xy(470,429),xy(468,427)]).
midline(r2, [xy(470,431),xy(471,428)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,99),xy(59,51),xy(61,38),xy(66,26),xy(80,24),xy(388,24),xy(403,26),xy(415,31),xy(415,98),xy(412,116),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(416,213),xy(420,221),xy(440,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(430,25),xy(441,24),xy(518,24),xy(520,26)]).
midline(r2, [xy(521,24),xy(532,20),xy(545,19),xy(589,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(624,576),xy(621,582),xy(607,585),xy(513,584),xy(497,576),xy(455,535)]).
midline(r2, [xy(473,428),xy(476,433),xy(481,432),xy(480,434)]).
midline(r2, [xy(488,438),xy(483,434),xy(484,437)]).
midline(r2, [xy(489,438),xy(492,441),xy(494,439),xy(495,442),xy(496,440)]).
midline(r2, [xy(498,442),xy(503,447)]).
...
midline(r5, [xy(202,75),xy(114,75)]).
midline(r5, [xy(203,74),xy(289,74),xy(303,76),xy(315,81),xy(315,175),xy(279,228),xy(276,236),xy(240,259),xy(196,304),xy(194,310),xy(195,344),xy(226,345),xy(235,343),xy(279,300),xy(287,288),xy(307,268),xy(277,237)]).
midline(r5, [xy(316,174),xy(319,172),xy(318,175)]).
midline(r5, [xy(316,80),xy(331,75),xy(365,75)]).
midline(r5, [xy(321,172),xy(346,155),xy(384,155),xy(385,187),xy(380,199),xy(338,241),xy(327,248),xy(308,267),xy(315,275),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(300,520),xy(339,519),xy(353,515),xy(358,504),xy(360,462),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(316,275),xy(350,292),xy(376,299),xy(539,299),xy(557,322),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(540,298),xy(556,279),xy(563,263),xy(565,249),xy(565,200),xy(563,186),xy(551,163),xy(529,169),xy(511,170),xy(495,168),xy(477,159),xy(471,144),xy(469,122),xy(471,105),xy(479,89)]).
...
region(r11, '#2ecc40', 22500, centroid(126,352)).
perimeter(r11, 900).
polygon(r11, [xy(189,500),xy(90,499),xy(90,150),xy(140,150),xy(140,399),xy(190,400),xy(189,500)]).
midline(r11, [xy(115,408),xy(115,174)]).
midline(r11, [xy(115,409),xy(125,432),xy(140,450)]).
fillpoint(r11, xy(139,450), 50.0).
fillpoint(r11, xy(118,418), 29.0).
fillpoint(r11, xy(117,415), 28.0).
fillpoint(r11, xy(116,412), 27.0).
fillpoint(r11, xy(115,408), 26.0).
fillpoint(r11, xy(115,286), 25.0).
...
midline(r25, [xy(169,605),xy(125,605),xy(125,634),xy(131,635),xy(553,634),xy(555,631),xy(555,607),xy(548,604),xy(170,604)]).
midline(r25, [xy(555,606),xy(560,604),xy(579,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r25, [xy(585,606),xy(591,604),xy(613,605),xy(615,614),xy(615,631),xy(613,634),xy(591,635),xy(585,633)]).
...
region(r27, '#5a5a5a', 5600, centroid(410,620)).
perimeter(r27, 600).
polygon(r27, [xy(549,630),xy(270,630),xy(270,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(485,620),xy(279,620)]).
midline(r27, [xy(486,620),xy(540,620)]).
fillpoint(r27, xy(279,620), 10.0).
...
midline(r21, [xy(589,542),xy(590,530),xy(588,525),xy(565,523),xy(565,504),xy(563,500),xy(550,499),xy(541,501),xy(539,510),xy(541,548),xy(576,550),xy(587,548),xy(589,543)]).
midline(r21, [xy(565,500),xy(588,501),xy(590,512),xy(589,524)]).
...
region(r26, '#2ecc40', 2800, centroid(200,620)).
perimeter(r26, 320).
polygon(r26, [xy(269,630),xy(130,630),xy(130,610),xy(269,610),xy(269,630)]).
midline(r26, [xy(141,619),xy(139,620)]).
midline(r26, [xy(142,620),xy(260,620)]).
fillpoint(r26, xy(139,620), 10.0).
region(r8, '#870c25', 1500, centroid(114,134)).
perimeter(r8, 160).
polygon(r8, [xy(139,150),xy(90,150),xy(90,120),xy(139,120),xy(139,150)]).
midline(r8, [xy(116,134),xy(104,135)]).
midline(r8, [xy(117,135),xy(125,135)]).
fillpoint(r8, xy(104,135), 15.0).
region(r6, '#bebebe', 1000, centroid(114,110)).
perimeter(r6, 140).
polygon(r6, [xy(139,120),xy(90,120),xy(90,100),xy(139,100),xy(139,120)]).
midline(r6, [xy(112,109),xy(99,110)]).
midline(r6, [xy(113,109),xy(130,110)]).
fillpoint(r6, xy(99,110), 10.0).
...
midline(r12, [xy(374,182),xy(375,170),xy(373,165),xy(355,165),xy(354,173),xy(355,184),xy(374,184)]).
...
midline(r14, [xy(219,314),xy(205,315),xy(205,334),xy(218,335),xy(224,333),xy(225,320),xy(224,316),xy(220,315)]).
...
midline(r22, [xy(566,535),xy(575,535)]).
...
adjacent(r2, r5).
shared_edge(r2, r5, 3470).
adjacent(r2, r6).
shared_edge(r2, r6, 40).
adjacent(r2, r8).
shared_edge(r2, r8, 60).
adjacent(r2, r11).
shared_edge(r2, r11, 850).
adjacent(r2, r24).
...
adjacent(r25, r26).
shared_edge(r25, r26, 300).
adjacent(r25, r27).
shared_edge(r25, r27, 580).
adjacent(r25, r28).
