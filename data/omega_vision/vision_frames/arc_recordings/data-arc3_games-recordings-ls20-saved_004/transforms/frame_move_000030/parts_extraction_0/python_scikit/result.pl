...
midline(r2, [xy(466,423),xy(465,425),xy(425,387),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(165,180),xy(164,152),xy(165,140),xy(169,129),xy(191,124),xy(265,125)]).
midline(r2, [xy(165,181),xy(164,349),xy(169,370),xy(181,374),xy(203,376),xy(214,382),xy(230,375),xy(265,375)]).
midline(r2, [xy(215,383),xy(214,508),xy(206,529),xy(188,550),xy(160,550),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,628),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,602),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,120),xy(59,98),xy(59,50),xy(66,26),xy(80,24),xy(388,24),xy(403,26),xy(413,30),xy(415,34),xy(415,96),xy(412,116),xy(407,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(440,24),xy(519,24),xy(519,26)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,198),xy(419,220),xy(430,224),xy(443,225),xy(515,225)]).
midline(r2, [xy(521,24),xy(540,19),xy(588,19),xy(601,21),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,482),xy(624,576),xy(621,582),xy(609,585),xy(520,585),xy(507,582),xy(490,570),xy(454,534),xy(455,464),xy(465,427),xy(467,425),xy(467,429),xy(469,427),xy(473,430),xy(468,430)]).
midline(r2, [xy(473,432),xy(475,430),xy(476,433),xy(480,434),xy(477,430)]).
midline(r2, [xy(454,535),xy(419,566),xy(403,573),xy(389,575),xy(231,574),xy(207,564),xy(190,549)]).
midline(r2, [xy(481,431),xy(483,433),xy(481,435),xy(484,436),xy(484,434)]).
midline(r2, [xy(486,436),xy(485,437)]).
...
midline(r5, [xy(449,324),xy(442,325),xy(423,322),xy(404,312),xy(390,299),xy(362,296),xy(315,276),xy(289,250)]).
midline(r5, [xy(450,324),xy(489,325),xy(503,323),xy(519,316),xy(539,299),xy(554,317),xy(563,336),xy(565,350),xy(565,464),xy(545,483),xy(525,485),xy(525,564),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(290,248),xy(315,220),xy(315,82),xy(313,80),xy(289,74),xy(141,74),xy(119,79),xy(114,100),xy(114,397),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(316,220),xy(323,214),xy(322,217)]).
midline(r5, [xy(315,277),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,461),xy(270,499),xy(276,515),xy(300,520),xy(329,520),xy(353,515),xy(358,504),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(540,298),xy(554,282),xy(564,259),xy(565,202),xy(563,186),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,122),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,125),xy(558,105),xy(552,90),xy(534,81),xy(517,79),xy(495,81),xy(480,87)]).
...
fillpoint(r5, xy(421,321), 29.0).
fillpoint(r5, xy(508,321), 29.0).
...
fillpoint(r5, xy(424,322), 28.0).
fillpoint(r5, xy(505,322), 28.0).
...
fillpoint(r5, xy(427,323), 27.0).
fillpoint(r5, xy(502,323), 27.0).
...
fillpoint(r5, xy(432,324), 26.0).
fillpoint(r5, xy(498,324), 26.0).
...
midline(r22, [xy(312,635),xy(126,634),xy(124,629),xy(124,611),xy(125,605),xy(131,604),xy(553,605),xy(555,606),xy(555,628),xy(554,633),xy(549,635),xy(313,635)]).
midline(r22, [xy(556,605),xy(579,604),xy(585,606),xy(585,632),xy(579,635),xy(555,633)]).
midline(r22, [xy(586,605),xy(604,604),xy(613,605),xy(614,607),xy(621,604),xy(635,605)]).
midline(r22, [xy(615,608),xy(615,632),xy(613,634),xy(593,635),xy(585,633)]).
...
midline(r19, [xy(99,553),xy(98,542),xy(89,539),xy(30,539),xy(21,541),xy(19,554),xy(20,575),xy(23,580),xy(19,590),xy(21,618),xy(31,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(49,579),xy(24,579)]).
midline(r19, [xy(100,554),xy(100,609),xy(98,617),xy(88,620),xy(72,620),xy(60,617)]).
...
region(r24, '#5a5a5a', 6000, centroid(400,620)).
perimeter(r24, 640).
polygon(r24, [xy(549,630),xy(250,630),xy(250,610),xy(549,610),xy(549,630)]).
midline(r24, [xy(424,619),xy(259,620)]).
midline(r24, [xy(425,619),xy(540,620)]).
fillpoint(r24, xy(259,620), 10.0).
...
midline(r16, [xy(589,542),xy(590,531),xy(588,524),xy(571,525),xy(565,523),xy(565,505),xy(563,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(565,500),xy(579,499),xy(588,501),xy(589,523)]).
...
region(r23, '#2ecc40', 2400, centroid(190,620)).
perimeter(r23, 280).
polygon(r23, [xy(249,630),xy(130,630),xy(130,610),xy(249,610),xy(249,630)]).
midline(r23, [xy(151,620),xy(139,620)]).
midline(r23, [xy(152,619),xy(240,620)]).
...
midline(r20, [xy(80,587),xy(80,600)]).
midline(r20, [xy(80,586),xy(80,570),xy(77,561),xy(66,559),xy(39,560)]).
...
region(r10, '#870c25', 1500, centroid(464,284)).
perimeter(r10, 160).
polygon(r10, [xy(489,300),xy(440,300),xy(440,270),xy(489,270),xy(489,300)]).
midline(r10, [xy(466,284),xy(454,285)]).
midline(r10, [xy(467,285),xy(475,285)]).
fillpoint(r10, xy(454,285), 15.0).
region(r9, '#bebebe', 1000, centroid(464,260)).
perimeter(r9, 140).
polygon(r9, [xy(489,270),xy(440,270),xy(440,250),xy(489,250),xy(489,270)]).
midline(r9, [xy(459,260),xy(449,260)]).
midline(r9, [xy(460,260),xy(480,260)]).
fillpoint(r9, xy(449,260), 10.0).
region(r3, '#0074d9', 500, centroid(564,44)).
perimeter(r3, 120).
polygon(r3, [xy(589,50),xy(540,50),xy(540,40),xy(589,40),xy(589,50)]).
midline(r3, [xy(569,45),xy(544,45)]).
midline(r3, [xy(570,45),xy(585,45)]).
...
midline(r17, [xy(566,535),xy(575,535)]).
...
adjacent(r22, r23).
shared_edge(r22, r23, 260).
adjacent(r22, r24).
shared_edge(r22, r24, 620).
adjacent(r22, r25).
