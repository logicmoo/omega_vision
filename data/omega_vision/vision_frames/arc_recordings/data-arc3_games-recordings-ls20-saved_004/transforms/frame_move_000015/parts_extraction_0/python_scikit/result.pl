...
midline(r2, [xy(164,215),xy(164,151),xy(169,129),xy(191,124),xy(265,125)]).
midline(r2, [xy(164,216),xy(164,349),xy(166,363),xy(170,371),xy(180,374),xy(199,375),xy(215,381),xy(215,498),xy(213,513),xy(206,529),xy(188,550),xy(161,550),xy(132,523),xy(122,517),xy(108,514),xy(83,514),xy(65,504),xy(43,524),xy(10,524),xy(5,525),xy(4,531),xy(4,629),xy(5,634),xy(12,635),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,98),xy(59,51),xy(61,38),xy(66,26),xy(81,24),xy(389,24),xy(403,26),xy(415,31),xy(415,97),xy(411,119),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(416,213),xy(420,221),xy(440,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(430,25),xy(444,24),xy(519,25),xy(541,19),xy(597,20),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,481),xy(624,576),xy(621,582),xy(609,585),xy(521,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(520,26),xy(519,29),xy(521,31),xy(521,28)]).
midline(r2, [xy(523,31),xy(522,32)]).
midline(r2, [xy(66,121),xy(68,119)]).
midline(r2, [xy(454,535),xy(419,566),xy(403,573),xy(389,575),xy(231,574),xy(210,566),xy(190,550)]).
...
midline(r5, [xy(202,75),xy(131,75),xy(119,79),xy(115,90),xy(114,398),xy(119,421),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,75),xy(289,74),xy(303,76),xy(315,81),xy(315,220),xy(308,227),xy(278,238),xy(275,235),xy(272,239),xy(270,238),xy(257,248),xy(254,248),xy(238,261),xy(202,297),xy(196,304),xy(194,311),xy(195,344),xy(229,345),xy(235,343),xy(284,294),xy(278,239)]).
midline(r5, [xy(285,295),xy(304,317),xy(314,340),xy(315,423),xy(274,436),xy(269,461),xy(271,504),xy(276,515),xy(290,519),xy(339,519),xy(355,513),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(312,226),xy(360,266),xy(380,274),xy(409,278),xy(425,287),xy(439,300),xy(539,299),xy(556,320),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(524,558),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(316,80),xy(331,75),xy(365,75)]).
midline(r5, [xy(540,298),xy(556,279),xy(564,259),xy(565,202),xy(563,186),xy(550,162),xy(534,168),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(558,105),xy(560,125),xy(558,144),xy(551,161)]).
fillpoint(r5, xy(278,237), 87.9).
fillpoint(r5, xy(281,236), 87.0).
fillpoint(r5, xy(292,232), 83.1).
fillpoint(r5, xy(295,231), 82.2).
fillpoint(r5, xy(298,230), 81.5).
fillpoint(r5, xy(301,229), 80.9).
fillpoint(r5, xy(304,228), 80.4).
fillpoint(r5, xy(307,227), 80.0).
fillpoint(r5, xy(310,226), 79.8).
...
fillpoint(r5, xy(371,271), 29.0).
fillpoint(r5, xy(408,278), 29.0).
fillpoint(r5, xy(311,331), 29.0).
...
fillpoint(r5, xy(374,272), 28.0).
fillpoint(r5, xy(405,277), 28.0).
fillpoint(r5, xy(312,334), 28.0).
...
fillpoint(r5, xy(377,273), 27.0).
fillpoint(r5, xy(402,276), 27.0).
fillpoint(r5, xy(313,337), 27.0).
...
fillpoint(r5, xy(382,274), 26.0).
fillpoint(r5, xy(398,275), 26.0).
fillpoint(r5, xy(314,342), 26.0).
...
midline(r22, [xy(377,634),xy(132,635),xy(126,634),xy(124,627),xy(125,605),xy(130,604),xy(547,604),xy(555,606),xy(555,632),xy(549,635),xy(378,634)]).
midline(r22, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(577,635),xy(560,635),xy(555,633)]).
midline(r22, [xy(585,606),xy(590,604),xy(609,604),xy(615,606),xy(615,631),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r18, [xy(589,542),xy(590,530),xy(587,524),xy(571,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,512),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r18, [xy(566,500),xy(578,499),xy(588,501),xy(590,511),xy(589,524)]).
...
region(r12, '#870c25', 1500, centroid(364,334)).
perimeter(r12, 160).
polygon(r12, [xy(389,350),xy(340,350),xy(340,320),xy(389,320),xy(389,350)]).
midline(r12, [xy(360,335),xy(354,335)]).
midline(r12, [xy(361,334),xy(375,335)]).
fillpoint(r12, xy(354,335), 15.0).
region(r23, '#2ecc40', 1200, centroid(160,620)).
perimeter(r23, 160).
polygon(r23, [xy(189,630),xy(130,630),xy(130,610),xy(189,610),xy(189,630)]).
midline(r23, [xy(149,620),xy(139,620)]).
midline(r23, [xy(150,619),xy(180,620)]).
fillpoint(r23, xy(139,620), 10.0).
region(r9, '#bebebe', 1000, centroid(364,310)).
perimeter(r9, 140).
polygon(r9, [xy(389,320),xy(340,320),xy(340,300),xy(389,300),xy(389,320)]).
midline(r9, [xy(359,310),xy(349,310)]).
midline(r9, [xy(360,310),xy(380,310)]).
fillpoint(r9, xy(349,310), 10.0).
...
midline(r3, [xy(581,45),xy(585,45)]).
...
midline(r19, [xy(555,521),xy(555,534),xy(575,535)]).
midline(r19, [xy(555,520),xy(555,514)]).
