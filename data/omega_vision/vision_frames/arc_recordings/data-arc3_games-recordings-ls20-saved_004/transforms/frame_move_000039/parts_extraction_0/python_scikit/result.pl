...
midline(r2, [xy(164,215),xy(164,152),xy(165,140),xy(170,128),xy(191,124),xy(265,125)]).
midline(r2, [xy(165,216),xy(164,349),xy(166,363),xy(170,371),xy(199,375),xy(215,381),xy(215,495),xy(214,509),xy(207,527),xy(188,550),xy(161,550),xy(132,523),xy(122,517),xy(107,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,532),xy(4,628),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,120),xy(59,98),xy(59,52),xy(61,38),xy(66,26),xy(81,24),xy(388,24),xy(403,26),xy(413,30),xy(415,35),xy(415,96),xy(412,116),xy(407,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(440,24),xy(520,25),xy(528,21),xy(540,19),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(623,579),xy(619,583),xy(608,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(387,575),xy(230,574),xy(210,566),xy(190,550)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(416,213),xy(420,221),xy(440,225),xy(515,225)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(429,390),xy(409,378),xy(386,374),xy(364,375)]).
midline(r2, [xy(466,428),xy(469,428),xy(468,430)]).
midline(r2, [xy(471,430),xy(485,437),xy(487,436),xy(488,439),xy(496,441),xy(496,443)]).
midline(r2, [xy(498,443),xy(507,448)]).
...
midline(r5, [xy(589,484),xy(584,483),xy(564,464),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(605,490),xy(603,485),xy(590,485)]).
midline(r5, [xy(565,463),xy(564,340),xy(556,320),xy(539,300),xy(392,300),xy(370,298),xy(350,292),xy(315,275),xy(289,250)]).
midline(r5, [xy(539,299),xy(554,282),xy(564,259),xy(565,200),xy(563,186),xy(550,162),xy(534,168),xy(513,170),xy(495,168),xy(477,159),xy(471,144),xy(470,122),xy(465,109),xy(465,74)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(471,123),xy(489,112),xy(500,110),xy(504,106),xy(511,104),xy(523,105),xy(529,110),xy(540,112),xy(558,121),xy(560,125),xy(558,144),xy(551,161)]).
midline(r5, [xy(290,248),xy(315,219),xy(315,83),xy(313,80),xy(299,75),xy(288,74),xy(141,74),xy(126,76),xy(118,80),xy(114,100),xy(114,393),xy(115,408),xy(119,421),xy(127,435),xy(140,450)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(560,121),xy(565,99),xy(565,74)]).
midline(r5, [xy(314,276),xy(315,420),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,489),xy(274,513),xy(285,518),xy(326,520),xy(344,518),xy(355,513),xy(360,488),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
midline(r22, [xy(377,634),xy(130,635),xy(125,633),xy(124,612),xy(125,605),xy(131,604),xy(549,604),xy(554,606),xy(555,611),xy(555,630),xy(553,634),xy(549,635),xy(378,634)]).
midline(r22, [xy(555,606),xy(560,604),xy(576,604),xy(583,605),xy(585,609),xy(585,630),xy(583,634),xy(560,635),xy(555,633)]).
midline(r22, [xy(585,606),xy(595,604),xy(615,606),xy(615,632),xy(613,634),xy(591,635),xy(585,633)]).
...
border(r22).
region(r19, '#aaaaaa', 7600, centroid(61,578)).
perimeter(r19, 720).
polygon(r19, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r19, [xy(90,609),xy(89,590),xy(50,589),xy(49,550),xy(30,550),xy(30,610),xy(90,609)]).
hole(r19, [xy(90,569),xy(89,550),xy(70,550),xy(70,570),xy(90,569)]).
midline(r19, [xy(61,578),xy(59,542),xy(41,539),xy(21,541),xy(19,551),xy(19,608),xy(21,618),xy(30,620),xy(84,620),xy(98,617),xy(100,595),xy(97,580),xy(62,578)]).
midline(r19, [xy(61,542),xy(70,539),xy(98,541),xy(100,569),xy(97,578)]).
fillpoint(r19, xy(60,542), 12.8).
fillpoint(r19, xy(97,580), 12.8).
...
fillpoint(r19, xy(99,574), 11.0).
fillpoint(r19, xy(65,579), 11.0).
fillpoint(r19, xy(99,585), 11.0).
...
fillpoint(r19, xy(19,580), 10.0).
fillpoint(r19, xy(59,560), 10.0).
fillpoint(r19, xy(99,560), 10.0).
fillpoint(r19, xy(71,580), 10.0).
fillpoint(r19, xy(99,600), 10.0).
...
midline(r23, [xy(239,620),xy(139,620)]).
midline(r23, [xy(240,619),xy(420,620)]).
...
midline(r16, [xy(589,542),xy(590,530),xy(588,525),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,515),xy(541,548),xy(550,550),xy(578,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(566,500),xy(578,499),xy(588,501),xy(590,511),xy(589,524)]).
...
midline(r24, [xy(451,620),xy(439,620)]).
midline(r24, [xy(452,620),xy(540,620)]).
fillpoint(r24, xy(439,620), 10.0).
region(r20, '#870c25', 2000, centroid(52,588)).
perimeter(r20, 240).
polygon(r20, [xy(89,610),xy(30,609),xy(30,550),xy(50,550),xy(50,590),xy(90,590),xy(89,610)]).
midline(r20, [xy(39,586),xy(41,598),xy(80,600)]).
midline(r20, [xy(40,585),xy(40,559)]).
fillpoint(r20, xy(41,598), 12.0).
fillpoint(r20, xy(40,594), 11.0).
fillpoint(r20, xy(45,599), 11.0).
fillpoint(r20, xy(39,574), 10.0).
fillpoint(r20, xy(51,600), 10.0).
region(r7, '#870c25', 1500, centroid(514,84)).
perimeter(r7, 160).
polygon(r7, [xy(539,100),xy(490,100),xy(490,70),xy(539,70),xy(539,100)]).
midline(r7, [xy(510,85),xy(504,85)]).
midline(r7, [xy(511,84),xy(525,85)]).
...
midline(r6, [xy(509,60),xy(499,60)]).
midline(r6, [xy(510,60),xy(530,60)]).
...
midline(r17, [xy(555,521),xy(555,534),xy(575,535)]).
midline(r17, [xy(555,520),xy(555,514)]).
fillpoint(r17, xy(555,534), 6.0).
fillpoint(r17, xy(555,521), 5.0).
fillpoint(r17, xy(561,535), 5.0).
region(r21, '#870c25', 400, centroid(80,560)).
perimeter(r21, 80).
...
adjacent(r22, r23).
shared_edge(r22, r23, 620).
adjacent(r22, r24).
shared_edge(r22, r24, 260).
adjacent(r22, r25).
