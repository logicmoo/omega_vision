...
midline(r2, [xy(164,215),xy(164,151),xy(166,136),xy(170,128),xy(192,124),xy(265,125)]).
midline(r2, [xy(165,216),xy(164,347),xy(166,363),xy(170,371),xy(203,376),xy(215,381),xy(215,499),xy(213,513),xy(206,529),xy(189,550),xy(163,550),xy(159,549),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(10,524),xy(5,525),xy(4,530),xy(4,627),xy(5,634),xy(11,635),xy(113,634),xy(116,594),xy(159,550)]).
midline(r2, [xy(191,550),xy(207,564),xy(231,574),xy(389,575),xy(403,573),xy(419,566),xy(454,535),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(411,379),xy(388,374),xy(364,375)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,97),xy(59,50),xy(66,26),xy(83,24),xy(387,24),xy(403,26),xy(413,30),xy(415,35),xy(415,98),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(440,24),xy(516,24),xy(519,26),xy(525,22),xy(540,19),xy(587,19),xy(601,21),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,480),xy(624,576),xy(621,582),xy(609,585),xy(513,584),xy(497,576),xy(455,535)]).
midline(r2, [xy(466,428),xy(475,433),xy(477,431),xy(478,434),xy(486,436),xy(486,438)]).
midline(r2, [xy(488,438),xy(492,439),xy(492,441)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(416,213),xy(420,221),xy(441,225),xy(515,225)]).
midline(r2, [xy(66,122),xy(68,120)]).
...
midline(r5, [xy(565,127),xy(564,90),xy(559,78),xy(539,74),xy(480,75),xy(468,80),xy(465,91),xy(464,147),xy(465,159),xy(470,171),xy(490,175),xy(558,174),xy(561,180),xy(565,202),xy(564,258),xy(557,277),xy(539,300),xy(376,299),xy(350,292),xy(317,276),xy(289,250)]).
midline(r5, [xy(540,301),xy(556,320),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(314,275),xy(315,423),xy(274,436),xy(270,450),xy(269,489),xy(274,513),xy(285,518),xy(329,520),xy(344,518),xy(355,513),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(290,248),xy(316,219),xy(314,215),xy(315,85),xy(313,80),xy(289,74),xy(140,74),xy(126,76),xy(118,80),xy(114,102),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(559,173),xy(564,159),xy(565,128)]).
...
midline(r19, [xy(524,635),xy(131,635),xy(125,633),xy(125,605),xy(549,604),xy(555,606),xy(555,632),xy(548,635),xy(525,634)]).
midline(r19, [xy(556,605),xy(579,604),xy(584,607),xy(591,604),xy(609,604),xy(615,606),xy(614,633),xy(591,635),xy(584,632),xy(585,608)]).
midline(r19, [xy(616,605),xy(635,605)]).
midline(r19, [xy(584,633),xy(577,635),xy(555,633)]).
...
midline(r16, [xy(19,563),xy(20,544),xy(24,540),xy(49,539),xy(59,543),xy(70,539),xy(95,540),xy(98,541),xy(100,552),xy(100,569),xy(96,580),xy(70,580),xy(62,578),xy(59,569),xy(60,544)]).
midline(r16, [xy(97,581),xy(100,590),xy(100,606),xy(97,618),xy(89,620),xy(24,619),xy(20,615),xy(19,608),xy(20,564)]).
...
midline(r20, [xy(305,620),xy(400,620)]).
...
midline(r13, [xy(589,542),xy(588,524),xy(570,525),xy(565,523),xy(565,502),xy(563,500),xy(551,499),xy(541,501),xy(539,512),xy(541,548),xy(578,550),xy(587,548),xy(589,543)]).
midline(r13, [xy(565,500),xy(579,499),xy(588,501),xy(590,511),xy(589,523)]).
...
midline(r21, [xy(431,620),xy(419,620)]).
midline(r21, [xy(432,620),xy(540,620)]).
...
midline(r17, [xy(56,599),xy(44,599),xy(40,595),xy(40,559)]).
midline(r17, [xy(57,600),xy(80,600)]).
...
midline(r6, [xy(510,109),xy(499,110)]).
midline(r6, [xy(511,109),xy(530,110)]).
