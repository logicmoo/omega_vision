...
midline(r2, [xy(164,215),xy(164,345),xy(166,363),xy(170,371),xy(199,375),xy(215,381),xy(215,499),xy(213,513),xy(207,527),xy(188,550),xy(160,550),xy(139,529),xy(122,517),xy(107,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,533),xy(4,629),xy(5,634),xy(13,635),xy(113,634),xy(116,594),xy(159,550)]).
midline(r2, [xy(165,214),xy(164,151),xy(169,129),xy(191,124),xy(265,125)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,99),xy(59,51),xy(61,38),xy(66,26),xy(83,24),xy(389,24),xy(403,26),xy(415,31),xy(415,99),xy(412,116),xy(408,124),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,198),xy(416,213),xy(420,221),xy(443,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(440,24),xy(518,24),xy(520,26)]).
midline(r2, [xy(521,24),xy(540,19),xy(587,19),xy(609,24),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,481),xy(625,567),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(409,571),xy(389,575),xy(231,574),xy(207,564),xy(190,549)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(409,378),xy(388,374),xy(364,375)]).
...
midline(r5, [xy(202,75),xy(131,75),xy(119,79),xy(116,86),xy(114,100),xy(115,375)]).
midline(r5, [xy(203,75),xy(289,74),xy(303,76),xy(315,81),xy(315,174),xy(288,217),xy(280,225),xy(281,228),xy(277,235),xy(243,256),xy(196,304),xy(194,311),xy(195,344),xy(229,345),xy(235,343),xy(278,301),xy(288,287),xy(307,268),xy(277,237)]).
midline(r5, [xy(282,226),xy(284,223)]).
midline(r5, [xy(316,80),xy(330,75),xy(365,75)]).
midline(r5, [xy(315,176),xy(319,172),xy(333,166),xy(346,155),xy(384,155),xy(385,161),xy(385,188),xy(383,195),xy(341,238),xy(327,248),xy(308,267),xy(315,277),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,461),xy(270,499),xy(276,515),xy(301,520),xy(339,519),xy(353,515),xy(358,504),xy(360,461),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(315,274),xy(353,293),xy(376,299),xy(391,300),xy(538,300),xy(549,289),xy(560,271),xy(564,258),xy(565,200),xy(561,180),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,127),xy(558,105),xy(552,90),xy(534,81),xy(514,79),xy(495,81),xy(480,87)]).
midline(r5, [xy(551,88),xy(550,89)]).
midline(r5, [xy(540,300),xy(557,322),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r25, [xy(137,634),xy(126,634),xy(124,629),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(138,635)]).
midline(r25, [xy(556,605),xy(578,604),xy(585,606),xy(585,632),xy(577,635),xy(555,633)]).
midline(r25, [xy(586,605),xy(613,605),xy(615,609),xy(615,631),xy(609,635),xy(590,635),xy(585,633)]).
midline(r25, [xy(615,606),xy(622,604),xy(635,605)]).
...
region(r27, '#5a5a5a', 8000, centroid(350,620)).
perimeter(r27, 840).
polygon(r27, [xy(549,630),xy(150,630),xy(150,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(376,620),xy(159,620)]).
midline(r27, [xy(377,619),xy(540,620)]).
fillpoint(r27, xy(159,620), 10.0).
region(r14, '#2ecc40', 7500, centroid(148,458)).
perimeter(r14, 400).
polygon(r14, [xy(189,500),xy(90,499),xy(90,450),xy(139,450),xy(140,400),xy(190,400),xy(189,500)]).
midline(r14, [xy(164,441),xy(164,459),xy(159,471),xy(138,475),xy(114,475)]).
midline(r14, [xy(165,440),xy(165,424)]).
fillpoint(r14, xy(160,470), 29.7).
fillpoint(r14, xy(161,468), 29.0).
fillpoint(r14, xy(158,471), 29.0).
fillpoint(r14, xy(162,465), 28.0).
fillpoint(r14, xy(155,472), 28.0).
fillpoint(r14, xy(163,462), 27.0).
fillpoint(r14, xy(152,473), 27.0).
fillpoint(r14, xy(164,458), 26.0).
fillpoint(r14, xy(148,474), 26.0).
fillpoint(r14, xy(165,436), 25.0).
fillpoint(r14, xy(114,475), 25.0).
...
midline(r21, [xy(589,542),xy(590,530),xy(588,524),xy(571,525),xy(565,523),xy(565,505),xy(563,500),xy(541,501),xy(539,512),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r21, [xy(565,500),xy(588,501),xy(590,511),xy(589,523)]).
...
region(r15, '#870c25', 1500, centroid(114,434)).
perimeter(r15, 160).
polygon(r15, [xy(139,450),xy(90,450),xy(90,420),xy(139,420),xy(139,450)]).
midline(r15, [xy(113,435),xy(104,435)]).
midline(r15, [xy(114,434),xy(125,435)]).
fillpoint(r15, xy(104,435), 15.0).
region(r13, '#bebebe', 1000, centroid(114,410)).
perimeter(r13, 140).
polygon(r13, [xy(139,420),xy(90,420),xy(90,400),xy(139,400),xy(139,420)]).
midline(r13, [xy(101,409),xy(99,410)]).
midline(r13, [xy(102,410),xy(130,410)]).
fillpoint(r13, xy(99,410), 10.0).
...
midline(r9, [xy(369,164),xy(355,165),xy(355,184),xy(366,185),xy(374,183),xy(374,166),xy(370,165)]).
...
midline(r11, [xy(219,314),xy(205,315),xy(205,334),xy(217,335),xy(224,333),xy(225,320),xy(224,316),xy(220,315)]).
...
midline(r4, [xy(85,64),xy(85,95)]).
midline(r4, [xy(85,63),xy(85,54)]).
...
region(r26, '#2ecc40', 400, centroid(140,620)).
perimeter(r26, 80).
polygon(r26, [xy(149,630),xy(130,629),xy(130,610),xy(150,610),xy(149,630)]).
midline(r26, [xy(139,619),xy(140,620)]).
...
adjacent(r2, r5).
shared_edge(r2, r5, 4070).
adjacent(r2, r13).
shared_edge(r2, r13, 20).
adjacent(r2, r14).
shared_edge(r2, r14, 300).
adjacent(r2, r15).
shared_edge(r2, r15, 30).
adjacent(r2, r24).
...
adjacent(r14, r15).
shared_edge(r14, r15, 80).
adjacent(r21, r22).
shared_edge(r21, r22, 120).
adjacent(r21, r23).
shared_edge(r21, r23, 40).
adjacent(r25, r26).
shared_edge(r25, r26, 60).
adjacent(r25, r27).
shared_edge(r25, r27, 820).
adjacent(r25, r28).
