...
midline(r2, [xy(64,277),xy(65,119),xy(61,111),xy(59,98),xy(59,52),xy(61,38),xy(66,26),xy(80,24),xy(389,24),xy(403,26),xy(415,31),xy(415,97),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(64,278),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,601),xy(116,594),xy(159,549),xy(139,529),xy(122,517),xy(106,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(416,213),xy(420,221),xy(443,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(440,24),xy(519,25),xy(541,19),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(623,579),xy(619,583),xy(608,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(386,575),xy(231,574),xy(210,566),xy(190,549),xy(160,550)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,428),xy(464,424),xy(429,390),xy(409,378),xy(387,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(478,432),xy(478,434)]).
midline(r2, [xy(480,434),xy(506,447),xy(506,449)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(165,359),xy(165,140),xy(169,129),xy(180,125),xy(265,125)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(119,79),xy(115,90),xy(114,396),xy(119,421),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,74),xy(289,74),xy(303,76),xy(315,81),xy(315,174),xy(264,224),xy(264,243),xy(238,261),xy(195,306),xy(195,344),xy(229,345),xy(240,339),xy(280,299),xy(289,286),xy(265,244)]).
midline(r5, [xy(316,175),xy(365,175)]).
midline(r5, [xy(316,80),xy(330,75),xy(365,75)]).
midline(r5, [xy(290,287),xy(315,300),xy(315,422),xy(313,425),xy(285,431),xy(274,436),xy(269,460),xy(270,499),xy(274,513),xy(290,519),xy(329,520),xy(344,518),xy(355,513),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(316,299),xy(537,300),xy(549,289),xy(556,279),xy(564,259),xy(565,200),xy(561,180),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
...
midline(r5, [xy(540,300),xy(554,317),xy(564,340),xy(565,461),xy(564,465),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r22, [xy(524,635),xy(130,635),xy(125,633),xy(124,624),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(554,633),xy(548,635),xy(525,635)]).
midline(r22, [xy(556,605),xy(579,604),xy(585,606),xy(585,630),xy(583,634),xy(576,635),xy(555,633)]).
midline(r22, [xy(586,605),xy(609,604),xy(615,606),xy(615,630),xy(613,634),xy(591,635),xy(585,633)]).
...
midline(r18, [xy(589,542),xy(590,531),xy(587,524),xy(570,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,513),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r18, [xy(566,500),xy(588,501),xy(590,510),xy(589,524)]).
...
midline(r10, [xy(360,235),xy(354,235)]).
midline(r10, [xy(361,234),xy(375,235)]).
...
midline(r9, [xy(360,209),xy(380,210)]).
...
midline(r4, [xy(85,79),xy(85,54)]).
midline(r4, [xy(84,80),xy(85,95)]).
