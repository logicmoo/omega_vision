...
midline(r2, [xy(508,25),xy(441,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(81,24),xy(66,26),xy(61,38),xy(59,51),xy(59,99),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(106,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(519,25),xy(540,19),xy(589,19),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,480),xy(625,566),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(406,572),xy(389,575),xy(231,574),xy(207,564),xy(190,549),xy(160,550)]).
midline(r2, [xy(66,121),xy(67,118),xy(69,120)]).
...
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(455,533),xy(455,464),xy(465,428),xy(464,424),xy(430,391),xy(411,379),xy(399,375),xy(364,375)]).
midline(r2, [xy(472,429),xy(466,423),xy(466,429),xy(470,429),xy(470,431)]).
midline(r2, [xy(473,428),xy(472,431),xy(475,430),xy(475,432)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(118,80),xy(115,91),xy(114,398),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,75),xy(287,74),xy(303,76),xy(315,81),xy(314,217),xy(316,219),xy(311,223),xy(267,203),xy(239,200)]).
midline(r5, [xy(312,224),xy(317,276),xy(279,309),xy(259,321),xy(239,325),xy(214,325)]).
midline(r5, [xy(315,280),xy(315,421),xy(313,425),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(300,520),xy(339,519),xy(353,515),xy(358,504),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(318,276),xy(350,292),xy(376,299),xy(539,299),xy(556,320),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(525,564),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(316,80),xy(330,75),xy(365,75)]).
midline(r5, [xy(540,298),xy(554,282),xy(564,259),xy(565,200),xy(563,186),xy(551,163),xy(529,169),xy(511,170),xy(495,168),xy(477,159),xy(471,144),xy(469,123),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,125),xy(558,105),xy(552,90),xy(534,81),xy(516,79),xy(495,81),xy(480,87)]).
midline(r5, [xy(551,88),xy(550,89)]).
fillpoint(r5, xy(312,224), 77.5).
fillpoint(r5, xy(317,276), 77.5).
fillpoint(r5, xy(313,228), 77.0).
fillpoint(r5, xy(316,272), 77.0).
fillpoint(r5, xy(314,236), 76.0).
fillpoint(r5, xy(315,264), 76.0).
fillpoint(r5, xy(278,207), 58.0).
fillpoint(r5, xy(351,292), 58.0).
fillpoint(r5, xy(266,203), 54.0).
fillpoint(r5, xy(363,296), 54.0).
fillpoint(r5, xy(262,202), 53.0).
fillpoint(r5, xy(367,297), 53.0).
fillpoint(r5, xy(258,201), 52.0).
fillpoint(r5, xy(372,298), 52.0).
fillpoint(r5, xy(251,200), 51.0).
...
midline(r22, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(554,633),xy(549,635),xy(525,635)]).
midline(r22, [xy(556,605),xy(583,605),xy(585,609),xy(585,629),xy(583,634),xy(578,635),xy(555,633)]).
midline(r22, [xy(585,606),xy(590,604),xy(609,604),xy(615,606),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
border(r22).
region(r24, '#5a5a5a', 8000, centroid(350,620)).
perimeter(r24, 840).
polygon(r24, [xy(549,630),xy(150,630),xy(150,610),xy(549,610),xy(549,630)]).
midline(r24, [xy(324,619),xy(159,620)]).
midline(r24, [xy(325,620),xy(540,620)]).
fillpoint(r24, xy(159,620), 10.0).
...
midline(r19, [xy(19,563),xy(21,541),xy(30,539),xy(89,539),xy(98,541),xy(100,550),xy(100,608),xy(99,615),xy(95,619),xy(70,620),xy(59,616),xy(49,620),xy(22,618),xy(19,609),xy(19,590),xy(23,579),xy(20,575),xy(19,564)]).
midline(r19, [xy(59,615),xy(60,590),xy(58,582),xy(49,579),xy(24,579)]).
...
midline(r16, [xy(589,542),xy(590,533),xy(588,525),xy(570,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,511),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(566,500),xy(579,499),xy(588,501),xy(590,511),xy(589,524)]).
...
midline(r20, [xy(63,559),xy(39,560)]).
midline(r20, [xy(64,559),xy(78,561),xy(80,600)]).
...
region(r10, '#870c25', 1500, centroid(214,284)).
perimeter(r10, 160).
polygon(r10, [xy(239,300),xy(190,300),xy(190,270),xy(239,270),xy(239,300)]).
midline(r10, [xy(216,284),xy(204,285)]).
midline(r10, [xy(217,285),xy(225,285)]).
fillpoint(r10, xy(204,285), 15.0).
region(r9, '#bebebe', 1000, centroid(214,260)).
perimeter(r9, 140).
polygon(r9, [xy(239,270),xy(190,270),xy(190,250),xy(239,250),xy(239,270)]).
midline(r9, [xy(210,259),xy(199,260)]).
midline(r9, [xy(211,259),xy(230,260)]).
fillpoint(r9, xy(199,260), 10.0).
...
midline(r17, [xy(555,524),xy(555,514)]).
midline(r17, [xy(554,525),xy(555,534),xy(575,535)]).
...
region(r23, '#2ecc40', 400, centroid(140,620)).
perimeter(r23, 80).
polygon(r23, [xy(149,630),xy(130,629),xy(130,610),xy(150,610),xy(149,630)]).
midline(r23, [xy(139,619),xy(140,620)]).
...
adjacent(r5, r9).
shared_edge(r5, r9, 70).
adjacent(r5, r10).
shared_edge(r5, r10, 80).
adjacent(r5, r16).
...
adjacent(r22, r23).
shared_edge(r22, r23, 60).
adjacent(r22, r24).
shared_edge(r22, r24, 820).
adjacent(r22, r25).
