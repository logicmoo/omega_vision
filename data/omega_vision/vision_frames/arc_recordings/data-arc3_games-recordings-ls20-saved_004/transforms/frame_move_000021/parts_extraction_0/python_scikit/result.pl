...
midline(r2, [xy(165,180),xy(164,151),xy(166,136),xy(170,128),xy(194,124),xy(265,125)]).
midline(r2, [xy(164,181),xy(164,349),xy(168,369),xy(180,374),xy(203,376),xy(214,382),xy(231,375),xy(265,375)]).
midline(r2, [xy(215,383),xy(214,509),xy(206,529),xy(189,549),xy(161,550),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,625),xy(5,634),xy(10,635),xy(113,634),xy(115,626),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,98),xy(59,58),xy(60,42),xy(66,26),xy(81,24),xy(386,24),xy(403,26),xy(415,31),xy(415,99),xy(411,119),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,198),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(426,26),xy(441,24),xy(520,25),xy(528,21),xy(540,19),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,480),xy(624,576),xy(621,582),xy(609,585),xy(523,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(465,425),xy(430,391),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(454,535),xy(419,566),xy(403,573),xy(386,575),xy(231,574),xy(212,567),xy(190,550)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(517,79),xy(534,81),xy(551,88),xy(559,110),xy(558,144),xy(550,163),xy(519,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(561,180),xy(564,190),xy(565,247),xy(561,269),xy(552,285),xy(539,300),xy(390,300),xy(366,297),xy(348,291),xy(318,274),xy(302,261),xy(295,243),xy(275,235),xy(272,239),xy(239,260),xy(196,304),xy(194,310),xy(194,339),xy(195,344),xy(200,345),xy(233,344),xy(239,340),xy(278,301),xy(293,282),xy(303,264)]).
midline(r5, [xy(540,301),xy(556,320),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(524,558),xy(525,564),xy(531,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(296,242),xy(315,219),xy(315,82),xy(313,80),xy(299,75),xy(286,74),xy(141,74),xy(126,76),xy(118,80),xy(114,100),xy(114,398),xy(119,421),xy(127,435),xy(140,450)]).
...
midline(r13, [xy(271,500),xy(269,460),xy(271,445),xy(276,434),xy(302,429),xy(344,431),xy(355,436),xy(360,461),xy(359,499),xy(353,515),xy(328,520),xy(290,519),xy(276,515),xy(271,501)]).
...
midline(r25, [xy(418,635),xy(135,635),xy(125,633),xy(125,605),xy(547,604),xy(555,606),xy(555,632),xy(553,634),xy(419,634)]).
midline(r25, [xy(556,605),xy(578,604),xy(585,606),xy(585,628),xy(583,634),xy(560,635),xy(555,633)]).
midline(r25, [xy(586,605),xy(608,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r25, [xy(615,608),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r22, [xy(19,563),xy(21,541),xy(30,539),xy(89,539),xy(98,541),xy(100,550),xy(100,609),xy(99,615),xy(95,619),xy(71,620),xy(59,616),xy(55,619),xy(47,620),xy(22,618),xy(19,608),xy(19,590),xy(23,579),xy(20,575),xy(19,564)]).
midline(r22, [xy(60,615),xy(60,590),xy(58,582),xy(48,579),xy(24,579)]).
...
midline(r27, [xy(470,620),xy(319,620)]).
midline(r27, [xy(471,620),xy(540,620)]).
...
midline(r19, [xy(589,542),xy(590,530),xy(587,524),xy(571,525),xy(565,523),xy(565,502),xy(563,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r19, [xy(565,500),xy(579,499),xy(588,501),xy(590,510),xy(589,524)]).
...
midline(r26, [xy(185,619),xy(300,620)]).
...
midline(r23, [xy(52,559),xy(78,561),xy(80,600)]).
...
midline(r12, [xy(310,385),xy(304,385)]).
midline(r12, [xy(311,385),xy(325,385)]).
...
midline(r11, [xy(311,360),xy(299,360)]).
midline(r11, [xy(312,359),xy(330,360)]).
...
midline(r9, [xy(219,314),xy(205,315),xy(205,334),xy(224,333),xy(224,316),xy(220,315)]).
