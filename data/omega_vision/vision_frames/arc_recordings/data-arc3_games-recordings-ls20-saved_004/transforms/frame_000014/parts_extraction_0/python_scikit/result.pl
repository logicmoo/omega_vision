...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(80,24),xy(66,26),xy(59,50),xy(59,96),xy(60,107),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,604),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(107,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(520,25),xy(532,20),xy(587,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,482),xy(625,568),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(388,575),xy(231,574),xy(207,564),xy(190,549),xy(160,549)]).
...
midline(r2, [xy(466,429),xy(471,429),xy(471,431)]).
midline(r2, [xy(473,431),xy(475,433)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(199,375),xy(180,374),xy(170,371),xy(166,363),xy(164,348),xy(165,141),xy(168,130),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(488,438),xy(478,432),xy(478,434)]).
midline(r2, [xy(489,437),xy(491,439)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(510,79),xy(534,81),xy(551,88),xy(559,110),xy(560,129),xy(558,144),xy(551,161),xy(547,164),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(560,178),xy(564,190),xy(565,249),xy(561,269),xy(549,289),xy(536,300),xy(440,300),xy(339,199),xy(317,200),xy(314,198),xy(315,82),xy(313,80),xy(289,74),xy(140,74),xy(120,78),xy(116,86),xy(114,100),xy(114,398),xy(119,421),xy(127,435),xy(140,450)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,341),xy(565,462),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(533,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(438,300),xy(419,316),xy(399,324),xy(316,325),xy(283,293),xy(278,271),xy(264,243),xy(239,260),xy(196,304),xy(194,312),xy(194,339),xy(195,344),xy(200,345),xy(229,345),xy(235,343),xy(283,294)]).
midline(r5, [xy(314,325),xy(315,422),xy(313,425),xy(285,431),xy(274,436),xy(269,460),xy(269,489),xy(274,513),xy(285,518),xy(328,520),xy(344,518),xy(355,513),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(265,242),xy(266,226),xy(314,200)]).
...
midline(r22, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(549,604),xy(554,607),xy(560,604),xy(579,604),xy(585,606),xy(584,633),xy(561,635),xy(554,632),xy(555,608)]).
midline(r22, [xy(525,635),xy(547,635),xy(554,633)]).
midline(r22, [xy(586,605),xy(609,604),xy(615,606),xy(615,630),xy(613,634),xy(608,635),xy(585,633)]).
...
midline(r24, [xy(345,619),xy(540,620)]).
...
midline(r18, [xy(589,542),xy(590,530),xy(588,524),xy(572,525),xy(565,523),xy(565,502),xy(563,500),xy(550,499),xy(541,501),xy(539,510),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r18, [xy(565,500),xy(579,499),xy(588,501),xy(589,523)]).
...
midline(r10, [xy(372,285),xy(354,285)]).
midline(r10, [xy(373,284),xy(375,285)]).
...
midline(r23, [xy(150,619),xy(160,620)]).
