...
midline(r2, [xy(112,25),xy(82,24),xy(66,26),xy(60,42),xy(59,99),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(13,635),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(108,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,24),xy(388,24),xy(411,29),xy(414,31),xy(415,43),xy(415,99),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(440,24),xy(520,25),xy(528,21),xy(542,19),xy(589,19),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,480),xy(625,568),xy(623,579),xy(619,583),xy(605,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(403,573),xy(387,575),xy(230,574),xy(210,566),xy(190,549),xy(160,549)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,196),xy(415,209),xy(420,221),xy(441,225),xy(515,225)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,509),xy(215,382),xy(199,375),xy(180,374),xy(170,371),xy(166,363),xy(164,349),xy(165,141),xy(169,129),xy(180,125),xy(265,125)]).
...
midline(r2, [xy(477,433),xy(480,433),xy(480,435)]).
midline(r2, [xy(482,435),xy(490,438),xy(490,440)]).
...
midline(r5, [xy(202,75),xy(131,75),xy(119,79),xy(115,90),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
midline(r5, [xy(203,74),xy(288,74),xy(303,76),xy(314,81),xy(315,219),xy(295,243),xy(275,235),xy(246,254),xy(199,300),xy(194,310),xy(195,344),xy(229,345),xy(239,340),xy(278,301),xy(287,288),xy(307,268),xy(302,261),xy(296,244)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(308,268),xy(315,275),xy(315,375)]).
midline(r5, [xy(316,275),xy(353,293),xy(376,299),xy(390,300),xy(539,300),xy(549,289),xy(556,279),xy(564,259),xy(565,202),xy(561,180),xy(551,163),xy(529,169),xy(512,170),xy(495,168),xy(477,159),xy(471,144),xy(469,121),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,128),xy(558,105),xy(552,90),xy(543,84),xy(519,79),xy(495,81),xy(480,87)]).
midline(r5, [xy(551,88),xy(550,89)]).
midline(r5, [xy(540,301),xy(554,317),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(525,564),xy(595,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r1, [xy(19,190),xy(20,500)]).
...
midline(r11, [xy(294,456),xy(276,471),xy(269,471),xy(264,447),xy(265,424)]).
midline(r11, [xy(269,473),xy(270,499),xy(276,515),xy(301,520),xy(329,520),xy(353,515),xy(359,499),xy(360,474),xy(333,455),xy(300,454),xy(295,456)]).
midline(r11, [xy(360,472),xy(365,449),xy(365,424)]).
...
midline(r23, [xy(418,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(547,604),xy(555,606),xy(555,630),xy(553,634),xy(419,634)]).
midline(r23, [xy(556,605),xy(583,605),xy(585,609),xy(585,631),xy(579,635),xy(555,633)]).
midline(r23, [xy(585,606),xy(608,604),xy(613,605),xy(615,609),xy(615,631),xy(613,634),xy(591,635),xy(585,633)]).
midline(r23, [xy(615,606),xy(635,605)]).
...
midline(r19, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(541,548),xy(578,550),xy(587,548),xy(589,543)]).
midline(r19, [xy(589,523),xy(588,502),xy(577,499),xy(566,500)]).
...
midline(r24, [xy(141,619),xy(139,620)]).
midline(r24, [xy(142,620),xy(240,620)]).
...
midline(r13, [xy(312,435),xy(304,435)]).
midline(r13, [xy(313,434),xy(325,435)]).
...
midline(r12, [xy(320,410),xy(299,410)]).
midline(r12, [xy(321,410),xy(330,410)]).
...
midline(r9, [xy(205,327),xy(205,315),xy(224,315),xy(224,333),xy(210,335),xy(205,333),xy(204,328)]).
