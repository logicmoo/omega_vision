...
midline(r2, [xy(112,25),xy(80,24),xy(66,26),xy(60,42),xy(59,96),xy(60,107),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,25),xy(388,24),xy(406,27),xy(413,30),xy(415,34),xy(415,99),xy(411,119),xy(405,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(440,24),xy(517,24),xy(520,26)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,197),xy(419,220),xy(430,224),xy(442,225),xy(515,225)]).
midline(r2, [xy(521,24),xy(541,19),xy(586,19),xy(604,22),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(622,581),xy(616,584),xy(605,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(403,573),xy(387,575),xy(230,574),xy(210,566),xy(190,549),xy(160,550)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,509),xy(215,382),xy(203,376),xy(170,371),xy(166,363),xy(164,348),xy(165,141),xy(169,129),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(455,533),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(429,390),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,427),xy(469,428),xy(466,429)]).
midline(r2, [xy(473,430),xy(470,429),xy(470,431)]).
midline(r2, [xy(473,432),xy(474,430)]).
midline(r2, [xy(475,433),xy(476,432)]).
...
border(r2).
region(r5, '#2ecc40', 133800, centroid(303,303)).
perimeter(r5, 4320).
polygon(r5, [xy(609,570),xy(520,569),xy(520,480),xy(540,479),xy(539,350),xy(340,350),xy(340,399),xy(390,400),xy(390,549),xy(240,549),xy(240,400),xy(289,400),xy(290,350),xy(190,349),xy(190,150),xy(289,150),xy(289,100),xy(140,100),xy(140,399),xy(190,400),xy(190,499),xy(90,499),xy(90,50),xy(390,50),xy(390,99),xy(340,100),xy(340,149),xy(390,150),xy(390,249),xy(539,250),xy(540,299),xy(590,300),xy(590,479),xy(610,480),xy(609,570)]).
...
midline(r5, [xy(524,516),xy(525,485),xy(545,483),xy(565,464),xy(565,353),xy(561,331),xy(553,326),xy(531,324),xy(518,320),xy(504,312),xy(490,299),xy(390,300),xy(362,296),xy(315,275),xy(289,250)]).
midline(r5, [xy(290,248),xy(315,219),xy(315,83),xy(313,80),xy(289,74),xy(140,74),xy(119,79),xy(114,101),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(565,465),xy(584,483),xy(604,485),xy(604,563),xy(597,565),xy(526,564),xy(524,556),xy(525,517)]).
midline(r5, [xy(314,276),xy(315,423),xy(274,436),xy(270,450),xy(269,489),xy(274,513),xy(285,518),xy(327,520),xy(344,518),xy(355,513),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
fillpoint(r5, xy(524,322), 28.0).
fillpoint(r5, xy(555,327), 28.0).
...
fillpoint(r5, xy(527,323), 27.0).
fillpoint(r5, xy(552,326), 27.0).
...
fillpoint(r5, xy(532,324), 26.0).
fillpoint(r5, xy(548,325), 26.0).
fillpoint(r5, xy(564,342), 26.0).
fillpoint(r5, xy(115,408), 26.0).
region(r6, '#2ecc40', 24500, centroid(520,135)).
perimeter(r6, 820).
polygon(r6, [xy(589,250),xy(540,250),xy(539,200),xy(440,199),xy(440,50),xy(590,50),xy(589,250)]).
...
midline(r6, [xy(508,169),xy(486,165),xy(480,162),xy(474,153),xy(470,139),xy(469,121),xy(471,105),xy(479,89)]).
midline(r6, [xy(478,161),xy(479,160)]).
midline(r6, [xy(509,169),xy(529,169),xy(551,161),xy(558,144),xy(560,129),xy(559,110),xy(555,96),xy(549,87),xy(529,80),xy(500,80),xy(480,87)]).
midline(r6, [xy(551,88),xy(550,89)]).
midline(r6, [xy(551,163),xy(561,180),xy(564,190),xy(565,225)]).
...
midline(r23, [xy(169,605),xy(125,605),xy(124,629),xy(125,634),xy(130,635),xy(553,634),xy(555,630),xy(555,607),xy(549,604),xy(170,604)]).
midline(r23, [xy(555,606),xy(577,604),xy(583,605),xy(585,609),xy(585,631),xy(583,634),xy(563,635),xy(555,633)]).
midline(r23, [xy(585,606),xy(590,604),xy(609,604),xy(613,605),xy(615,609),xy(615,630),xy(613,634),xy(591,635),xy(585,633)]).
midline(r23, [xy(615,606),xy(623,604),xy(635,605)]).
...
border(r23).
region(r20, '#aaaaaa', 7600, centroid(58,581)).
perimeter(r20, 720).
polygon(r20, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r20, [xy(90,609),xy(89,550),xy(30,550),xy(30,570),xy(70,570),xy(70,610),xy(90,609)]).
hole(r20, [xy(50,609),xy(49,590),xy(30,590),xy(30,610),xy(50,609)]).
midline(r20, [xy(99,562),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,550),xy(19,568),xy(23,579),xy(19,590),xy(21,618),xy(33,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(47,579),xy(24,580)]).
midline(r20, [xy(99,563),xy(100,609),xy(98,617),xy(89,620),xy(71,620),xy(60,617)]).
fillpoint(r20, xy(22,580), 12.8).
fillpoint(r20, xy(60,617), 12.8).
...
fillpoint(r20, xy(20,574), 11.0).
fillpoint(r20, xy(54,580), 11.0).
fillpoint(r20, xy(20,585), 11.0).
fillpoint(r20, xy(59,585), 11.0).
fillpoint(r20, xy(20,614), 11.0).
fillpoint(r20, xy(99,614), 11.0).
fillpoint(r20, xy(25,619), 11.0).
fillpoint(r20, xy(54,619), 11.0).
fillpoint(r20, xy(65,619), 11.0).
fillpoint(r20, xy(94,619), 11.0).
fillpoint(r20, xy(31,540), 10.0).
fillpoint(r20, xy(19,560), 10.0).
fillpoint(r20, xy(99,580), 10.0).
fillpoint(r20, xy(31,580), 10.0).
fillpoint(r20, xy(19,600), 10.0).
fillpoint(r20, xy(59,600), 10.0).
fillpoint(r20, xy(31,620), 10.0).
fillpoint(r20, xy(71,620), 10.0).
region(r25, '#5a5a5a', 5200, centroid(420,620)).
perimeter(r25, 560).
polygon(r25, [xy(549,630),xy(290,630),xy(290,610),xy(549,610),xy(549,630)]).
midline(r25, [xy(439,620),xy(299,620)]).
midline(r25, [xy(440,620),xy(540,620)]).
fillpoint(r25, xy(299,620), 10.0).
region(r17, '#aaaaaa', 4300, centroid(565,524)).
perimeter(r17, 440).
polygon(r17, [xy(599,560),xy(530,559),xy(530,490),xy(600,490),xy(599,560)]).
...
midline(r17, [xy(589,542),xy(588,524),xy(572,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,511),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r17, [xy(589,523),xy(590,511),xy(588,502),xy(578,499),xy(566,500)]).
fillpoint(r17, xy(542,501), 12.0).
fillpoint(r17, xy(588,501), 12.0).
fillpoint(r17, xy(541,548), 12.0).
fillpoint(r17, xy(587,548), 12.0).
fillpoint(r17, xy(545,500), 11.0).
fillpoint(r17, xy(565,500), 11.0).
fillpoint(r17, xy(584,500), 11.0).
fillpoint(r17, xy(540,505), 11.0).
fillpoint(r17, xy(589,505), 11.0).
...
fillpoint(r17, xy(551,500), 10.0).
fillpoint(r17, xy(571,500), 10.0).
fillpoint(r17, xy(539,525), 10.0).
fillpoint(r17, xy(589,515), 10.0).
...
region(r24, '#2ecc40', 3200, centroid(210,620)).
perimeter(r24, 360).
polygon(r24, [xy(289,630),xy(130,630),xy(130,610),xy(289,610),xy(289,630)]).
midline(r24, [xy(279,620),xy(139,620)]).
midline(r24, [xy(280,620),xy(280,619)]).
fillpoint(r24, xy(139,620), 10.0).
region(r21, '#870c25', 2000, centroid(68,572)).
perimeter(r21, 240).
polygon(r21, [xy(89,610),xy(70,609),xy(69,570),xy(30,569),xy(30,550),xy(90,550),xy(89,610)]).
midline(r21, [xy(80,587),xy(80,571),xy(77,561),xy(68,559),xy(39,560)]).
midline(r21, [xy(79,588),xy(80,600)]).
...
region(r11, '#870c25', 1500, centroid(564,284)).
perimeter(r11, 160).
polygon(r11, [xy(589,300),xy(540,300),xy(540,270),xy(589,270),xy(589,300)]).
midline(r11, [xy(560,285),xy(554,285)]).
midline(r11, [xy(561,285),xy(575,285)]).
fillpoint(r11, xy(554,285), 15.0).
region(r10, '#bebebe', 1000, centroid(564,260)).
perimeter(r10, 140).
polygon(r10, [xy(589,270),xy(540,270),xy(540,250),xy(589,250),xy(589,270)]).
midline(r10, [xy(559,260),xy(549,260)]).
midline(r10, [xy(560,259),xy(580,260)]).
fillpoint(r10, xy(549,260), 10.0).
...
midline(r18, [xy(555,524),xy(555,514)]).
midline(r18, [xy(554,525),xy(555,534),xy(575,535)]).
fillpoint(r18, xy(555,534), 6.0).
fillpoint(r18, xy(555,521), 5.0).
fillpoint(r18, xy(561,535), 5.0).
region(r22, '#870c25', 400, centroid(40,600)).
perimeter(r22, 80).
...
adjacent(r5, r11).
shared_edge(r5, r11, 80).
adjacent(r5, r17).
shared_edge(r5, r17, 280).
adjacent(r6, r10).
shared_edge(r6, r10, 50).
adjacent(r10, r11).
...
adjacent(r23, r24).
shared_edge(r23, r24, 340).
adjacent(r23, r25).
shared_edge(r23, r25, 540).
adjacent(r23, r26).
