...
midline(r2, [xy(508,25),xy(441,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(80,24),xy(66,26),xy(59,50),xy(59,98),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,604),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(520,25),xy(528,21),xy(540,19),xy(587,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(625,566),xy(622,581),xy(608,585),xy(513,584),xy(497,576),xy(454,534),xy(439,550),xy(419,566),xy(403,573),xy(388,575),xy(230,574),xy(207,564),xy(190,549),xy(160,549)]).
midline(r2, [xy(415,32),xy(415,97),xy(413,113),xy(409,123),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,198),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,382),xy(203,376),xy(173,372),xy(166,363),xy(164,347),xy(165,141),xy(169,129),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(455,533),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(429,390),xy(411,379),xy(388,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(490,440),xy(492,439),xy(492,441)]).
...
midline(r5, [xy(203,74),xy(289,74),xy(303,76),xy(315,81),xy(315,174),xy(277,235),xy(261,243),xy(245,255),xy(196,304),xy(194,311),xy(195,344),xy(228,345),xy(235,343),xy(280,299),xy(287,288),xy(307,268),xy(277,237)]).
midline(r5, [xy(261,245),xy(260,246)]).
midline(r5, [xy(316,174),xy(329,168),xy(346,155),xy(384,155),xy(385,189),xy(380,199),xy(308,268),xy(315,277),xy(315,423),xy(304,428),xy(276,434),xy(270,450),xy(269,489),xy(271,504),xy(276,515),xy(300,520),xy(339,519),xy(353,515),xy(358,504),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(315,274),xy(350,292),xy(376,299),xy(539,299),xy(556,320),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(316,80),xy(330,75),xy(365,75)]).
midline(r5, [xy(540,298),xy(554,282),xy(564,259),xy(565,201),xy(563,186),xy(550,162),xy(534,168),xy(511,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
...
midline(r11, [xy(116,409),xy(123,429),xy(140,450)]).
...
midline(r25, [xy(524,635),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(546,604),xy(553,605),xy(555,609),xy(555,632),xy(548,635),xy(525,634)]).
midline(r25, [xy(555,606),xy(560,604),xy(585,606),xy(583,634),xy(561,635),xy(555,633)]).
midline(r25, [xy(586,605),xy(609,604),xy(615,606),xy(615,630),xy(613,634),xy(609,635),xy(590,635),xy(585,633)]).
...
midline(r27, [xy(444,619),xy(279,620)]).
midline(r27, [xy(445,619),xy(540,620)]).
...
midline(r21, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(565,502),xy(563,500),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(550,550),xy(585,549),xy(589,543)]).
midline(r21, [xy(565,500),xy(579,499),xy(588,501),xy(589,523)]).
...
midline(r26, [xy(206,620),xy(139,620)]).
midline(r26, [xy(207,619),xy(260,620)]).
...
midline(r8, [xy(110,135),xy(104,135)]).
midline(r8, [xy(111,134),xy(125,135)]).
...
midline(r6, [xy(109,110),xy(99,110)]).
midline(r6, [xy(110,110),xy(130,110)]).
...
midline(r12, [xy(355,177),xy(355,165),xy(374,165),xy(374,183),xy(366,185),xy(356,184),xy(354,178)]).
...
midline(r14, [xy(219,314),xy(205,315),xy(205,334),xy(217,335),xy(224,333),xy(224,316),xy(220,315)]).
