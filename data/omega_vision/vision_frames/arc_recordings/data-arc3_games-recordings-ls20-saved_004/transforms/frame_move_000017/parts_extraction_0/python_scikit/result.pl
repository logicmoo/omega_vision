...
midline(r2, [xy(544,585),xy(513,584),xy(503,580),xy(490,570),xy(454,534),xy(455,464),xy(465,425),xy(429,390),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(545,585),xy(616,584),xy(622,581),xy(625,569),xy(625,480),xy(622,467),xy(614,455),xy(615,40),xy(613,27),xy(597,20),xy(540,19),xy(528,21),xy(520,25),xy(441,24),xy(426,26),xy(415,31),xy(403,26),xy(388,24),xy(84,24),xy(66,26),xy(61,38),xy(59,54),xy(60,107),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,602),xy(116,594),xy(159,550),xy(141,531),xy(122,517),xy(107,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(466,428),xy(470,431),xy(473,430),xy(473,432)]).
midline(r2, [xy(475,432),xy(478,432),xy(478,434)]).
midline(r2, [xy(480,434),xy(497,442)]).
midline(r2, [xy(454,535),xy(419,566),xy(403,573),xy(389,575),xy(230,574),xy(207,564),xy(189,549),xy(160,550)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,385),xy(213,380),xy(203,376),xy(173,372),xy(166,363),xy(164,346),xy(165,141),xy(168,130),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,95),xy(413,113),xy(409,123),xy(407,125),xy(364,125)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(119,79),xy(115,90),xy(114,395),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,75),xy(286,74),xy(303,76),xy(315,81),xy(314,217),xy(316,219),xy(295,243),xy(276,236),xy(250,251),xy(200,299),xy(194,311),xy(195,344),xy(225,345),xy(233,344),xy(239,340),xy(279,300),xy(299,271),xy(303,262),xy(296,244)]).
midline(r5, [xy(316,80),xy(330,75),xy(365,75)]).
midline(r5, [xy(304,263),xy(330,282),xy(350,292),xy(376,299),xy(539,300),xy(554,282),xy(564,259),xy(565,202),xy(563,186),xy(550,162),xy(534,168),xy(512,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,301),xy(554,317),xy(564,340),xy(565,462),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r13, [xy(271,500),xy(269,460),xy(271,445),xy(276,434),xy(300,429),xy(344,431),xy(355,436),xy(360,462),xy(359,499),xy(353,515),xy(328,520),xy(290,519),xy(276,515),xy(271,501)]).
...
midline(r23, [xy(418,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(130,604),xy(549,604),xy(554,607),xy(565,604),xy(579,604),xy(584,607),xy(592,604),xy(609,604),xy(613,605),xy(615,609),xy(615,632),xy(613,634),xy(419,635)]).
...
midline(r19, [xy(589,542),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,511),xy(539,539),xy(541,548),xy(578,550),xy(587,548),xy(589,543)]).
midline(r19, [xy(589,523),xy(590,510),xy(588,502),xy(578,499),xy(566,500)]).
...
midline(r24, [xy(185,620),xy(220,620)]).
...
midline(r12, [xy(317,384),xy(325,385)]).
...
midline(r9, [xy(224,332),xy(223,315),xy(205,315),xy(204,320),xy(205,334),xy(224,334)]).
...
midline(r20, [xy(555,521),xy(555,534),xy(575,535)]).
midline(r20, [xy(555,520),xy(555,514)]).
