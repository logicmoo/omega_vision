...
midline(r2, [xy(112,25),xy(83,24),xy(66,26),xy(60,42),xy(59,99),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,626),xy(114,600),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,24),xy(389,24),xy(411,29),xy(415,34),xy(415,96),xy(411,119),xy(408,124),xy(404,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(440,24),xy(517,24),xy(519,26),xy(525,22),xy(540,19),xy(589,19),xy(613,26),xy(615,43),xy(614,455),xy(622,467),xy(625,481),xy(624,576),xy(621,582),xy(609,585),xy(520,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(465,425),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(416,213),xy(420,221),xy(443,225),xy(515,225)]).
midline(r2, [xy(466,429),xy(473,430),xy(473,432)]).
midline(r2, [xy(475,432),xy(486,438),xy(488,437),xy(488,439)]).
midline(r2, [xy(66,121),xy(68,119)]).
midline(r2, [xy(454,535),xy(422,564),xy(409,571),xy(389,575),xy(240,575),xy(226,573),xy(210,566),xy(189,549),xy(160,550)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,386),xy(214,381),xy(209,378),xy(170,371),xy(166,363),xy(164,349),xy(165,141),xy(169,129),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(490,439),xy(491,440)]).
midline(r2, [xy(493,440),xy(496,443)]).
...
midline(r5, [xy(274,234),xy(283,225),xy(315,173),xy(315,83),xy(309,78),xy(289,74),xy(141,74),xy(119,79),xy(114,100),xy(115,225)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(316,174),xy(321,171),xy(319,174)]).
midline(r5, [xy(323,172),xy(346,155),xy(384,155),xy(385,189),xy(380,199),xy(341,238),xy(327,248),xy(308,267),xy(276,236),xy(265,241),xy(241,258),xy(199,300),xy(194,310),xy(195,344),xy(233,344),xy(278,301),xy(308,268),xy(315,278),xy(315,420),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,489),xy(274,513),xy(285,518),xy(328,520),xy(344,518),xy(355,513),xy(360,488),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(276,235),xy(279,232)]).
midline(r5, [xy(315,274),xy(350,292),xy(370,298),xy(390,300),xy(538,300),xy(549,289),xy(560,271),xy(564,258),xy(565,201),xy(562,183),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
...
midline(r5, [xy(540,300),xy(556,320),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
border(r1).
region(r13, '#2ecc40', 15000, centroid(131,416)).
perimeter(r13, 600).
polygon(r13, [xy(189,500),xy(90,499),xy(90,300),xy(140,300),xy(140,399),xy(190,400),xy(189,500)]).
midline(r13, [xy(115,384),xy(115,324)]).
midline(r13, [xy(115,385),xy(115,409),xy(118,419),xy(127,435),xy(140,450)]).
...
midline(r25, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(548,604),xy(554,607),xy(561,604),xy(578,604),xy(584,607),xy(590,604),xy(609,604),xy(614,607),xy(624,604),xy(635,605)]).
midline(r25, [xy(525,635),xy(553,634),xy(555,632),xy(555,608)]).
midline(r25, [xy(585,608),xy(585,631),xy(583,634),xy(560,635),xy(555,633)]).
...
region(r27, '#5a5a5a', 6800, centroid(380,620)).
perimeter(r27, 720).
polygon(r27, [xy(549,630),xy(210,630),xy(210,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(425,620),xy(219,620)]).
midline(r27, [xy(426,620),xy(540,620)]).
fillpoint(r27, xy(219,620), 10.0).
...
midline(r21, [xy(589,542),xy(590,530),xy(587,524),xy(571,525),xy(565,523),xy(565,502),xy(563,500),xy(550,499),xy(541,501),xy(539,511),xy(541,548),xy(552,550),xy(585,549),xy(589,543)]).
midline(r21, [xy(565,500),xy(578,499),xy(588,501),xy(589,524)]).
...
region(r26, '#2ecc40', 1600, centroid(170,620)).
perimeter(r26, 200).
polygon(r26, [xy(209,630),xy(130,630),xy(130,610),xy(209,610),xy(209,630)]).
midline(r26, [xy(184,620),xy(139,620)]).
midline(r26, [xy(185,620),xy(200,620)]).
fillpoint(r26, xy(139,620), 10.0).
region(r12, '#870c25', 1500, centroid(114,284)).
perimeter(r12, 160).
polygon(r12, [xy(139,300),xy(90,300),xy(90,270),xy(139,270),xy(139,300)]).
midline(r12, [xy(122,285),xy(104,285)]).
midline(r12, [xy(123,285),xy(125,285)]).
fillpoint(r12, xy(104,285), 15.0).
region(r11, '#bebebe', 1000, centroid(114,260)).
perimeter(r11, 140).
polygon(r11, [xy(139,270),xy(90,270),xy(90,250),xy(139,250),xy(139,270)]).
midline(r11, [xy(120,260),xy(99,260)]).
midline(r11, [xy(121,259),xy(130,260)]).
fillpoint(r11, xy(99,260), 10.0).
...
midline(r14, [xy(219,314),xy(205,315),xy(205,334),xy(219,335),xy(224,333),xy(225,320),xy(224,316),xy(220,315)]).
...
adjacent(r25, r26).
shared_edge(r25, r26, 180).
adjacent(r25, r27).
shared_edge(r25, r27, 700).
adjacent(r25, r28).
