...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(388,24),xy(83,24),xy(66,26),xy(61,38),xy(59,53),xy(60,107),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,24),xy(519,25),xy(528,21),xy(542,19),xy(587,19),xy(601,21),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,481),xy(625,569),xy(622,581),xy(608,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(403,573),xy(388,575),xy(240,575),xy(226,573),xy(210,566),xy(189,549),xy(160,550)]).
...
midline(r2, [xy(190,548),xy(204,532),xy(214,508),xy(215,382),xy(203,376),xy(173,372),xy(168,369),xy(166,363),xy(164,348),xy(165,140),xy(169,129),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(455,533),xy(455,464),xy(465,425),xy(429,390),xy(409,378),xy(387,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(470,428),xy(472,430),xy(468,430)]).
...
midline(r5, [xy(203,75),xy(289,74),xy(303,76),xy(315,81),xy(315,221),xy(289,249),xy(316,275),xy(314,283),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(300,520),xy(329,520),xy(353,515),xy(358,504),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(317,276),xy(348,291),xy(370,298),xy(390,300),xy(440,299),xy(460,316),xy(480,324),xy(558,324),xy(563,336),xy(565,350),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(532,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(559,323),xy(565,299),xy(565,204),xy(561,180),xy(550,162),xy(534,168),xy(512,170),xy(495,168),xy(477,159),xy(471,144),xy(469,123),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(480,87),xy(495,81),xy(517,79),xy(534,81),xy(551,88),xy(558,105),xy(560,120),xy(558,144),xy(551,161)]).
...
midline(r22, [xy(524,635),xy(137,635),xy(126,634),xy(124,629),xy(125,605),xy(130,604),xy(546,604),xy(555,606),xy(555,632),xy(547,635),xy(525,635)]).
midline(r22, [xy(556,605),xy(578,604),xy(584,607),xy(590,604),xy(613,605),xy(615,610),xy(615,631),xy(613,634),xy(607,635),xy(585,633),xy(579,635),xy(560,635),xy(555,633)]).
...
midline(r19, [xy(99,553),xy(99,544),xy(95,540),xy(32,539),xy(21,541),xy(19,550),xy(20,575),xy(23,579),xy(19,590),xy(21,618),xy(33,620),xy(55,619),xy(60,614),xy(58,582),xy(47,579),xy(24,579)]).
midline(r19, [xy(100,554),xy(100,609),xy(98,617),xy(87,620),xy(71,620),xy(60,617)]).
...
midline(r24, [xy(485,620),xy(279,620)]).
midline(r24, [xy(486,619),xy(540,620)]).
...
midline(r16, [xy(589,542),xy(590,531),xy(588,524),xy(571,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(550,550),xy(578,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(589,523),xy(590,510),xy(588,502),xy(577,499),xy(566,500)]).
...
midline(r23, [xy(206,620),xy(139,620)]).
midline(r23, [xy(207,620),xy(260,620)]).
...
midline(r20, [xy(80,587),xy(80,571),xy(77,561),xy(67,559),xy(39,560)]).
...
midline(r9, [xy(509,260),xy(499,260)]).
midline(r9, [xy(510,260),xy(530,260)]).
