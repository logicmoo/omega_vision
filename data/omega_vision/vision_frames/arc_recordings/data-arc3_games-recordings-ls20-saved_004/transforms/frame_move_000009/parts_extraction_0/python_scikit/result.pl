...
midline(r2, [xy(165,180),xy(165,358),xy(170,371),xy(180,374),xy(199,375),xy(214,381),xy(215,498),xy(211,519),xy(202,535),xy(189,550),xy(160,550),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(10,524),xy(5,525),xy(4,531),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(116,594),xy(159,550)]).
midline(r2, [xy(191,550),xy(207,564),xy(231,574),xy(389,575),xy(403,573),xy(422,564),xy(455,534),xy(455,464),xy(465,425),xy(429,390),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(165,179),xy(164,150),xy(166,136),xy(170,128),xy(190,124),xy(265,125)]).
midline(r2, [xy(65,503),xy(65,121),xy(59,98),xy(59,50),xy(66,26),xy(84,24),xy(389,24),xy(403,26),xy(415,31),xy(415,99),xy(412,116),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(416,30),xy(440,24),xy(519,25),xy(528,21),xy(542,19),xy(587,19),xy(601,21),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,481),xy(624,576),xy(621,582),xy(609,585),xy(513,584),xy(497,576),xy(455,535)]).
...
midline(r8, [xy(564,224),xy(565,203),xy(563,186),xy(551,163),xy(529,169),xy(513,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r8, [xy(479,160),xy(478,161)]).
midline(r8, [xy(480,87),xy(495,81),xy(518,79),xy(534,81),xy(551,88),xy(558,105),xy(560,123),xy(558,144),xy(550,160),xy(551,162)]).
midline(r8, [xy(565,225),xy(565,249),xy(562,266),xy(552,285),xy(539,300),xy(391,300),xy(370,298),xy(350,292),xy(317,276),xy(275,235),xy(272,239),xy(253,249),xy(239,260),xy(196,304),xy(194,310),xy(194,339),xy(195,344),xy(200,345),xy(228,345),xy(235,343),xy(283,296),xy(287,289),xy(307,269)]).
midline(r8, [xy(314,275),xy(315,423),xy(274,436),xy(270,450),xy(269,489),xy(274,513),xy(285,518),xy(329,520),xy(344,518),xy(355,513),xy(360,486),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r8, [xy(540,301),xy(556,320),xy(564,341),xy(565,462),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r8, [xy(276,235),xy(314,177),xy(315,124)]).
midline(r8, [xy(315,176),xy(319,172),xy(333,166),xy(346,155),xy(384,155),xy(385,160),xy(385,187),xy(383,195),xy(328,249)]).
...
midline(r5, [xy(114,380),xy(115,409),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(115,379),xy(114,102),xy(117,83),xy(123,77),xy(140,74),xy(265,75)]).
...
midline(r26, [xy(524,635),xy(137,635),xy(126,634),xy(124,628),xy(125,605),xy(131,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(525,635)]).
midline(r26, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(579,635),xy(555,633)]).
midline(r26, [xy(585,606),xy(591,604),xy(615,606),xy(613,634),xy(592,635),xy(585,633)]).
midline(r26, [xy(616,605),xy(635,605)]).
...
midline(r28, [xy(470,620),xy(319,620)]).
midline(r28, [xy(471,620),xy(540,620)]).
...
midline(r22, [xy(589,542),xy(590,530),xy(587,524),xy(570,525),xy(565,523),xy(565,502),xy(563,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r22, [xy(565,500),xy(578,499),xy(588,501),xy(590,510),xy(589,524)]).
...
midline(r27, [xy(290,620),xy(139,620)]).
midline(r27, [xy(291,619),xy(300,620)]).
...
midline(r9, [xy(317,85),xy(325,85)]).
...
midline(r6, [xy(320,60),xy(299,60)]).
midline(r6, [xy(321,59),xy(330,60)]).
...
midline(r13, [xy(355,177),xy(355,165),xy(374,165),xy(375,170),xy(373,184),xy(356,184),xy(355,178)]).
...
midline(r15, [xy(205,327),xy(205,315),xy(224,315),xy(225,320),xy(223,334),xy(206,334),xy(205,328)]).
...
midline(r23, [xy(555,521),xy(555,514)]).
midline(r23, [xy(555,522),xy(555,534),xy(575,535)]).
