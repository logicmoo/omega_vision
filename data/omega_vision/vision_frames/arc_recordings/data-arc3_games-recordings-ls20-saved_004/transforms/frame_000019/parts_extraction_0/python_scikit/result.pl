...
midline(r2, [xy(165,180),xy(164,150),xy(166,136),xy(170,128),xy(190,124),xy(265,125)]).
midline(r2, [xy(165,181),xy(165,358),xy(169,370),xy(180,374),xy(203,376),xy(213,380),xy(215,384),xy(215,497),xy(211,519),xy(202,535),xy(187,550),xy(159,549),xy(132,523),xy(122,517),xy(107,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,533),xy(4,628),xy(5,634),xy(12,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(64,125),xy(66,120),xy(61,111),xy(59,98),xy(59,50),xy(66,26),xy(84,24),xy(388,24),xy(403,26),xy(415,31),xy(415,99),xy(411,119),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(416,213),xy(420,221),xy(442,225),xy(515,225)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(416,30),xy(430,25),xy(441,24),xy(516,24),xy(520,26)]).
midline(r2, [xy(521,24),xy(541,19),xy(589,19),xy(609,24),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(622,581),xy(607,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(409,571),xy(389,575),xy(231,574),xy(212,567),xy(190,550)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(471,429),xy(474,432),xy(478,431),xy(477,433)]).
midline(r2, [xy(480,431),xy(480,435),xy(485,435),xy(482,432)]).
midline(r2, [xy(495,441),xy(486,436),xy(486,438)]).
midline(r2, [xy(493,441),xy(494,442)]).
...
border(r2).
region(r5, '#2ecc40', 158300, centroid(341,274)).
perimeter(r5, 5240).
...
hole(r5, [xy(340,499),xy(339,450),xy(290,450),xy(290,500),xy(340,499)]).
...
midline(r5, [xy(202,75),xy(131,75),xy(120,78),xy(115,91),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(203,75),xy(286,74),xy(303,76),xy(314,81),xy(315,219),xy(295,243),xy(276,236),xy(258,245),xy(238,261),xy(200,299),xy(194,310),xy(195,344),xy(224,345),xy(233,344),xy(239,340),xy(279,300),xy(288,287),xy(307,268),xy(302,261),xy(296,244)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(257,248),xy(258,247)]).
midline(r5, [xy(308,268),xy(315,275),xy(315,416),xy(313,419),xy(303,423),xy(281,425),xy(268,430),xy(264,451),xy(264,497),xy(268,519),xy(280,524),xy(337,525),xy(349,524),xy(361,519),xy(365,499),xy(365,451),xy(361,430),xy(353,426),xy(326,423),xy(315,418)]).
midline(r5, [xy(316,275),xy(350,292),xy(376,299),xy(539,299),xy(557,322),xy(564,341),xy(565,463),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(540,298),xy(554,282),xy(564,259),xy(565,200),xy(563,186),xy(550,162),xy(534,168),xy(512,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(480,87),xy(495,81),xy(518,79),xy(534,81),xy(551,88),xy(558,105),xy(560,120),xy(558,144),xy(551,161)]).
...
fillpoint(r5, xy(269,429), 29.7).
fillpoint(r5, xy(360,429), 29.7).
fillpoint(r5, xy(269,520), 29.7).
fillpoint(r5, xy(360,520), 29.7).
...
fillpoint(r5, xy(308,421), 29.0).
fillpoint(r5, xy(321,421), 29.0).
fillpoint(r5, xy(271,428), 29.0).
fillpoint(r5, xy(358,428), 29.0).
fillpoint(r5, xy(268,431), 29.0).
fillpoint(r5, xy(361,431), 29.0).
fillpoint(r5, xy(268,518), 29.0).
fillpoint(r5, xy(361,518), 29.0).
fillpoint(r5, xy(271,521), 29.0).
fillpoint(r5, xy(358,521), 29.0).
...
fillpoint(r5, xy(305,422), 28.0).
fillpoint(r5, xy(324,422), 28.0).
fillpoint(r5, xy(274,427), 28.0).
fillpoint(r5, xy(355,427), 28.0).
fillpoint(r5, xy(267,434), 28.0).
fillpoint(r5, xy(362,434), 28.0).
fillpoint(r5, xy(267,515), 28.0).
fillpoint(r5, xy(362,515), 28.0).
fillpoint(r5, xy(274,522), 28.0).
fillpoint(r5, xy(355,522), 28.0).
...
fillpoint(r5, xy(302,423), 27.0).
fillpoint(r5, xy(327,423), 27.0).
fillpoint(r5, xy(277,426), 27.0).
fillpoint(r5, xy(352,426), 27.0).
fillpoint(r5, xy(266,437), 27.0).
fillpoint(r5, xy(363,437), 27.0).
fillpoint(r5, xy(266,512), 27.0).
fillpoint(r5, xy(363,512), 27.0).
fillpoint(r5, xy(277,523), 27.0).
fillpoint(r5, xy(352,523), 27.0).
...
fillpoint(r5, xy(298,424), 26.0).
fillpoint(r5, xy(332,424), 26.0).
fillpoint(r5, xy(282,425), 26.0).
fillpoint(r5, xy(348,425), 26.0).
fillpoint(r5, xy(265,442), 26.0).
fillpoint(r5, xy(364,442), 26.0).
fillpoint(r5, xy(265,508), 26.0).
fillpoint(r5, xy(364,508), 26.0).
fillpoint(r5, xy(282,524), 26.0).
fillpoint(r5, xy(348,524), 26.0).
...
fillpoint(r5, xy(264,475), 25.0).
fillpoint(r5, xy(364,475), 25.0).
fillpoint(r5, xy(291,525), 25.0).
...
midline(r19, [xy(418,635),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(548,604),xy(555,606),xy(555,630),xy(553,634),xy(419,634)]).
midline(r19, [xy(556,605),xy(579,604),xy(585,606),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r19, [xy(586,605),xy(613,605),xy(615,609),xy(615,630),xy(613,634),xy(608,635),xy(590,635),xy(585,633)]).
midline(r19, [xy(615,606),xy(621,604),xy(635,605)]).
...
midline(r16, [xy(99,562),xy(99,544),xy(95,540),xy(32,539),xy(21,541),xy(19,551),xy(20,575),xy(23,580),xy(20,584),xy(19,592),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(58,582),xy(47,579),xy(24,579)]).
midline(r16, [xy(99,563),xy(100,609),xy(98,617),xy(89,620),xy(70,620),xy(60,617)]).
...
midline(r21, [xy(485,620),xy(279,620)]).
midline(r21, [xy(486,620),xy(540,620)]).
...
midline(r13, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,510),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r13, [xy(589,523),xy(590,510),xy(588,502),xy(579,499),xy(566,500)]).
...
midline(r20, [xy(152,619),xy(260,620)]).
...
midline(r17, [xy(80,587),xy(80,570),xy(77,561),xy(68,559),xy(39,560)]).
midline(r17, [xy(80,588),xy(80,600)]).
...
region(r12, '#870c25', 1500, centroid(314,484)).
perimeter(r12, 160).
polygon(r12, [xy(339,500),xy(290,500),xy(290,470),xy(339,470),xy(339,500)]).
midline(r12, [xy(316,484),xy(304,485)]).
midline(r12, [xy(317,485),xy(325,485)]).
fillpoint(r12, xy(304,485), 15.0).
region(r11, '#bebebe', 1000, centroid(314,460)).
perimeter(r11, 140).
polygon(r11, [xy(339,470),xy(290,470),xy(290,450),xy(339,450),xy(339,470)]).
midline(r11, [xy(311,460),xy(299,460)]).
midline(r11, [xy(312,459),xy(330,460)]).
fillpoint(r11, xy(299,460), 10.0).
...
midline(r9, [xy(205,327),xy(205,334),xy(213,335),xy(223,334),xy(225,329),xy(224,316),xy(217,314),xy(205,315),xy(205,326)]).
...
midline(r14, [xy(555,521),xy(555,514)]).
midline(r14, [xy(554,522),xy(555,534),xy(575,535)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 300).
adjacent(r19, r21).
shared_edge(r19, r21, 580).
adjacent(r19, r22).
