...
midline(r2, [xy(165,216),xy(164,348),xy(166,363),xy(169,370),xy(173,372),xy(203,376),xy(215,381),xy(215,499),xy(213,513),xy(206,529),xy(189,549),xy(160,550),xy(132,523),xy(122,517),xy(108,514),xy(83,514),xy(65,504),xy(43,524),xy(11,524),xy(5,525),xy(4,530),xy(4,629),xy(5,634),xy(12,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,120),xy(59,98),xy(59,50),xy(66,26),xy(82,24),xy(387,24),xy(403,26),xy(415,31),xy(415,99),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(416,213),xy(420,221),xy(440,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(440,24),xy(519,25),xy(528,21),xy(543,19),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,482),xy(625,569),xy(623,579),xy(619,583),xy(609,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(409,571),xy(389,575),xy(230,574),xy(207,564),xy(190,549)]).
midline(r2, [xy(66,119),xy(69,117),xy(69,119)]).
midline(r2, [xy(455,533),xy(455,464),xy(465,428),xy(464,424),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(473,430),xy(490,440),xy(492,439),xy(492,441)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(120,78),xy(115,90),xy(114,397),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,74),xy(288,74),xy(303,76),xy(314,82),xy(331,75),xy(365,75)]).
midline(r5, [xy(315,83),xy(315,220),xy(295,243),xy(275,235),xy(249,252),xy(199,300),xy(194,310),xy(195,344),xy(229,345),xy(235,343),xy(279,300),xy(288,287),xy(307,268),xy(302,261),xy(296,244)]).
midline(r5, [xy(308,268),xy(315,275),xy(315,416),xy(313,419),xy(303,423),xy(281,425),xy(269,429),xy(264,450),xy(266,513),xy(270,521),xy(292,525),xy(339,525),xy(360,520)]).
midline(r5, [xy(316,275),xy(350,292),xy(376,299),xy(539,300),xy(548,290),xy(557,277),xy(564,259),xy(565,200),xy(561,180),xy(550,162),xy(534,168),xy(512,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,301),xy(556,320),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(524,558),xy(525,564),xy(532,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(361,518),xy(365,498),xy(365,450),xy(361,430),xy(353,426),xy(326,423),xy(315,418)]).
midline(r5, [xy(480,87),xy(495,81),xy(518,79),xy(534,81),xy(551,88),xy(558,105),xy(560,121),xy(558,144),xy(551,161)]).
...
midline(r19, [xy(137,634),xy(125,633),xy(125,605),xy(130,604),xy(549,604),xy(554,607),xy(562,604),xy(579,604),xy(585,606),xy(585,632),xy(578,635),xy(560,635),xy(554,632),xy(555,608)]).
midline(r19, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(609,635),xy(585,633)]).
midline(r19, [xy(616,605),xy(635,605)]).
midline(r19, [xy(554,633),xy(548,635),xy(138,635)]).
...
midline(r16, [xy(99,553),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,550),xy(20,575),xy(23,579),xy(19,591),xy(21,618),xy(30,620),xy(55,619),xy(60,616),xy(58,582),xy(49,579),xy(24,580)]).
midline(r16, [xy(99,554),xy(100,609),xy(98,617),xy(84,620),xy(70,620),xy(61,617)]).
...
midline(r21, [xy(445,619),xy(540,620)]).
...
midline(r13, [xy(589,542),xy(588,525),xy(570,525),xy(565,523),xy(565,502),xy(563,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r13, [xy(565,500),xy(578,499),xy(588,501),xy(590,512),xy(589,524)]).
...
midline(r17, [xy(80,596),xy(80,600)]).
midline(r17, [xy(80,595),xy(80,571),xy(77,561),xy(69,559),xy(39,560)]).
...
midline(r12, [xy(310,485),xy(304,485)]).
midline(r12, [xy(311,485),xy(325,485)]).
...
midline(r11, [xy(320,460),xy(299,460)]).
midline(r11, [xy(321,459),xy(330,460)]).
...
midline(r9, [xy(224,332),xy(225,323),xy(223,315),xy(205,315),xy(204,322),xy(205,334),xy(224,334)]).
...
midline(r14, [xy(565,535),xy(555,533),xy(555,514)]).
midline(r14, [xy(566,535),xy(575,535)]).
