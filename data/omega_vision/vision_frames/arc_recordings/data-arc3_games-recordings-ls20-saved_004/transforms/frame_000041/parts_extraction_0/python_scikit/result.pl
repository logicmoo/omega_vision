...
midline(r3, [xy(280,309),xy(269,310),xy(265,306),xy(258,304),xy(245,305),xy(244,319),xy(250,329),xy(250,345),xy(261,368),xy(248,390),xy(215,424),xy(210,425),xy(199,417),xy(148,391),xy(140,363),xy(139,299),xy(152,285),xy(161,269),xy(165,241),xy(169,229),xy(180,225),xy(199,224),xy(212,219),xy(207,208),xy(195,193),xy(195,155),xy(233,155),xy(250,169),xy(252,168),xy(263,174),xy(265,172),xy(264,90),xy(258,78),xy(248,75),xy(174,74),xy(156,55),xy(153,35),xy(80,34),xy(75,35),xy(74,40),xy(75,114),xy(153,114),xy(156,94),xy(174,75)]).
midline(r3, [xy(262,367),xy(275,353),xy(279,345),xy(279,339),xy(284,333),xy(285,321),xy(280,311)]).
midline(r3, [xy(268,311),xy(251,328)]).
midline(r3, [xy(213,220),xy(239,219),xy(253,215),xy(258,204),xy(265,174),xy(386,174),xy(389,186),xy(390,213),xy(398,241),xy(380,260),xy(368,281),xy(346,304),xy(344,310),xy(345,344),xy(379,345),xy(384,343),xy(385,337),xy(384,306),xy(367,284),xy(369,284)]).
midline(r3, [xy(387,173),xy(389,149),xy(399,139),xy(410,121),xy(414,108),xy(416,86),xy(420,78),xy(443,74),xy(515,75)]).
midline(r3, [xy(215,425),xy(289,500),xy(301,500),xy(346,544),xy(379,545),xy(384,543),xy(384,506),xy(357,477),xy(326,484),xy(302,499)]).
midline(r3, [xy(357,476),xy(363,463),xy(365,440),xy(369,429),xy(390,424),xy(458,424),xy(464,440),xy(465,458),xy(469,470),xy(511,479),xy(525,487),xy(540,500)]).
midline(r3, [xy(459,423),xy(464,409),xy(465,391),xy(469,378),xy(477,364),xy(490,350),xy(477,335),xy(468,319),xy(463,286),xy(457,272),xy(448,259),xy(439,249),xy(420,248),xy(399,241)]).
midline(r3, [xy(441,249),xy(454,237),xy(468,229),xy(480,225),xy(503,223),xy(519,216),xy(539,199),xy(552,214),xy(561,230),xy(565,250),xy(565,298),xy(563,313),xy(556,329),xy(538,350),xy(491,350)]).
midline(r3, [xy(540,350),xy(552,364),xy(561,380),xy(565,401),xy(565,449),xy(563,463),xy(556,479),xy(540,498)]).
...
midline(r2, [xy(493,125),xy(481,125),xy(468,130),xy(464,150),xy(465,165)]).
midline(r2, [xy(494,124),xy(608,124),xy(613,136),xy(615,150),xy(614,559),xy(608,571),xy(588,575),xy(490,575),xy(468,570),xy(450,559),xy(430,539),xy(422,527),xy(415,508),xy(415,474)]).
midline(r2, [xy(609,123),xy(614,109),xy(615,97),xy(614,40),xy(611,30),xy(599,25),xy(391,24),xy(376,26),xy(360,33),xy(340,50),xy(317,32),xy(298,25),xy(184,25),xy(172,17),xy(159,14),xy(71,14),xy(57,17),xy(54,32),xy(55,126),xy(63,142),xy(93,173),xy(90,186),xy(90,200),xy(73,220),xy(65,241),xy(65,330),xy(61,338),xy(59,350),xy(60,407),xy(64,419),xy(67,420),xy(64,426),xy(65,459),xy(68,469),xy(80,489),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(12,635),xy(109,635),xy(114,633),xy(114,601),xy(116,594),xy(159,549),xy(100,490),xy(81,489)]).
midline(r2, [xy(94,173),xy(123,161),xy(150,160)]).
midline(r2, [xy(339,51),xy(325,67),xy(316,86),xy(314,100),xy(315,125)]).
midline(r2, [xy(160,549),xy(190,549),xy(210,566),xy(226,573),xy(241,575),xy(398,574),xy(417,567),xy(439,550)]).
...
midline(r12, [xy(320,413),xy(320,378),xy(312,378),xy(309,381),xy(312,380)]).
midline(r12, [xy(320,376),xy(314,349),xy(314,290),xy(307,274),xy(240,274),xy(223,277),xy(219,279),xy(216,286),xy(215,315)]).
midline(r12, [xy(308,274),xy(310,272),xy(310,219)]).
midline(r12, [xy(319,414),xy(320,430)]).
midline(r12, [xy(322,374),xy(389,375),xy(409,371),xy(414,358),xy(415,334)]).
...
midline(r33, [xy(169,605),xy(125,605),xy(125,634),xy(134,635),xy(553,634),xy(555,632),xy(555,607),xy(549,604),xy(170,605)]).
midline(r33, [xy(555,606),xy(561,604),xy(585,606),xy(585,631),xy(583,634),xy(563,635),xy(555,633)]).
midline(r33, [xy(586,605),xy(613,605),xy(615,609),xy(615,632),xy(609,635),xy(585,633)]).
midline(r33, [xy(615,606),xy(621,604),xy(635,605)]).
...
midline(r34, [xy(345,620),xy(139,620)]).
midline(r34, [xy(346,619),xy(540,620)]).
...
midline(r31, [xy(29,610),xy(20,595),xy(19,586),xy(20,564),xy(29,549)]).
midline(r31, [xy(31,549),xy(36,544),xy(51,539),xy(75,540),xy(90,549)]).
midline(r31, [xy(31,610),xy(36,615),xy(50,620),xy(87,620),xy(97,618),xy(100,609),xy(100,593),xy(99,584),xy(89,570),xy(90,551)]).
...
midline(r4, [xy(139,92),xy(140,60),xy(139,54),xy(135,50),xy(100,49),xy(91,51),xy(89,60),xy(91,74),xy(89,89),xy(91,98),xy(100,100),xy(113,99),xy(115,97),xy(114,76),xy(109,74),xy(92,74)]).
...
midline(r7, [xy(572,85),xy(554,85)]).
midline(r7, [xy(573,84),xy(575,85)]).
...
midline(r5, [xy(559,60),xy(549,60)]).
midline(r5, [xy(560,60),xy(580,60)]).
...
midline(r9, [xy(219,164),xy(205,165),xy(205,184),xy(217,185),xy(224,183),xy(224,166),xy(220,165)]).
...
midline(r29, [xy(369,514),xy(355,515),xy(355,534),xy(369,535),xy(374,533),xy(374,516),xy(370,515)]).
...
midline(r11, [xy(459,194),xy(444,195)]).
midline(r11, [xy(460,195),xy(485,195)]).
...
midline(r13, [xy(335,217),xy(335,245)]).
midline(r13, [xy(335,216),xy(335,204)]).
...
midline(r14, [xy(495,261),xy(495,295)]).
midline(r14, [xy(495,260),xy(495,254)]).
...
midline(r16, [xy(409,304),xy(394,305)]).
midline(r16, [xy(410,305),xy(435,305)]).
...
midline(r24, [xy(219,345),xy(194,345)]).
midline(r24, [xy(220,345),xy(235,345)]).
...
midline(r25, [xy(85,367),xy(85,395)]).
midline(r25, [xy(85,366),xy(85,354)]).
...
midline(r26, [xy(295,417),xy(295,404)]).
midline(r26, [xy(295,418),xy(295,445)]).
...
midline(r27, [xy(495,417),xy(495,404)]).
midline(r27, [xy(495,418),xy(495,445)]).
...
midline(r20, [xy(265,331),xy(265,325),xy(275,325)]).
midline(r20, [xy(264,332),xy(265,335)]).
