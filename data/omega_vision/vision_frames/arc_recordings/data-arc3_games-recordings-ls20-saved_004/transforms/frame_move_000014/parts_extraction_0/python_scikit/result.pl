...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(388,24),xy(81,24),xy(66,26),xy(61,38),xy(59,53),xy(59,99),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,627),xy(114,600),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(108,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,24),xy(519,25),xy(541,19),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,482),xy(625,565),xy(622,581),xy(607,585),xy(513,584),xy(497,576),xy(455,535),xy(429,559),xy(417,567),xy(403,573),xy(388,575),xy(240,575),xy(226,573),xy(210,566),xy(190,549),xy(160,550)]).
midline(r2, [xy(415,32),xy(415,97),xy(414,109),xy(409,123),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(429,390),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,428),xy(468,427),xy(469,429),xy(471,427),xy(469,426)]).
midline(r2, [xy(470,430),xy(472,430),xy(472,427)]).
midline(r2, [xy(473,431),xy(474,428)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,382),xy(203,376),xy(170,371),xy(165,359),xy(165,141),xy(168,130),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(488,438),xy(476,430),xy(478,434)]).
midline(r2, [xy(489,438),xy(507,448)]).
...
midline(r5, [xy(203,74),xy(288,74),xy(303,76),xy(314,81),xy(314,199),xy(266,226),xy(265,242),xy(238,261),xy(195,306),xy(195,344),xy(227,345),xy(239,340),xy(283,294),xy(278,271),xy(265,244)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(284,294),xy(316,325),xy(314,327),xy(315,422),xy(313,425),xy(285,431),xy(274,436),xy(269,463),xy(271,504),xy(276,515),xy(290,519),xy(329,520),xy(344,518),xy(355,513),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(317,324),xy(399,324),xy(422,314),xy(439,299),xy(339,199),xy(315,200)]).
midline(r5, [xy(440,300),xy(539,299),xy(556,279),xy(564,259),xy(564,191),xy(560,178),xy(552,164),xy(550,162),xy(534,168),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,121),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,300),xy(557,322),xy(564,341),xy(565,462),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
fillpoint(r5, xy(278,272), 62.0).
fillpoint(r5, xy(279,275), 61.0).
fillpoint(r5, xy(280,278), 60.0).
fillpoint(r5, xy(281,282), 59.0).
fillpoint(r5, xy(282,286), 58.0).
fillpoint(r5, xy(283,291), 57.0).
...
midline(r22, [xy(377,634),xy(126,634),xy(125,605),xy(135,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(378,635)]).
midline(r22, [xy(556,605),xy(583,605),xy(585,609),xy(585,629),xy(584,633),xy(579,635),xy(555,633)]).
midline(r22, [xy(585,606),xy(590,604),xy(608,604),xy(613,605),xy(615,609),xy(615,631),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r24, [xy(385,620),xy(179,620)]).
midline(r24, [xy(386,619),xy(540,620)]).
...
midline(r18, [xy(589,542),xy(590,530),xy(587,524),xy(572,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(576,550),xy(587,548),xy(589,543)]).
midline(r18, [xy(566,500),xy(579,499),xy(588,501),xy(590,511),xy(589,524)]).
...
midline(r9, [xy(360,260),xy(380,260)]).
...
midline(r11, [xy(205,327),xy(205,315),xy(224,315),xy(224,333),xy(219,335),xy(206,334),xy(204,328)]).
