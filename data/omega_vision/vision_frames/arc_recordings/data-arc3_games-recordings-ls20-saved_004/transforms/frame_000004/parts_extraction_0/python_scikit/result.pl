...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(80,24),xy(66,26),xy(59,50),xy(59,99),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,602),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(106,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(520,25),xy(528,21),xy(540,19),xy(588,19),xy(601,21),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(623,579),xy(619,583),xy(607,585),xy(520,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(465,425),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(415,32),xy(415,99),xy(409,123),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,196),xy(416,213),xy(420,221),xy(442,225),xy(515,225)]).
midline(r2, [xy(454,535),xy(419,566),xy(403,573),xy(389,575),xy(231,574),xy(210,566),xy(190,549),xy(160,549)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,509),xy(215,382),xy(199,375),xy(173,372),xy(168,368),xy(165,359),xy(165,140),xy(170,128),xy(181,125),xy(265,125)]).
...
midline(r5, [xy(202,75),xy(140,74),xy(126,76),xy(118,80),xy(114,101),xy(115,225)]).
midline(r5, [xy(203,74),xy(288,74),xy(303,76),xy(315,81),xy(315,173),xy(306,190),xy(275,236),xy(257,248),xy(253,248),xy(196,304),xy(194,311),xy(195,344),xy(229,345),xy(235,343),xy(278,301),xy(285,291),xy(308,268),xy(276,236)]).
midline(r5, [xy(309,269),xy(315,277),xy(315,422),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,489),xy(274,513),xy(285,518),xy(326,520),xy(344,518),xy(355,513),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(253,250),xy(251,252)]).
midline(r5, [xy(308,267),xy(327,248),xy(341,238),xy(378,201),xy(384,193),xy(385,186),xy(384,156),xy(378,154),xy(346,155),xy(329,168),xy(316,174)]).
midline(r5, [xy(315,274),xy(350,292),xy(376,299),xy(538,300),xy(548,290),xy(556,279),xy(564,258),xy(565,200),xy(562,183),xy(550,162),xy(534,168),xy(513,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(558,105),xy(560,121),xy(558,144),xy(551,161)]).
...
midline(r13, [xy(114,331),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
midline(r13, [xy(115,330),xy(115,324)]).
...
midline(r25, [xy(524,635),xy(130,635),xy(125,633),xy(124,612),xy(125,605),xy(131,604),xy(548,604),xy(555,606),xy(554,633),xy(549,635),xy(525,635)]).
midline(r25, [xy(556,605),xy(579,604),xy(585,606),xy(585,632),xy(577,635),xy(555,633)]).
midline(r25, [xy(586,605),xy(613,605),xy(615,610),xy(615,629),xy(614,633),xy(609,635),xy(585,633)]).
...
midline(r27, [xy(436,620),xy(219,620)]).
midline(r27, [xy(437,619),xy(540,620)]).
...
midline(r21, [xy(589,542),xy(590,530),xy(587,524),xy(570,525),xy(565,523),xy(565,503),xy(563,500),xy(550,499),xy(541,501),xy(539,510),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r21, [xy(565,500),xy(579,499),xy(588,501),xy(590,510),xy(589,524)]).
...
midline(r26, [xy(152,619),xy(200,620)]).
...
midline(r12, [xy(116,284),xy(104,285)]).
midline(r12, [xy(117,284),xy(125,285)]).
...
midline(r11, [xy(109,260),xy(99,260)]).
midline(r11, [xy(110,259),xy(130,260)]).
...
midline(r9, [xy(374,182),xy(375,172),xy(373,165),xy(355,165),xy(354,173),xy(355,184),xy(374,184)]).
...
midline(r14, [xy(219,314),xy(205,315),xy(205,334),xy(217,335),xy(224,333),xy(225,320),xy(224,316),xy(220,315)]).
...
midline(r22, [xy(555,527),xy(555,534),xy(575,535)]).
midline(r22, [xy(555,526),xy(555,514)]).
