...
midline(r2, [xy(112,25),xy(80,24),xy(66,26),xy(60,42),xy(59,99),xy(65,121),xy(65,504),xy(43,524),xy(5,525),xy(4,628),xy(5,634),xy(10,635),xy(113,634),xy(116,594),xy(159,550),xy(141,531),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
...
midline(r2, [xy(416,30),xy(440,24),xy(518,24),xy(520,28)]).
midline(r2, [xy(520,24),xy(542,19),xy(589,19),xy(609,24),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,481),xy(625,569),xy(623,579),xy(619,583),xy(609,585),xy(520,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(465,428),xy(464,424),xy(429,390),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,427),xy(466,429)]).
midline(r2, [xy(468,429),xy(475,433),xy(477,431),xy(478,434),xy(490,440),xy(492,439),xy(492,441)]).
midline(r2, [xy(454,535),xy(422,564),xy(406,572),xy(389,575),xy(240,575),xy(226,573),xy(212,567),xy(189,549),xy(160,550)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,508),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(166,363),xy(164,347),xy(165,141),xy(169,129),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(66,122),xy(66,119),xy(69,117),xy(68,120)]).
...
midline(r5, [xy(336,304),xy(323,320),xy(315,340),xy(314,424),xy(304,428),xy(285,431),xy(274,436),xy(269,460),xy(270,499),xy(276,515),xy(301,520),xy(339,519),xy(353,515),xy(359,499),xy(360,463),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(337,303),xy(348,291),xy(323,242),xy(310,224),xy(264,224),xy(231,259),xy(218,281),xy(196,304),xy(194,312),xy(195,344),xy(233,344),xy(235,339),xy(235,310),xy(233,304),xy(222,292),xy(218,282)]).
midline(r5, [xy(349,291),xy(370,298),xy(391,300),xy(536,300),xy(549,289),xy(556,279),xy(563,263),xy(565,248),xy(565,201),xy(561,180),xy(550,162),xy(534,168),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,300),xy(554,317),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(480,87),xy(495,81),xy(518,79),xy(534,81),xy(551,88),xy(558,105),xy(560,120),xy(558,144),xy(551,161)]).
midline(r5, [xy(311,224),xy(315,220),xy(315,82),xy(313,80),xy(299,75),xy(288,74),xy(140,74),xy(126,76),xy(118,80),xy(114,100),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
...
midline(r24, [xy(524,635),xy(133,635),xy(125,633),xy(125,605),xy(547,604),xy(555,606),xy(554,633),xy(546,635),xy(525,634)]).
midline(r24, [xy(556,605),xy(579,604),xy(584,607),xy(590,604),xy(613,605),xy(615,606),xy(615,630),xy(613,634),xy(608,635),xy(590,635),xy(585,633),xy(563,635),xy(555,633)]).
midline(r24, [xy(616,605),xy(635,605)]).
midline(r24, [xy(585,608),xy(585,632)]).
...
midline(r21, [xy(19,563),xy(20,575),xy(23,579),xy(19,590),xy(21,618),xy(46,620),xy(59,617),xy(59,584),xy(55,580),xy(24,580)]).
midline(r21, [xy(61,617),xy(70,620),xy(88,620),xy(95,619),xy(99,615),xy(100,550),xy(98,542),xy(89,539),xy(24,540),xy(20,544),xy(20,562)]).
...
midline(r25, [xy(291,620),xy(340,620)]).
...
midline(r18, [xy(589,542),xy(590,530),xy(588,525),xy(570,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(550,550),xy(585,549),xy(589,543)]).
midline(r18, [xy(566,500),xy(579,499),xy(588,501),xy(590,512),xy(589,524)]).
...
midline(r26, [xy(510,620),xy(359,620)]).
midline(r26, [xy(511,619),xy(540,620)]).
...
midline(r22, [xy(80,587),xy(80,571),xy(77,561),xy(69,559),xy(39,560)]).
midline(r22, [xy(79,588),xy(80,600)]).
...
midline(r12, [xy(272,335),xy(254,335)]).
midline(r12, [xy(273,334),xy(275,335)]).
...
midline(r9, [xy(262,309),xy(249,310)]).
midline(r9, [xy(263,309),xy(280,310)]).
