...
midline(r2, [xy(508,25),xy(442,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(80,24),xy(66,26),xy(59,50),xy(59,99),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(518,24),xy(520,26)]).
midline(r2, [xy(415,32),xy(415,98),xy(414,109),xy(409,123),xy(404,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(521,24),xy(541,19),xy(589,19),xy(609,24),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(625,568),xy(622,581),xy(608,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(389,575),xy(240,575),xy(226,573),xy(212,567),xy(190,549),xy(160,550)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(430,391),xy(409,378),xy(388,374),xy(364,375)]).
midline(r2, [xy(466,428),xy(470,431),xy(481,433),xy(482,436),xy(483,434)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(165,359),xy(165,140),xy(168,130),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(495,441),xy(486,435),xy(487,438)]).
midline(r2, [xy(490,439),xy(494,442)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(118,80),xy(115,91),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(203,75),xy(287,74),xy(303,76),xy(315,81),xy(315,220),xy(308,227),xy(278,238),xy(276,236),xy(251,250),xy(200,299),xy(194,311),xy(195,344),xy(228,345),xy(235,343),xy(279,300),xy(283,294),xy(279,239)]).
midline(r5, [xy(284,294),xy(302,314),xy(313,336),xy(315,350),xy(315,417),xy(313,425),xy(285,431),xy(274,436),xy(269,461),xy(271,504),xy(276,515),xy(290,519),xy(339,519),xy(355,513),xy(360,487),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(312,226),xy(360,266),xy(376,273),xy(398,275),xy(411,279),xy(425,287),xy(439,300),xy(539,299),xy(556,279),xy(564,259),xy(565,200),xy(563,186),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
...
midline(r5, [xy(540,300),xy(556,320),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(597,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r22, [xy(524,635),xy(131,635),xy(125,633),xy(124,627),xy(125,605),xy(130,604),xy(549,604),xy(554,607),xy(560,604),xy(579,604),xy(585,606),xy(585,629),xy(583,634),xy(560,635),xy(554,632),xy(549,635),xy(525,635)]).
midline(r22, [xy(586,605),xy(609,604),xy(615,606),xy(615,629),xy(614,633),xy(609,635),xy(590,635),xy(585,633)]).
midline(r22, [xy(616,605),xy(635,605)]).
midline(r22, [xy(555,631),xy(555,608)]).
...
midline(r24, [xy(405,620),xy(199,620)]).
midline(r24, [xy(406,620),xy(540,620)]).
...
midline(r18, [xy(589,542),xy(588,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,511),xy(539,539),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r18, [xy(566,500),xy(588,501),xy(589,524)]).
...
midline(r12, [xy(372,335),xy(354,335)]).
midline(r12, [xy(373,334),xy(375,335)]).
...
midline(r23, [xy(150,619),xy(139,620)]).
midline(r23, [xy(151,619),xy(180,620)]).
...
midline(r9, [xy(360,309),xy(380,310)]).
...
midline(r10, [xy(219,314),xy(205,315),xy(205,334),xy(218,335),xy(224,333),xy(224,316),xy(220,315)]).
...
midline(r19, [xy(555,527),xy(555,514)]).
midline(r19, [xy(555,528),xy(555,534),xy(575,535)]).
