...
midline(r2, [xy(112,25),xy(80,24),xy(66,26),xy(60,42),xy(59,98),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(12,635),xy(113,634),xy(115,628),xy(114,604),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,24),xy(389,24),xy(411,29),xy(415,35),xy(415,99),xy(411,119),xy(408,124),xy(404,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(441,24),xy(520,25),xy(528,21),xy(541,19),xy(597,20),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,480),xy(625,568),xy(623,579),xy(619,583),xy(608,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(409,571),xy(389,575),xy(231,574),xy(207,564),xy(190,549),xy(160,549)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(66,121),xy(67,118),xy(70,118),xy(68,120)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(429,390),xy(411,379),xy(399,375),xy(364,375)]).
midline(r2, [xy(466,427),xy(466,429)]).
midline(r2, [xy(468,429),xy(470,431)]).
midline(r2, [xy(472,431),xy(484,435),xy(484,437)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,384),xy(213,380),xy(203,376),xy(173,372),xy(168,368),xy(165,359),xy(165,141),xy(168,130),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(486,437),xy(490,440),xy(493,439),xy(498,444),xy(501,443),xy(500,445)]).
midline(r2, [xy(503,445),xy(504,446)]).
...
border(r2).
region(r5, '#2ecc40', 138300, centroid(345,246)).
perimeter(r5, 4540).
polygon(r5, [xy(609,570),xy(520,569),xy(520,480),xy(540,479),xy(539,350),xy(340,350),xy(340,399),xy(290,400),xy(289,350),xy(190,349),xy(190,150),xy(289,150),xy(289,100),xy(140,100),xy(140,399),xy(190,400),xy(190,499),xy(90,499),xy(90,50),xy(389,50),xy(390,99),xy(340,100),xy(340,149),xy(390,150),xy(390,250),xy(540,249),xy(539,200),xy(440,199),xy(440,50),xy(590,50),xy(590,479),xy(610,480),xy(609,570)]).
...
midline(r5, [xy(202,75),xy(131,75),xy(120,78),xy(115,90),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
midline(r5, [xy(203,75),xy(289,74),xy(303,76),xy(314,81),xy(314,217),xy(316,219),xy(295,243),xy(275,235),xy(249,252),xy(200,299),xy(194,310),xy(195,344),xy(228,345),xy(240,339),xy(278,301),xy(287,288),xy(307,268),xy(302,261),xy(296,244)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(308,268),xy(316,275),xy(314,277),xy(315,375)]).
midline(r5, [xy(317,275),xy(353,293),xy(376,299),xy(392,300),xy(537,300),xy(549,289),xy(556,279),xy(564,259),xy(565,200),xy(561,180),xy(550,162),xy(534,168),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(524,558),xy(525,564),xy(530,565),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(558,105),xy(560,122),xy(558,144),xy(551,161)]).
...
fillpoint(r5, xy(315,363), 25.0).
fillpoint(r5, xy(565,408), 25.0).
region(r1, '#aaaaaa', 20800, centroid(20,260)).
perimeter(r1, 1120).
polygon(r1, [xy(40,0),xy(40,519),xy(0,520)]).
midline(r1, [xy(20,189),xy(20,19)]).
midline(r1, [xy(20,190),xy(20,500)]).
fillpoint(r1, xy(19,260), 20.0).
border(r1).
region(r11, '#2ecc40', 19100, centroid(314,481)).
perimeter(r11, 820).
polygon(r11, [xy(389,550),xy(240,549),xy(240,400),xy(289,400),xy(290,450),xy(339,450),xy(340,400),xy(390,400),xy(389,550)]).
hole(r11, [xy(330,489),xy(329,460),xy(300,460),xy(300,490),xy(330,489)]).
midline(r11, [xy(294,456),xy(283,466),xy(269,471),xy(264,449),xy(265,424)]).
midline(r11, [xy(270,473),xy(270,499),xy(276,515),xy(303,520),xy(329,520),xy(353,515),xy(359,499),xy(360,477),xy(333,455),xy(302,454),xy(295,456)]).
midline(r11, [xy(352,468),xy(358,473),xy(363,463),xy(365,424)]).
midline(r11, [xy(360,473),xy(359,474)]).
fillpoint(r11, xy(275,514), 35.4).
fillpoint(r11, xy(354,514), 35.4).
fillpoint(r11, xy(271,503), 32.0).
fillpoint(r11, xy(358,503), 32.0).
fillpoint(r11, xy(286,518), 32.0).
fillpoint(r11, xy(343,518), 32.0).
fillpoint(r11, xy(270,498), 31.0).
fillpoint(r11, xy(359,498), 31.0).
fillpoint(r11, xy(292,519), 31.0).
fillpoint(r11, xy(338,519), 31.0).
fillpoint(r11, xy(269,480), 30.0).
fillpoint(r11, xy(359,480), 30.0).
fillpoint(r11, xy(301,520), 30.0).
fillpoint(r11, xy(268,468), 29.0).
fillpoint(r11, xy(361,468), 29.0).
fillpoint(r11, xy(267,465), 28.0).
fillpoint(r11, xy(362,465), 28.0).
fillpoint(r11, xy(266,462), 27.0).
fillpoint(r11, xy(363,462), 27.0).
fillpoint(r11, xy(265,458), 26.0).
fillpoint(r11, xy(364,458), 26.0).
fillpoint(r11, xy(265,436), 25.0).
fillpoint(r11, xy(365,436), 25.0).
...
midline(r25, [xy(418,635),xy(133,635),xy(126,634),xy(124,627),xy(125,605),xy(131,604),xy(549,604),xy(555,606),xy(555,631),xy(549,635),xy(419,635)]).
midline(r25, [xy(556,605),xy(578,604),xy(584,607),xy(590,604),xy(609,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r25, [xy(585,608),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r25, [xy(615,608),xy(615,631),xy(613,634),xy(590,635),xy(585,633)]).
...
border(r25).
region(r22, '#aaaaaa', 7600, centroid(58,581)).
perimeter(r22, 720).
polygon(r22, [xy(109,630),xy(10,629),xy(10,530),xy(110,530),xy(109,630)]).
hole(r22, [xy(90,609),xy(89,550),xy(30,550),xy(30,570),xy(70,570),xy(70,610),xy(90,609)]).
hole(r22, [xy(50,609),xy(49,590),xy(30,590),xy(30,610),xy(50,609)]).
midline(r22, [xy(99,553),xy(100,609),xy(97,618),xy(73,620),xy(64,619),xy(59,616),xy(55,619),xy(30,620),xy(21,617),xy(19,607),xy(19,590),xy(23,580),xy(19,568),xy(21,541),xy(31,539),xy(89,539),xy(98,541),xy(100,552)]).
midline(r22, [xy(59,615),xy(60,590),xy(58,582),xy(48,579),xy(24,580)]).
fillpoint(r22, xy(22,580), 12.8).
fillpoint(r22, xy(60,617), 12.8).
fillpoint(r22, xy(22,541), 12.0).
fillpoint(r22, xy(98,541), 12.0).
fillpoint(r22, xy(58,581), 12.0).
fillpoint(r22, xy(21,618), 12.0).
fillpoint(r22, xy(97,618), 12.0).
fillpoint(r22, xy(25,540), 11.0).
fillpoint(r22, xy(94,540), 11.0).
fillpoint(r22, xy(20,545), 11.0).
fillpoint(r22, xy(99,545), 11.0).
fillpoint(r22, xy(20,574), 11.0).
fillpoint(r22, xy(54,580), 11.0).
fillpoint(r22, xy(20,585), 11.0).
fillpoint(r22, xy(59,585), 11.0).
fillpoint(r22, xy(20,614), 11.0).
fillpoint(r22, xy(99,614), 11.0).
fillpoint(r22, xy(25,619), 11.0).
fillpoint(r22, xy(54,619), 11.0).
fillpoint(r22, xy(65,619), 11.0).
fillpoint(r22, xy(94,619), 11.0).
fillpoint(r22, xy(31,540), 10.0).
fillpoint(r22, xy(19,560), 10.0).
fillpoint(r22, xy(99,580), 10.0).
fillpoint(r22, xy(31,580), 10.0).
fillpoint(r22, xy(19,600), 10.0).
fillpoint(r22, xy(59,600), 10.0).
fillpoint(r22, xy(31,620), 10.0).
fillpoint(r22, xy(71,620), 10.0).
region(r27, '#5a5a5a', 5200, centroid(420,620)).
perimeter(r27, 560).
polygon(r27, [xy(549,630),xy(290,630),xy(290,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(464,619),xy(299,620)]).
midline(r27, [xy(465,620),xy(540,620)]).
fillpoint(r27, xy(299,620), 10.0).
...
midline(r19, [xy(589,542),xy(590,535),xy(587,524),xy(571,525),xy(565,523),xy(565,504),xy(563,500),xy(550,499),xy(541,501),xy(539,511),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r19, [xy(565,500),xy(577,499),xy(588,501),xy(590,510),xy(589,524)]).
...
region(r26, '#2ecc40', 3200, centroid(210,620)).
perimeter(r26, 360).
polygon(r26, [xy(289,630),xy(130,630),xy(130,610),xy(289,610),xy(289,630)]).
midline(r26, [xy(279,620),xy(139,620)]).
midline(r26, [xy(280,620),xy(280,619)]).
fillpoint(r26, xy(139,620), 10.0).
region(r23, '#870c25', 2000, centroid(68,572)).
perimeter(r23, 240).
polygon(r23, [xy(89,610),xy(70,609),xy(69,570),xy(30,569),xy(30,550),xy(90,550),xy(89,610)]).
midline(r23, [xy(41,559),xy(39,560)]).
midline(r23, [xy(42,559),xy(78,561),xy(80,570),xy(80,600)]).
fillpoint(r23, xy(78,561), 12.0).
fillpoint(r23, xy(74,560), 11.0).
fillpoint(r23, xy(79,565), 11.0).
fillpoint(r23, xy(39,560), 10.0).
fillpoint(r23, xy(79,586), 10.0).
region(r13, '#870c25', 1500, centroid(314,434)).
perimeter(r13, 160).
polygon(r13, [xy(339,450),xy(290,450),xy(290,420),xy(339,420),xy(339,450)]).
midline(r13, [xy(323,435),xy(304,435)]).
midline(r13, [xy(324,435),xy(325,435)]).
fillpoint(r13, xy(304,435), 15.0).
region(r12, '#bebebe', 1000, centroid(314,410)).
perimeter(r12, 140).
polygon(r12, [xy(339,420),xy(290,420),xy(290,400),xy(339,400),xy(339,420)]).
midline(r12, [xy(309,410),xy(299,410)]).
midline(r12, [xy(310,409),xy(330,410)]).
fillpoint(r12, xy(299,410), 10.0).
...
midline(r9, [xy(219,314),xy(205,315),xy(205,334),xy(219,335),xy(224,333),xy(224,316),xy(220,315)]).
...
midline(r3, [xy(560,45),xy(585,45)]).
...
midline(r20, [xy(555,530),xy(555,514)]).
midline(r20, [xy(555,531),xy(555,534),xy(575,535)]).
fillpoint(r20, xy(555,534), 6.0).
fillpoint(r20, xy(555,521), 5.0).
fillpoint(r20, xy(561,535), 5.0).
region(r24, '#870c25', 400, centroid(40,600)).
perimeter(r24, 80).
...
adjacent(r2, r5).
shared_edge(r2, r5, 3870).
adjacent(r2, r11).
shared_edge(r2, r11, 550).
adjacent(r2, r22).
...
adjacent(r22, r23).
shared_edge(r22, r23, 240).
adjacent(r22, r24).
shared_edge(r22, r24, 80).
adjacent(r25, r26).
shared_edge(r25, r26, 340).
adjacent(r25, r27).
shared_edge(r25, r27, 540).
adjacent(r25, r28).
