...
midline(r2, [xy(164,216),xy(164,349),xy(169,370),xy(181,374),xy(203,376),xy(214,382),xy(231,375),xy(265,375)]).
midline(r2, [xy(215,383),xy(214,509),xy(204,532),xy(189,549),xy(159,549),xy(132,523),xy(122,517),xy(108,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,120),xy(59,98),xy(59,50),xy(66,26),xy(82,24),xy(389,24),xy(403,26),xy(414,32),xy(426,26),xy(443,24),xy(519,25),xy(528,21),xy(542,19),xy(586,19),xy(604,22),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,483),xy(625,569),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(409,571),xy(389,575),xy(230,574),xy(212,567),xy(190,550)]).
midline(r2, [xy(415,33),xy(415,98),xy(414,109),xy(409,123),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,198),xy(416,213),xy(420,221),xy(440,225),xy(515,225)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(430,391),xy(409,378),xy(387,374),xy(364,375)]).
midline(r2, [xy(467,429),xy(469,427),xy(468,430)]).
midline(r2, [xy(471,429),xy(470,430)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(119,79),xy(115,91),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(203,75),xy(288,74),xy(303,76),xy(315,81),xy(315,221),xy(289,249),xy(316,275),xy(314,278),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,463),xy(270,499),xy(276,515),xy(301,520),xy(329,520),xy(353,515),xy(358,504),xy(360,487),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(317,276),xy(350,292),xy(370,298),xy(394,300),xy(440,299),xy(460,316),xy(481,324),xy(558,324),xy(563,336),xy(565,351),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(597,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(559,323),xy(564,309),xy(565,298),xy(565,201),xy(561,180),xy(551,163),xy(529,169),xy(512,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,129),xy(558,105),xy(552,90),xy(534,81),xy(518,79),xy(495,81),xy(480,87)]).
...
fillpoint(r5, xy(561,318), 29.0).
fillpoint(r5, xy(471,321), 29.0).
...
fillpoint(r5, xy(562,315), 28.0).
fillpoint(r5, xy(474,322), 28.0).
...
fillpoint(r5, xy(563,312), 27.0).
fillpoint(r5, xy(477,323), 27.0).
...
fillpoint(r5, xy(564,308), 26.0).
fillpoint(r5, xy(482,324), 26.0).
...
midline(r22, [xy(169,605),xy(125,605),xy(125,634),xy(132,635),xy(553,634),xy(555,632),xy(555,609),xy(553,605),xy(549,604),xy(170,605)]).
midline(r22, [xy(555,606),xy(562,604),xy(585,606),xy(585,632),xy(583,634),xy(564,635),xy(555,633)]).
midline(r22, [xy(586,605),xy(608,604),xy(615,606),xy(615,630),xy(613,634),xy(607,635),xy(585,633)]).
...
midline(r19, [xy(19,563),xy(20,544),xy(24,540),xy(87,539),xy(98,541),xy(100,553),xy(100,609),xy(99,615),xy(95,619),xy(70,620),xy(59,616),xy(49,620),xy(22,618),xy(19,605),xy(20,584),xy(23,580),xy(20,575),xy(20,564)]).
midline(r19, [xy(59,615),xy(60,592),xy(58,582),xy(49,579),xy(24,579)]).
...
region(r24, '#5a5a5a', 5600, centroid(410,620)).
perimeter(r24, 600).
polygon(r24, [xy(549,630),xy(270,630),xy(270,610),xy(549,610),xy(549,630)]).
midline(r24, [xy(444,619),xy(279,620)]).
midline(r24, [xy(445,620),xy(540,620)]).
fillpoint(r24, xy(279,620), 10.0).
...
midline(r16, [xy(589,542),xy(590,530),xy(588,525),xy(565,523),xy(565,504),xy(563,500),xy(550,499),xy(541,501),xy(539,511),xy(539,539),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
...
region(r23, '#2ecc40', 2800, centroid(200,620)).
perimeter(r23, 320).
polygon(r23, [xy(269,630),xy(130,630),xy(130,610),xy(269,610),xy(269,630)]).
midline(r23, [xy(141,619),xy(139,620)]).
midline(r23, [xy(142,620),xy(260,620)]).
...
midline(r20, [xy(80,587),xy(80,570),xy(77,561),xy(66,559),xy(39,560)]).
...
region(r10, '#870c25', 1500, centroid(514,284)).
perimeter(r10, 160).
polygon(r10, [xy(539,300),xy(490,300),xy(490,270),xy(539,270),xy(539,300)]).
midline(r10, [xy(510,285),xy(504,285)]).
midline(r10, [xy(511,285),xy(525,285)]).
fillpoint(r10, xy(504,285), 15.0).
region(r9, '#bebebe', 1000, centroid(514,260)).
perimeter(r9, 140).
polygon(r9, [xy(539,270),xy(490,270),xy(490,250),xy(539,250),xy(539,270)]).
midline(r9, [xy(511,260),xy(499,260)]).
midline(r9, [xy(512,260),xy(530,260)]).
fillpoint(r9, xy(499,260), 10.0).
...
midline(r17, [xy(555,524),xy(555,534),xy(575,535)]).
midline(r17, [xy(555,523),xy(555,514)]).
...
adjacent(r22, r23).
shared_edge(r22, r23, 300).
adjacent(r22, r24).
shared_edge(r22, r24, 580).
adjacent(r22, r25).
