...
midline(r2, [xy(164,215),xy(164,150),xy(169,129),xy(192,124),xy(265,125)]).
midline(r2, [xy(165,216),xy(164,347),xy(166,363),xy(170,371),xy(203,376),xy(215,381),xy(215,498),xy(213,513),xy(206,529),xy(188,550),xy(161,550),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,531),xy(4,628),xy(5,634),xy(10,635),xy(113,634),xy(115,627),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,120),xy(61,111),xy(59,97),xy(59,51),xy(61,38),xy(66,26),xy(80,24),xy(389,24),xy(403,26),xy(415,31),xy(415,98),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(430,25),xy(443,24),xy(519,25),xy(528,21),xy(543,19),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,481),xy(624,576),xy(621,582),xy(609,585),xy(520,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(465,425),xy(430,391),xy(411,379),xy(399,375),xy(364,375)]).
midline(r2, [xy(466,428),xy(473,432),xy(476,431),xy(475,433)]).
midline(r2, [xy(478,432),xy(482,433),xy(483,436),xy(485,435),xy(484,437)]).
midline(r2, [xy(454,535),xy(422,564),xy(406,572),xy(389,575),xy(230,574),xy(207,564),xy(190,549)]).
midline(r2, [xy(486,438),xy(490,438),xy(498,442),xy(498,444)]).
...
midline(r5, [xy(551,163),xy(560,178),xy(564,190),xy(565,249),xy(563,263),xy(556,279),xy(539,300),xy(390,300),xy(376,299),xy(350,292),xy(347,289),xy(341,269),xy(338,230),xy(330,207),xy(314,199),xy(239,199),xy(223,220),xy(215,241),xy(214,299),xy(218,319),xy(226,323),xy(242,325),xy(315,324),xy(315,423),xy(274,436),xy(269,460),xy(270,499),xy(274,513),xy(285,518),xy(300,520),xy(339,519),xy(355,513),xy(360,488),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(348,291),xy(316,323)]).
midline(r5, [xy(540,301),xy(554,317),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(525,564),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(315,198),xy(315,82),xy(313,80),xy(289,74),xy(140,74),xy(119,79),xy(114,101),xy(114,398),xy(119,421),xy(127,435),xy(140,450)]).
...
midline(r22, [xy(524,635),xy(132,635),xy(126,634),xy(124,629),xy(125,605),xy(131,604),xy(549,604),xy(553,605),xy(555,609),xy(555,632),xy(549,635),xy(525,635)]).
midline(r22, [xy(555,606),xy(579,604),xy(583,605),xy(585,610),xy(585,632),xy(583,634),xy(561,635),xy(555,633)]).
midline(r22, [xy(585,606),xy(590,604),xy(607,604),xy(613,605),xy(615,610),xy(615,632),xy(613,634),xy(592,635),xy(585,633)]).
...
midline(r19, [xy(99,553),xy(100,608),xy(97,618),xy(70,620),xy(59,616),xy(55,619),xy(45,620),xy(24,619),xy(20,615),xy(19,608),xy(19,590),xy(23,579),xy(19,569),xy(21,541),xy(30,539),xy(88,539),xy(98,541),xy(100,552)]).
...
midline(r24, [xy(396,620),xy(179,620)]).
midline(r24, [xy(397,619),xy(540,620)]).
...
midline(r16, [xy(589,542),xy(590,532),xy(587,524),xy(571,525),xy(565,523),xy(564,500),xy(552,499),xy(541,501),xy(539,510),xy(541,548),xy(578,550),xy(587,548),xy(589,543)]).
...
midline(r20, [xy(80,596),xy(80,570),xy(77,561),xy(69,559),xy(39,560)]).
midline(r20, [xy(79,597),xy(80,600)]).
...
midline(r10, [xy(262,285),xy(254,285)]).
midline(r10, [xy(263,284),xy(275,285)]).
...
midline(r9, [xy(270,260),xy(249,260)]).
midline(r9, [xy(271,260),xy(280,260)]).
...
midline(r23, [xy(150,620),xy(160,620)]).
...
midline(r4, [xy(85,73),xy(85,54)]).
midline(r4, [xy(85,74),xy(85,95)]).
