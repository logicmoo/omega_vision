...
midline(r2, [xy(164,215),xy(164,150),xy(166,136),xy(170,128),xy(191,124),xy(265,125)]).
midline(r2, [xy(165,216),xy(164,349),xy(166,363),xy(170,371),xy(199,375),xy(215,381),xy(215,496),xy(213,513),xy(207,527),xy(189,550),xy(161,550),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,530),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(191,550),xy(210,566),xy(231,574),xy(389,575),xy(403,573),xy(419,566),xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(411,379),xy(388,374),xy(364,375)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,99),xy(59,50),xy(66,26),xy(80,24),xy(389,24),xy(403,26),xy(413,30),xy(415,35),xy(415,95),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(442,24),xy(519,25),xy(541,19),xy(586,19),xy(601,21),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,482),xy(624,576),xy(621,582),xy(609,585),xy(513,584),xy(497,576),xy(455,535)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(430,224),xy(442,225),xy(515,225)]).
midline(r2, [xy(466,429),xy(467,426),xy(465,424)]).
midline(r2, [xy(468,427),xy(471,428),xy(468,429)]).
midline(r2, [xy(472,429),xy(472,431),xy(470,430)]).
midline(r2, [xy(473,432),xy(474,431)]).
midline(r2, [xy(66,120),xy(69,117),xy(69,119)]).
midline(r2, [xy(216,380),xy(231,375),xy(265,375)]).
midline(r2, [xy(520,26),xy(521,27)]).
...
midline(r5, [xy(202,75),xy(140,74),xy(126,76),xy(118,80),xy(114,100),xy(115,275)]).
midline(r5, [xy(203,75),xy(288,74),xy(303,76),xy(313,80),xy(315,84),xy(315,174),xy(288,217),xy(279,226),xy(280,230),xy(277,235),xy(256,247),xy(238,261),xy(196,304),xy(194,311),xy(195,344),xy(229,345),xy(235,343),xy(279,300),xy(288,287),xy(307,268),xy(277,237)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(281,226),xy(282,225)]).
midline(r5, [xy(316,174),xy(319,173),xy(320,175),xy(323,172),xy(320,172)]).
midline(r5, [xy(323,170),xy(330,167),xy(325,172)]).
midline(r5, [xy(332,167),xy(344,156),xy(350,154),xy(384,155),xy(385,187),xy(380,199),xy(341,238),xy(327,248),xy(308,267),xy(315,275),xy(315,421),xy(313,425),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(300,520),xy(339,519),xy(353,515),xy(358,504),xy(360,461),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(310,267),xy(327,250)]).
midline(r5, [xy(316,275),xy(353,293),xy(376,299),xy(390,300),xy(538,300),xy(549,289),xy(560,271),xy(564,258),xy(565,203),xy(562,183),xy(550,162),xy(534,168),xy(511,170),xy(495,168),xy(477,159),xy(471,144),xy(469,121),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,300),xy(554,317),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
border(r1).
region(r15, '#2ecc40', 12500, centroid(134,434)).
perimeter(r15, 500).
polygon(r15, [xy(189,500),xy(90,499),xy(90,350),xy(139,350),xy(140,399),xy(190,400),xy(189,500)]).
midline(r15, [xy(115,379),xy(114,398),xy(118,419),xy(127,435),xy(140,450)]).
midline(r15, [xy(115,378),xy(115,374)]).
fillpoint(r15, xy(139,450), 50.0).
fillpoint(r15, xy(118,418), 29.0).
fillpoint(r15, xy(117,415), 28.0).
fillpoint(r15, xy(116,412), 27.0).
fillpoint(r15, xy(115,408), 26.0).
fillpoint(r15, xy(115,386), 25.0).
...
midline(r25, [xy(418,635),xy(130,635),xy(125,633),xy(124,611),xy(125,605),xy(131,604),xy(548,604),xy(554,607),xy(563,604),xy(579,604),xy(583,605),xy(585,610),xy(585,632),xy(578,635),xy(555,633),xy(549,635),xy(419,635)]).
midline(r25, [xy(585,606),xy(590,604),xy(609,604),xy(615,606),xy(615,632),xy(613,634),xy(591,635),xy(585,633)]).
...
region(r27, '#5a5a5a', 7200, centroid(370,620)).
perimeter(r27, 760).
polygon(r27, [xy(549,630),xy(190,630),xy(190,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(485,619),xy(199,620)]).
midline(r27, [xy(486,620),xy(540,620)]).
fillpoint(r27, xy(199,620), 10.0).
...
midline(r21, [xy(589,542),xy(590,532),xy(588,525),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(550,550),xy(578,550),xy(587,548),xy(589,543)]).
midline(r21, [xy(566,500),xy(579,499),xy(588,501),xy(590,512),xy(589,524)]).
...
region(r13, '#870c25', 1500, centroid(114,334)).
perimeter(r13, 160).
polygon(r13, [xy(139,350),xy(90,350),xy(90,320),xy(139,320),xy(139,350)]).
midline(r13, [xy(116,334),xy(104,335)]).
midline(r13, [xy(117,334),xy(125,335)]).
fillpoint(r13, xy(104,335), 15.0).
region(r26, '#2ecc40', 1200, centroid(160,620)).
perimeter(r26, 160).
polygon(r26, [xy(189,630),xy(130,630),xy(130,610),xy(189,610),xy(189,630)]).
midline(r26, [xy(149,620),xy(139,620)]).
midline(r26, [xy(150,620),xy(180,620)]).
fillpoint(r26, xy(139,620), 10.0).
region(r11, '#bebebe', 1000, centroid(114,310)).
perimeter(r11, 140).
polygon(r11, [xy(139,320),xy(90,320),xy(90,300),xy(139,300),xy(139,320)]).
midline(r11, [xy(109,310),xy(99,310)]).
midline(r11, [xy(110,309),xy(130,310)]).
fillpoint(r11, xy(99,310), 10.0).
...
midline(r9, [xy(374,182),xy(375,171),xy(373,165),xy(355,165),xy(354,170),xy(355,184),xy(374,184)]).
...
region(r12, '#5a5a5a', 800, centroid(214,324)).
perimeter(r12, 160).
polygon(r12, [xy(229,340),xy(200,339),xy(200,310),xy(230,310),xy(229,340)]).
hole(r12, [xy(220,329),xy(219,320),xy(210,320),xy(210,330),xy(220,329)]).
midline(r12, [xy(205,327),xy(205,315),xy(224,315),xy(225,321),xy(223,334),xy(206,334),xy(205,328)]).
fillpoint(r12, xy(206,315), 6.0).
fillpoint(r12, xy(224,315), 6.0).
fillpoint(r12, xy(205,334), 6.0).
fillpoint(r12, xy(223,334), 6.0).
fillpoint(r12, xy(211,315), 5.0).
fillpoint(r12, xy(204,325), 5.0).
fillpoint(r12, xy(224,325), 5.0).
fillpoint(r12, xy(211,335), 5.0).
...
midline(r22, [xy(555,527),xy(555,514)]).
midline(r22, [xy(555,528),xy(555,534),xy(575,535)]).
...
adjacent(r12, r14).
shared_edge(r12, r14, 40).
adjacent(r13, r15).
shared_edge(r13, r15, 50).
adjacent(r21, r22).
shared_edge(r21, r22, 120).
adjacent(r21, r23).
shared_edge(r21, r23, 40).
adjacent(r25, r26).
shared_edge(r25, r26, 140).
adjacent(r25, r27).
shared_edge(r25, r27, 740).
adjacent(r25, r28).
