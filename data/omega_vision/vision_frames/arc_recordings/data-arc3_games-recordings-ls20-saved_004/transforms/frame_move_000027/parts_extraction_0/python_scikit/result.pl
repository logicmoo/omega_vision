...
midline(r2, [xy(164,215),xy(164,151),xy(166,136),xy(170,128),xy(193,124),xy(265,125)]).
midline(r2, [xy(165,216),xy(164,349),xy(169,370),xy(180,374),xy(203,376),xy(214,382),xy(231,375),xy(265,375)]).
midline(r2, [xy(215,383),xy(214,508),xy(206,529),xy(189,550),xy(160,550),xy(132,523),xy(122,517),xy(116,515),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,624),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(191,550),xy(207,564),xy(231,574),xy(389,575),xy(403,573),xy(422,564),xy(455,534),xy(455,464),xy(459,444),xy(466,426),xy(440,400),xy(419,383),xy(398,375),xy(364,375)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,98),xy(59,50),xy(66,26),xy(81,24),xy(387,24),xy(403,26),xy(413,30),xy(415,34),xy(415,99),xy(412,116),xy(406,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(441,24),xy(520,25),xy(528,21),xy(542,19),xy(597,20),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,481),xy(624,576),xy(621,582),xy(608,585),xy(513,584),xy(497,576),xy(455,535)]).
midline(r2, [xy(466,428),xy(467,426)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,195),xy(415,209),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(487,437),xy(484,434),xy(477,433),xy(472,428),xy(469,428),xy(469,430)]).
midline(r2, [xy(482,436),xy(486,438)]).
midline(r2, [xy(475,433),xy(472,430)]).
...
midline(r5, [xy(203,75),xy(284,74),xy(299,75),xy(315,81),xy(314,196),xy(303,199),xy(270,201),xy(248,208),xy(241,230),xy(239,250),xy(239,300),xy(254,312),xy(270,321),xy(280,324),xy(299,325),xy(315,331),xy(315,423),xy(274,436),xy(269,462),xy(270,499),xy(274,513),xy(285,518),xy(301,520),xy(339,519),xy(355,513),xy(360,488),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(315,196),xy(326,199),xy(340,199),xy(352,214),xy(363,236),xy(368,269),xy(377,285),xy(389,298),xy(375,312),xy(359,321),xy(349,324),xy(330,325),xy(316,330)]).
midline(r5, [xy(390,300),xy(539,300),xy(552,285),xy(560,271),xy(565,249),xy(565,202),xy(560,178),xy(550,162),xy(534,168),xy(515,170),xy(495,168),xy(477,159),xy(471,144),xy(469,122),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,301),xy(554,317),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(524,558),xy(525,564),xy(532,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r22, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(130,604),xy(549,604),xy(553,605),xy(555,609),xy(554,633),xy(548,635),xy(525,635)]).
midline(r22, [xy(555,606),xy(560,604),xy(577,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r22, [xy(585,606),xy(590,604),xy(609,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r22, [xy(615,608),xy(615,632),xy(613,634),xy(595,635),xy(585,633)]).
...
midline(r19, [xy(19,563),xy(20,544),xy(24,540),xy(89,539),xy(98,541),xy(100,550),xy(100,609),xy(99,615),xy(95,619),xy(73,620),xy(64,619),xy(59,616),xy(48,620),xy(22,618),xy(19,609),xy(19,590),xy(23,580),xy(20,575),xy(20,564)]).
midline(r19, [xy(59,615),xy(60,594),xy(58,582),xy(49,579),xy(24,580)]).
...
midline(r24, [xy(365,619),xy(540,620)]).
...
midline(r16, [xy(589,542),xy(590,530),xy(588,524),xy(573,525),xy(565,523),xy(565,504),xy(563,500),xy(550,499),xy(541,501),xy(539,510),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(565,500),xy(578,499),xy(588,501),xy(590,510),xy(589,523)]).
...
midline(r20, [xy(80,587),xy(79,564),xy(77,561),xy(68,559),xy(39,560)]).
midline(r20, [xy(79,588),xy(80,600)]).
...
midline(r10, [xy(310,285),xy(304,285)]).
midline(r10, [xy(311,284),xy(325,285)]).
...
midline(r9, [xy(310,260),xy(330,260)]).
...
midline(r17, [xy(555,525),xy(555,534),xy(575,535)]).
