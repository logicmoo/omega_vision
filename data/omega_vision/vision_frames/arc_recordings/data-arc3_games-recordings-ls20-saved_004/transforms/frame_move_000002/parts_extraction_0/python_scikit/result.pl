...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(82,24),xy(66,26),xy(61,38),xy(59,53),xy(59,97),xy(61,111),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,622),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(520,25),xy(528,21),xy(540,19),xy(588,19),xy(609,24),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,481),xy(625,568),xy(622,581),xy(607,585),xy(513,584),xy(497,576),xy(455,535),xy(417,567),xy(403,573),xy(388,575),xy(230,574),xy(207,564),xy(190,549),xy(160,549)]).
midline(r2, [xy(415,32),xy(415,98),xy(414,109),xy(409,123),xy(405,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(416,213),xy(420,221),xy(445,225),xy(515,225)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(429,390),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,428),xy(470,431),xy(475,430),xy(475,432)]).
midline(r2, [xy(477,432),xy(477,430)]).
midline(r2, [xy(479,432),xy(485,436)]).
...
midline(r5, [xy(551,163),xy(561,180),xy(564,190),xy(564,259),xy(556,279),xy(549,289),xy(537,300),xy(391,300),xy(366,297),xy(348,291),xy(314,274),xy(275,235),xy(243,256),xy(196,304),xy(194,310),xy(194,339),xy(195,344),xy(200,345),xy(229,345),xy(235,343),xy(278,301),xy(285,291),xy(307,269)]).
midline(r5, [xy(276,235),xy(315,173),xy(315,89),xy(313,80),xy(303,76),xy(287,74),xy(141,74),xy(119,79),xy(114,100),xy(115,325)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(316,174),xy(325,169),xy(321,174)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,341),xy(565,463),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(314,275),xy(315,423),xy(274,436),xy(270,450),xy(269,484),xy(271,504),xy(276,515),xy(290,519),xy(329,520),xy(344,518),xy(355,513),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(327,171),xy(329,169)]).
midline(r5, [xy(331,168),xy(344,156),xy(350,154),xy(384,155),xy(385,189),xy(379,200),xy(309,267)]).
...
midline(r25, [xy(524,635),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(555,606),xy(554,633),xy(549,635),xy(525,634)]).
midline(r25, [xy(556,605),xy(579,604),xy(585,606),xy(585,629),xy(583,634),xy(576,635),xy(560,635),xy(555,633)]).
midline(r25, [xy(586,605),xy(606,604),xy(615,606),xy(615,630),xy(613,634),xy(609,635),xy(585,633)]).
...
midline(r27, [xy(465,619),xy(179,620)]).
midline(r27, [xy(466,620),xy(540,620)]).
...
midline(r21, [xy(589,542),xy(590,531),xy(588,524),xy(571,525),xy(565,523),xy(564,500),xy(552,499),xy(541,501),xy(539,513),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r21, [xy(589,523),xy(588,502),xy(579,499),xy(566,500)]).
...
midline(r13, [xy(110,359),xy(130,360)]).
...
midline(r26, [xy(160,620),xy(139,620)]).
