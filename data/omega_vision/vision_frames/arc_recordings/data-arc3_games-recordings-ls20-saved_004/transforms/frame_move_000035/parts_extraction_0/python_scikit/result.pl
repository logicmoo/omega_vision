...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(387,24),xy(80,24),xy(66,26),xy(59,50),xy(59,98),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,627),xy(114,600),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(517,24),xy(519,26),xy(528,21),xy(541,19),xy(589,19),xy(609,24),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(622,581),xy(608,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(409,571),xy(389,575),xy(230,574),xy(210,566),xy(190,549),xy(160,549)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,428),xy(464,424),xy(429,390),xy(409,378),xy(388,374),xy(364,375)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(166,363),xy(164,348),xy(165,141),xy(169,129),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,95),xy(414,109),xy(409,123),xy(407,125),xy(364,125)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(120,78),xy(115,90),xy(114,394),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,74),xy(288,74),xy(303,76),xy(315,81),xy(315,221),xy(289,249),xy(315,275),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(301,520),xy(339,519),xy(353,515),xy(358,504),xy(360,487),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(316,275),xy(348,291),xy(376,299),xy(539,299),xy(554,317),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(597,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(316,80),xy(330,75),xy(365,75)]).
midline(r5, [xy(540,298),xy(556,279),xy(564,259),xy(565,203),xy(563,186),xy(560,179),xy(553,176),xy(531,174),xy(517,169),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(518,168),xy(529,145),xy(529,139),xy(535,129),xy(534,116),xy(529,110),xy(529,104),xy(525,95),xy(516,79),xy(495,81),xy(480,87)]).
midline(r5, [xy(518,79),xy(531,75),xy(565,75)]).
...
midline(r22, [xy(418,635),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(554,607),xy(560,604),xy(576,604),xy(585,606),xy(584,633),xy(578,635),xy(561,635),xy(554,632),xy(553,634),xy(545,635),xy(419,634)]).
midline(r22, [xy(586,605),xy(613,605),xy(615,611),xy(615,631),xy(613,634),xy(606,635),xy(585,633)]).
...
midline(r19, [xy(99,553),xy(98,542),xy(89,539),xy(35,539),xy(21,541),xy(19,550),xy(19,569),xy(23,580),xy(20,584),xy(19,592),xy(21,618),xy(30,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(49,579),xy(24,580)]).
midline(r19, [xy(100,554),xy(100,608),xy(98,617),xy(85,620),xy(70,620),xy(60,617)]).
...
midline(r16, [xy(589,542),xy(588,524),xy(571,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,512),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(589,523),xy(590,510),xy(588,502),xy(578,499),xy(566,500)]).
...
midline(r24, [xy(500,620),xy(540,620)]).
...
midline(r9, [xy(567,134),xy(575,135)]).
...
midline(r4, [xy(85,70),xy(85,95)]).
midline(r4, [xy(85,69),xy(85,54)]).
