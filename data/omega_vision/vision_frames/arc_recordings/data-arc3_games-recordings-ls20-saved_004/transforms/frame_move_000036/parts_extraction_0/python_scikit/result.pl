...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(388,24),xy(85,24),xy(66,26),xy(61,38),xy(59,52),xy(60,107),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,24),xy(517,24),xy(518,28),xy(521,24),xy(532,20),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,481),xy(625,565),xy(622,581),xy(608,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(406,572),xy(389,575),xy(230,574),xy(207,564),xy(190,549),xy(160,550)]).
midline(r2, [xy(415,32),xy(415,99),xy(409,123),xy(405,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,198),xy(416,213),xy(420,221),xy(440,225),xy(515,225)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(481,435),xy(483,434),xy(482,436)]).
midline(r2, [xy(485,436),xy(484,437)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(166,363),xy(164,346),xy(165,140),xy(168,130),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(521,29),xy(522,30)]).
...
midline(r5, [xy(565,127),xy(564,91),xy(559,78),xy(539,74),xy(480,75),xy(469,79),xy(465,90),xy(464,147),xy(469,170),xy(490,175),xy(558,174),xy(561,180),xy(565,201),xy(564,259),xy(554,282),xy(539,299),xy(376,299),xy(350,292),xy(315,275),xy(289,250)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(525,564),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(290,248),xy(315,220),xy(315,83),xy(313,80),xy(303,76),xy(286,74),xy(141,74),xy(126,76),xy(118,80),xy(114,100),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(559,173),xy(564,159),xy(564,128)]).
midline(r5, [xy(314,276),xy(315,422),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,486),xy(274,513),xy(285,518),xy(329,520),xy(344,518),xy(355,513),xy(360,485),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
midline(r19, [xy(524,635),xy(132,635),xy(126,634),xy(124,628),xy(125,605),xy(132,604),xy(547,604),xy(554,607),xy(562,604),xy(579,604),xy(585,606),xy(585,631),xy(583,634),xy(525,635)]).
midline(r19, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(608,635),xy(585,633)]).
...
midline(r16, [xy(99,562),xy(99,544),xy(95,540),xy(72,539),xy(64,540),xy(60,543),xy(48,539),xy(21,541),xy(19,550),xy(19,568),xy(23,580),xy(19,590),xy(21,618),xy(32,620),xy(89,620),xy(97,618),xy(100,608),xy(100,563)]).
...
midline(r20, [xy(280,619),xy(360,620)]).
...
midline(r13, [xy(589,542),xy(590,531),xy(588,525),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r13, [xy(566,500),xy(579,499),xy(588,501),xy(590,512),xy(589,524)]).
...
midline(r21, [xy(530,620),xy(379,620)]).
midline(r21, [xy(531,620),xy(540,620)]).
...
midline(r6, [xy(511,110),xy(499,110)]).
midline(r6, [xy(512,110),xy(530,110)]).
...
midline(r14, [xy(555,527),xy(555,514)]).
midline(r14, [xy(555,528),xy(555,534),xy(575,535)]).
