...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(80,24),xy(66,26),xy(59,50),xy(59,99),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,24),xy(520,26)]).
midline(r2, [xy(415,32),xy(415,99),xy(409,123),xy(398,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(416,213),xy(420,221),xy(441,225),xy(515,225)]).
midline(r2, [xy(521,24),xy(541,19),xy(588,19),xy(601,21),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,484),xy(625,569),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(417,567),xy(403,573),xy(388,575),xy(230,574),xy(210,566),xy(189,549),xy(160,550)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(429,390),xy(409,378),xy(388,374),xy(364,375)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(199,375),xy(180,374),xy(170,371),xy(165,359),xy(165,141),xy(169,129),xy(180,125),xy(265,125)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(119,79),xy(115,91),xy(114,398),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,74),xy(289,74),xy(309,78),xy(315,84),xy(315,220),xy(310,223),xy(290,212),xy(267,203),xy(239,200)]).
midline(r5, [xy(312,224),xy(317,276),xy(302,287),xy(279,309),xy(261,320),xy(249,324),xy(214,325)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(318,276),xy(350,292),xy(370,298),xy(390,300),xy(537,300),xy(549,289),xy(560,271),xy(564,258),xy(565,201),xy(562,183),xy(551,163),xy(529,169),xy(500,169),xy(486,165),xy(477,159),xy(471,144),xy(469,124),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,127),xy(558,105),xy(552,90),xy(543,84),xy(519,79),xy(495,81),xy(480,87)]).
...
midline(r5, [xy(314,281),xy(315,420),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,488),xy(274,513),xy(285,518),xy(326,520),xy(344,518),xy(355,513),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
midline(r22, [xy(524,635),xy(131,635),xy(125,633),xy(125,605),xy(549,604),xy(555,606),xy(555,632),xy(548,635),xy(525,634)]).
midline(r22, [xy(556,605),xy(579,604),xy(584,607),xy(590,604),xy(608,604),xy(615,606),xy(614,633),xy(609,635),xy(590,635),xy(584,632),xy(585,608)]).
midline(r22, [xy(616,605),xy(635,605)]).
midline(r22, [xy(584,633),xy(573,635),xy(555,633)]).
...
midline(r24, [xy(365,620),xy(159,620)]).
midline(r24, [xy(366,619),xy(540,620)]).
...
midline(r19, [xy(54,539),xy(21,541),xy(19,569),xy(23,580),xy(20,584),xy(19,608),xy(21,618),xy(24,619),xy(48,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(49,579),xy(24,579)]).
midline(r19, [xy(55,539),xy(95,540),xy(98,541),xy(100,550),xy(100,608),xy(98,617),xy(88,620),xy(70,620),xy(60,617)]).
...
midline(r16, [xy(589,542),xy(590,530),xy(588,524),xy(571,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(541,548),xy(550,550),xy(578,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(589,523),xy(590,511),xy(588,502),xy(578,499),xy(566,500)]).
...
midline(r20, [xy(80,587),xy(80,571),xy(77,561),xy(68,559),xy(39,560)]).
...
midline(r10, [xy(212,285),xy(204,285)]).
midline(r10, [xy(213,285),xy(225,285)]).
...
midline(r9, [xy(220,260),xy(199,260)]).
midline(r9, [xy(221,259),xy(230,260)]).
