...
midline(r2, [xy(508,25),xy(441,24),xy(426,26),xy(415,31),xy(403,26),xy(388,24),xy(80,24),xy(66,26),xy(59,50),xy(59,99),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,628),xy(114,601),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(519,25),xy(528,21),xy(543,19),xy(586,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,483),xy(625,567),xy(623,579),xy(619,583),xy(609,585),xy(521,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(465,428),xy(464,424),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(415,32),xy(415,98),xy(413,113),xy(409,123),xy(405,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(466,429),xy(470,429),xy(470,431)]).
midline(r2, [xy(454,535),xy(430,558),xy(417,567),xy(403,573),xy(387,575),xy(240,575),xy(226,573),xy(212,567),xy(190,549),xy(160,550)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(199,375),xy(173,372),xy(166,363),xy(164,348),xy(165,140),xy(168,130),xy(180,125),xy(265,125)]).
...
midline(r5, [xy(202,75),xy(131,75),xy(120,78),xy(115,90),xy(114,397),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,75),xy(289,74),xy(303,76),xy(315,81),xy(314,217),xy(316,219),xy(289,249),xy(316,280),xy(314,282),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(300,520),xy(339,519),xy(353,515),xy(358,504),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(317,280),xy(360,316),xy(376,323),xy(393,325),xy(449,324),xy(469,316),xy(489,299),xy(538,300),xy(549,289),xy(557,277),xy(564,259),xy(565,201),xy(561,180),xy(550,162),xy(534,168),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,121),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,300),xy(554,317),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(480,87),xy(495,81),xy(515,79),xy(534,81),xy(551,88),xy(558,105),xy(560,122),xy(558,144),xy(551,161)]).
...
midline(r22, [xy(377,634),xy(126,634),xy(124,629),xy(125,605),xy(136,604),xy(544,604),xy(555,606),xy(555,632),xy(553,634),xy(378,635)]).
midline(r22, [xy(556,605),xy(583,605),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r22, [xy(585,606),xy(590,604),xy(615,606),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r19, [xy(99,553),xy(98,542),xy(89,539),xy(30,539),xy(21,541),xy(19,551),xy(20,575),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,614),xy(58,582),xy(49,579),xy(24,580)]).
...
midline(r24, [xy(525,619),xy(239,620)]).
midline(r24, [xy(526,620),xy(540,620)]).
...
midline(r16, [xy(589,542),xy(590,531),xy(588,525),xy(570,525),xy(565,523),xy(565,503),xy(563,500),xy(550,499),xy(541,501),xy(539,512),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(565,500),xy(578,499),xy(588,501),xy(590,510),xy(589,524)]).
...
midline(r23, [xy(152,619),xy(139,620)]).
midline(r23, [xy(153,619),xy(220,620)]).
...
midline(r17, [xy(554,522),xy(555,534),xy(575,535)]).
