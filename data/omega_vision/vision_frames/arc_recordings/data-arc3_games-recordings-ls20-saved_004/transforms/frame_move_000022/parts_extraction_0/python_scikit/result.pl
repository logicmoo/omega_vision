...
midline(r2, [xy(508,25),xy(443,24),xy(430,25),xy(415,31),xy(403,26),xy(389,24),xy(80,24),xy(66,26),xy(61,38),xy(59,52),xy(60,107),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(108,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(519,24),xy(519,26)]).
midline(r2, [xy(415,32),xy(415,99),xy(409,123),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,199),xy(416,213),xy(420,221),xy(443,225),xy(515,225)]).
midline(r2, [xy(521,24),xy(540,19),xy(589,19),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,480),xy(625,568),xy(622,581),xy(608,585),xy(513,584),xy(497,576),xy(454,534),xy(441,548),xy(419,566),xy(403,573),xy(386,575),xy(230,574),xy(210,566),xy(190,549),xy(160,549)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(203,376),xy(173,372),xy(168,369),xy(166,363),xy(164,347),xy(165,140),xy(168,130),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(455,533),xy(455,464),xy(459,444),xy(466,428),xy(465,425),xy(429,390),xy(411,379),xy(398,375),xy(364,375)]).
midline(r2, [xy(467,429),xy(471,429),xy(470,431)]).
midline(r2, [xy(473,431),xy(492,441),xy(498,441),xy(500,443),xy(496,443)]).
...
midline(r5, [xy(203,74),xy(286,74),xy(303,76),xy(314,81),xy(315,220),xy(312,223),xy(306,224),xy(266,226),xy(253,249),xy(239,260),xy(196,304),xy(194,311),xy(195,344),xy(229,345),xy(235,343),xy(260,318),xy(259,299),xy(251,253)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(313,223),xy(389,300),xy(539,300),xy(556,279),xy(563,263),xy(565,249),xy(565,200),xy(563,186),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,124),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,128),xy(558,105),xy(552,90),xy(534,81),xy(516,79),xy(495,81),xy(480,87)]).
midline(r5, [xy(551,88),xy(550,89)]).
midline(r5, [xy(540,301),xy(554,317),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r13, [xy(357,444),xy(353,434),xy(315,424),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(274,513),xy(285,518),xy(304,520),xy(339,519),xy(353,515),xy(358,504),xy(360,488),xy(358,445)]).
midline(r13, [xy(315,423),xy(315,374)]).
...
midline(r25, [xy(377,634),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(378,634)]).
midline(r25, [xy(556,605),xy(583,605),xy(585,609),xy(585,631),xy(579,635),xy(555,633)]).
midline(r25, [xy(585,606),xy(590,604),xy(608,604),xy(613,605),xy(615,609),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r22, [xy(99,553),xy(99,544),xy(95,540),xy(32,539),xy(21,541),xy(19,550),xy(19,568),xy(23,579),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,616),xy(58,582),xy(49,579),xy(24,580)]).
midline(r22, [xy(100,554),xy(100,609),xy(98,617),xy(89,620),xy(70,620),xy(61,617)]).
...
midline(r19, [xy(589,542),xy(590,532),xy(588,524),xy(570,525),xy(565,523),xy(565,502),xy(563,500),xy(551,499),xy(541,501),xy(539,511),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r19, [xy(565,500),xy(578,499),xy(588,501),xy(590,511),xy(589,523)]).
...
midline(r26, [xy(290,620),xy(139,620)]).
midline(r26, [xy(291,620),xy(320,620)]).
...
midline(r23, [xy(80,587),xy(80,571),xy(77,561),xy(69,559),xy(39,560)]).
midline(r23, [xy(80,588),xy(80,600)]).
...
midline(r12, [xy(310,335),xy(304,335)]).
midline(r12, [xy(311,335),xy(325,335)]).
...
midline(r9, [xy(309,310),xy(299,310)]).
midline(r9, [xy(310,310),xy(330,310)]).
...
midline(r10, [xy(219,314),xy(205,315),xy(205,334),xy(219,335),xy(224,333),xy(225,320),xy(224,316),xy(220,315)]).
...
midline(r20, [xy(555,522),xy(555,534),xy(575,535)]).
