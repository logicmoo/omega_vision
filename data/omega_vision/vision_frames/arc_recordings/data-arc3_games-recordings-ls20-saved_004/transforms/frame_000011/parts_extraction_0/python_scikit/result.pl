...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(82,24),xy(66,26),xy(59,50),xy(59,98),xy(61,111),xy(66,120),xy(64,122),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(107,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(519,25),xy(540,19),xy(589,19),xy(609,24),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(389,575),xy(230,574),xy(210,566),xy(189,549),xy(160,550)]).
midline(r2, [xy(67,121),xy(69,119)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(429,390),xy(411,379),xy(398,375),xy(364,375)]).
midline(r2, [xy(466,427),xy(468,428),xy(466,429)]).
midline(r2, [xy(468,430),xy(469,427)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,383),xy(213,380),xy(203,376),xy(173,372),xy(168,369),xy(166,363),xy(164,347),xy(165,140),xy(168,130),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,98),xy(413,113),xy(409,123),xy(405,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(473,430),xy(471,429),xy(471,431)]).
midline(r2, [xy(474,431),xy(486,438),xy(488,437),xy(488,439)]).
...
border(r2).
region(r6, '#2ecc40', 114000, centroid(402,298)).
perimeter(r6, 3780).
polygon(r6, [xy(609,570),xy(520,569),xy(520,480),xy(540,479),xy(539,350),xy(340,350),xy(340,399),xy(390,400),xy(390,549),xy(240,549),xy(240,400),xy(289,400),xy(290,350),xy(190,349),xy(190,150),xy(289,150),xy(290,200),xy(339,200),xy(340,150),xy(389,150),xy(390,250),xy(539,250),xy(539,200),xy(440,199),xy(440,50),xy(590,50),xy(590,479),xy(610,480),xy(609,570)]).
hole(r6, [xy(600,559),xy(599,490),xy(530,490),xy(530,560),xy(600,559)]).
hole(r6, [xy(520,139),xy(520,130),xy(529,130),xy(530,120),xy(520,120),xy(519,110),xy(510,110),xy(510,119),xy(500,120),xy(500,129),xy(509,130),xy(510,140),xy(520,139)]).
hole(r6, [xy(380,189),xy(379,160),xy(350,160),xy(350,190),xy(380,189)]).
hole(r6, [xy(230,339),xy(229,310),xy(200,310),xy(200,340),xy(230,339)]).
hole(r6, [xy(330,489),xy(329,460),xy(300,460),xy(300,490),xy(330,489)]).
midline(r6, [xy(355,230),xy(317,276),xy(296,275),xy(252,249),xy(241,219),xy(240,199)]).
midline(r6, [xy(319,276),xy(350,292),xy(370,298),xy(390,300),xy(539,300),xy(548,290),xy(557,277),xy(564,258),xy(565,201),xy(562,183),xy(550,162),xy(534,168),xy(511,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r6, [xy(479,160),xy(478,161)]).
midline(r6, [xy(480,87),xy(495,81),xy(512,79),xy(534,81),xy(551,88),xy(558,105),xy(560,120),xy(558,144),xy(551,161)]).
midline(r6, [xy(540,301),xy(554,317),xy(564,341),xy(565,463),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r6, [xy(314,278),xy(315,422),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,487),xy(274,513),xy(285,518),xy(329,520),xy(344,518),xy(355,513),xy(360,488),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r6, [xy(299,277),xy(280,299),xy(235,343),xy(227,345),xy(196,344),xy(194,338),xy(194,311),xy(196,304),xy(239,260),xy(252,251)]).
midline(r6, [xy(356,229),xy(362,217),xy(345,193),xy(345,155),xy(384,155),xy(384,193),xy(363,216)]).
fillpoint(r6, xy(315,277), 77.2).
fillpoint(r6, xy(312,276), 77.0).
fillpoint(r6, xy(317,276), 77.0).
fillpoint(r6, xy(304,275), 76.0).
fillpoint(r6, xy(273,262), 65.1).
fillpoint(r6, xy(253,251), 63.7).
fillpoint(r6, xy(266,258), 63.7).
fillpoint(r6, xy(255,252), 63.5).
fillpoint(r6, xy(264,257), 63.5).
fillpoint(r6, xy(257,253), 63.3).
fillpoint(r6, xy(262,256), 63.3).
fillpoint(r6, xy(259,254), 63.1).
fillpoint(r6, xy(260,255), 63.1).
fillpoint(r6, xy(247,238), 58.0).
fillpoint(r6, xy(351,292), 58.0).
fillpoint(r6, xy(243,226), 54.0).
fillpoint(r6, xy(363,296), 54.0).
fillpoint(r6, xy(242,222), 53.0).
fillpoint(r6, xy(367,297), 53.0).
fillpoint(r6, xy(241,218), 52.0).
fillpoint(r6, xy(372,298), 52.0).
fillpoint(r6, xy(240,211), 51.0).
fillpoint(r6, xy(378,299), 51.0).
fillpoint(r6, xy(391,300), 50.0).
fillpoint(r6, xy(551,162), 39.0).
fillpoint(r6, xy(478,88), 38.8).
fillpoint(r6, xy(551,88), 38.8).
fillpoint(r6, xy(478,161), 38.8).
fillpoint(r6, xy(315,424), 35.4).
fillpoint(r6, xy(275,435), 35.4).
fillpoint(r6, xy(354,435), 35.4).
fillpoint(r6, xy(275,514), 35.4).
fillpoint(r6, xy(354,514), 35.4).
fillpoint(r6, xy(496,81), 32.0).
fillpoint(r6, xy(533,81), 32.0).
fillpoint(r6, xy(471,106), 32.0).
fillpoint(r6, xy(558,106), 32.0).
fillpoint(r6, xy(471,143), 32.0).
fillpoint(r6, xy(558,143), 32.0).
fillpoint(r6, xy(496,168), 32.0).
fillpoint(r6, xy(533,168), 32.0).
fillpoint(r6, xy(303,428), 32.0).
fillpoint(r6, xy(326,428), 32.0).
fillpoint(r6, xy(286,431), 32.0).
fillpoint(r6, xy(343,431), 32.0).
fillpoint(r6, xy(271,446), 32.0).
fillpoint(r6, xy(358,446), 32.0).
fillpoint(r6, xy(271,503), 32.0).
fillpoint(r6, xy(358,503), 32.0).
fillpoint(r6, xy(286,518), 32.0).
fillpoint(r6, xy(343,518), 32.0).
fillpoint(r6, xy(298,429), 31.1).
fillpoint(r6, xy(331,429), 31.1).
fillpoint(r6, xy(291,430), 31.1).
fillpoint(r6, xy(338,430), 31.1).
fillpoint(r6, xy(502,80), 31.0).
fillpoint(r6, xy(528,80), 31.0).
fillpoint(r6, xy(470,112), 31.0).
fillpoint(r6, xy(559,112), 31.0).
fillpoint(r6, xy(470,138), 31.0).
fillpoint(r6, xy(559,138), 31.0).
fillpoint(r6, xy(502,169), 31.0).
fillpoint(r6, xy(528,169), 31.0).
fillpoint(r6, xy(270,452), 31.0).
fillpoint(r6, xy(359,452), 31.0).
fillpoint(r6, xy(270,498), 31.0).
fillpoint(r6, xy(359,498), 31.0).
fillpoint(r6, xy(292,519), 31.0).
fillpoint(r6, xy(338,519), 31.0).
fillpoint(r6, xy(511,80), 30.0).
fillpoint(r6, xy(469,125), 30.0).
fillpoint(r6, xy(559,125), 30.0).
fillpoint(r6, xy(511,170), 30.0).
fillpoint(r6, xy(269,475), 30.0).
fillpoint(r6, xy(359,475), 30.0).
fillpoint(r6, xy(301,520), 30.0).
fillpoint(r6, xy(561,181), 29.0).
fillpoint(r6, xy(361,218), 29.0).
fillpoint(r6, xy(561,268), 29.0).
fillpoint(r6, xy(561,331), 29.0).
fillpoint(r6, xy(562,184), 28.0).
fillpoint(r6, xy(562,265), 28.0).
fillpoint(r6, xy(562,334), 28.0).
fillpoint(r6, xy(563,187), 27.0).
fillpoint(r6, xy(563,262), 27.0).
fillpoint(r6, xy(563,337), 27.0).
fillpoint(r6, xy(564,192), 26.0).
fillpoint(r6, xy(564,258), 26.0).
fillpoint(r6, xy(564,342), 26.0).
fillpoint(r6, xy(564,225), 25.0).
fillpoint(r6, xy(314,375), 25.0).
fillpoint(r6, xy(565,408), 25.0).
region(r5, '#2ecc40', 42500, centroid(176,227)).
perimeter(r5, 1700).
polygon(r5, [xy(189,500),xy(90,499),xy(90,50),xy(389,50),xy(390,99),xy(340,100),xy(339,150),xy(290,150),xy(289,100),xy(140,100),xy(140,399),xy(190,400),xy(189,500)]).
midline(r5, [xy(114,380),xy(114,100),xy(118,80),xy(126,76),xy(140,74),xy(287,74),xy(303,76),xy(314,82),xy(330,75),xy(365,75)]).
midline(r5, [xy(315,83),xy(315,125)]).
midline(r5, [xy(114,381),xy(115,409),xy(118,419),xy(127,435),xy(140,450)]).
...
midline(r25, [xy(377,634),xy(126,634),xy(124,610),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(555,631),xy(549,635),xy(378,635)]).
midline(r25, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(579,635),xy(555,633)]).
midline(r25, [xy(585,606),xy(590,604),xy(609,604),xy(613,605),xy(615,609),xy(615,632),xy(613,634),xy(591,635),xy(585,633)]).
midline(r25, [xy(615,606),xy(621,604),xy(635,605)]).
...
region(r26, '#2ecc40', 4400, centroid(240,620)).
perimeter(r26, 480).
polygon(r26, [xy(349,630),xy(130,630),xy(130,610),xy(349,610),xy(349,630)]).
midline(r26, [xy(279,620),xy(139,620)]).
midline(r26, [xy(280,620),xy(340,620)]).
...
midline(r21, [xy(589,542),xy(590,530),xy(588,524),xy(571,525),xy(565,523),xy(564,500),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(576,550),xy(587,548),xy(589,543)]).
midline(r21, [xy(589,523),xy(590,511),xy(588,502),xy(577,499),xy(566,500)]).
...
region(r27, '#5a5a5a', 4000, centroid(450,620)).
perimeter(r27, 440).
polygon(r27, [xy(549,630),xy(350,630),xy(350,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(499,620),xy(359,620)]).
midline(r27, [xy(500,620),xy(540,620)]).
fillpoint(r27, xy(359,620), 10.0).
region(r12, '#870c25', 1500, centroid(314,184)).
perimeter(r12, 160).
polygon(r12, [xy(339,200),xy(290,200),xy(290,170),xy(339,170),xy(339,200)]).
midline(r12, [xy(312,185),xy(304,185)]).
midline(r12, [xy(313,184),xy(325,185)]).
fillpoint(r12, xy(304,185), 15.0).
region(r10, '#bebebe', 1000, centroid(314,160)).
perimeter(r10, 140).
polygon(r10, [xy(339,170),xy(290,170),xy(290,150),xy(339,150),xy(339,170)]).
midline(r10, [xy(311,160),xy(299,160)]).
midline(r10, [xy(312,159),xy(330,160)]).
fillpoint(r10, xy(299,160), 10.0).
...
midline(r11, [xy(369,164),xy(355,165),xy(355,184),xy(367,185),xy(374,183),xy(375,170),xy(374,166),xy(370,165)]).
...
midline(r14, [xy(205,327),xy(205,315),xy(224,315),xy(224,333),xy(210,335),xy(205,333),xy(204,328)]).
...
midline(r22, [xy(555,521),xy(555,514)]).
midline(r22, [xy(555,522),xy(555,534),xy(575,535)]).
...
border(r30).
region(r13, '#2ecc40', 100, centroid(364,174)).
perimeter(r13, 40).
polygon(r13, [xy(369,180),xy(360,179),xy(360,170),xy(370,170),xy(369,180)]).
midline(r13, [xy(365,175),xy(365,174)]).
fillpoint(r13, xy(364,175), 5.0).
...
adjacent(r2, r5).
shared_edge(r2, r5, 1600).
adjacent(r2, r6).
shared_edge(r2, r6, 2820).
adjacent(r2, r24).
...
adjacent(r6, r12).
shared_edge(r6, r12, 110).
adjacent(r6, r14).
shared_edge(r6, r14, 120).
adjacent(r6, r21).
shared_edge(r6, r21, 280).
adjacent(r10, r12).
shared_edge(r10, r12, 50).
adjacent(r11, r13).
shared_edge(r11, r13, 40).
adjacent(r14, r15).
...
adjacent(r25, r26).
shared_edge(r25, r26, 460).
adjacent(r25, r27).
shared_edge(r25, r27, 420).
adjacent(r25, r28).
