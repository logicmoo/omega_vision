...
midline(r2, [xy(112,25),xy(80,24),xy(66,26),xy(60,42),xy(59,99),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,627),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,25),xy(389,24),xy(403,26),xy(414,32),xy(426,26),xy(440,24),xy(519,25),xy(540,19),xy(589,19),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,481),xy(625,569),xy(622,581),xy(616,584),xy(604,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(389,575),xy(230,574),xy(207,564),xy(189,549),xy(160,549)]).
midline(r2, [xy(415,33),xy(415,98),xy(414,109),xy(409,123),xy(404,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,428),xy(464,424),xy(429,390),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(467,426),xy(470,431)]).
midline(r2, [xy(472,431),xy(480,435),xy(482,434),xy(482,436)]).
midline(r2, [xy(484,436),xy(492,441),xy(494,440),xy(494,442)]).
midline(r2, [xy(496,442),xy(507,448)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(166,363),xy(164,349),xy(165,141),xy(168,130),xy(180,125),xy(265,125)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(517,80),xy(530,75),xy(565,75)]).
midline(r5, [xy(518,81),xy(529,104),xy(529,110),xy(534,116),xy(535,128),xy(533,135),xy(529,139),xy(527,150),xy(516,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(518,170),xy(531,174),xy(556,177),xy(560,179),xy(564,190),xy(564,259),xy(556,279),xy(539,299),xy(390,300),xy(370,298),xy(350,292),xy(314,274),xy(289,250)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,340),xy(565,460),xy(564,465),xy(545,483),xy(525,485),xy(525,564),xy(597,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(315,276),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(304,520),xy(339,519),xy(353,515),xy(358,504),xy(360,487),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(290,248),xy(315,219),xy(315,85),xy(313,80),xy(289,74),xy(140,74),xy(126,76),xy(118,80),xy(114,100),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
...
fillpoint(r5, xy(560,179), 29.7).
fillpoint(r5, xy(121,78), 29.0).
fillpoint(r5, xy(308,78), 29.0).
fillpoint(r5, xy(321,78), 29.0).
fillpoint(r5, xy(521,78), 29.0).
fillpoint(r5, xy(118,81), 29.0).
fillpoint(r5, xy(521,171), 29.0).
fillpoint(r5, xy(558,178), 29.0).
...
fillpoint(r5, xy(524,77), 28.0).
fillpoint(r5, xy(117,84), 28.0).
fillpoint(r5, xy(524,172), 28.0).
fillpoint(r5, xy(555,177), 28.0).
...
fillpoint(r5, xy(527,76), 27.0).
fillpoint(r5, xy(116,87), 27.0).
fillpoint(r5, xy(527,173), 27.0).
fillpoint(r5, xy(552,176), 27.0).
...
fillpoint(r5, xy(532,75), 26.0).
fillpoint(r5, xy(115,92), 26.0).
fillpoint(r5, xy(532,174), 26.0).
fillpoint(r5, xy(548,175), 26.0).
...
midline(r22, [xy(377,634),xy(131,635),xy(126,634),xy(124,629),xy(125,605),xy(131,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(378,634)]).
midline(r22, [xy(556,605),xy(578,604),xy(585,606),xy(585,631),xy(583,634),xy(576,635),xy(560,635),xy(555,633)]).
midline(r22, [xy(586,605),xy(608,604),xy(615,606),xy(615,631),xy(613,634),xy(607,635),xy(590,635),xy(585,633)]).
...
midline(r19, [xy(99,562),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,550),xy(19,568),xy(23,579),xy(19,591),xy(21,618),xy(32,620),xy(55,619),xy(60,615),xy(60,590),xy(58,582),xy(49,579),xy(24,580)]).
midline(r19, [xy(100,563),xy(100,608),xy(98,617),xy(85,620),xy(64,619),xy(60,617)]).
...
region(r23, '#2ecc40', 4400, centroid(240,620)).
perimeter(r23, 480).
polygon(r23, [xy(349,630),xy(130,630),xy(130,610),xy(349,610),xy(349,630)]).
midline(r23, [xy(279,620),xy(139,620)]).
midline(r23, [xy(280,620),xy(340,620)]).
...
midline(r16, [xy(589,542),xy(590,531),xy(587,524),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,512),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(566,500),xy(578,499),xy(588,501),xy(589,524)]).
...
region(r24, '#5a5a5a', 4000, centroid(450,620)).
perimeter(r24, 440).
polygon(r24, [xy(549,630),xy(350,630),xy(350,610),xy(549,610),xy(549,630)]).
midline(r24, [xy(499,620),xy(359,620)]).
midline(r24, [xy(500,619),xy(540,620)]).
fillpoint(r24, xy(359,620), 10.0).
...
midline(r20, [xy(80,586),xy(80,572),xy(77,561),xy(69,559),xy(39,560)]).
...
region(r9, '#870c25', 1500, centroid(564,134)).
perimeter(r9, 160).
polygon(r9, [xy(589,150),xy(540,150),xy(540,120),xy(589,120),xy(589,150)]).
midline(r9, [xy(566,134),xy(554,135)]).
midline(r9, [xy(567,135),xy(575,135)]).
fillpoint(r9, xy(554,135), 15.0).
region(r6, '#bebebe', 1000, centroid(564,110)).
perimeter(r6, 140).
polygon(r6, [xy(589,120),xy(540,120),xy(540,100),xy(589,100),xy(589,120)]).
midline(r6, [xy(570,110),xy(549,110)]).
midline(r6, [xy(571,109),xy(580,110)]).
fillpoint(r6, xy(549,110), 10.0).
...
adjacent(r5, r6).
shared_edge(r5, r6, 70).
adjacent(r5, r9).
shared_edge(r5, r9, 80).
adjacent(r5, r16).
...
adjacent(r22, r23).
shared_edge(r22, r23, 460).
adjacent(r22, r24).
shared_edge(r22, r24, 420).
adjacent(r22, r25).
