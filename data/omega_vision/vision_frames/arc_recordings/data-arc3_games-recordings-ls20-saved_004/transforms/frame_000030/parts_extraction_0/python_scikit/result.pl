...
midline(r2, [xy(508,25),xy(441,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(83,24),xy(66,26),xy(59,50),xy(60,107),xy(66,120),xy(64,122),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,601),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(108,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(518,24),xy(520,29),xy(520,26)]).
midline(r2, [xy(520,24),xy(541,19),xy(585,19),xy(609,24),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,481),xy(625,566),xy(622,581),xy(606,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(403,573),xy(388,575),xy(240,575),xy(226,573),xy(212,567),xy(189,549),xy(160,550)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,509),xy(215,383),xy(213,380),xy(203,376),xy(173,372),xy(166,363),xy(164,348),xy(165,141),xy(168,130),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,97),xy(414,109),xy(409,123),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(416,213),xy(420,221),xy(440,225),xy(515,225)]).
midline(r2, [xy(522,29),xy(521,30)]).
midline(r2, [xy(455,533),xy(455,464),xy(459,444),xy(466,428),xy(465,425),xy(429,390),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(467,429),xy(470,428),xy(466,426)]).
midline(r2, [xy(480,433),xy(472,428),xy(470,430),xy(481,434)]).
...
midline(r5, [xy(202,75),xy(131,75),xy(120,78),xy(115,91),xy(114,398),xy(119,421),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,74),xy(287,74),xy(303,76),xy(315,81),xy(315,221),xy(289,249),xy(314,274),xy(315,278),xy(315,421),xy(313,425),xy(276,434),xy(271,445),xy(269,463),xy(270,499),xy(276,515),xy(303,520),xy(339,519),xy(353,515),xy(358,504),xy(360,487),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(315,274),xy(353,293),xy(376,299),xy(390,299),xy(410,316),xy(426,323),xy(441,325),xy(503,323),xy(525,312),xy(548,290),xy(556,279),xy(564,258),xy(565,200),xy(562,183),xy(551,163),xy(529,169),xy(511,170),xy(495,168),xy(477,159),xy(471,144),xy(469,121),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,129),xy(558,105),xy(552,90),xy(543,84),xy(519,79),xy(495,81),xy(480,87)]).
midline(r5, [xy(551,88),xy(550,89)]).
midline(r5, [xy(540,300),xy(557,322),xy(564,341),xy(565,462),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(536,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(316,80),xy(340,74),xy(365,75)]).
...
midline(r1, [xy(19,373),xy(20,500)]).
midline(r1, [xy(20,372),xy(20,19)]).
...
midline(r22, [xy(377,634),xy(132,635),xy(126,634),xy(124,627),xy(125,605),xy(130,604),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(378,634)]).
midline(r22, [xy(556,605),xy(579,604),xy(584,607),xy(590,604),xy(613,605),xy(615,606),xy(615,630),xy(613,634),xy(604,635),xy(585,633),xy(563,635),xy(555,633)]).
midline(r22, [xy(616,605),xy(635,605)]).
midline(r22, [xy(585,608),xy(585,632)]).
...
midline(r19, [xy(99,553),xy(99,544),xy(95,540),xy(32,539),xy(21,541),xy(19,554),xy(20,575),xy(23,579),xy(19,590),xy(21,618),xy(31,620),xy(55,619),xy(60,615),xy(58,582),xy(48,579),xy(24,579)]).
midline(r19, [xy(100,554),xy(100,604),xy(98,617),xy(88,620),xy(72,620),xy(60,617)]).
...
midline(r24, [xy(476,620),xy(259,620)]).
midline(r24, [xy(477,619),xy(540,620)]).
...
midline(r16, [xy(589,542),xy(590,531),xy(588,524),xy(570,525),xy(565,523),xy(565,503),xy(563,500),xy(550,499),xy(541,501),xy(539,512),xy(541,548),xy(578,550),xy(587,548),xy(589,543)]).
...
midline(r10, [xy(462,285),xy(454,285)]).
midline(r10, [xy(463,284),xy(475,285)]).
...
midline(r9, [xy(460,259),xy(480,260)]).
