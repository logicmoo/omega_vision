...
midline(r2, [xy(164,181),xy(164,349),xy(169,370),xy(180,374),xy(203,376),xy(214,382),xy(231,375),xy(265,375)]).
midline(r2, [xy(215,383),xy(214,508),xy(204,532),xy(189,549),xy(160,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(64,122),xy(66,120),xy(61,111),xy(59,98),xy(59,50),xy(66,26),xy(81,24),xy(386,24),xy(403,26),xy(415,31),xy(415,99),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,197),xy(415,209),xy(420,221),xy(441,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(440,24),xy(519,24),xy(519,26)]).
midline(r2, [xy(521,24),xy(540,19),xy(588,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(624,473),xy(625,566),xy(623,579),xy(619,583),xy(609,585),xy(520,585),xy(507,582),xy(497,576),xy(454,534),xy(455,464),xy(465,425),xy(430,391),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(474,432),xy(477,430),xy(476,432)]).
midline(r2, [xy(454,535),xy(419,566),xy(403,573),xy(389,575),xy(230,574),xy(210,566),xy(190,549)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(518,79),xy(534,81),xy(551,88),xy(559,110),xy(560,129),xy(558,144),xy(551,161),xy(547,164),xy(518,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(561,180),xy(564,190),xy(565,249),xy(563,263),xy(557,277),xy(539,299),xy(391,300),xy(370,298),xy(350,292),xy(315,274),xy(300,270),xy(269,240),xy(238,261),xy(196,304),xy(194,314),xy(195,344),xy(201,345),xy(227,345),xy(235,343),xy(279,300),xy(288,287),xy(303,272)]).
midline(r5, [xy(270,239),xy(266,226),xy(302,185),xy(313,163),xy(315,147),xy(315,82),xy(303,76),xy(289,74),xy(140,74),xy(126,76),xy(118,80),xy(114,100),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(315,275),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(303,520),xy(339,519),xy(353,515),xy(358,504),xy(360,485),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
midline(r22, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(553,605),xy(555,610),xy(554,633),xy(547,635),xy(525,634)]).
midline(r22, [xy(555,606),xy(560,604),xy(578,604),xy(584,607),xy(591,604),xy(615,606),xy(615,630),xy(613,634),xy(590,635),xy(584,632),xy(579,635),xy(561,635),xy(555,633)]).
midline(r22, [xy(616,605),xy(635,605)]).
midline(r22, [xy(585,631),xy(585,608)]).
...
midline(r23, [xy(490,620),xy(139,620)]).
midline(r23, [xy(491,620),xy(540,620)]).
...
midline(r18, [xy(589,542),xy(590,531),xy(587,524),xy(571,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,512),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r18, [xy(566,500),xy(579,499),xy(588,501),xy(590,510),xy(589,524)]).
...
midline(r9, [xy(360,159),xy(349,160)]).
midline(r9, [xy(361,160),xy(380,160)]).
...
midline(r11, [xy(224,332),xy(225,321),xy(223,315),xy(205,315),xy(204,323),xy(205,334),xy(224,334)]).
...
midline(r19, [xy(555,530),xy(555,514)]).
midline(r19, [xy(555,531),xy(555,534),xy(575,535)]).
