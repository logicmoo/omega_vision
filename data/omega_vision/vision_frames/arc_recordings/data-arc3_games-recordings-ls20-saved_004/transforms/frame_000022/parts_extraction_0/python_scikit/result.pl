...
midline(r2, [xy(508,25),xy(441,24),xy(426,26),xy(415,31),xy(399,25),xy(386,24),xy(81,24),xy(66,26),xy(59,50),xy(59,99),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,602),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,24),xy(518,24),xy(519,27),xy(521,24),xy(532,20),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,480),xy(625,563),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(409,571),xy(389,575),xy(230,574),xy(207,564),xy(190,549),xy(160,550)]).
midline(r2, [xy(521,27),xy(520,28)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(411,379),xy(388,374),xy(364,375)]).
midline(r2, [xy(466,428),xy(474,430),xy(476,433),xy(480,431),xy(476,430)]).
midline(r2, [xy(478,434),xy(481,432),xy(480,435)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(166,363),xy(164,349),xy(165,140),xy(169,129),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,99),xy(409,123),xy(405,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(482,435),xy(485,435),xy(484,432),xy(487,435),xy(486,438),xy(488,436),xy(489,439),xy(490,436)]).
midline(r2, [xy(495,441),xy(492,438),xy(494,442)]).
...
border(r2).
region(r5, '#2ecc40', 133300, centroid(346,242)).
perimeter(r5, 4540).
polygon(r5, [xy(609,570),xy(520,569),xy(520,480),xy(540,479),xy(539,350),xy(340,350),xy(339,300),xy(290,300),xy(289,350),xy(190,349),xy(190,150),xy(289,150),xy(289,100),xy(140,100),xy(140,399),xy(190,400),xy(190,499),xy(90,499),xy(90,50),xy(389,50),xy(390,99),xy(340,100),xy(340,149),xy(390,150),xy(390,250),xy(540,249),xy(539,200),xy(440,199),xy(440,50),xy(590,50),xy(590,479),xy(610,480),xy(609,570)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(559,110),xy(560,128),xy(558,144),xy(550,163),xy(529,169),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(561,180),xy(564,191),xy(565,249),xy(563,263),xy(556,279),xy(539,299),xy(390,300),xy(313,223),xy(273,225),xy(266,226),xy(253,249),xy(238,261),xy(196,304),xy(194,311),xy(194,338),xy(195,344),xy(200,345),xy(233,344),xy(259,320),xy(259,300),xy(251,253)]).
midline(r5, [xy(539,300),xy(554,317),xy(564,340),xy(565,461),xy(564,465),xy(545,483),xy(525,485),xy(524,558),xy(525,564),xy(531,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(313,222),xy(315,220),xy(315,83),xy(313,80),xy(299,75),xy(286,74),xy(142,74),xy(130,75),xy(118,80),xy(114,106),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
fillpoint(r5, xy(312,223), 77.0).
fillpoint(r5, xy(267,226), 77.0).
fillpoint(r5, xy(304,224), 76.0).
fillpoint(r5, xy(276,225), 76.0).
fillpoint(r5, xy(389,299), 50.0).
...
region(r13, '#2ecc40', 24100, centroid(314,464)).
perimeter(r13, 820).
polygon(r13, [xy(389,550),xy(240,549),xy(240,400),xy(289,400),xy(290,350),xy(339,350),xy(340,399),xy(390,400),xy(389,550)]).
hole(r13, [xy(330,489),xy(329,460),xy(300,460),xy(300,490),xy(330,489)]).
midline(r13, [xy(357,444),xy(353,434),xy(325,428),xy(314,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(269,489),xy(274,513),xy(285,518),xy(300,520),xy(329,520),xy(353,515),xy(358,504),xy(360,489),xy(358,445)]).
midline(r13, [xy(315,422),xy(315,374)]).
fillpoint(r13, xy(315,424), 35.4).
fillpoint(r13, xy(275,435), 35.4).
fillpoint(r13, xy(354,435), 35.4).
fillpoint(r13, xy(275,514), 35.4).
fillpoint(r13, xy(354,514), 35.4).
fillpoint(r13, xy(303,428), 32.0).
fillpoint(r13, xy(326,428), 32.0).
...
fillpoint(r13, xy(298,429), 31.1).
fillpoint(r13, xy(331,429), 31.1).
fillpoint(r13, xy(291,430), 31.1).
fillpoint(r13, xy(338,430), 31.1).
...
midline(r25, [xy(418,635),xy(131,635),xy(126,634),xy(124,628),xy(125,605),xy(130,604),xy(546,604),xy(555,606),xy(555,632),xy(549,635),xy(419,635)]).
midline(r25, [xy(556,605),xy(578,604),xy(584,607),xy(590,604),xy(613,605),xy(615,610),xy(615,632),xy(607,635),xy(593,635),xy(584,632),xy(579,635),xy(555,633)]).
...
midline(r22, [xy(99,553),xy(98,542),xy(89,539),xy(31,539),xy(21,541),xy(19,551),xy(19,568),xy(23,580),xy(19,590),xy(21,618),xy(30,620),xy(55,619),xy(60,616),xy(58,582),xy(46,579),xy(24,580)]).
midline(r22, [xy(100,554),xy(100,605),xy(98,617),xy(86,620),xy(64,619),xy(61,617)]).
...
midline(r19, [xy(589,542),xy(590,530),xy(588,525),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(578,550),xy(587,548),xy(589,543)]).
midline(r19, [xy(566,500),xy(579,499),xy(588,501),xy(590,510),xy(589,524)]).
...
midline(r26, [xy(280,619),xy(320,620)]).
...
midline(r23, [xy(52,559),xy(39,560)]).
midline(r23, [xy(53,560),xy(68,559),xy(78,561),xy(80,570),xy(80,600)]).
...
region(r9, '#bebebe', 1000, centroid(314,310)).
perimeter(r9, 140).
polygon(r9, [xy(339,320),xy(290,320),xy(290,300),xy(339,300),xy(339,320)]).
midline(r9, [xy(310,309),xy(299,310)]).
midline(r9, [xy(311,309),xy(330,310)]).
fillpoint(r9, xy(299,310), 10.0).
...
midline(r10, [xy(219,314),xy(205,315),xy(205,334),xy(218,335),xy(224,333),xy(225,320),xy(224,316),xy(220,315)]).
...
midline(r20, [xy(565,535),xy(555,533),xy(555,514)]).
midline(r20, [xy(566,534),xy(575,535)]).
