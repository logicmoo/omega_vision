...
midline(r2, [xy(508,25),xy(442,24),xy(426,26),xy(415,31),xy(399,25),xy(386,24),xy(81,24),xy(66,26),xy(61,38),xy(59,52),xy(59,98),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(519,25),xy(540,19),xy(587,19),xy(601,21),xy(613,26),xy(615,41),xy(614,455),xy(622,467),xy(625,480),xy(625,567),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(406,572),xy(389,575),xy(230,574),xy(207,564),xy(190,549),xy(160,550)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(203,376),xy(170,371),xy(165,359),xy(165,141),xy(168,130),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,95),xy(414,109),xy(409,123),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(455,533),xy(455,464),xy(459,444),xy(466,428),xy(464,424),xy(430,391),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(467,429),xy(482,434),xy(482,436)]).
midline(r2, [xy(484,436),xy(486,438)]).
midline(r2, [xy(488,438),xy(494,440),xy(494,442)]).
midline(r2, [xy(496,442),xy(500,443),xy(500,445)]).
midline(r2, [xy(520,26),xy(519,28),xy(521,27)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(120,78),xy(115,90),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
midline(r5, [xy(203,74),xy(289,74),xy(303,76),xy(314,82),xy(331,75),xy(365,75)]).
midline(r5, [xy(315,83),xy(314,221),xy(295,243),xy(276,236),xy(261,245),xy(259,244),xy(238,261),xy(199,300),xy(195,306),xy(194,314),xy(195,344),xy(229,345),xy(235,343),xy(283,296),xy(287,288),xy(307,268),xy(302,261),xy(296,244)]).
midline(r5, [xy(257,248),xy(259,246)]).
midline(r5, [xy(308,268),xy(315,275),xy(315,375)]).
midline(r5, [xy(316,275),xy(348,291),xy(376,299),xy(539,300),xy(549,289),xy(556,279),xy(564,259),xy(565,200),xy(562,183),xy(550,162),xy(534,168),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,121),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(540,301),xy(556,320),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(532,565),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r11, [xy(294,456),xy(280,468),xy(275,471),xy(269,471),xy(265,459),xy(265,424)]).
midline(r11, [xy(269,473),xy(270,499),xy(276,515),xy(301,520),xy(329,520),xy(353,515),xy(359,499),xy(359,472),xy(347,466),xy(333,455),xy(301,454),xy(295,456)]).
midline(r11, [xy(360,471),xy(364,459),xy(365,424)]).
...
midline(r25, [xy(377,634),xy(130,635),xy(125,633),xy(124,610),xy(125,605),xy(133,604),xy(547,604),xy(555,606),xy(555,630),xy(553,634),xy(549,635),xy(378,634)]).
midline(r25, [xy(556,605),xy(579,604),xy(585,606),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r25, [xy(586,605),xy(613,605),xy(615,609),xy(615,631),xy(609,635),xy(590,635),xy(585,633)]).
...
midline(r22, [xy(65,539),xy(24,540),xy(21,541),xy(19,550),xy(19,568),xy(23,580),xy(20,584),xy(19,592),xy(21,618),xy(31,620),xy(57,618),xy(60,612),xy(58,582),xy(49,579),xy(24,579)]).
midline(r22, [xy(66,540),xy(88,539),xy(98,541),xy(100,550),xy(100,606),xy(99,615),xy(95,619),xy(72,620),xy(60,617)]).
...
midline(r27, [xy(439,620),xy(299,620)]).
midline(r27, [xy(440,620),xy(540,620)]).
...
midline(r19, [xy(589,542),xy(590,533),xy(588,525),xy(565,523),xy(565,502),xy(563,500),xy(550,499),xy(541,501),xy(539,512),xy(541,548),xy(550,550),xy(578,550),xy(587,548),xy(589,543)]).
midline(r19, [xy(565,500),xy(579,499),xy(588,501),xy(590,512),xy(589,524)]).
...
midline(r23, [xy(63,559),xy(39,560)]).
midline(r23, [xy(64,560),xy(78,561),xy(80,600)]).
...
midline(r13, [xy(316,434),xy(304,435)]).
midline(r13, [xy(317,435),xy(325,435)]).
...
midline(r9, [xy(219,314),xy(205,315),xy(205,334),xy(218,335),xy(224,333),xy(225,320),xy(224,316),xy(220,315)]).
...
midline(r20, [xy(555,527),xy(555,514)]).
midline(r20, [xy(555,528),xy(555,534),xy(575,535)]).
