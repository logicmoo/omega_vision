...
midline(r2, [xy(112,25),xy(80,24),xy(66,26),xy(60,42),xy(59,96),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(116,594),xy(159,550),xy(141,531),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,25),xy(389,24),xy(409,28),xy(415,31),xy(415,99),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(415,209),xy(420,221),xy(442,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(440,24),xy(519,24),xy(518,27),xy(522,29)]).
midline(r2, [xy(521,24),xy(540,19),xy(588,19),xy(609,24),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(622,581),xy(606,585),xy(513,584),xy(497,576),xy(454,534),xy(422,564),xy(409,571),xy(389,575),xy(230,574),xy(207,564),xy(189,549),xy(160,549)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,383),xy(213,380),xy(203,376),xy(173,372),xy(168,368),xy(165,359),xy(165,140),xy(169,129),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(455,533),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(411,379),xy(388,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(483,435)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(559,110),xy(560,129),xy(558,144),xy(550,163),xy(529,169),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(560,178),xy(564,191),xy(564,259),xy(554,282),xy(538,300),xy(391,300),xy(362,296),xy(339,287),xy(317,275),xy(315,276),xy(300,236),xy(266,227)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(315,277),xy(314,424),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(301,520),xy(339,519),xy(353,515),xy(358,504),xy(360,488),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(302,236),xy(315,220),xy(315,82),xy(313,80),xy(289,74),xy(140,74),xy(119,79),xy(114,100),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
...
midline(r22, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(548,604),xy(554,606),xy(555,632),xy(546,635),xy(525,634)]).
midline(r22, [xy(555,606),xy(560,604),xy(579,604),xy(585,606),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r22, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(608,635),xy(585,633)]).
...
midline(r23, [xy(346,620),xy(540,620)]).
...
midline(r19, [xy(99,553),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,550),xy(19,568),xy(23,580),xy(19,591),xy(21,618),xy(30,620),xy(55,619),xy(60,614),xy(58,582),xy(49,579),xy(24,579)]).
midline(r19, [xy(100,554),xy(100,608),xy(98,617),xy(88,620),xy(64,619),xy(60,617)]).
...
midline(r16, [xy(589,542),xy(590,532),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,511),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r16, [xy(589,523),xy(590,511),xy(588,502),xy(576,499),xy(566,500)]).
...
midline(r10, [xy(217,335),xy(225,335)]).
...
midline(r9, [xy(209,310),xy(199,310)]).
midline(r9, [xy(210,310),xy(230,310)]).
