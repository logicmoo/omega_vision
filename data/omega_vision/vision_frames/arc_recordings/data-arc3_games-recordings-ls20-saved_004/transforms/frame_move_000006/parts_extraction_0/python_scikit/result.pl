...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(387,24),xy(80,24),xy(66,26),xy(59,50),xy(59,96),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550),xy(140,530),xy(122,517),xy(108,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,24),xy(519,25),xy(541,19),xy(588,19),xy(609,24),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,482),xy(625,567),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(387,575),xy(231,574),xy(210,566),xy(190,549),xy(160,550)]).
midline(r2, [xy(415,32),xy(415,98),xy(413,113),xy(409,123),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,198),xy(419,220),xy(442,225),xy(515,225)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(429,390),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,427),xy(466,429)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,509),xy(215,382),xy(199,375),xy(180,374),xy(170,371),xy(165,359),xy(165,140),xy(169,129),xy(180,125),xy(265,125)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(516,79),xy(534,81),xy(551,88),xy(559,110),xy(560,129),xy(558,144),xy(550,163),xy(529,169),xy(511,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(561,180),xy(564,190),xy(565,249),xy(563,263),xy(557,277),xy(538,300),xy(376,299),xy(350,292),xy(315,275),xy(275,235),xy(306,190),xy(315,171),xy(315,89),xy(313,80),xy(299,75),xy(288,74),xy(130,75),xy(120,78),xy(116,86),xy(114,100),xy(115,125)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(539,300),xy(554,317),xy(564,340),xy(565,463),xy(545,483),xy(525,485),xy(524,558),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(275,237),xy(250,251),xy(238,261),xy(195,306),xy(195,344),xy(233,344),xy(279,300),xy(287,288),xy(328,247),xy(339,240),xy(383,195),xy(385,189),xy(385,162),xy(383,155),xy(346,155),xy(331,167),xy(316,174),xy(314,178)]).
midline(r5, [xy(314,276),xy(315,421),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,485),xy(274,513),xy(285,518),xy(326,520),xy(344,518),xy(355,513),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
border(r1).
region(r13, '#2ecc40', 20000, centroid(127,374)).
perimeter(r13, 800).
polygon(r13, [xy(189,500),xy(90,499),xy(90,200),xy(140,200),xy(140,399),xy(190,400),xy(189,500)]).
midline(r13, [xy(115,403),xy(115,224)]).
midline(r13, [xy(115,404),xy(116,413),xy(122,427),xy(140,450)]).
...
midline(r25, [xy(377,634),xy(126,634),xy(124,629),xy(124,611),xy(125,605),xy(131,604),xy(547,604),xy(553,605),xy(555,610),xy(555,632),xy(548,635),xy(378,635)]).
midline(r25, [xy(555,606),xy(560,604),xy(585,606),xy(585,630),xy(583,634),xy(560,635),xy(555,633)]).
midline(r25, [xy(586,605),xy(607,604),xy(614,607),xy(620,604),xy(635,605)]).
...
region(r27, '#5a5a5a', 6000, centroid(400,620)).
perimeter(r27, 640).
polygon(r27, [xy(549,630),xy(250,630),xy(250,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(424,619),xy(259,620)]).
midline(r27, [xy(425,619),xy(540,620)]).
fillpoint(r27, xy(259,620), 10.0).
...
midline(r21, [xy(589,542),xy(590,531),xy(588,524),xy(574,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,513),xy(541,548),xy(578,550),xy(587,548),xy(589,543)]).
...
region(r26, '#2ecc40', 2400, centroid(190,620)).
perimeter(r26, 280).
polygon(r26, [xy(249,630),xy(130,630),xy(130,610),xy(249,610),xy(249,630)]).
midline(r26, [xy(141,619),xy(139,620)]).
midline(r26, [xy(142,619),xy(240,620)]).
fillpoint(r26, xy(139,620), 10.0).
region(r11, '#870c25', 1500, centroid(114,184)).
perimeter(r11, 160).
polygon(r11, [xy(139,200),xy(90,200),xy(90,170),xy(139,170),xy(139,200)]).
midline(r11, [xy(110,185),xy(104,185)]).
midline(r11, [xy(111,184),xy(125,185)]).
fillpoint(r11, xy(104,185), 15.0).
region(r9, '#bebebe', 1000, centroid(114,160)).
perimeter(r9, 140).
polygon(r9, [xy(139,170),xy(90,170),xy(90,150),xy(139,150),xy(139,170)]).
midline(r9, [xy(110,159),xy(99,160)]).
midline(r9, [xy(111,160),xy(130,160)]).
fillpoint(r9, xy(99,160), 10.0).
region(r10, '#5a5a5a', 800, centroid(364,174)).
perimeter(r10, 160).
polygon(r10, [xy(379,190),xy(350,189),xy(350,160),xy(380,160),xy(379,190)]).
hole(r10, [xy(370,179),xy(369,170),xy(360,170),xy(360,180),xy(370,179)]).
midline(r10, [xy(369,164),xy(355,165),xy(355,184),xy(369,185),xy(374,183),xy(375,170),xy(374,166),xy(370,165)]).
fillpoint(r10, xy(356,165), 6.0).
fillpoint(r10, xy(374,165), 6.0).
fillpoint(r10, xy(355,184), 6.0).
fillpoint(r10, xy(373,184), 6.0).
fillpoint(r10, xy(361,165), 5.0).
fillpoint(r10, xy(354,175), 5.0).
fillpoint(r10, xy(374,175), 5.0).
fillpoint(r10, xy(361,185), 5.0).
...
midline(r14, [xy(205,327),xy(205,315),xy(224,315),xy(225,322),xy(223,334),xy(206,334),xy(205,328)]).
...
adjacent(r2, r5).
shared_edge(r2, r5, 3570).
adjacent(r2, r9).
shared_edge(r2, r9, 40).
adjacent(r2, r11).
shared_edge(r2, r11, 60).
adjacent(r2, r13).
shared_edge(r2, r13, 750).
adjacent(r2, r24).
...
adjacent(r25, r26).
shared_edge(r25, r26, 260).
adjacent(r25, r27).
shared_edge(r25, r27, 620).
adjacent(r25, r28).
