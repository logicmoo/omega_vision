...
midline(r2, [xy(164,215),xy(164,348),xy(166,363),xy(170,371),xy(199,375),xy(215,381),xy(215,498),xy(213,513),xy(207,527),xy(189,550),xy(162,550),xy(132,523),xy(122,517),xy(109,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,531),xy(4,627),xy(5,634),xy(11,635),xy(113,634),xy(116,594),xy(159,550)]).
midline(r2, [xy(191,550),xy(210,566),xy(231,574),xy(389,575),xy(403,573),xy(419,566),xy(454,535),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(430,391),xy(411,379),xy(388,374),xy(364,375)]).
midline(r2, [xy(165,214),xy(164,150),xy(166,136),xy(170,128),xy(192,124),xy(265,125)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,96),xy(59,50),xy(66,26),xy(80,24),xy(389,24),xy(403,26),xy(413,30),xy(415,35),xy(415,99),xy(412,116),xy(409,123),xy(405,125),xy(364,125)]).
midline(r2, [xy(415,31),xy(426,26),xy(440,24),xy(517,24),xy(519,26)]).
midline(r2, [xy(466,428),xy(468,430),xy(470,428),xy(471,431),xy(474,430),xy(472,428)]).
midline(r2, [xy(474,432),xy(479,432),xy(479,434)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,198),xy(419,220),xy(440,225),xy(515,225)]).
midline(r2, [xy(481,434),xy(499,443)]).
midline(r2, [xy(520,24),xy(540,19),xy(586,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(624,576),xy(621,582),xy(606,585),xy(513,584),xy(497,576),xy(455,535)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(119,79),xy(115,91),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
midline(r5, [xy(203,74),xy(288,74),xy(309,78),xy(315,84),xy(315,220),xy(289,249),xy(315,275),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,466),xy(270,499),xy(276,515),xy(304,520),xy(339,519),xy(353,515),xy(358,504),xy(360,486),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(316,275),xy(362,296),xy(392,300),xy(539,300),xy(549,289),xy(557,277),xy(564,259),xy(565,203),xy(562,183),xy(557,174),xy(492,175),xy(480,174),xy(468,169),xy(464,149),xy(464,100),xy(466,86),xy(470,78),xy(490,74),xy(539,74),xy(553,76),xy(561,80),xy(565,101),xy(565,149),xy(563,163),xy(558,174)]).
midline(r5, [xy(540,301),xy(556,320),xy(564,341),xy(565,463),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r19, [xy(377,634),xy(126,634),xy(124,629),xy(124,610),xy(125,605),xy(132,604),xy(549,604),xy(555,606),xy(555,631),xy(549,635),xy(378,635)]).
midline(r19, [xy(556,605),xy(583,605),xy(585,609),xy(585,629),xy(584,633),xy(579,635),xy(560,635),xy(555,633)]).
midline(r19, [xy(585,606),xy(590,604),xy(608,604),xy(613,605),xy(615,610),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r16, [xy(19,563),xy(21,541),xy(48,539),xy(59,542),xy(60,569),xy(57,578),xy(23,580),xy(20,575),xy(20,564)]).
midline(r16, [xy(22,581),xy(19,593),xy(21,618),xy(30,620),xy(88,620),xy(97,618),xy(100,606),xy(99,544),xy(97,541),xy(89,539),xy(72,539),xy(61,542)]).
...
region(r20, '#2ecc40', 4800, centroid(250,620)).
perimeter(r20, 520).
polygon(r20, [xy(369,630),xy(130,630),xy(130,610),xy(369,610),xy(369,630)]).
midline(r20, [xy(290,620),xy(139,620)]).
midline(r20, [xy(291,620),xy(360,620)]).
...
midline(r13, [xy(589,542),xy(590,530),xy(588,524),xy(572,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,512),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r13, [xy(589,523),xy(590,511),xy(588,502),xy(579,499),xy(566,500)]).
...
region(r21, '#5a5a5a', 3600, centroid(460,620)).
perimeter(r21, 400).
polygon(r21, [xy(549,630),xy(370,630),xy(370,610),xy(549,610),xy(549,630)]).
midline(r21, [xy(519,620),xy(379,620)]).
midline(r21, [xy(520,619),xy(540,620)]).
fillpoint(r21, xy(379,620), 10.0).
...
midline(r18, [xy(79,588),xy(79,595),xy(75,599),xy(39,600)]).
...
midline(r7, [xy(516,134),xy(504,135)]).
midline(r7, [xy(517,134),xy(525,135)]).
...
midline(r6, [xy(520,110),xy(499,110)]).
midline(r6, [xy(521,110),xy(530,110)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 500).
adjacent(r19, r21).
shared_edge(r19, r21, 380).
adjacent(r19, r22).
