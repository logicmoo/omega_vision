...
midline(r2, [xy(112,25),xy(80,24),xy(66,26),xy(60,42),xy(59,97),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,627),xy(5,634),xy(10,635),xy(113,634),xy(115,627),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,25),xy(387,24),xy(406,27),xy(415,31),xy(415,99),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,197),xy(416,213),xy(420,221),xy(441,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(430,25),xy(441,24),xy(519,25),xy(540,19),xy(597,20),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(623,579),xy(619,583),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(386,575),xy(230,574),xy(207,564),xy(189,549),xy(160,549)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(466,426),xy(430,391),xy(417,382),xy(399,375),xy(364,375)]).
midline(r2, [xy(466,428),xy(470,430),xy(472,428),xy(474,432)]).
midline(r2, [xy(476,430),xy(477,433),xy(478,431)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,508),xy(215,382),xy(199,375),xy(180,374),xy(170,371),xy(165,359),xy(165,140),xy(169,129),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(480,433),xy(481,434)]).
...
midline(r5, [xy(540,299),xy(376,299),xy(353,293),xy(315,275),xy(289,250)]).
midline(r5, [xy(315,276),xy(315,420),xy(313,425),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(304,520),xy(339,519),xy(353,515),xy(358,504),xy(360,489),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(290,248),xy(315,220),xy(315,85),xy(313,80),xy(303,76),xy(287,74),xy(140,74),xy(126,76),xy(118,80),xy(114,101),xy(114,397),xy(119,421),xy(127,435),xy(140,450)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(540,301),xy(554,317),xy(564,341),xy(565,463),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
region(r6, '#2ecc40', 22000, centroid(514,124)).
perimeter(r6, 720).
polygon(r6, [xy(589,200),xy(440,199),xy(440,50),xy(590,50),xy(589,200)]).
...
midline(r6, [xy(509,169),xy(529,169),xy(551,161)]).
midline(r6, [xy(552,159),xy(558,144),xy(560,120),xy(558,105),xy(552,90),xy(534,81),xy(518,79),xy(495,81),xy(480,87)]).
midline(r6, [xy(551,88),xy(550,89)]).
fillpoint(r6, xy(478,88), 38.8).
fillpoint(r6, xy(551,88), 38.8).
fillpoint(r6, xy(478,161), 38.8).
fillpoint(r6, xy(551,161), 38.8).
...
midline(r23, [xy(418,635),xy(130,635),xy(125,633),xy(124,627),xy(125,605),xy(130,604),xy(549,604),xy(554,606),xy(555,611),xy(555,629),xy(554,633),xy(549,635),xy(419,635)]).
midline(r23, [xy(555,606),xy(560,604),xy(578,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(561,635),xy(555,633)]).
midline(r23, [xy(585,606),xy(591,604),xy(615,606),xy(615,630),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r20, [xy(19,563),xy(20,544),xy(24,540),xy(89,539),xy(98,541),xy(100,551),xy(99,615),xy(97,618),xy(89,620),xy(71,620),xy(60,616),xy(49,620),xy(22,618),xy(19,609),xy(19,590),xy(23,580),xy(20,575),xy(19,564)]).
midline(r20, [xy(60,615),xy(58,582),xy(49,579),xy(24,579)]).
...
region(r25, '#5a5a5a', 4800, centroid(430,620)).
perimeter(r25, 520).
polygon(r25, [xy(549,630),xy(310,630),xy(310,610),xy(549,610),xy(549,630)]).
midline(r25, [xy(484,619),xy(319,620)]).
midline(r25, [xy(485,619),xy(540,620)]).
fillpoint(r25, xy(319,620), 10.0).
...
midline(r17, [xy(589,542),xy(590,531),xy(588,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,514),xy(541,548),xy(550,550),xy(578,550),xy(587,548),xy(589,543)]).
midline(r17, [xy(566,500),xy(579,499),xy(588,501),xy(590,510),xy(589,524)]).
...
region(r24, '#2ecc40', 3600, centroid(220,620)).
perimeter(r24, 400).
polygon(r24, [xy(309,630),xy(130,630),xy(130,610),xy(309,610),xy(309,630)]).
midline(r24, [xy(279,620),xy(139,620)]).
midline(r24, [xy(280,620),xy(300,620)]).
...
midline(r21, [xy(41,559),xy(39,560)]).
midline(r21, [xy(42,559),xy(78,561),xy(80,570),xy(80,600)]).
...
region(r11, '#870c25', 1500, centroid(564,234)).
perimeter(r11, 160).
polygon(r11, [xy(589,250),xy(540,250),xy(540,220),xy(589,220),xy(589,250)]).
midline(r11, [xy(572,235),xy(554,235)]).
midline(r11, [xy(573,234),xy(575,235)]).
fillpoint(r11, xy(554,235), 15.0).
region(r10, '#bebebe', 1000, centroid(564,210)).
perimeter(r10, 140).
polygon(r10, [xy(589,220),xy(540,220),xy(540,200),xy(589,200),xy(589,220)]).
midline(r10, [xy(570,210),xy(549,210)]).
midline(r10, [xy(571,209),xy(580,210)]).
fillpoint(r10, xy(549,210), 10.0).
...
midline(r18, [xy(555,521),xy(555,534),xy(575,535)]).
midline(r18, [xy(555,520),xy(555,514)]).
...
adjacent(r23, r24).
shared_edge(r23, r24, 380).
adjacent(r23, r25).
shared_edge(r23, r25, 500).
adjacent(r23, r26).
