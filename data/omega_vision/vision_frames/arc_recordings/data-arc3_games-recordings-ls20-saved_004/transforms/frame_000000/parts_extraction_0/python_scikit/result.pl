...
midline(r2, [xy(508,25),xy(440,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(80,24),xy(66,26),xy(59,50),xy(59,98),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(11,635),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(520,25),xy(528,21),xy(541,19),xy(589,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,482),xy(625,569),xy(622,581),xy(607,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(389,575),xy(231,574),xy(210,566),xy(190,549),xy(160,549)]).
midline(r2, [xy(415,32),xy(415,95),xy(413,113),xy(409,123),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(416,213),xy(420,221),xy(440,225),xy(515,225)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(466,425),xy(430,391),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(199,375),xy(170,371),xy(166,363),xy(164,349),xy(165,140),xy(170,128),xy(181,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(472,429),xy(467,426),xy(466,429),xy(469,430)]).
midline(r2, [xy(473,430),xy(474,431)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(559,110),xy(560,128),xy(558,144),xy(550,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(561,180),xy(564,190),xy(565,248),xy(561,269),xy(552,285),xy(539,300),xy(390,300),xy(370,298),xy(350,292),xy(314,274),xy(275,235),xy(270,240),xy(268,238),xy(260,246),xy(239,260),xy(196,304),xy(194,310),xy(194,338),xy(195,344),xy(200,345),xy(229,345),xy(239,340),xy(281,298),xy(288,287),xy(374,205),xy(384,193),xy(384,156),xy(379,154),xy(346,155),xy(330,168),xy(316,174),xy(314,172),xy(315,86),xy(313,80),xy(303,76),xy(289,74),xy(141,74),xy(120,78),xy(116,86),xy(114,100),xy(115,408),xy(120,421),xy(149,425),xy(160,429),xy(164,441),xy(165,475)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(277,235),xy(283,221),xy(306,190),xy(314,174)]).
midline(r5, [xy(285,221),xy(286,220)]).
...
midline(r5, [xy(314,275),xy(315,423),xy(274,436),xy(270,450),xy(269,489),xy(274,513),xy(285,518),xy(329,520),xy(344,518),xy(355,513),xy(360,485),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(265,243),xy(268,240)]).
...
midline(r24, [xy(169,605),xy(125,605),xy(124,629),xy(125,634),xy(130,635),xy(553,634),xy(555,632),xy(555,607),xy(549,604),xy(170,604)]).
midline(r24, [xy(555,606),xy(560,604),xy(578,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(560,635),xy(555,633)]).
midline(r24, [xy(585,606),xy(590,604),xy(615,606),xy(615,632),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r25, [xy(490,620),xy(139,620)]).
midline(r25, [xy(491,619),xy(540,620)]).
...
midline(r20, [xy(589,542),xy(588,524),xy(571,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r20, [xy(589,523),xy(590,510),xy(588,502),xy(579,499),xy(566,500)]).
...
midline(r16, [xy(117,485),xy(125,485)]).
...
midline(r11, [xy(219,314),xy(205,315),xy(205,334),xy(216,335),xy(224,333),xy(224,316),xy(220,315)]).
...
midline(r3, [xy(556,45),xy(544,45)]).
midline(r3, [xy(557,44),xy(585,45)]).
