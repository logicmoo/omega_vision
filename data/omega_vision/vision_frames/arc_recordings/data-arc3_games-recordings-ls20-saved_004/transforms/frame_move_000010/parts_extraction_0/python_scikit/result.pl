...
midline(r2, [xy(508,25),xy(442,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(84,24),xy(66,26),xy(61,38),xy(59,54),xy(59,99),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,601),xy(116,594),xy(159,550),xy(141,531),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(519,24),xy(520,26),xy(518,26)]).
midline(r2, [xy(521,24),xy(541,19),xy(589,19),xy(609,24),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,480),xy(625,568),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(454,534),xy(439,550),xy(419,566),xy(403,573),xy(388,575),xy(240,575),xy(226,573),xy(212,567),xy(190,549),xy(160,550)]).
midline(r2, [xy(66,121),xy(68,119)]).
midline(r2, [xy(521,27),xy(520,28)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,508),xy(215,382),xy(199,375),xy(180,374),xy(170,371),xy(165,359),xy(165,141),xy(169,129),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(230,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,92),xy(414,109),xy(409,123),xy(406,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(419,220),xy(430,224),xy(442,225),xy(515,225)]).
midline(r2, [xy(455,533),xy(455,464),xy(465,428),xy(464,424),xy(429,390),xy(411,379),xy(399,375),xy(364,375)]).
midline(r2, [xy(468,426),xy(466,423)]).
midline(r2, [xy(474,432),xy(469,427),xy(466,428),xy(471,431)]).
midline(r2, [xy(475,433),xy(475,431)]).
...
border(r2).
region(r6, '#2ecc40', 116500, centroid(400,295)).
perimeter(r6, 3680).
polygon(r6, [xy(609,570),xy(520,569),xy(520,480),xy(540,479),xy(539,350),xy(340,350),xy(340,399),xy(390,400),xy(390,549),xy(240,549),xy(240,400),xy(289,400),xy(290,350),xy(190,349),xy(190,150),xy(389,150),xy(390,250),xy(539,250),xy(539,200),xy(440,199),xy(440,50),xy(590,50),xy(590,479),xy(610,480),xy(609,570)]).
...
midline(r6, [xy(564,224),xy(564,190),xy(560,178),xy(550,162),xy(534,168),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,120),xy(471,105),xy(479,89)]).
midline(r6, [xy(479,160),xy(478,161)]).
midline(r6, [xy(480,87),xy(495,81),xy(517,79),xy(534,81),xy(551,88),xy(558,105),xy(560,120),xy(558,144),xy(551,161)]).
midline(r6, [xy(565,225),xy(565,249),xy(561,269),xy(552,285),xy(537,300),xy(392,300),xy(366,297),xy(315,276),xy(275,235),xy(274,237),xy(269,237),xy(261,245),xy(240,259),xy(195,306),xy(195,344),xy(229,345),xy(240,339),xy(278,301),xy(288,287),xy(328,247),xy(340,239),xy(384,193),xy(384,156),xy(378,154),xy(346,155),xy(293,207),xy(277,235)]).
midline(r6, [xy(540,300),xy(556,320),xy(564,341),xy(565,461),xy(564,465),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r6, [xy(315,277),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(301,520),xy(329,520),xy(353,515),xy(358,504),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r6, [xy(265,243),xy(270,239)]).
midline(r6, [xy(273,238),xy(272,239)]).
fillpoint(r6, xy(303,263), 87.7).
fillpoint(r6, xy(277,237), 87.4).
...
region(r5, '#2ecc40', 40000, centroid(168,234)).
perimeter(r5, 1600).
polygon(r5, [xy(189,500),xy(90,499),xy(90,50),xy(389,50),xy(389,100),xy(140,100),xy(140,399),xy(190,400),xy(189,500)]).
midline(r5, [xy(347,75),xy(140,74),xy(119,79),xy(114,100),xy(114,398),xy(119,421),xy(127,435),xy(140,450)]).
midline(r5, [xy(348,75),xy(365,75)]).
...
midline(r25, [xy(418,635),xy(130,635),xy(125,633),xy(124,611),xy(125,605),xy(131,604),xy(548,604),xy(554,607),xy(560,604),xy(579,604),xy(585,606),xy(585,630),xy(583,634),xy(419,635)]).
midline(r25, [xy(586,605),xy(613,605),xy(615,609),xy(615,632),xy(609,635),xy(585,633)]).
...
region(r27, '#5a5a5a', 4400, centroid(440,620)).
perimeter(r27, 480).
polygon(r27, [xy(549,630),xy(330,630),xy(330,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(479,620),xy(339,620)]).
midline(r27, [xy(480,619),xy(540,620)]).
fillpoint(r27, xy(339,620), 10.0).
...
midline(r21, [xy(589,542),xy(590,530),xy(587,524),xy(570,525),xy(565,523),xy(564,500),xy(551,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
midline(r21, [xy(566,500),xy(579,499),xy(588,501),xy(590,511),xy(589,524)]).
...
region(r26, '#2ecc40', 4000, centroid(230,620)).
perimeter(r26, 440).
polygon(r26, [xy(329,630),xy(130,630),xy(130,610),xy(329,610),xy(329,630)]).
midline(r26, [xy(279,620),xy(139,620)]).
midline(r26, [xy(280,620),xy(320,620)]).
fillpoint(r26, xy(139,620), 10.0).
region(r9, '#870c25', 1500, centroid(314,134)).
perimeter(r9, 160).
polygon(r9, [xy(339,150),xy(290,150),xy(290,120),xy(339,120),xy(339,150)]).
midline(r9, [xy(312,135),xy(304,135)]).
midline(r9, [xy(313,135),xy(325,135)]).
fillpoint(r9, xy(304,135), 15.0).
region(r7, '#bebebe', 1000, centroid(314,110)).
perimeter(r7, 140).
polygon(r7, [xy(339,120),xy(290,120),xy(290,100),xy(339,100),xy(339,120)]).
midline(r7, [xy(320,110),xy(299,110)]).
midline(r7, [xy(321,109),xy(330,110)]).
fillpoint(r7, xy(299,110), 10.0).
region(r12, '#5a5a5a', 800, centroid(364,174)).
perimeter(r12, 160).
polygon(r12, [xy(379,190),xy(350,189),xy(350,160),xy(380,160),xy(379,190)]).
hole(r12, [xy(370,179),xy(369,170),xy(360,170),xy(360,180),xy(370,179)]).
midline(r12, [xy(369,164),xy(355,165),xy(355,184),xy(368,185),xy(374,183),xy(375,170),xy(374,166),xy(370,165)]).
fillpoint(r12, xy(356,165), 6.0).
fillpoint(r12, xy(374,165), 6.0).
fillpoint(r12, xy(355,184), 6.0).
fillpoint(r12, xy(373,184), 6.0).
fillpoint(r12, xy(361,165), 5.0).
fillpoint(r12, xy(354,175), 5.0).
fillpoint(r12, xy(374,175), 5.0).
fillpoint(r12, xy(361,185), 5.0).
...
midline(r14, [xy(224,332),xy(225,321),xy(223,315),xy(205,315),xy(204,320),xy(205,334),xy(224,334)]).
...
midline(r3, [xy(577,45),xy(585,45)]).
...
midline(r22, [xy(555,524),xy(555,514)]).
midline(r22, [xy(554,525),xy(555,534),xy(575,535)]).
...
adjacent(r25, r26).
shared_edge(r25, r26, 420).
adjacent(r25, r27).
shared_edge(r25, r27, 460).
adjacent(r25, r28).
