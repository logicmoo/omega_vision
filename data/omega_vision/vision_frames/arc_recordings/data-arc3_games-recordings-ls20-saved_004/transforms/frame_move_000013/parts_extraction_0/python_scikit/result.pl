...
midline(r2, [xy(165,216),xy(164,348),xy(166,363),xy(170,371),xy(203,376),xy(215,381),xy(215,493),xy(214,509),xy(206,529),xy(189,550),xy(161,550),xy(132,523),xy(122,517),xy(108,514),xy(83,514),xy(65,504),xy(43,524),xy(5,525),xy(4,533),xy(4,628),xy(5,634),xy(12,635),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550)]).
midline(r2, [xy(191,550),xy(207,564),xy(230,574),xy(389,575),xy(403,573),xy(422,564),xy(454,535),xy(455,464),xy(465,428),xy(464,424),xy(430,391),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,97),xy(59,50),xy(66,26),xy(85,24),xy(388,24),xy(403,26),xy(415,31),xy(415,95),xy(412,116),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,197),xy(415,209),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(466,427),xy(466,429)]).
midline(r2, [xy(416,30),xy(430,25),xy(444,24),xy(519,25),xy(540,19),xy(589,19),xy(613,26),xy(615,40),xy(614,455),xy(622,467),xy(625,482),xy(624,576),xy(621,582),xy(609,585),xy(513,584),xy(497,576),xy(455,535)]).
midline(r2, [xy(468,429),xy(470,428),xy(466,423)]).
midline(r2, [xy(471,429),xy(475,433),xy(498,442),xy(498,444)]).
...
midline(r5, [xy(202,75),xy(131,75),xy(120,78),xy(115,90),xy(114,395),xy(118,419),xy(127,435),xy(140,450)]).
midline(r5, [xy(203,75),xy(289,74),xy(303,76),xy(314,82),xy(330,75),xy(365,75)]).
midline(r5, [xy(315,83),xy(315,174),xy(264,224),xy(264,241),xy(241,258),xy(195,306),xy(195,344),xy(227,345),xy(239,340),xy(278,301),xy(289,286),xy(265,244),xy(263,244)]).
midline(r5, [xy(316,174),xy(365,175)]).
midline(r5, [xy(290,287),xy(315,301),xy(315,423),xy(274,436),xy(269,461),xy(270,499),xy(274,513),xy(290,519),xy(329,520),xy(344,518),xy(355,513),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(316,300),xy(538,300),xy(552,285),xy(564,259),xy(565,200),xy(561,180),xy(551,163),xy(529,169),xy(510,170),xy(495,168),xy(477,159),xy(471,144),xy(469,123),xy(471,105),xy(479,89)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,162),xy(550,160),xy(558,144),xy(560,126),xy(558,105),xy(552,90),xy(534,81),xy(518,79),xy(495,81),xy(480,87)]).
midline(r5, [xy(551,88),xy(550,89)]).
midline(r5, [xy(540,300),xy(557,322),xy(564,341),xy(565,464),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
fillpoint(r5, xy(264,234), 75.0).
fillpoint(r5, xy(277,266), 65.1).
fillpoint(r5, xy(281,273), 63.7).
fillpoint(r5, xy(288,286), 63.7).
fillpoint(r5, xy(282,275), 63.5).
fillpoint(r5, xy(287,284), 63.5).
fillpoint(r5, xy(283,277), 63.3).
fillpoint(r5, xy(286,282), 63.3).
fillpoint(r5, xy(284,279), 63.1).
fillpoint(r5, xy(285,280), 63.1).
fillpoint(r5, xy(341,300), 50.0).
...
midline(r22, [xy(555,622),xy(554,633),xy(548,635),xy(131,635),xy(126,634),xy(124,628),xy(125,605),xy(131,604),xy(549,604),xy(555,606),xy(555,621)]).
midline(r22, [xy(556,605),xy(579,604),xy(585,606),xy(585,631),xy(583,634),xy(578,635),xy(555,633)]).
midline(r22, [xy(586,605),xy(607,604),xy(615,606),xy(615,629),xy(614,633),xy(609,635),xy(590,635),xy(585,633)]).
...
midline(r24, [xy(366,620),xy(540,620)]).
...
midline(r18, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,511),xy(539,539),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r18, [xy(589,523),xy(590,510),xy(588,502),xy(578,499),xy(566,500)]).
...
region(r10, '#870c25', 1500, centroid(364,234)).
perimeter(r10, 160).
polygon(r10, [xy(389,250),xy(340,250),xy(340,220),xy(389,220),xy(389,250)]).
midline(r10, [xy(373,235),xy(354,235)]).
midline(r10, [xy(375,235),xy(375,234)]).
fillpoint(r10, xy(354,235), 15.0).
region(r9, '#bebebe', 1000, centroid(364,210)).
perimeter(r9, 140).
polygon(r9, [xy(389,220),xy(340,220),xy(340,200),xy(389,200),xy(389,220)]).
midline(r9, [xy(359,210),xy(349,210)]).
midline(r9, [xy(360,210),xy(380,210)]).
fillpoint(r9, xy(349,210), 10.0).
...
midline(r11, [xy(224,332),xy(225,323),xy(223,315),xy(205,315),xy(204,320),xy(205,334),xy(224,334)]).
...
midline(r19, [xy(554,522),xy(555,534),xy(575,535)]).
