...
midline(r2, [xy(508,25),xy(442,24),xy(426,26),xy(415,31),xy(403,26),xy(388,24),xy(80,24),xy(66,26),xy(61,38),xy(59,51),xy(60,107),xy(64,119),xy(68,119),xy(64,123),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,629),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(518,24),xy(520,29),xy(522,29)]).
midline(r2, [xy(520,24),xy(542,19),xy(586,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(625,568),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(429,559),xy(417,567),xy(403,573),xy(387,575),xy(230,574),xy(210,566),xy(190,549),xy(160,549)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(429,390),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(467,426),xy(468,429)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(203,376),xy(170,371),xy(166,363),xy(164,349),xy(165,141),xy(168,130),xy(180,125),xy(265,125)]).
midline(r2, [xy(215,381),xy(231,375),xy(265,375)]).
midline(r2, [xy(414,32),xy(415,91),xy(414,109),xy(409,123),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,198),xy(416,213),xy(420,221),xy(443,225),xy(515,225)]).
midline(r2, [xy(470,428),xy(474,432),xy(478,431),xy(476,433)]).
midline(r2, [xy(487,437),xy(484,434),xy(480,433),xy(480,435)]).
midline(r2, [xy(483,436),xy(486,438)]).
...
midline(r5, [xy(551,163),xy(560,178),xy(564,190),xy(564,259),xy(556,279),xy(538,300),xy(392,300),xy(370,298),xy(348,291),xy(315,275),xy(274,234),xy(238,261),xy(195,306),xy(195,344),xy(229,345),xy(239,340),xy(279,300),xy(287,288),xy(327,248),xy(341,238),xy(383,195),xy(385,187),xy(384,156),xy(376,154),xy(346,155),xy(332,167),xy(314,174),xy(315,82),xy(306,77),xy(283,74),xy(140,74),xy(120,78),xy(116,86),xy(114,100),xy(115,175)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(276,235),xy(314,175)]).
midline(r5, [xy(282,226),xy(283,225)]).
midline(r5, [xy(270,240),xy(275,237)]).
...
midline(r5, [xy(314,276),xy(315,422),xy(313,425),xy(285,431),xy(274,436),xy(270,450),xy(269,487),xy(274,513),xy(285,518),xy(329,520),xy(344,518),xy(355,513),xy(360,486),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
midline(r13, [xy(115,279),xy(115,274)]).
midline(r13, [xy(115,280),xy(115,409),xy(125,432),xy(140,450)]).
...
midline(r25, [xy(524,635),xy(130,635),xy(125,633),xy(124,626),xy(125,605),xy(130,604),xy(548,604),xy(554,606),xy(555,632),xy(545,635),xy(525,635)]).
midline(r25, [xy(555,606),xy(560,604),xy(585,606),xy(585,632),xy(583,634),xy(562,635),xy(555,633)]).
midline(r25, [xy(586,605),xy(608,604),xy(615,606),xy(615,632),xy(609,635),xy(585,633)]).
...
midline(r21, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(565,502),xy(563,500),xy(550,499),xy(541,501),xy(539,511),xy(541,548),xy(578,550),xy(587,548),xy(589,543)]).
midline(r21, [xy(565,500),xy(578,499),xy(588,501),xy(590,511),xy(589,523)]).
...
midline(r26, [xy(152,619),xy(220,620)]).
...
midline(r12, [xy(116,234),xy(104,235)]).
midline(r12, [xy(117,235),xy(125,235)]).
...
midline(r11, [xy(121,209),xy(130,210)]).
...
midline(r9, [xy(355,177),xy(355,165),xy(374,165),xy(374,183),xy(360,185),xy(355,183),xy(354,178)]).
