...
midline(r2, [xy(164,215),xy(164,150),xy(166,136),xy(170,128),xy(190,124),xy(265,125)]).
midline(r2, [xy(165,216),xy(164,344),xy(166,363),xy(168,369),xy(173,372),xy(203,376),xy(215,381),xy(215,496),xy(213,513),xy(207,527),xy(189,549),xy(161,550),xy(132,523),xy(122,517),xy(108,514),xy(83,514),xy(65,504),xy(43,524),xy(10,524),xy(5,525),xy(4,531),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(159,550)]).
midline(r2, [xy(65,503),xy(65,119),xy(61,111),xy(59,99),xy(59,54),xy(60,42),xy(66,26),xy(86,24),xy(388,24),xy(403,26),xy(415,31),xy(415,98),xy(411,119),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,199),xy(416,213),xy(420,221),xy(441,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(426,26),xy(445,24),xy(519,25),xy(541,19),xy(589,19),xy(613,26),xy(615,42),xy(614,455),xy(622,467),xy(625,483),xy(625,569),xy(623,579),xy(619,583),xy(608,585),xy(513,584),xy(497,576),xy(455,535),xy(422,564),xy(406,572),xy(389,575),xy(230,574),xy(207,564),xy(190,549)]).
midline(r2, [xy(66,119),xy(66,121)]).
...
midline(r5, [xy(202,75),xy(130,75),xy(120,78),xy(115,90),xy(114,399),xy(116,413),xy(122,427),xy(140,450)]).
midline(r5, [xy(203,74),xy(298,75),xy(313,80),xy(315,84),xy(315,221),xy(289,249),xy(315,277),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,461),xy(270,499),xy(276,515),xy(300,520),xy(329,520),xy(353,515),xy(358,504),xy(360,481),xy(359,450),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
midline(r5, [xy(315,81),xy(331,75),xy(365,75)]).
midline(r5, [xy(315,274),xy(350,292),xy(376,299),xy(539,300),xy(552,285),xy(562,266),xy(565,249),xy(565,224)]).
midline(r5, [xy(540,301),xy(556,320),xy(564,341),xy(565,462),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(531,565),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
...
midline(r1, [xy(19,255),xy(20,500)]).
fillpoint(r1, xy(19,260), 20.0).
border(r1).
region(r6, '#2ecc40', 19500, centroid(508,118)).
perimeter(r6, 720).
polygon(r6, [xy(539,200),xy(440,199),xy(440,50),xy(590,50),xy(590,149),xy(540,150),xy(539,200)]).
...
midline(r6, [xy(480,87),xy(500,80),xy(529,80),xy(551,88),xy(555,96),xy(559,110),xy(559,120),xy(543,135),xy(531,141),xy(525,153),xy(510,170)]).
...
midline(r23, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(555,606),xy(555,632),xy(549,635),xy(525,634)]).
midline(r23, [xy(556,605),xy(576,604),xy(583,605),xy(584,607),xy(590,604),xy(613,605),xy(615,606),xy(615,632),xy(606,635),xy(585,633),xy(561,635),xy(555,633)]).
midline(r23, [xy(616,605),xy(635,605)]).
midline(r23, [xy(585,608),xy(585,632)]).
...
midline(r20, [xy(99,553),xy(99,544),xy(95,540),xy(33,539),xy(21,541),xy(19,550),xy(19,569),xy(23,580),xy(20,584),xy(19,592),xy(21,618),xy(30,620),xy(55,619),xy(60,614),xy(58,582),xy(48,579),xy(24,580)]).
midline(r20, [xy(100,554),xy(100,608),xy(98,617),xy(88,620),xy(70,620),xy(60,617)]).
...
region(r25, '#5a5a5a', 4400, centroid(440,620)).
perimeter(r25, 480).
polygon(r25, [xy(549,630),xy(330,630),xy(330,610),xy(549,610),xy(549,630)]).
midline(r25, [xy(479,620),xy(339,620)]).
midline(r25, [xy(480,619),xy(540,620)]).
fillpoint(r25, xy(339,620), 10.0).
...
midline(r17, [xy(589,542),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(550,499),xy(541,501),xy(539,510),xy(539,539),xy(541,548),xy(579,550),xy(587,548),xy(589,543)]).
midline(r17, [xy(589,523),xy(590,510),xy(588,502),xy(579,499),xy(566,500)]).
...
region(r24, '#2ecc40', 4000, centroid(230,620)).
perimeter(r24, 440).
polygon(r24, [xy(329,630),xy(130,630),xy(130,610),xy(329,610),xy(329,630)]).
midline(r24, [xy(279,620),xy(139,620)]).
midline(r24, [xy(280,620),xy(320,620)]).
...
midline(r21, [xy(80,587),xy(80,570),xy(77,561),xy(68,559),xy(39,560)]).
...
region(r11, '#870c25', 1500, centroid(564,184)).
perimeter(r11, 160).
polygon(r11, [xy(589,200),xy(540,200),xy(540,170),xy(589,170),xy(589,200)]).
midline(r11, [xy(560,185),xy(554,185)]).
midline(r11, [xy(561,184),xy(575,185)]).
fillpoint(r11, xy(554,185), 15.0).
region(r10, '#bebebe', 1000, centroid(564,160)).
perimeter(r10, 140).
polygon(r10, [xy(589,170),xy(540,170),xy(540,150),xy(589,150),xy(589,170)]).
midline(r10, [xy(559,160),xy(549,160)]).
midline(r10, [xy(560,160),xy(580,160)]).
fillpoint(r10, xy(549,160), 10.0).
...
midline(r18, [xy(565,535),xy(555,533),xy(555,514)]).
midline(r18, [xy(566,534),xy(575,535)]).
...
adjacent(r2, r5).
shared_edge(r2, r5, 3920).
adjacent(r2, r6).
shared_edge(r2, r6, 450).
adjacent(r2, r10).
...
adjacent(r23, r24).
shared_edge(r23, r24, 420).
adjacent(r23, r25).
shared_edge(r23, r25, 460).
adjacent(r23, r26).
