...
midline(r2, [xy(112,25),xy(81,24),xy(66,26),xy(60,42),xy(59,96),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(4,627),xy(5,634),xy(11,635),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(159,550),xy(141,531),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,24),xy(389,24),xy(409,28),xy(415,31),xy(415,98),xy(410,121),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,140),xy(414,197),xy(415,209),xy(419,220),xy(441,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(426,26),xy(444,24),xy(518,24),xy(520,26)]).
midline(r2, [xy(521,24),xy(543,19),xy(588,19),xy(609,24),xy(613,26),xy(614,31),xy(614,455),xy(622,467),xy(625,481),xy(625,569),xy(622,581),xy(607,585),xy(513,584),xy(497,576),xy(455,535),xy(417,567),xy(403,573),xy(386,575),xy(231,574),xy(207,564),xy(190,549),xy(160,550)]).
midline(r2, [xy(66,121),xy(68,119)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(430,391),xy(411,379),xy(389,374),xy(364,375)]).
midline(r2, [xy(466,429),xy(482,434),xy(482,436)]).
midline(r2, [xy(484,436),xy(491,438),xy(492,441),xy(495,440),xy(496,443),xy(497,441)]).
midline(r2, [xy(499,443),xy(498,444)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(203,376),xy(170,371),xy(165,359),xy(165,140),xy(170,128),xy(181,125),xy(265,125)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(518,79),xy(534,81),xy(551,88),xy(559,110),xy(560,128),xy(558,144),xy(551,161),xy(547,164),xy(519,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(561,180),xy(564,190),xy(564,258),xy(554,282),xy(538,300),xy(390,300),xy(366,297),xy(348,291),xy(315,274),xy(300,270),xy(269,239),xy(241,258),xy(196,304),xy(194,310),xy(195,344),xy(203,345),xy(229,345),xy(235,343),xy(278,301),xy(287,288),xy(303,272)]).
midline(r5, [xy(270,238),xy(266,226),xy(302,185),xy(313,163),xy(315,148),xy(314,81),xy(303,76),xy(289,74),xy(145,74),xy(130,75),xy(118,80),xy(114,101),xy(114,398),xy(119,421),xy(127,435),xy(140,450)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(266,242),xy(265,243)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,340),xy(565,461),xy(564,465),xy(545,483),xy(525,485),xy(524,559),xy(525,564),xy(530,565),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(315,276),xy(315,422),xy(313,425),xy(304,428),xy(276,434),xy(271,445),xy(269,460),xy(270,499),xy(276,515),xy(300,520),xy(329,520),xy(353,515),xy(358,504),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
fillpoint(r5, xy(299,269), 81.1).
fillpoint(r5, xy(270,240), 81.0).
fillpoint(r5, xy(301,270), 80.9).
fillpoint(r5, xy(304,271), 80.4).
fillpoint(r5, xy(269,236), 80.0).
fillpoint(r5, xy(307,272), 80.0).
fillpoint(r5, xy(310,273), 79.8).
fillpoint(r5, xy(313,274), 79.7).
fillpoint(r5, xy(268,232), 79.0).
fillpoint(r5, xy(267,228), 78.0).
...
midline(r22, [xy(169,605),xy(125,605),xy(124,629),xy(125,634),xy(130,635),xy(553,634),xy(555,632),xy(555,607),xy(549,604),xy(170,604)]).
midline(r22, [xy(555,606),xy(560,604),xy(579,604),xy(585,606),xy(585,631),xy(583,634),xy(563,635),xy(555,633)]).
midline(r22, [xy(586,605),xy(609,604),xy(615,606),xy(615,632),xy(609,635),xy(590,635),xy(585,633)]).
...
midline(r18, [xy(589,542),xy(590,532),xy(588,524),xy(573,525),xy(565,523),xy(563,500),xy(541,501),xy(539,517),xy(541,548),xy(577,550),xy(587,548),xy(589,543)]).
midline(r18, [xy(565,500),xy(579,499),xy(588,501),xy(590,511),xy(589,523)]).
...
region(r10, '#870c25', 1500, centroid(364,184)).
perimeter(r10, 160).
polygon(r10, [xy(389,200),xy(340,200),xy(340,170),xy(389,170),xy(389,200)]).
midline(r10, [xy(366,184),xy(354,185)]).
midline(r10, [xy(367,184),xy(375,185)]).
fillpoint(r10, xy(354,185), 15.0).
region(r9, '#bebebe', 1000, centroid(364,160)).
perimeter(r9, 140).
polygon(r9, [xy(389,170),xy(340,170),xy(340,150),xy(389,150),xy(389,170)]).
midline(r9, [xy(373,159),xy(349,160)]).
midline(r9, [xy(374,160),xy(380,160)]).
fillpoint(r9, xy(349,160), 10.0).
...
midline(r11, [xy(205,327),xy(205,315),xy(224,315),xy(225,321),xy(223,334),xy(206,334),xy(205,328)]).
...
midline(r19, [xy(565,535),xy(555,533),xy(555,514)]).
midline(r19, [xy(566,534),xy(575,535)]).
