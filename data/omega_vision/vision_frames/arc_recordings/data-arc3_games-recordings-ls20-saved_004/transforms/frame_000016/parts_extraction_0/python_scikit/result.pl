...
midline(r2, [xy(508,25),xy(441,24),xy(426,26),xy(415,31),xy(403,26),xy(389,24),xy(82,24),xy(66,26),xy(59,50),xy(59,98),xy(61,111),xy(65,119),xy(65,504),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,624),xy(114,600),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(106,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(509,25),xy(520,25),xy(528,21),xy(540,19),xy(589,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,481),xy(625,569),xy(622,581),xy(616,584),xy(605,585),xy(513,584),xy(497,576),xy(455,535),xy(417,567),xy(403,573),xy(382,575),xy(230,574),xy(210,566),xy(190,549),xy(160,549)]).
midline(r2, [xy(455,534),xy(455,464),xy(465,425),xy(430,391),xy(411,379),xy(388,374),xy(364,375)]).
midline(r2, [xy(466,426),xy(467,429),xy(472,431),xy(474,429),xy(473,432)]).
midline(r2, [xy(190,548),xy(204,532),xy(214,508),xy(215,383),xy(213,380),xy(203,376),xy(170,371),xy(166,363),xy(164,347),xy(165,140),xy(170,128),xy(181,125),xy(265,125)]).
...
midline(r2, [xy(480,433),xy(476,431),xy(476,433)]).
midline(r2, [xy(480,435),xy(481,434)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(559,110),xy(560,129),xy(558,144),xy(551,161),xy(547,164),xy(519,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(560,178),xy(564,191),xy(565,249),xy(563,263),xy(557,277),xy(539,300),xy(390,300),xy(313,223),xy(273,225),xy(266,226),xy(253,249),xy(239,260),xy(196,304),xy(194,311),xy(195,344),xy(233,344),xy(259,320),xy(259,300),xy(251,253)]).
midline(r5, [xy(540,301),xy(554,317),xy(564,341),xy(565,462),xy(545,483),xy(525,485),xy(525,564),xy(599,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(313,222),xy(315,220),xy(315,82),xy(313,80),xy(289,74),xy(140,74),xy(119,79),xy(114,100),xy(114,399),xy(116,413),xy(123,429),xy(140,450)]).
...
midline(r13, [xy(357,444),xy(353,434),xy(315,424),xy(276,434),xy(271,445),xy(269,463),xy(269,489),xy(274,513),xy(285,518),xy(303,520),xy(329,520),xy(353,515),xy(358,504),xy(360,488),xy(358,445)]).
...
midline(r23, [xy(555,622),xy(555,609),xy(553,605),xy(549,604),xy(125,605),xy(124,629),xy(125,634),xy(130,635),xy(548,635),xy(554,633),xy(554,623)]).
midline(r23, [xy(555,606),xy(560,604),xy(579,604),xy(585,606),xy(585,631),xy(583,634),xy(561,635),xy(555,633)]).
midline(r23, [xy(586,605),xy(613,605),xy(615,609),xy(615,631),xy(613,634),xy(605,635),xy(585,633)]).
midline(r23, [xy(615,606),xy(620,604),xy(635,605)]).
...
midline(r25, [xy(319,620),xy(219,620)]).
midline(r25, [xy(320,619),xy(540,620)]).
...
midline(r19, [xy(589,542),xy(590,532),xy(588,524),xy(565,523),xy(565,503),xy(563,500),xy(550,499),xy(541,501),xy(539,511),xy(541,548),xy(550,550),xy(579,550),xy(587,548),xy(589,543)]).
...
midline(r24, [xy(152,619),xy(200,620)]).
...
midline(r12, [xy(312,335),xy(304,335)]).
midline(r12, [xy(313,334),xy(325,335)]).
