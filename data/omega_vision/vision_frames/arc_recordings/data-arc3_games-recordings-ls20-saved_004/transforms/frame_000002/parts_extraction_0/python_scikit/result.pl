...
midline(r2, [xy(112,25),xy(80,24),xy(66,26),xy(60,42),xy(59,97),xy(61,111),xy(65,120),xy(65,504),xy(43,524),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(113,634),xy(116,594),xy(159,550),xy(139,529),xy(122,517),xy(109,514),xy(83,514),xy(66,505)]).
midline(r2, [xy(113,24),xy(389,24),xy(409,28),xy(415,31),xy(415,99),xy(410,121),xy(407,125),xy(364,125)]).
midline(r2, [xy(408,125),xy(414,141),xy(414,198),xy(416,213),xy(420,221),xy(441,225),xy(515,225)]).
midline(r2, [xy(416,30),xy(440,24),xy(515,24),xy(520,26)]).
midline(r2, [xy(521,24),xy(541,19),xy(586,19),xy(604,22),xy(613,26),xy(614,30),xy(614,455),xy(622,467),xy(625,480),xy(625,569),xy(622,581),xy(609,585),xy(513,584),xy(497,576),xy(455,535),xy(419,566),xy(403,573),xy(387,575),xy(231,574),xy(210,566),xy(190,549),xy(160,550)]).
midline(r2, [xy(66,120),xy(69,117),xy(68,120)]).
midline(r2, [xy(455,534),xy(455,464),xy(459,444),xy(465,429),xy(464,424),xy(429,390),xy(409,378),xy(389,374),xy(364,375)]).
midline(r2, [xy(190,548),xy(206,529),xy(214,508),xy(215,382),xy(199,375),xy(180,374),xy(170,371),xy(165,359),xy(165,141),xy(169,129),xy(181,125),xy(265,125)]).
...
midline(r5, [xy(480,87),xy(495,81),xy(519,79),xy(534,81),xy(551,88),xy(559,110),xy(558,144),xy(550,163),xy(519,170),xy(495,168),xy(477,159),xy(470,139),xy(470,119)]).
midline(r5, [xy(479,160),xy(478,161)]).
midline(r5, [xy(551,163),xy(560,178),xy(564,191),xy(565,248),xy(563,263),xy(556,279),xy(538,300),xy(395,300),xy(370,298),xy(350,292),xy(315,276),xy(276,236),xy(268,238),xy(257,248),xy(245,255),xy(196,304),xy(194,310),xy(195,344),xy(229,345),xy(239,340),xy(278,301),xy(287,288),xy(328,247),xy(341,238),xy(383,195),xy(385,187),xy(384,156),xy(377,154),xy(346,155),xy(322,172),xy(314,174),xy(306,190),xy(281,225),xy(277,235)]).
midline(r5, [xy(315,172),xy(315,85),xy(314,81),xy(309,78),xy(287,74),xy(140,74),xy(120,78),xy(116,86),xy(114,100),xy(115,325)]).
midline(r5, [xy(315,81),xy(330,75),xy(365,75)]).
midline(r5, [xy(320,174),xy(321,173)]).
midline(r5, [xy(266,242),xy(272,239)]).
midline(r5, [xy(540,300),xy(556,320),xy(564,340),xy(565,464),xy(545,483),xy(525,485),xy(525,564),xy(598,565),xy(604,563),xy(604,486),xy(584,483),xy(565,465)]).
midline(r5, [xy(315,277),xy(315,423),xy(304,428),xy(276,434),xy(271,445),xy(269,462),xy(270,499),xy(276,515),xy(300,520),xy(339,519),xy(353,515),xy(358,504),xy(360,489),xy(360,460),xy(355,436),xy(344,431),xy(325,428),xy(315,424)]).
...
midline(r25, [xy(524,635),xy(132,635),xy(125,633),xy(125,605),xy(546,604),xy(553,605),xy(554,607),xy(560,604),xy(579,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(562,635),xy(554,632),xy(548,635),xy(525,634)]).
midline(r25, [xy(585,606),xy(592,604),xy(615,606),xy(613,634),xy(591,635),xy(585,633)]).
midline(r25, [xy(616,605),xy(635,605)]).
midline(r25, [xy(555,631),xy(555,608)]).
...
border(r25).
region(r15, '#2ecc40', 10000, centroid(140,450)).
perimeter(r15, 400).
polygon(r15, [xy(189,500),xy(90,499),xy(90,400),xy(190,400),xy(189,500)]).
midline(r15, [xy(139,449),xy(140,450)]).
...
region(r27, '#5a5a5a', 7600, centroid(360,620)).
perimeter(r27, 800).
polygon(r27, [xy(549,630),xy(170,630),xy(170,610),xy(549,610),xy(549,630)]).
midline(r27, [xy(385,620),xy(179,620)]).
midline(r27, [xy(386,619),xy(540,620)]).
fillpoint(r27, xy(179,620), 10.0).
...
midline(r21, [xy(589,542),xy(590,530),xy(588,524),xy(570,525),xy(565,523),xy(564,500),xy(552,499),xy(541,501),xy(539,510),xy(541,548),xy(550,550),xy(585,549),xy(589,543)]).
midline(r21, [xy(589,523),xy(590,510),xy(588,502),xy(575,499),xy(566,500)]).
...
region(r14, '#870c25', 1500, centroid(114,384)).
perimeter(r14, 160).
polygon(r14, [xy(139,400),xy(90,400),xy(90,370),xy(139,370),xy(139,400)]).
midline(r14, [xy(110,385),xy(104,385)]).
midline(r14, [xy(111,384),xy(125,385)]).
fillpoint(r14, xy(104,385), 15.0).
region(r13, '#bebebe', 1000, centroid(114,360)).
perimeter(r13, 140).
polygon(r13, [xy(139,370),xy(90,370),xy(90,350),xy(139,350),xy(139,370)]).
midline(r13, [xy(109,360),xy(99,360)]).
midline(r13, [xy(110,360),xy(130,360)]).
fillpoint(r13, xy(99,360), 10.0).
...
midline(r11, [xy(219,314),xy(205,315),xy(205,334),xy(219,335),xy(224,333),xy(224,316),xy(220,315)]).
...
region(r26, '#2ecc40', 800, centroid(150,620)).
perimeter(r26, 120).
polygon(r26, [xy(169,630),xy(130,630),xy(130,610),xy(169,610),xy(169,630)]).
midline(r26, [xy(149,620),xy(139,620)]).
midline(r26, [xy(150,620),xy(160,620)]).
...
adjacent(r2, r5).
shared_edge(r2, r5, 3970).
adjacent(r2, r13).
shared_edge(r2, r13, 40).
adjacent(r2, r14).
shared_edge(r2, r14, 60).
adjacent(r2, r15).
shared_edge(r2, r15, 350).
adjacent(r2, r24).
...
adjacent(r25, r26).
shared_edge(r25, r26, 100).
adjacent(r25, r27).
shared_edge(r25, r27, 780).
adjacent(r25, r28).
