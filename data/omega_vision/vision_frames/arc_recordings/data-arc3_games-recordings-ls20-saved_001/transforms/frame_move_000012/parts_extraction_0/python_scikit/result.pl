...
midline(r2, [xy(296,206),xy(273,196),xy(252,181),xy(194,124),xy(164,124),xy(115,178),xy(96,213),xy(91,230),xy(89,250),xy(90,413),xy(97,439),xy(108,461),xy(45,523),xy(39,525),xy(10,524),xy(5,525),xy(4,530),xy(5,634),xy(113,634),xy(115,629),xy(114,601),xy(116,594),xy(163,545),xy(133,478),xy(122,464),xy(109,461)]).
midline(r2, [xy(195,124),xy(252,68),xy(273,53),xy(295,43),xy(321,39),xy(406,39),xy(437,44),xy(449,49),xy(472,64),xy(525,114),xy(525,134),xy(472,185),xy(456,196),xy(432,207)]).
midline(r2, [xy(525,135),xy(553,164),xy(570,187),xy(582,210),xy(589,236),xy(590,499),xy(587,523),xy(581,540),xy(563,547),xy(538,550),xy(190,550),xy(164,546)]).
...
border(r2).
region(r8, '#2ecc40', 87000, centroid(355,365)).
perimeter(r8, 2020).
polygon(r8, [xy(539,500),xy(190,500),xy(190,400),xy(140,399),xy(140,250),xy(339,250),xy(340,200),xy(389,200),xy(390,250),xy(539,250),xy(539,500)]).
hole(r8, [xy(340,449),xy(340,300),xy(290,300),xy(290,399),xy(240,400),xy(240,449),xy(340,449)]).
hole(r8, [xy(220,339),xy(220,330),xy(229,330),xy(230,320),xy(220,320),xy(219,310),xy(210,310),xy(210,319),xy(200,320),xy(200,329),xy(209,330),xy(210,340),xy(220,339)]).
midline(r8, [xy(300,274),xy(276,276),xy(252,289),xy(229,280),xy(200,280),xy(178,288),xy(174,296),xy(170,310),xy(169,329),xy(171,344),xy(178,361),xy(215,375),xy(214,448),xy(219,470),xy(226,473),xy(243,475),xy(337,475),xy(353,473),xy(369,466),xy(380,458),xy(440,398),xy(439,349),xy(365,275),xy(301,275)]).
midline(r8, [xy(253,290),xy(260,320),xy(259,339),xy(255,353),xy(249,362),xy(216,374)]).
midline(r8, [xy(365,274),xy(365,224)]).
fillpoint(r8, xy(439,375), 100.0).
fillpoint(r8, xy(252,288), 39.0).
fillpoint(r8, xy(178,288), 38.8).
fillpoint(r8, xy(178,361), 38.8).
fillpoint(r8, xy(251,361), 38.8).
fillpoint(r8, xy(215,375), 35.4).
fillpoint(r8, xy(192,367), 33.1).
fillpoint(r8, xy(237,367), 33.1).
fillpoint(r8, xy(207,372), 33.1).
fillpoint(r8, xy(222,372), 33.1).
fillpoint(r8, xy(195,368), 32.6).
fillpoint(r8, xy(234,368), 32.6).
fillpoint(r8, xy(204,371), 32.6).
fillpoint(r8, xy(225,371), 32.6).
fillpoint(r8, xy(198,369), 32.3).
fillpoint(r8, xy(231,369), 32.3).
fillpoint(r8, xy(201,370), 32.3).
fillpoint(r8, xy(228,370), 32.3).
fillpoint(r8, xy(196,281), 32.0).
fillpoint(r8, xy(233,281), 32.0).
fillpoint(r8, xy(171,306), 32.0).
fillpoint(r8, xy(258,306), 32.0).
fillpoint(r8, xy(171,343), 32.0).
fillpoint(r8, xy(258,343), 32.0).
fillpoint(r8, xy(202,280), 31.0).
fillpoint(r8, xy(228,280), 31.0).
fillpoint(r8, xy(170,312), 31.0).
fillpoint(r8, xy(259,312), 31.0).
fillpoint(r8, xy(170,338), 31.0).
fillpoint(r8, xy(259,338), 31.0).
fillpoint(r8, xy(211,280), 30.0).
fillpoint(r8, xy(169,325), 30.0).
fillpoint(r8, xy(259,325), 30.0).
fillpoint(r8, xy(219,470), 29.7).
fillpoint(r8, xy(271,278), 29.0).
fillpoint(r8, xy(218,468), 29.0).
fillpoint(r8, xy(221,471), 29.0).
fillpoint(r8, xy(358,471), 29.0).
fillpoint(r8, xy(274,277), 28.0).
fillpoint(r8, xy(217,465), 28.0).
fillpoint(r8, xy(224,472), 28.0).
fillpoint(r8, xy(355,472), 28.0).
fillpoint(r8, xy(277,276), 27.0).
fillpoint(r8, xy(216,462), 27.0).
fillpoint(r8, xy(227,473), 27.0).
fillpoint(r8, xy(352,473), 27.0).
fillpoint(r8, xy(282,275), 26.0).
fillpoint(r8, xy(215,458), 26.0).
fillpoint(r8, xy(232,474), 26.0).
fillpoint(r8, xy(348,474), 26.0).
fillpoint(r8, xy(365,236), 25.0).
fillpoint(r8, xy(291,275), 25.0).
fillpoint(r8, xy(214,425), 25.0).
fillpoint(r8, xy(241,475), 25.0).
region(r1, '#aaaaaa', 20800, centroid(20,260)).
perimeter(r1, 1120).
polygon(r1, [xy(40,0),xy(40,519),xy(0,520)]).
midline(r1, [xy(19,492),xy(20,19)]).
midline(r1, [xy(19,493),xy(20,500)]).
...
midline(r16, [xy(524,635),xy(131,635),xy(126,634),xy(124,628),xy(125,605),xy(130,604),xy(549,604),xy(553,605),xy(555,610),xy(554,633),xy(548,635),xy(525,635)]).
midline(r16, [xy(555,606),xy(564,604),xy(585,606),xy(585,631),xy(583,634),xy(561,635),xy(555,633)]).
midline(r16, [xy(586,605),xy(606,604),xy(615,606),xy(615,632),xy(609,635),xy(590,635),xy(585,633)]).
...
midline(r9, [xy(314,341),xy(315,324)]).
midline(r9, [xy(314,342),xy(315,399),xy(311,419),xy(299,424),xy(264,425)]).
...
midline(r13, [xy(19,563),xy(20,544),xy(24,540),xy(88,539),xy(98,541),xy(100,550),xy(100,607),xy(99,615),xy(95,619),xy(73,620),xy(64,619),xy(60,616),xy(48,620),xy(22,618),xy(19,609),xy(19,593),xy(20,584),xy(23,580),xy(20,575),xy(19,564)]).
midline(r13, [xy(60,615),xy(60,590),xy(57,581),xy(49,579),xy(24,580)]).
...
region(r18, '#5a5a5a', 6200, centroid(394,620)).
perimeter(r18, 660).
polygon(r18, [xy(549,630),xy(240,630),xy(240,610),xy(549,610),xy(549,630)]).
midline(r18, [xy(466,620),xy(249,620)]).
midline(r18, [xy(467,619),xy(540,620)]).
fillpoint(r18, xy(249,620), 10.0).
region(r4, '#aeaeae', 4800, centroid(364,129)).
perimeter(r4, 460).
polygon(r4, [xy(389,170),xy(340,170),xy(340,160),xy(330,159),xy(330,90),xy(400,90),xy(400,159),xy(390,160),xy(389,170)]).
...
midline(r4, [xy(389,142),xy(389,104),xy(385,100),xy(351,99),xy(341,101),xy(339,111),xy(341,148),xy(354,155),xy(364,154),xy(364,126),xy(359,124),xy(342,125)]).
midline(r4, [xy(366,154),xy(375,155),xy(386,149),xy(389,143)]).
fillpoint(r4, xy(365,154), 15.8).
fillpoint(r4, xy(358,154), 15.0).
fillpoint(r4, xy(376,154), 15.0).
fillpoint(r4, xy(342,101), 12.0).
fillpoint(r4, xy(388,101), 12.0).
fillpoint(r4, xy(342,148), 12.0).
...
region(r3, '#2ecc40', 2700, centroid(364,117)).
perimeter(r3, 560).
polygon(r3, [xy(409,170),xy(390,169),xy(390,160),xy(400,159),xy(399,90),xy(330,90),xy(330,159),xy(339,160),xy(340,169),xy(320,169),xy(320,80),xy(410,80),xy(409,170)]).
midline(r3, [xy(325,161),xy(325,85),xy(399,84),xy(404,85),xy(405,95),xy(405,158),xy(403,164),xy(394,165)]).
midline(r3, [xy(325,162),xy(325,164),xy(335,165)]).
...
fillpoint(r3, xy(394,165), 5.0).
region(r17, '#2ecc40', 2200, centroid(184,620)).
perimeter(r17, 260).
polygon(r17, [xy(239,630),xy(130,630),xy(130,610),xy(239,610),xy(239,630)]).
midline(r17, [xy(151,620),xy(139,620)]).
midline(r17, [xy(152,619),xy(230,620)]).
...
midline(r14, [xy(80,587),xy(80,572),xy(77,561),xy(67,559),xy(39,560)]).
...
region(r7, '#870c25', 1500, centroid(364,184)).
perimeter(r7, 160).
polygon(r7, [xy(389,200),xy(340,200),xy(340,170),xy(389,170),xy(389,200)]).
midline(r7, [xy(366,184),xy(354,185)]).
midline(r7, [xy(367,184),xy(375,185)]).
fillpoint(r7, xy(354,185), 15.0).
...
adjacent(r2, r3).
shared_edge(r2, r3, 310).
adjacent(r2, r7).
shared_edge(r2, r7, 60).
adjacent(r2, r8).
shared_edge(r2, r8, 1350).
adjacent(r2, r13).
