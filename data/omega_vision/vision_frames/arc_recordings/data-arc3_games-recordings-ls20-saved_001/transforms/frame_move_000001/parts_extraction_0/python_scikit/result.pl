...
midline(r2, [xy(91,231),xy(98,208),xy(115,178),xy(164,124),xy(195,124),xy(252,181),xy(273,196),xy(298,206),xy(298,208)]).
midline(r2, [xy(196,123),xy(252,68),xy(273,53),xy(295,43),xy(321,39),xy(405,39),xy(437,44),xy(456,53),xy(477,68),xy(524,114),xy(525,134),xy(491,168),xy(464,191),xy(432,207),xy(426,202),xy(427,205)]).
midline(r2, [xy(525,135),xy(553,164),xy(570,187),xy(583,213),xy(589,236),xy(589,513),xy(581,540),xy(559,548),xy(539,550),xy(190,550),xy(164,546),xy(156,532),xy(136,483),xy(122,464),xy(108,460),xy(97,439),xy(91,419),xy(89,398),xy(89,253),xy(91,232)]).
midline(r2, [xy(163,546),xy(116,594),xy(114,600),xy(115,627),xy(113,634),xy(10,635),xy(5,633),xy(5,525),xy(38,525),xy(45,523),xy(108,461)]).
...
border(r2).
region(r3, '#2ecc40', 89200, centroid(357,350)).
perimeter(r3, 2620).
polygon(r3, [xy(539,500),xy(340,500),xy(339,300),xy(290,300),xy(290,399),xy(240,400),xy(240,449),xy(290,450),xy(290,499),xy(190,499),xy(190,400),xy(140,399),xy(140,250),xy(339,250),xy(340,170),xy(320,169),xy(320,80),xy(410,80),xy(410,169),xy(390,170),xy(390,250),xy(540,250),xy(539,500)]).
...
midline(r3, [xy(398,308),xy(364,274),xy(281,275),xy(268,279),xy(253,288),xy(234,281),xy(210,279),xy(195,281),xy(178,288),xy(170,310),xy(169,329),xy(171,344),xy(178,361),xy(215,375),xy(214,449),xy(218,469),xy(231,474),xy(265,475)]).
midline(r3, [xy(399,309),xy(440,349),xy(440,400)]).
midline(r3, [xy(253,289),xy(260,320),xy(259,339),xy(255,353),xy(249,362),xy(216,374)]).
midline(r3, [xy(364,273),xy(365,185),xy(345,166),xy(325,163),xy(324,91),xy(325,85),xy(330,84),xy(404,85),xy(404,163),xy(384,166),xy(365,184)]).
...
midline(r16, [xy(524,635),xy(130,635),xy(125,633),xy(124,628),xy(125,605),xy(547,604),xy(555,606),xy(555,632),xy(549,635),xy(525,634)]).
midline(r16, [xy(556,605),xy(583,605),xy(585,609),xy(585,632),xy(578,635),xy(555,633)]).
midline(r16, [xy(585,606),xy(590,604),xy(615,606),xy(615,632),xy(613,634),xy(591,635),xy(585,633)]).
...
midline(r7, [xy(315,342),xy(315,399),xy(310,420),xy(299,424),xy(264,425)]).
...
region(r18, '#5a5a5a', 8200, centroid(344,620)).
perimeter(r18, 860).
polygon(r18, [xy(549,630),xy(140,630),xy(140,610),xy(549,610),xy(549,630)]).
midline(r18, [xy(314,619),xy(149,620)]).
midline(r18, [xy(315,620),xy(540,620)]).
fillpoint(r18, xy(149,620), 10.0).
...
midline(r13, [xy(99,553),xy(99,544),xy(95,540),xy(31,539),xy(21,541),xy(19,552),xy(19,608),xy(21,618),xy(30,620),xy(57,618),xy(60,615),xy(59,590),xy(61,581),xy(74,579),xy(96,580),xy(99,575),xy(100,554)]).
midline(r13, [xy(97,581),xy(100,592),xy(99,615),xy(97,618),xy(70,620),xy(60,617)]).
...
midline(r4, [xy(389,142),xy(390,110),xy(389,104),xy(385,100),xy(350,99),xy(341,101),xy(339,110),xy(341,125),xy(339,139),xy(341,148),xy(364,149),xy(364,126),xy(359,124),xy(342,124)]).
...
midline(r12, [xy(311,484),xy(325,485)]).
...
midline(r11, [xy(309,460),xy(299,460)]).
midline(r11, [xy(310,460),xy(330,460)]).
