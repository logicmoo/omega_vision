...
midline(r2, [xy(590,49),xy(575,37),xy(559,28),xy(539,24),xy(190,24),xy(176,26),xy(162,32),xy(140,50),xy(89,49),xy(69,78),xy(64,103),xy(65,258),xy(73,279),xy(90,299),xy(90,340),xy(83,355),xy(79,380),xy(79,469),xy(82,487),xy(43,524),xy(5,525),xy(5,634),xy(113,634),xy(115,628),xy(114,600),xy(116,594),xy(174,535),xy(159,520),xy(145,510),xy(124,501),xy(96,495),xy(83,488)]).
midline(r2, [xy(175,534),xy(225,534),xy(245,530),xy(265,522),xy(250,461),xy(250,380),xy(248,363),xy(240,340),xy(234,341),xy(223,347),xy(223,349)]).
midline(r2, [xy(266,523),xy(315,524),xy(350,559),xy(370,571),xy(381,574),xy(585,575),xy(598,574),xy(610,570),xy(615,549),xy(614,380),xy(606,360),xy(598,349),xy(592,344),xy(584,345)]).
midline(r2, [xy(240,339),xy(248,308),xy(262,301),xy(265,297),xy(265,174)]).
midline(r2, [xy(590,51),xy(589,150),xy(607,172),xy(613,186),xy(615,200),xy(614,308),xy(606,329),xy(594,344)]).
midline(r2, [xy(316,523),xy(339,500),xy(360,483),xy(376,476),xy(398,474),xy(411,469),xy(415,447),xy(414,402),xy(417,383),xy(420,378),xy(426,376),xy(459,371),xy(463,363),xy(465,349),xy(465,250),xy(463,236),xy(461,230),xy(456,227),xy(426,223),xy(418,219),xy(414,196),xy(415,174)]).
...
border(r2).
region(r3, '#2ecc40', 135400, centroid(369,257)).
perimeter(r3, 4460).
polygon(r3, [xy(589,550),xy(390,549),xy(390,500),xy(440,499),xy(440,400),xy(490,399),xy(490,200),xy(440,199),xy(439,150),xy(390,150),xy(390,249),xy(440,250),xy(440,349),xy(390,350),xy(390,449),xy(340,450),xy(340,400),xy(290,399),xy(290,350),xy(340,349),xy(340,250),xy(290,249),xy(290,150),xy(240,150),xy(240,249),xy(190,250),xy(190,379),xy(210,380),xy(210,469),xy(120,470),xy(120,380),xy(140,379),xy(140,250),xy(90,249),xy(90,100),xy(189,100),xy(190,50),xy(539,50),xy(540,199),xy(590,200),xy(590,299),xy(540,300),xy(540,389),xy(590,390),xy(589,550)]).
...
midline(r3, [xy(549,430),xy(520,421),xy(478,438),xy(471,455),xy(469,471),xy(470,489),xy(476,511),xy(459,521),xy(451,519),xy(433,505),xy(395,505),xy(395,544),xy(433,544),xy(456,522)]).
midline(r3, [xy(477,511),xy(479,510),xy(495,518),xy(511,520),xy(534,518),xy(551,511)]).
midline(r3, [xy(520,420),xy(514,389),xy(515,291),xy(522,272),xy(540,249),xy(523,229),xy(516,213),xy(514,191),xy(510,178),xy(502,164),xy(489,150),xy(488,130),xy(482,110),xy(476,106),xy(453,100),xy(376,100),xy(350,107),xy(339,113),xy(326,106),xy(303,100),xy(239,99),xy(206,133),xy(177,129),xy(151,129),xy(126,134),xy(121,145),xy(119,164),xy(120,199),xy(124,213),xy(135,218),xy(165,225),xy(165,364),xy(145,383),xy(125,385),xy(125,464),xy(198,465),xy(204,463),xy(204,386),xy(184,383),xy(165,365)]).
midline(r3, [xy(166,224),xy(194,218),xy(205,213),xy(210,188),xy(210,163),xy(206,134)]).
midline(r3, [xy(339,114),xy(339,200),xy(356,220),xy(363,236),xy(365,259),xy(369,271),xy(377,285),xy(390,300),xy(377,314),xy(368,330),xy(363,363),xy(358,374),xy(314,375)]).
midline(r3, [xy(552,509),xy(558,494),xy(560,471),xy(558,455),xy(550,439),xy(549,432)]).
midline(r3, [xy(358,375),xy(364,390),xy(365,425)]).
...
fillpoint(r3, xy(364,392), 26.0).
fillpoint(r3, xy(515,398), 26.0).
fillpoint(r3, xy(165,308), 25.0).
fillpoint(r3, xy(514,345), 25.0).
fillpoint(r3, xy(314,375), 25.0).
fillpoint(r3, xy(365,413), 25.0).
...
midline(r19, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(548,604),xy(554,607),xy(562,604),xy(576,604),xy(583,605),xy(584,607),xy(591,604),xy(609,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r19, [xy(525,634),xy(553,634),xy(555,608)]).
midline(r19, [xy(585,608),xy(585,630),xy(583,634),xy(563,635),xy(555,633)]).
midline(r19, [xy(615,608),xy(615,631),xy(613,634),xy(592,635),xy(585,633)]).
...
midline(r20, [xy(436,619),xy(139,620)]).
...
midline(r16, [xy(99,553),xy(100,608),xy(97,618),xy(70,620),xy(60,616),xy(55,619),xy(30,620),xy(22,618),xy(19,609),xy(19,590),xy(23,580),xy(19,569),xy(21,541),xy(34,539),xy(89,539),xy(98,541),xy(100,552)]).
midline(r16, [xy(60,615),xy(58,582),xy(49,579),xy(24,579)]).
...
midline(r6, [xy(189,442),xy(190,431),xy(187,424),xy(165,425),xy(163,449),xy(144,449),xy(140,445),xy(139,438),xy(140,404),xy(144,400),xy(179,399),xy(188,401),xy(190,410),xy(189,424)]).
...
midline(r17, [xy(80,587),xy(79,564),xy(77,561),xy(68,559),xy(39,560)]).
...
region(r9, '#870c25', 1500, centroid(314,434)).
perimeter(r9, 160).
polygon(r9, [xy(339,450),xy(290,450),xy(290,420),xy(339,420),xy(339,450)]).
midline(r9, [xy(323,435),xy(304,435)]).
midline(r9, [xy(324,435),xy(325,435)]).
fillpoint(r9, xy(304,435), 15.0).
region(r7, '#bebebe', 1000, centroid(314,410)).
perimeter(r7, 140).
polygon(r7, [xy(339,420),xy(290,420),xy(290,400),xy(339,400),xy(339,420)]).
midline(r7, [xy(309,410),xy(299,410)]).
midline(r7, [xy(310,409),xy(330,410)]).
fillpoint(r7, xy(299,410), 10.0).
...
midline(r14, [xy(419,514),xy(405,515),xy(405,534),xy(424,533),xy(424,516),xy(420,515)]).
...
adjacent(r19, r20).
shared_edge(r19, r20, 880).
adjacent(r19, r21).
shared_edge(r19, r21, 80).
adjacent(r19, r22).
shared_edge(r19, r22, 80).
adjacent(r19, r23).
shared_edge(r19, r23, 60).
