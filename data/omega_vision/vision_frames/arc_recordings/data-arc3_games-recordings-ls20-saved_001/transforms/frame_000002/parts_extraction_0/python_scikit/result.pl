...
midline(r2, [xy(431,208),xy(431,205),xy(434,206),xy(449,200),xy(472,185),xy(525,134),xy(525,115),xy(472,64),xy(449,49),xy(434,43),xy(409,39),xy(321,39),xy(295,43),xy(273,53),xy(252,68),xy(194,125),xy(164,124),xy(126,164),xy(109,187),xy(97,210),xy(90,236),xy(90,413),xy(96,436),xy(108,461),xy(45,523),xy(34,525),xy(10,524),xy(5,525),xy(4,531),xy(5,634),xy(113,634),xy(115,629),xy(114,602),xy(116,594),xy(163,545),xy(133,478),xy(122,464),xy(109,461)]).
midline(r2, [xy(525,135),xy(553,164),xy(572,190),xy(582,210),xy(589,236),xy(590,497),xy(588,519),xy(582,539),xy(567,546),xy(539,550),xy(191,550),xy(164,546)]).
...
midline(r3, [xy(398,308),xy(362,274),xy(280,275),xy(268,279),xy(253,288),xy(234,281),xy(219,279),xy(200,280),xy(186,284),xy(178,288),xy(170,310),xy(170,339),xy(178,361),xy(214,376),xy(251,361)]).
midline(r3, [xy(252,359),xy(258,344),xy(260,328),xy(259,310),xy(253,289)]).
midline(r3, [xy(215,377),xy(215,475)]).
midline(r3, [xy(399,309),xy(440,349)]).
midline(r3, [xy(365,274),xy(365,185),xy(345,166),xy(326,164),xy(324,159),xy(325,85),xy(404,85),xy(404,163),xy(384,166),xy(365,184)]).
midline(r3, [xy(440,351),xy(440,399),xy(389,450),xy(375,462),xy(359,471),xy(337,475),xy(314,475)]).
...
midline(r16, [xy(524,635),xy(130,635),xy(126,634),xy(124,629),xy(125,605),xy(549,604),xy(553,605),xy(555,609),xy(554,633),xy(549,635),xy(525,634)]).
midline(r16, [xy(555,606),xy(560,604),xy(577,604),xy(583,605),xy(585,609),xy(585,632),xy(583,634),xy(565,635),xy(555,633)]).
midline(r16, [xy(585,606),xy(593,604),xy(608,604),xy(614,607),xy(620,604),xy(635,605)]).
midline(r16, [xy(615,608),xy(615,631),xy(613,634),xy(591,635),xy(585,633)]).
...
midline(r7, [xy(315,342),xy(315,399),xy(311,418),xy(299,424),xy(264,425)]).
...
midline(r18, [xy(325,619),xy(540,620)]).
...
midline(r13, [xy(19,563),xy(19,607),xy(21,618),xy(47,620),xy(59,617),xy(61,581),xy(70,579),xy(92,580),xy(98,577),xy(100,569),xy(98,542),xy(89,539),xy(24,540),xy(20,544),xy(20,562)]).
...
midline(r4, [xy(389,142),xy(390,111),xy(389,104),xy(385,100),xy(351,99),xy(341,101),xy(339,110),xy(341,148),xy(350,150),xy(363,149),xy(365,147),xy(364,126),xy(342,124)]).
