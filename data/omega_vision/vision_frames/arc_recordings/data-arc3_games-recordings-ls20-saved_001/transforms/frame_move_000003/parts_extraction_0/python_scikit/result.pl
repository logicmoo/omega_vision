...
midline(r2, [xy(91,231),xy(89,251),xy(90,413),xy(97,439),xy(108,461),xy(45,523),xy(38,525),xy(5,525),xy(4,629),xy(5,634),xy(10,635),xy(109,635),xy(114,633),xy(114,600),xy(116,594),xy(163,545),xy(133,478),xy(122,464),xy(109,461)]).
midline(r2, [xy(92,230),xy(98,208),xy(115,178),xy(164,124),xy(195,124),xy(252,181),xy(273,196),xy(297,207)]).
midline(r2, [xy(196,123),xy(252,68),xy(273,53),xy(295,43),xy(321,39),xy(409,39),xy(437,44),xy(449,49),xy(472,64),xy(525,114),xy(525,131),xy(524,135),xy(489,170),xy(464,191),xy(431,208),xy(423,200),xy(425,204)]).
midline(r2, [xy(525,135),xy(553,164),xy(570,187),xy(583,213),xy(589,236),xy(590,495),xy(589,513),xy(581,540),xy(563,547),xy(537,550),xy(190,550),xy(164,546)]).
...
border(r2).
region(r3, '#2ecc40', 89200, centroid(360,350)).
perimeter(r3, 2620).
polygon(r3, [xy(539,500),xy(240,500),xy(240,450),xy(340,449),xy(339,300),xy(290,300),xy(290,399),xy(240,400),xy(239,450),xy(190,450),xy(190,400),xy(140,399),xy(140,250),xy(340,249),xy(340,170),xy(320,169),xy(320,80),xy(410,80),xy(410,169),xy(390,170),xy(390,250),xy(540,250),xy(539,500)]).
...
midline(r3, [xy(398,308),xy(362,274),xy(280,275),xy(268,279),xy(252,289),xy(234,281),xy(219,279),xy(195,281),xy(178,288),xy(170,310),xy(169,328),xy(171,344),xy(178,361),xy(215,375),xy(214,425),xy(215,425),xy(264,475),xy(339,475),xy(353,473),xy(369,466),xy(391,448),xy(440,397),xy(439,349),xy(399,309)]).
midline(r3, [xy(253,290),xy(258,305),xy(260,321),xy(259,339),xy(255,353),xy(249,362),xy(216,374)]).
midline(r3, [xy(365,274),xy(365,186),xy(345,166),xy(326,164),xy(324,154),xy(325,85),xy(404,85),xy(404,163),xy(384,166),xy(365,184)]).
...
fillpoint(r3, xy(215,413), 25.0).
fillpoint(r3, xy(264,475), 25.0).
...
midline(r16, [xy(524,635),xy(131,635),xy(125,633),xy(125,605),xy(549,604),xy(555,606),xy(554,633),xy(546,635),xy(525,634)]).
midline(r16, [xy(556,605),xy(579,604),xy(584,607),xy(590,604),xy(607,604),xy(614,607),xy(625,604),xy(635,605)]).
midline(r16, [xy(585,608),xy(583,634),xy(561,635),xy(555,633)]).
midline(r16, [xy(615,608),xy(615,629),xy(613,634),xy(590,635),xy(585,633)]).
...
midline(r7, [xy(314,341),xy(315,324)]).
midline(r7, [xy(315,342),xy(315,393),xy(311,418),xy(306,422),xy(298,424),xy(264,425)]).
...
midline(r13, [xy(99,553),xy(99,544),xy(95,540),xy(30,539),xy(21,541),xy(19,551),xy(19,607),xy(21,618),xy(30,620),xy(57,618),xy(60,614),xy(59,591),xy(61,581),xy(70,579),xy(95,580),xy(99,575),xy(100,554)]).
...
midline(r4, [xy(389,142),xy(390,113),xy(389,104),xy(385,100),xy(350,99),xy(341,101),xy(339,114),xy(341,148),xy(350,150),xy(364,149),xy(364,126),xy(359,124),xy(342,125)]).
...
region(r12, '#870c25', 1500, centroid(214,484)).
perimeter(r12, 160).
polygon(r12, [xy(239,500),xy(190,500),xy(190,470),xy(239,470),xy(239,500)]).
midline(r12, [xy(216,484),xy(204,485)]).
midline(r12, [xy(217,485),xy(225,485)]).
fillpoint(r12, xy(204,485), 15.0).
region(r11, '#bebebe', 1000, centroid(214,460)).
perimeter(r11, 140).
polygon(r11, [xy(239,470),xy(190,470),xy(190,450),xy(239,450),xy(239,470)]).
midline(r11, [xy(211,460),xy(199,460)]).
midline(r11, [xy(212,460),xy(230,460)]).
fillpoint(r11, xy(199,460), 10.0).
...
midline(r17, [xy(150,619),xy(150,620)]).
...
midline(r5, [xy(375,133),xy(375,135)]).
midline(r5, [xy(375,132),xy(373,115),xy(354,115)]).
...
adjacent(r2, r3).
shared_edge(r2, r3, 1620).
adjacent(r2, r11).
shared_edge(r2, r11, 20).
adjacent(r2, r12).
shared_edge(r2, r12, 80).
adjacent(r2, r13).
