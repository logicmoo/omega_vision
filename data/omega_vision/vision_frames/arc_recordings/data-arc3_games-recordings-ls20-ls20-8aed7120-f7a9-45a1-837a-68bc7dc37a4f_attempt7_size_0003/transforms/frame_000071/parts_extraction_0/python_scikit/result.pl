...
region(r1, '#aaaaaa', 271200, centroid(301,330)).
perimeter(r1, 5560).
...
midline(r1, [xy(434,39),xy(427,40),xy(399,34),xy(320,34),xy(304,36),xy(293,40),xy(268,40),xy(237,47),xy(216,56),xy(191,61),xy(140,82),xy(102,102),xy(86,164),xy(86,187),xy(80,213),xy(79,306),xy(81,334),xy(86,352),xy(86,375),xy(96,419),xy(106,449),xy(83,466),xy(29,520),xy(19,533),xy(15,543),xy(14,565),xy(17,580),xy(14,590),xy(14,606),xy(17,622),xy(30,625),xy(56,624),xy(60,622),xy(60,600),xy(39,579),xy(18,579)]).
midline(r1, [xy(435,40),xy(456,41),xy(479,48),xy(482,47),xy(503,56),xy(514,57),xy(516,59),xy(489,88),xy(517,58)]).
midline(r1, [xy(61,623),xy(88,625),xy(102,622),xy(109,617),xy(110,602),xy(114,590),xy(151,544),xy(168,515),xy(169,509),xy(107,450)]).
midline(r1, [xy(169,516),xy(164,524)]).
midline(r1, [xy(87,188),xy(90,191),xy(92,190),xy(87,185),xy(87,179)]).
midline(r1, [xy(93,191),xy(89,181)]).
midline(r1, [xy(519,59),xy(538,65),xy(555,74),xy(562,75),xy(574,103),xy(574,106),xy(540,142),xy(575,107)]).
midline(r1, [xy(170,509),xy(220,525),xy(256,533),xy(277,534),xy(285,525),xy(292,496),xy(294,494),xy(294,497)]).
midline(r1, [xy(279,534),xy(283,530)]).
midline(r1, [xy(282,534),xy(297,538),xy(320,540),xy(399,540),xy(437,535),xy(438,531),xy(424,495),xy(426,495)]).
midline(r1, [xy(439,533),xy(456,534),xy(469,532),xy(506,523),xy(542,511),xy(555,525),xy(555,632),xy(553,634),xy(132,635),xy(124,633),xy(109,619)]).
midline(r1, [xy(556,526),xy(586,556),xy(584,561),xy(585,632),xy(577,635),xy(560,635),xy(555,633)]).
midline(r1, [xy(91,183),xy(96,188),xy(95,191),xy(97,189)]).
midline(r1, [xy(97,193),xy(100,191),xy(105,194),xy(108,191),xy(88,171)]).
midline(r1, [xy(106,195),xy(111,192),xy(108,196)]).
midline(r1, [xy(113,193),xy(115,195),xy(112,195),xy(112,197)]).
midline(r1, [xy(114,197),xy(116,198),xy(116,196)]).
midline(r1, [xy(587,557),xy(616,586),xy(614,588),xy(615,627),xy(614,633),xy(609,635),xy(585,633)]).
midline(r1, [xy(293,41),xy(299,57),xy(301,57)]).
midline(r1, [xy(87,355),xy(87,351),xy(90,348),xy(89,353)]).
midline(r1, [xy(435,520),xy(437,525)]).
midline(r1, [xy(91,351),xy(93,347),xy(109,345),xy(117,340),xy(116,343)]).
midline(r1, [xy(543,510),xy(562,467),xy(565,455),xy(571,445),xy(577,425),xy(577,417),xy(586,397),xy(594,362),xy(595,346),xy(594,342),xy(587,335),xy(588,338)]).
midline(r1, [xy(595,341),xy(590,336)]).
midline(r1, [xy(593,337),xy(595,337),xy(598,326),xy(600,308),xy(600,230),xy(595,202),xy(593,200),xy(588,203),xy(586,201),xy(584,203),xy(587,204)]).
midline(r1, [xy(594,199),xy(595,190),xy(592,167),xy(586,142),xy(577,122),xy(575,109)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(122,339),xy(120,341)]).
midline(r1, [xy(123,338),xy(129,336),xy(129,338)]).
midline(r1, [xy(144,209),xy(136,204),xy(125,201),xy(121,197),xy(118,198),xy(123,201)]).
midline(r1, [xy(142,207),xy(142,205),xy(138,204)]).
midline(r1, [xy(144,207),xy(147,211)]).
fillpoint(r1, xy(106,450), 106.6).
fillpoint(r1, xy(104,442), 105.0).
fillpoint(r1, xy(102,102), 103.0).
fillpoint(r1, xy(169,509), 100.6).
fillpoint(r1, xy(99,111), 100.0).
fillpoint(r1, xy(99,428), 100.0).
fillpoint(r1, xy(149,490), 100.0).
fillpoint(r1, xy(171,510), 100.0).
fillpoint(r1, xy(134,474), 99.9).
fillpoint(r1, xy(135,475), 99.9).
fillpoint(r1, xy(144,484), 99.9).
fillpoint(r1, xy(145,485), 99.9).
fillpoint(r1, xy(154,494), 99.9).
fillpoint(r1, xy(155,495), 99.9).
...
midline(r2, [xy(430,409),xy(437,396),xy(427,385),xy(419,371),xy(415,358),xy(413,336),xy(407,324),xy(322,325),xy(315,309),xy(313,286),xy(309,276),xy(305,274),xy(184,275)]).
midline(r2, [xy(321,325),xy(316,336),xy(314,350),xy(314,435),xy(325,446),xy(330,460)]).
midline(r2, [xy(308,274),xy(312,267),xy(296,245),xy(294,239),xy(295,205),xy(333,205),xy(357,222),xy(313,266)]).
midline(r2, [xy(438,396),xy(453,391),xy(469,389)]).
midline(r2, [xy(358,221),xy(363,219),xy(365,215),xy(364,131),xy(349,125),xy(330,124),xy(320,121),xy(315,105),xy(303,94),xy(295,90),xy(289,89),xy(279,95),xy(264,95)]).
midline(r2, [xy(365,218),xy(380,224),xy(403,226),xy(410,229),xy(412,233),xy(415,250),xy(415,299),xy(413,313),xy(408,324)]).
midline(r2, [xy(365,131),xy(376,126),xy(399,124),xy(410,120)]).
midline(r2, [xy(433,409),xy(434,417),xy(436,417)]).
midline(r2, [xy(411,118),xy(409,110),xy(395,93),xy(395,74)]).
midline(r2, [xy(411,112),xy(406,105)]).
midline(r2, [xy(411,114),xy(413,112)]).
midline(r2, [xy(412,116),xy(433,95),xy(435,84)]).
midline(r2, [xy(315,104),xy(325,93),xy(330,79)]).
midline(r2, [xy(470,387),xy(483,383)]).
midline(r2, [xy(484,381),xy(494,376)]).
midline(r2, [xy(495,374),xy(510,359),xy(516,348),xy(515,341),xy(520,326),xy(519,311),xy(522,294),xy(519,270),xy(521,255),xy(524,249),xy(520,239),xy(520,213),xy(515,199),xy(515,189),xy(505,166),xy(505,154),xy(500,145),xy(500,139),xy(495,133),xy(495,124)]).
midline(r2, [xy(523,294),xy(545,295)]).
midline(r2, [xy(525,249),xy(537,250)]).
midline(r2, [xy(518,350),xy(517,351)]).
...
fillpoint(r2, xy(523,250), 33.6).
fillpoint(r2, xy(521,243), 32.0).
fillpoint(r2, xy(521,256), 32.0).
fillpoint(r2, xy(521,295), 32.0).
...
fillpoint(r2, xy(520,262), 31.0).
fillpoint(r2, xy(520,288), 31.0).
fillpoint(r2, xy(520,302), 31.0).
fillpoint(r2, xy(519,220), 30.0).
fillpoint(r2, xy(519,275), 30.0).
...
midline(r5, [xy(464,250),xy(465,192),xy(461,170),xy(409,170)]).
midline(r5, [xy(461,168),xy(464,159),xy(465,134),xy(457,122),xy(450,105),xy(450,99)]).
midline(r5, [xy(464,251),xy(465,277),xy(461,280),xy(465,279)]).
...
midline(r6, [xy(174,239),xy(169,240)]).
midline(r6, [xy(175,239),xy(183,235),xy(194,224),xy(238,225),xy(253,223),xy(261,219),xy(265,190),xy(271,175),xy(265,159),xy(265,132),xy(263,130),xy(269,120)]).
...
region(r14, '#ffdc00', 10900, centroid(245,357)).
perimeter(r14, 580).
polygon(r14, [xy(289,460),xy(280,460),xy(279,450),xy(260,450),xy(260,440),xy(250,440),xy(250,430),xy(240,429),xy(240,350),xy(170,350),xy(170,310),xy(160,309),xy(160,300),xy(290,300),xy(289,460)]).
midline(r14, [xy(264,342),xy(259,328),xy(237,324),xy(196,325),xy(175,306),xy(164,305)]).
midline(r14, [xy(264,343),xy(265,407),xy(263,410),xy(267,415),xy(274,435),xy(284,446),xy(285,455)]).
fillpoint(r14, xy(260,329), 29.7).
fillpoint(r14, xy(258,328), 29.0).
fillpoint(r14, xy(261,331), 29.0).
fillpoint(r14, xy(255,327), 28.0).
fillpoint(r14, xy(262,334), 28.0).
fillpoint(r14, xy(252,326), 27.0).
fillpoint(r14, xy(263,337), 27.0).
fillpoint(r14, xy(248,325), 26.0).
fillpoint(r14, xy(264,342), 26.0).
fillpoint(r14, xy(194,325), 25.0).
fillpoint(r14, xy(264,381), 25.0).
fillpoint(r14, xy(274,434), 16.0).
region(r18, '#ffdc00', 6100, centroid(369,419)).
perimeter(r18, 420).
polygon(r18, [xy(399,470),xy(340,469),xy(340,360),xy(389,360),xy(390,449),xy(440,450),xy(439,460),xy(400,460),xy(399,470)]).
midline(r18, [xy(435,454),xy(400,454),xy(390,460),xy(384,459),xy(370,450),xy(364,444),xy(365,384)]).
fillpoint(r18, xy(364,415), 25.0).
fillpoint(r18, xy(385,459), 11.0).
region(r21, '#2ecc40', 4800, centroid(250,620)).
perimeter(r21, 520).
polygon(r21, [xy(369,630),xy(130,630),xy(130,610),xy(369,610),xy(369,630)]).
midline(r21, [xy(290,620),xy(139,620)]).
midline(r21, [xy(291,620),xy(360,620)]).
...
region(r22, '#5a5a5a', 3600, centroid(460,620)).
perimeter(r22, 400).
polygon(r22, [xy(549,630),xy(370,630),xy(370,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(530,620),xy(379,620)]).
midline(r22, [xy(531,620),xy(540,620)]).
fillpoint(r22, xy(379,620), 10.0).
region(r16, '#2ecc40', 3100, centroid(216,380)).
perimeter(r16, 280).
polygon(r16, [xy(239,430),xy(230,430),xy(230,420),xy(220,420),xy(220,410),xy(210,410),xy(209,400),xy(200,399),xy(200,380),xy(190,380),xy(190,370),xy(180,369),xy(180,350),xy(240,350),xy(239,430)]).
midline(r16, [xy(219,370),xy(195,360),xy(189,360)]).
midline(r16, [xy(219,372),xy(219,382),xy(229,404),xy(229,410),xy(234,416),xy(235,425)]).
fillpoint(r16, xy(218,371), 21.0).
fillpoint(r16, xy(219,373), 21.0).
fillpoint(r16, xy(219,382), 20.0).
fillpoint(r16, xy(205,365), 16.0).
fillpoint(r16, xy(224,394), 16.0).
fillpoint(r16, xy(194,360), 11.0).
fillpoint(r16, xy(229,405), 11.0).
...
midline(r3, [xy(360,85),xy(354,85)]).
midline(r3, [xy(361,84),xy(375,85)]).
...
midline(r12, [xy(367,284),xy(375,285)]).
...
midline(r11, [xy(359,260),xy(349,260)]).
midline(r11, [xy(360,260),xy(380,260)]).
...
midline(r8, [xy(411,194),xy(394,195)]).
midline(r8, [xy(412,194),xy(435,195)]).
...
midline(r15, [xy(445,326),xy(445,304)]).
midline(r15, [xy(445,327),xy(445,345)]).
fillpoint(r15, xy(444,325), 5.0).
region(r17, '#0074d9', 500, centroid(364,354)).
perimeter(r17, 120).
polygon(r17, [xy(389,360),xy(340,360),xy(340,350),xy(389,350),xy(389,360)]).
midline(r17, [xy(359,354),xy(344,355)]).
midline(r17, [xy(360,355),xy(385,355)]).
fillpoint(r17, xy(344,355), 5.0).
...
adjacent(r1, r14).
shared_edge(r1, r14, 150).
adjacent(r1, r16).
shared_edge(r1, r16, 140).
adjacent(r1, r18).
shared_edge(r1, r18, 120).
adjacent(r1, r19).
shared_edge(r1, r19, 240).
adjacent(r1, r20).
shared_edge(r1, r20, 80).
adjacent(r1, r21).
shared_edge(r1, r21, 500).
adjacent(r1, r22).
...
adjacent(r2, r14).
shared_edge(r2, r14, 290).
adjacent(r2, r15).
shared_edge(r2, r15, 60).
adjacent(r2, r17).
shared_edge(r2, r17, 70).
adjacent(r2, r18).
shared_edge(r2, r18, 250).
adjacent(r5, r8).
shared_edge(r5, r8, 60).
adjacent(r5, r15).
shared_edge(r5, r15, 60).
adjacent(r6, r7).
