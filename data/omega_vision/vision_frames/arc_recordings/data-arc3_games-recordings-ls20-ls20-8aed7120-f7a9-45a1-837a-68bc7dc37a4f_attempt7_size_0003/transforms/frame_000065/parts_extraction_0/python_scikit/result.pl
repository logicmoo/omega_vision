...
region(r1, '#aaaaaa', 307000, centroid(367,308)).
perimeter(r1, 5300).
...
midline(r1, [xy(464,175),xy(413,144),xy(356,114),xy(298,90),xy(270,83),xy(246,74),xy(211,66),xy(186,65),xy(164,60),xy(60,60),xy(43,86),xy(27,105),xy(20,122),xy(19,508),xy(24,527),xy(17,537),xy(14,551),xy(14,568),xy(17,580),xy(14,590),xy(14,609),xy(17,622),xy(32,625),xy(49,625),xy(60,622),xy(59,599),xy(39,579),xy(18,580)]).
midline(r1, [xy(25,527),xy(40,530),xy(51,529),xy(63,534),xy(82,537),xy(94,545),xy(103,546),xy(117,552),xy(134,565),xy(117,585),xy(111,598),xy(109,617),xy(106,620),xy(89,625),xy(61,623)]).
midline(r1, [xy(135,565),xy(162,564),xy(179,560),xy(179,553),xy(174,544),xy(176,544)]).
midline(r1, [xy(180,554),xy(180,555)]).
midline(r1, [xy(181,559),xy(203,559),xy(242,550),xy(262,542),xy(287,536),xy(348,510),xy(350,508),xy(292,448),xy(352,508),xy(399,483),xy(437,459),xy(377,398),xy(352,392),xy(345,388),xy(345,390)]).
midline(r1, [xy(42,89),xy(44,97),xy(46,97)]).
midline(r1, [xy(289,89),xy(287,91)]).
midline(r1, [xy(109,619),xy(124,633),xy(130,635),xy(553,634),xy(555,632),xy(555,526),xy(467,437),xy(438,458)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,631),xy(579,635),xy(555,633)]).
midline(r1, [xy(364,396),xy(365,396)]).
midline(r1, [xy(586,556),xy(615,585),xy(615,630),xy(613,634),xy(604,635),xy(585,633)]).
midline(r1, [xy(467,436),xy(474,384),xy(475,281),xy(473,244),xy(464,177)]).
midline(r1, [xy(361,395),xy(362,396)]).
midline(r1, [xy(185,66),xy(178,88),xy(170,103),xy(173,102)]).
midline(r1, [xy(184,72),xy(186,69)]).
midline(r1, [xy(184,74),xy(182,78)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(46,99),xy(51,107),xy(50,109),xy(52,109)]).
midline(r1, [xy(450,169),xy(448,167),xy(374,241),xy(368,244),xy(365,243),xy(365,245)]).
midline(r1, [xy(375,242),xy(448,169),xy(378,241)]).
midline(r1, [xy(380,241),xy(451,170)]).
...
midline(r3, [xy(133,274),xy(119,270),xy(114,249),xy(115,191),xy(118,180),xy(129,162),xy(124,154),xy(130,143),xy(129,141),xy(131,139),xy(131,141)]).
midline(r3, [xy(134,274),xy(275,274),xy(286,285),xy(298,291),xy(300,350),xy(294,360),xy(295,395)]).
midline(r3, [xy(276,273),xy(293,255),xy(295,244)]).
midline(r3, [xy(130,162),xy(151,165),xy(162,165),xy(164,163),xy(165,165),xy(180,169),xy(184,168),xy(205,177),xy(220,180)]).
midline(r3, [xy(165,162),xy(169,155),xy(168,153),xy(170,151),xy(170,153)]).
...
midline(r2, [xy(161,504),xy(146,505),xy(140,510),xy(134,509),xy(126,505),xy(105,485),xy(95,485),xy(74,478),xy(68,469),xy(65,459),xy(64,154),xy(75,143),xy(80,129)]).
...
region(r8, '#2ecc40', 16200, centroid(166,409)).
perimeter(r8, 840).
...
midline(r8, [xy(230,440),xy(219,445),xy(206,444),xy(192,433),xy(166,425),xy(164,419),xy(165,391),xy(153,384),xy(139,380),xy(119,379),xy(96,404),xy(94,410),xy(95,444),xy(133,444),xy(145,434),xy(154,428),xy(154,430)]).
midline(r8, [xy(165,425),xy(156,429)]).
midline(r8, [xy(230,438),xy(235,429),xy(234,416),xy(224,404),xy(220,393),xy(209,379),xy(185,381),xy(165,390)]).
midline(r8, [xy(224,405),xy(195,434)]).
midline(r8, [xy(165,427),xy(165,475)]).
fillpoint(r8, xy(165,390), 40.3).
fillpoint(r8, xy(165,425), 35.4).
...
midline(r6, [xy(227,324),xy(249,325),xy(260,329),xy(265,350),xy(265,400),xy(255,423),xy(255,435),xy(250,444),xy(250,449),xy(239,460),xy(234,460),xy(225,465),xy(220,464),xy(207,467),xy(200,484),xy(200,490)]).
...
midline(r4, [xy(209,225),xy(238,225),xy(249,222),xy(255,204),xy(250,195),xy(250,189),xy(245,183),xy(245,174)]).
...
midline(r18, [xy(152,619),xy(240,620)]).
...
midline(r7, [xy(122,335),xy(104,335)]).
midline(r7, [xy(123,335),xy(125,335)]).
...
midline(r5, [xy(101,309),xy(99,310)]).
midline(r5, [xy(102,310),xy(130,310)]).
...
midline(r14, [xy(214,432),xy(215,435)]).
