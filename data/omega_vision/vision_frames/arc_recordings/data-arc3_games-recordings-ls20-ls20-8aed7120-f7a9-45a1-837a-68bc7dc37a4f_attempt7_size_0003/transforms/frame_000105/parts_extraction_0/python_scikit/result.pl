...
region(r1, '#aaaaaa', 273100, centroid(325,308)).
perimeter(r1, 5680).
...
midline(r1, [xy(429,635),xy(132,635),xy(124,633),xy(108,618),xy(102,622),xy(88,625),xy(43,624),xy(27,616),xy(17,602),xy(14,589),xy(14,550),xy(17,537),xy(30,519),xy(76,473),xy(69,455),xy(62,425),xy(60,414),xy(61,394),xy(55,373),xy(54,282),xy(55,266),xy(60,246),xy(62,214),xy(85,133),xy(99,99),xy(130,87),xy(182,139)]).
midline(r1, [xy(61,244),xy(63,245),xy(61,247)]).
midline(r1, [xy(430,634),xy(548,635),xy(555,632),xy(555,525),xy(543,513),xy(487,536),xy(462,542),xy(442,550),xy(438,550),xy(409,521),xy(436,550),xy(403,559),xy(361,559),xy(357,553),xy(358,549),xy(340,515),xy(338,502),xy(329,499),xy(291,501),xy(289,510),xy(289,564),xy(257,564),xy(241,560),xy(237,553),xy(244,545),xy(249,530),xy(253,528),xy(248,536)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,630),xy(583,634),xy(577,635),xy(555,633)]).
midline(r1, [xy(238,559),xy(210,558),xy(177,550),xy(156,542),xy(136,516),xy(123,503),xy(77,474)]).
midline(r1, [xy(63,247),xy(92,257)]).
midline(r1, [xy(543,512),xy(566,432),xy(569,415),xy(569,397),xy(558,392),xy(554,393),xy(543,387),xy(538,388),xy(530,382),xy(531,385)]).
midline(r1, [xy(569,396),xy(574,375),xy(575,359),xy(575,280),xy(570,243),xy(566,241),xy(562,243),xy(559,240),xy(549,249),xy(541,252),xy(537,251),xy(535,253),xy(538,253)]).
midline(r1, [xy(569,241),xy(569,234),xy(567,232),xy(560,239),xy(567,234)]).
midline(r1, [xy(567,243),xy(563,245),xy(558,243),xy(551,249)]).
midline(r1, [xy(561,245),xy(556,247)]).
midline(r1, [xy(569,232),xy(568,217),xy(559,178),xy(535,107),xy(532,104),xy(486,86),xy(470,83),xy(446,74),xy(405,65),xy(386,66),xy(370,61),xy(348,59),xy(272,59),xy(255,60),xy(234,65),xy(208,66),xy(173,74),xy(132,87)]).
midline(r1, [xy(387,67),xy(386,69),xy(383,68),xy(380,83),xy(372,100),xy(373,102),xy(374,100)]).
midline(r1, [xy(390,67),xy(385,70)]).
midline(r1, [xy(386,72),xy(383,75)]).
midline(r1, [xy(393,67),xy(388,72)]).
midline(r1, [xy(381,82),xy(379,86)]).
midline(r1, [xy(60,491),xy(59,560),xy(60,560),xy(79,580),xy(120,579),xy(111,598),xy(109,617)]).
midline(r1, [xy(121,578),xy(156,543)]).
midline(r1, [xy(291,564),xy(306,565),xy(315,562),xy(315,502)]).
midline(r1, [xy(564,396),xy(561,395)]).
midline(r1, [xy(558,394),xy(559,395)]).
midline(r1, [xy(240,555),xy(243,548)]).
midline(r1, [xy(62,395),xy(64,393)]).
midline(r1, [xy(66,392),xy(70,389),xy(76,391),xy(84,384),xy(84,387),xy(82,387)]).
midline(r1, [xy(78,391),xy(87,388),xy(89,386),xy(86,384),xy(89,382),xy(90,385),xy(93,383),xy(91,382)]).
midline(r1, [xy(383,77),xy(382,78)]).
midline(r1, [xy(359,559),xy(342,564),xy(315,564)]).
midline(r1, [xy(586,556),xy(615,586),xy(615,629),xy(614,633),xy(609,635),xy(585,633)]).
midline(r1, [xy(234,66),xy(236,70),xy(233,73),xy(236,74),xy(236,80),xy(239,77),xy(237,71)]).
midline(r1, [xy(360,556),xy(359,550)]).
midline(r1, [xy(239,81),xy(236,86),xy(239,85)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(101,378),xy(94,380),xy(94,382)]).
midline(r1, [xy(101,376),xy(102,377)]).
...
fillpoint(r1, xy(120,501), 58.0).
fillpoint(r1, xy(138,519), 58.0).
fillpoint(r1, xy(186,552), 58.0).
fillpoint(r1, xy(433,552), 58.0).
fillpoint(r1, xy(124,504), 57.6).
fillpoint(r1, xy(125,505), 57.6).
fillpoint(r1, xy(134,514), 57.6).
fillpoint(r1, xy(135,515), 57.6).
...
border(r1).
region(r3, '#2ecc40', 58200, centroid(316,309)).
perimeter(r3, 2680).
polygon(r3, [xy(189,480),xy(180,480),xy(180,470),xy(170,470),xy(170,460),xy(160,460),xy(160,450),xy(150,449),xy(150,430),xy(140,430),xy(140,420),xy(130,419),xy(130,400),xy(120,399),xy(120,360),xy(110,359),xy(110,280),xy(120,279),xy(120,240),xy(130,239),xy(130,220),xy(140,220),xy(140,250),xy(289,250),xy(290,200),xy(340,199),xy(340,150),xy(290,150),xy(290,120),xy(349,120),xy(350,130),xy(389,130),xy(390,140),xy(409,140),xy(409,150),xy(390,150),xy(390,199),xy(440,200),xy(440,350),xy(490,349),xy(490,240),xy(500,240),xy(500,279),xy(510,280),xy(510,359),xy(500,360),xy(500,399),xy(490,400),xy(490,419),xy(480,420),xy(480,429),xy(470,430),xy(469,450),xy(390,450),xy(390,350),xy(340,350),xy(339,300),xy(140,300),xy(140,350),xy(240,350),xy(240,449),xy(190,450),xy(189,480)]).
...
midline(r3, [xy(210,379),xy(185,381),xy(167,389),xy(148,378),xy(140,370),xy(124,345),xy(124,294),xy(145,274),xy(134,263),xy(130,255),xy(129,249),xy(134,243),xy(135,224)]).
midline(r3, [xy(210,381),xy(220,393),xy(224,405),xy(195,434),xy(174,427),xy(173,416),xy(167,402),xy(167,390)]).
midline(r3, [xy(225,405),xy(234,416),xy(235,429),xy(233,435),xy(225,443),xy(219,445),xy(206,444),xy(195,435)]).
midline(r3, [xy(175,429),xy(174,445),xy(179,454),xy(179,460),xy(184,466),xy(185,475)]).
midline(r3, [xy(146,274),xy(289,275),xy(311,270),xy(312,268),xy(307,258),xy(296,245),xy(294,239),xy(295,205),xy(333,205),xy(364,226),xy(365,155),xy(353,144),xy(335,134),xy(304,135)]).
midline(r3, [xy(366,226),xy(384,255),xy(381,262),xy(340,269),xy(313,269)]).
midline(r3, [xy(382,262),xy(388,280),xy(389,300),xy(407,322),xy(413,336),xy(418,369),xy(427,385),xy(437,396),xy(433,407)]).
midline(r3, [xy(438,396),xy(470,379),xy(499,350),xy(500,289),xy(494,279),xy(495,244)]).
midline(r3, [xy(366,154),xy(376,144),xy(405,145)]).
midline(r3, [xy(461,393),xy(468,400)]).
...
midline(r9, [xy(228,477),xy(229,474),xy(204,465)]).
midline(r9, [xy(229,478),xy(232,475),xy(243,476),xy(249,489)]).
midline(r9, [xy(244,475),xy(264,455),xy(265,449),xy(265,350),xy(261,330),xy(253,326),xy(239,324),xy(164,325)]).
...
midline(r2, [xy(190,224),xy(176,225),xy(170,223),xy(160,227),xy(160,229)]).
midline(r2, [xy(191,225),xy(238,225),xy(253,223),xy(261,219),xy(266,186),xy(271,175),xy(264,154),xy(275,143),xy(280,129)]).
midline(r2, [xy(272,174),xy(315,175)]).
...
midline(r5, [xy(469,324),xy(470,300),xy(464,279),xy(465,239),xy(455,216),xy(455,204),xy(450,195),xy(450,190),xy(439,179),xy(434,179),xy(425,174),xy(408,172),xy(405,164)]).
...
midline(r23, [xy(444,619),xy(279,620)]).
midline(r23, [xy(445,620),xy(540,620)]).
...
midline(r4, [xy(235,134),xy(234,143),xy(224,154),xy(217,174),xy(214,177),xy(198,179),xy(175,189),xy(169,189),xy(163,194),xy(154,195)]).
...
midline(r22, [xy(152,620),xy(260,620)]).
...
midline(r12, [xy(311,334),xy(325,335)]).
...
midline(r10, [xy(309,310),xy(299,310)]).
midline(r10, [xy(310,309),xy(330,310)]).
...
midline(r7, [xy(319,214),xy(305,215),xy(305,234),xy(318,235),xy(324,233),xy(324,216),xy(320,215)]).
...
midline(r11, [xy(445,329),xy(445,304)]).
midline(r11, [xy(444,330),xy(445,345)]).
...
midline(r17, [xy(214,432),xy(215,435)]).
...
region(r18, '#7fdbff', 100, centroid(304,514)).
perimeter(r18, 40).
polygon(r18, [xy(309,520),xy(300,519),xy(300,510),xy(310,510),xy(309,520)]).
midline(r18, [xy(305,515),xy(305,514)]).
fillpoint(r18, xy(304,515), 5.0).
