...
midline(r1, [xy(39,39),xy(24,60),xy(19,80),xy(19,456),xy(21,471),xy(27,484),xy(41,501),xy(42,496),xy(44,494),xy(44,496)]).
midline(r1, [xy(42,502),xy(55,523),xy(79,549),xy(70,569),xy(80,586),xy(92,602),xy(126,634),xy(553,634),xy(555,631),xy(555,525),xy(378,348),xy(374,349),xy(352,340),xy(354,343)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r1, [xy(459,430),xy(376,349),xy(456,431),xy(455,433),xy(424,452),xy(365,483),xy(339,494),xy(334,494),xy(307,507),xy(262,521),xy(209,470),xy(258,521),xy(244,526),xy(213,533),xy(194,534),xy(188,528),xy(185,528),xy(187,524),xy(183,520),xy(184,517),xy(176,500),xy(177,498),xy(178,500)]).
midline(r1, [xy(365,346),xy(369,347)]).
midline(r1, [xy(188,530),xy(186,530)]).
midline(r1, [xy(460,428),xy(467,394),xy(475,309),xy(474,205),xy(468,169),xy(434,142),xy(383,110),xy(329,82),xy(272,59),xy(253,56),xy(232,47),xy(206,41),xy(176,40),xy(165,36),xy(149,34),xy(70,34),xy(41,40)]).
midline(r1, [xy(187,532),xy(186,535),xy(172,538),xy(114,540),xy(80,548)]).
midline(r1, [xy(586,556),xy(615,586),xy(615,632),xy(606,635),xy(590,635),xy(585,633)]).
midline(r1, [xy(185,518),xy(187,520)]).
midline(r1, [xy(192,534),xy(188,535)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(385,183),xy(376,192),xy(371,191),xy(368,194),xy(353,196),xy(350,199),xy(346,197),xy(341,200),xy(343,202)]).
midline(r1, [xy(354,198),xy(352,199)]).
midline(r1, [xy(345,201),xy(349,200)]).
midline(r1, [xy(379,191),xy(388,182)]).
...
midline(r2, [xy(64,400),xy(64,435),xy(75,446),xy(81,458),xy(90,460),xy(130,460)]).
midline(r2, [xy(65,399),xy(64,104),xy(75,93),xy(80,79)]).
...
midline(r3, [xy(188,149),xy(176,143),xy(163,140),xy(144,144),xy(96,95),xy(94,89),xy(95,74)]).
midline(r3, [xy(144,145),xy(127,164),xy(118,180),xy(114,200),xy(115,225)]).
midline(r3, [xy(160,139),xy(160,125),xy(143,92),xy(140,79)]).
midline(r3, [xy(158,120),xy(160,123),xy(162,121),xy(161,117),xy(166,112),xy(169,101),xy(171,99),xy(171,102)]).
midline(r3, [xy(163,117),xy(165,115)]).
midline(r3, [xy(162,123),xy(161,124)]).
...
midline(r11, [xy(210,379),xy(185,381),xy(164,390),xy(144,381),xy(123,377),xy(115,359),xy(115,324)]).
midline(r11, [xy(164,391),xy(164,425),xy(142,436),xy(133,444),xy(96,444),xy(94,438),xy(95,406),xy(122,377)]).
midline(r11, [xy(210,381),xy(220,393),xy(224,405),xy(195,434),xy(166,425),xy(159,435),xy(160,438),xy(146,454),xy(145,465)]).
midline(r11, [xy(161,437),xy(163,433)]).
...
midline(r6, [xy(255,162),xy(255,154),xy(250,145),xy(250,139),xy(245,133),xy(245,124)]).
midline(r6, [xy(255,163),xy(262,184),xy(265,190),xy(268,189),xy(265,192),xy(263,213),xy(258,221),xy(238,225),xy(164,225)]).
...
midline(r7, [xy(221,274),xy(285,274),xy(295,286),xy(300,300),xy(296,304),xy(294,312),xy(295,345)]).
...
midline(r21, [xy(425,620),xy(219,620)]).
midline(r21, [xy(426,620),xy(540,620)]).
...
midline(r20, [xy(153,620),xy(200,620)]).
...
midline(r9, [xy(120,260),xy(99,260)]).
midline(r9, [xy(121,260),xy(130,260)]).
...
midline(r4, [xy(105,82),xy(105,84),xy(111,85),xy(123,84),xy(125,74)]).
