...
midline(r1, [xy(69,570),xy(90,528),xy(124,485),xy(98,453),xy(71,410),xy(61,387),xy(49,369),xy(26,313),xy(26,302),xy(21,291),xy(19,276),xy(19,62),xy(21,48),xy(26,37),xy(26,26),xy(64,10),xy(70,10),xy(76,5),xy(95,5)]).
midline(r1, [xy(106,460),xy(132,434),xy(132,426),xy(139,412),xy(138,407),xy(143,400),xy(143,394),xy(147,390),xy(146,387),xy(148,385),xy(148,387)]).
midline(r1, [xy(108,463),xy(131,440),xy(132,436)]).
midline(r1, [xy(125,485),xy(173,490),xy(249,490),xy(327,482),xy(328,480),xy(288,440),xy(289,435),xy(284,425),xy(284,416),xy(280,412),xy(277,398),xy(266,378),xy(269,380)]).
midline(r1, [xy(279,400),xy(278,399)]).
midline(r1, [xy(134,426),xy(135,425)]).
midline(r1, [xy(279,402),xy(283,407),xy(281,409)]).
midline(r1, [xy(282,412),xy(284,411),xy(283,409)]).
midline(r1, [xy(284,413),xy(285,415)]).
midline(r1, [xy(329,481),xy(334,480),xy(290,436)]).
midline(r1, [xy(26,299),xy(30,298),xy(27,301)]).
midline(r1, [xy(285,419),xy(286,425)]).
midline(r1, [xy(335,480),xy(381,470),xy(437,452),xy(339,351),xy(438,452)]).
midline(r1, [xy(440,451),xy(470,439),xy(486,400),xy(498,358),xy(407,267),xy(411,268),xy(499,357)]).
midline(r1, [xy(500,355),xy(515,296),xy(466,247),xy(455,241),xy(437,235),xy(434,236),xy(424,229),xy(426,233)]).
midline(r1, [xy(433,237),xy(428,233)]).
midline(r1, [xy(515,294),xy(517,286),xy(479,248),xy(461,243)]).
midline(r1, [xy(517,284),xy(525,208),xy(524,115),xy(483,85),xy(476,92),xy(472,93),xy(468,90),xy(458,97),xy(450,97),xy(440,103),xy(436,102),xy(434,104),xy(436,104)]).
midline(r1, [xy(475,90),xy(482,83),xy(476,77),xy(428,45),xy(404,35),xy(389,24),xy(355,10),xy(349,10),xy(343,5),xy(324,5)]).
midline(r1, [xy(478,80),xy(469,89)]).
midline(r1, [xy(479,82),xy(471,90)]).
midline(r1, [xy(463,94),xy(470,93)]).
midline(r1, [xy(483,87),xy(479,91)]).
midline(r1, [xy(450,99),xy(449,100)]).
midline(r1, [xy(468,247),xy(469,248)]).
midline(r1, [xy(470,440),xy(555,526),xy(555,629),xy(553,634),xy(130,635),xy(124,633),xy(92,602),xy(78,583),xy(71,571),xy(73,571)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,631),xy(579,635),xy(560,635),xy(555,633)]).
midline(r1, [xy(586,556),xy(615,586),xy(615,632),xy(607,635),xy(590,635),xy(585,633)]).
...
midline(r3, [xy(186,359),xy(179,360),xy(169,354),xy(136,354),xy(133,344),xy(124,334),xy(113,309),xy(115,307),xy(115,290),xy(121,275),xy(116,263),xy(114,249),xy(115,190),xy(125,167),xy(140,150),xy(140,139),xy(96,95),xy(94,89),xy(94,60),xy(95,55),xy(100,54),xy(133,55),xy(179,99),xy(141,138)]).
midline(r3, [xy(187,359),xy(230,360)]).
midline(r3, [xy(180,100),xy(190,100),xy(210,83),xy(231,75),xy(287,74),xy(309,78),xy(313,86),xy(315,108),xy(320,121),xy(353,126),xy(365,131),xy(365,224),xy(350,217),xy(348,218),xy(333,205),xy(295,205),xy(295,243),xy(305,255),xy(309,264),xy(312,265),xy(311,267),xy(315,273),xy(313,275),xy(122,274)]).
midline(r3, [xy(349,219),xy(351,221)]).
midline(r3, [xy(316,274),xy(316,276),xy(324,280),xy(322,292),xy(318,302),xy(307,317),xy(300,334),xy(300,340)]).
midline(r3, [xy(325,279),xy(329,279)]).
midline(r3, [xy(330,277),xy(338,272)]).
midline(r3, [xy(366,130),xy(371,128),xy(390,109),xy(394,103),xy(395,94)]).
midline(r3, [xy(373,128),xy(389,137),xy(400,140)]).
midline(r3, [xy(339,270),xy(359,248),xy(364,226)]).
midline(r3, [xy(396,205),xy(366,225),xy(373,229),xy(377,228),xy(379,232)]).
midline(r3, [xy(397,205),xy(405,205)]).
...
midline(r2, [xy(360,79),xy(355,66),xy(355,54),xy(346,40),xy(322,29),xy(308,28),xy(299,23),xy(297,25),xy(120,24),xy(107,29),xy(98,29),xy(84,34),xy(74,44),xy(72,52),xy(68,57),xy(70,59),xy(67,74),xy(63,80),xy(58,76),xy(58,78)]).
midline(r2, [xy(65,80),xy(64,260),xy(69,272),xy(69,280),xy(67,282),xy(70,281)]).
midline(r2, [xy(362,79),xy(375,85)]).
midline(r2, [xy(70,283),xy(79,304),xy(79,310),xy(84,316),xy(85,325)]).
...
midline(r14, [xy(174,619),xy(139,620)]).
midline(r14, [xy(175,620),xy(540,620)]).
...
midline(r13, [xy(263,333),xy(260,333),xy(259,338),xy(246,354),xy(245,365)]).
midline(r13, [xy(261,331),xy(253,326),xy(237,324),xy(164,325)]).
...
midline(r9, [xy(212,185),xy(204,185)]).
midline(r9, [xy(213,184),xy(225,185)]).
...
midline(r7, [xy(209,160),xy(199,160)]).
midline(r7, [xy(210,160),xy(230,160)]).
...
midline(r4, [xy(124,82),xy(125,72),xy(123,65),xy(105,65),xy(104,70),xy(105,84),xy(124,84)]).
...
midline(r8, [xy(400,179),xy(400,180)]).
midline(r8, [xy(400,178),xy(400,159)]).
