...
midline(r1, [xy(90,549),xy(75,540),xy(69,539),xy(44,540),xy(29,549),xy(27,564),xy(19,573),xy(15,583),xy(14,608),xy(17,622),xy(30,625),xy(89,625),xy(100,621),xy(100,590),xy(95,576),xy(89,570),xy(89,551)]).
midline(r1, [xy(100,623),xy(115,624),xy(124,633),xy(135,635),xy(553,634),xy(555,630),xy(555,526),xy(499,469),xy(475,490),xy(435,519),xy(388,545),xy(360,518),xy(335,500),xy(322,499),xy(315,501),xy(301,499),xy(291,501),xy(289,511),xy(290,535),xy(296,545),xy(313,554),xy(334,573),xy(327,580),xy(302,592),xy(284,594),xy(259,605),xy(125,605),xy(124,613),xy(116,623)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,632),xy(579,635),xy(560,635),xy(555,633)]).
midline(r1, [xy(386,546),xy(363,561),xy(340,538),xy(314,515)]).
midline(r1, [xy(315,513),xy(314,502)]).
midline(r1, [xy(335,573),xy(350,568),xy(362,561)]).
midline(r1, [xy(586,556),xy(615,585),xy(615,632),xy(609,635),xy(585,633)]).
midline(r1, [xy(499,468),xy(499,357),xy(491,292),xy(486,281),xy(426,341),xy(418,344),xy(414,342),xy(405,348),xy(401,346),xy(397,350),xy(394,349),xy(385,353),xy(385,355)]).
midline(r1, [xy(414,344),xy(415,345)]).
midline(r1, [xy(393,352),xy(394,351)]).
midline(r1, [xy(399,350),xy(401,348)]).
midline(r1, [xy(428,341),xy(486,283),xy(430,341)]).
midline(r1, [xy(489,282),xy(479,239),xy(471,214),xy(469,213),xy(470,210),xy(461,180),xy(453,175),xy(371,142),xy(281,118),xy(199,109),xy(110,110),xy(90,134),xy(80,151),xy(68,162),xy(56,178),xy(34,216),xy(20,252),xy(20,500)]).
midline(r1, [xy(271,119),xy(239,151),xy(238,149),xy(269,118)]).
midline(r1, [xy(238,152),xy(238,158),xy(235,161),xy(236,167),xy(232,171),xy(228,184),xy(231,183)]).
midline(r1, [xy(231,180),xy(231,181)]).
midline(r1, [xy(237,161),xy(240,158),xy(239,155),xy(275,119),xy(241,157)]).
midline(r1, [xy(76,155),xy(80,159),xy(82,157),xy(80,153),xy(82,153)]).
midline(r1, [xy(278,120),xy(243,155)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(82,159),xy(81,164),xy(75,158),xy(73,160),xy(84,169),xy(83,172),xy(86,173),xy(84,176),xy(88,175),xy(86,178)]).
midline(r1, [xy(87,172),xy(83,166),xy(83,160)]).
...
midline(r4, [xy(233,563),xy(216,546),xy(189,550),xy(159,549),xy(99,489),xy(81,489),xy(68,469),xy(64,449),xy(64,279),xy(74,254),xy(84,243),xy(85,234)]).
midline(r4, [xy(234,564),xy(236,567)]).
midline(r4, [xy(238,566),xy(256,574),xy(256,576)]).
midline(r4, [xy(258,575),xy(285,575)]).
midline(r4, [xy(159,550),xy(116,594),xy(115,605)]).
midline(r4, [xy(216,545),xy(228,516),xy(229,489),xy(264,455),xy(264,340),xy(259,328),xy(248,325),xy(164,325)]).
...
midline(r2, [xy(199,440),xy(200,429),xy(195,423),xy(194,410),xy(196,404),xy(212,383),xy(208,378),xy(188,374),xy(122,375),xy(116,363),xy(114,349),xy(114,300),xy(116,286),xy(121,274),xy(114,254),xy(125,243),xy(130,229)]).
midline(r2, [xy(122,275),xy(247,275),xy(249,272),xy(249,274),xy(255,277),xy(272,279),xy(298,291),xy(305,304),xy(305,316),xy(316,344),xy(314,350),xy(315,462),xy(295,483),xy(275,485),xy(274,492),xy(275,564),xy(295,565)]).
midline(r2, [xy(121,375),xy(118,382),xy(95,406),xy(94,439),xy(95,444),xy(100,445),xy(126,445),xy(134,443),xy(134,406),xy(120,390),xy(119,383)]).
midline(r2, [xy(122,390),xy(122,389)]).
...
midline(r2, [xy(230,438),xy(234,433),xy(235,421),xy(233,414),xy(225,405)]).
...
midline(r22, [xy(280,620),xy(360,620)]).
...
midline(r23, [xy(424,620),xy(379,620)]).
midline(r23, [xy(425,619),xy(540,620)]).
...
midline(r6, [xy(350,450),xy(344,460),xy(345,475)]).
midline(r6, [xy(350,449),xy(350,389),xy(344,379),xy(345,364)]).
fillpoint(r6, xy(349,420), 10.0).
fillpoint(r6, xy(345,371), 5.0).
fillpoint(r6, xy(345,468), 5.0).
region(r21, '#7fdbff', 2000, centroid(60,588)).
perimeter(r21, 240).
polygon(r21, [xy(89,610),xy(30,609),xy(30,590),xy(50,589),xy(50,550),xy(70,550),xy(70,589),xy(90,590),xy(89,610)]).
midline(r21, [xy(59,595),xy(60,559)]).
midline(r21, [xy(54,599),xy(39,600)]).
midline(r21, [xy(55,599),xy(60,596),xy(64,599),xy(80,600)]).
fillpoint(r21, xy(60,597), 12.8).
fillpoint(r21, xy(54,599), 11.0).
fillpoint(r21, xy(65,599), 11.0).
fillpoint(r21, xy(59,574), 10.0).
...
midline(r16, [xy(145,467),xy(145,455),xy(184,455),xy(184,493),xy(179,495),xy(146,494),xy(144,489),xy(144,468)]).
...
midline(r13, [xy(172,435),xy(154,435)]).
midline(r13, [xy(173,434),xy(175,435)]).
...
midline(r17, [xy(155,477),xy(155,465),xy(174,465),xy(175,471),xy(173,484),xy(156,484),xy(155,478)]).
