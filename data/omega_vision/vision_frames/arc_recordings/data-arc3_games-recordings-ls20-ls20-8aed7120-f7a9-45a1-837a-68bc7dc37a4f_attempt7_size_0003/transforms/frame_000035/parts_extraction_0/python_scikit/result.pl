...
midline(r1, [xy(464,175),xy(413,144),xy(356,114),xy(298,90),xy(270,83),xy(246,74),xy(211,66),xy(187,65),xy(164,60),xy(60,60),xy(24,110),xy(19,130),xy(19,506),xy(21,521),xy(27,534),xy(41,551),xy(43,545),xy(45,545)]).
midline(r1, [xy(42,88),xy(43,90),xy(40,91),xy(45,94)]).
midline(r1, [xy(42,552),xy(60,579),xy(77,579),xy(92,602),xy(124,633),xy(130,635),xy(553,634),xy(555,632),xy(555,526),xy(550,520),xy(467,437),xy(439,458),xy(379,398),xy(372,396),xy(368,398),xy(358,392),xy(350,392),xy(343,387),xy(341,388),xy(328,381),xy(328,383)]).
midline(r1, [xy(556,526),xy(585,556),xy(585,627),xy(584,633),xy(579,635),xy(560,635),xy(555,633)]).
midline(r1, [xy(344,390),xy(342,389)]).
midline(r1, [xy(187,66),xy(181,74),xy(174,94),xy(175,96),xy(176,94)]).
midline(r1, [xy(183,74),xy(187,70)]).
midline(r1, [xy(79,579),xy(100,569),xy(117,565),xy(162,564),xy(178,560),xy(180,556),xy(171,538),xy(175,540)]).
midline(r1, [xy(181,555),xy(179,551)]).
midline(r1, [xy(176,544),xy(177,547)]).
...
midline(r1, [xy(369,399),xy(432,462),xy(430,464),xy(384,490),xy(312,418),xy(383,491),xy(351,507),xy(349,510),xy(287,536),xy(213,557),xy(189,560),xy(180,559)]).
midline(r1, [xy(433,462),xy(438,458)]).
midline(r1, [xy(451,170),xy(380,241),xy(373,242),xy(370,239),xy(358,247),xy(348,247),xy(335,255),xy(328,256),xy(328,258)]).
midline(r1, [xy(364,245),xy(370,241),xy(372,243)]).
midline(r1, [xy(348,249),xy(345,251)]).
midline(r1, [xy(379,239),xy(450,168)]).
midline(r1, [xy(45,96),xy(49,107),xy(51,107)]).
midline(r1, [xy(351,249),xy(352,249)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(337,143),xy(290,192),xy(340,142)]).
midline(r1, [xy(418,193),xy(417,194)]).
midline(r1, [xy(422,189),xy(421,190)]).
midline(r1, [xy(437,174),xy(436,175)]).
midline(r1, [xy(444,167),xy(443,168)]).
midline(r1, [xy(444,165),xy(445,166)]).
...
midline(r3, [xy(133,274),xy(118,269),xy(114,249),xy(115,190),xy(119,178),xy(129,162),xy(124,154),xy(131,138),xy(133,138)]).
midline(r3, [xy(134,274),xy(275,274),xy(286,285),xy(298,291),xy(300,301),xy(300,350),xy(294,360),xy(295,395)]).
midline(r3, [xy(276,273),xy(293,255),xy(295,244)]).
midline(r3, [xy(130,162),xy(163,165),xy(168,158),xy(168,154),xy(170,154)]).
midline(r3, [xy(165,165),xy(180,169),xy(185,168),xy(205,177),xy(220,180)]).
...
midline(r2, [xy(161,504),xy(146,505),xy(140,510),xy(134,509),xy(126,505),xy(104,484),xy(94,485),xy(74,478),xy(66,463),xy(64,449),xy(64,154),xy(75,143),xy(80,129)]).
midline(r2, [xy(94,486),xy(91,492),xy(94,491)]).
...
midline(r8, [xy(230,440),xy(223,444),xy(210,445),xy(204,443),xy(192,433),xy(165,424),xy(154,430),xy(152,429),xy(133,444),xy(96,444),xy(94,439),xy(95,406),xy(119,379),xy(144,381),xy(165,390),xy(165,423)]).
midline(r8, [xy(230,438),xy(234,433),xy(234,416),xy(224,404),xy(216,387),xy(209,380),xy(185,381),xy(166,389)]).
midline(r8, [xy(224,405),xy(195,434)]).
midline(r8, [xy(185,462),xy(183,454),xy(171,441),xy(165,426),xy(158,440),xy(145,456),xy(145,494),xy(183,494),xy(185,489),xy(184,463)]).
midline(r8, [xy(160,437),xy(161,435)]).
...
midline(r6, [xy(202,324),xy(164,325)]).
midline(r6, [xy(203,325),xy(236,324),xy(249,325),xy(260,329),xy(265,350),xy(265,400),xy(255,423),xy(255,435),xy(250,444),xy(250,449),xy(239,460),xy(234,460),xy(225,465),xy(207,467),xy(200,484),xy(200,490)]).
midline(r6, [xy(271,401),xy(267,399),xy(267,401)]).
midline(r6, [xy(272,402),xy(271,403)]).
...
midline(r4, [xy(208,225),xy(164,225)]).
midline(r4, [xy(209,224),xy(238,225),xy(248,223),xy(255,204),xy(250,195),xy(250,189),xy(245,183),xy(245,174)]).
...
region(r18, '#2ecc40', 7600, centroid(320,620)).
perimeter(r18, 800).
polygon(r18, [xy(509,630),xy(130,630),xy(130,610),xy(509,610),xy(509,630)]).
midline(r18, [xy(304,619),xy(139,620)]).
midline(r18, [xy(305,619),xy(500,620)]).
...
midline(r5, [xy(109,310),xy(99,310)]).
midline(r5, [xy(110,309),xy(130,310)]).
...
midline(r16, [xy(155,477),xy(155,465),xy(174,465),xy(175,470),xy(173,484),xy(156,484),xy(155,478)]).
...
region(r19, '#5a5a5a', 800, centroid(530,620)).
perimeter(r19, 120).
polygon(r19, [xy(549,630),xy(510,630),xy(510,610),xy(549,610),xy(549,630)]).
midline(r19, [xy(540,620),xy(519,620)]).
fillpoint(r19, xy(519,620), 10.0).
