...
midline(r1, [xy(359,274),xy(357,272),xy(308,321),xy(357,274),xy(312,321)]).
midline(r1, [xy(429,635),xy(130,635),xy(120,629),xy(104,629),xy(95,624),xy(23,624),xy(16,619),xy(14,604),xy(19,595),xy(20,584),xy(30,570),xy(29,549),xy(44,540),xy(60,539),xy(75,540),xy(90,549),xy(89,570),xy(95,576),xy(100,590),xy(100,609),xy(95,623)]).
midline(r1, [xy(430,634),xy(553,634),xy(555,631),xy(555,525),xy(475,445),xy(435,482),xy(379,523),xy(341,487),xy(328,481),xy(329,484)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,629),xy(583,634),xy(577,635),xy(555,633)]).
midline(r1, [xy(377,524),xy(343,544),xy(325,527),xy(341,545),xy(338,548),xy(305,569),xy(246,594),xy(234,594),xy(207,605),xy(125,605),xy(124,623),xy(120,628)]).
midline(r1, [xy(475,444),xy(474,355),xy(466,288),xy(460,261),xy(380,341),xy(370,343),xy(367,340),xy(358,347),xy(350,347),xy(347,350),xy(344,349),xy(341,352),xy(332,353),xy(326,359)]).
midline(r1, [xy(460,260),xy(459,254),xy(456,251),xy(368,339),xy(456,253),xy(370,341)]).
midline(r1, [xy(349,350),xy(351,349)]).
midline(r1, [xy(344,351),xy(346,351)]).
midline(r1, [xy(458,251),xy(448,211),xy(442,196),xy(403,175),xy(353,154),xy(278,129),xy(226,117),xy(196,115),xy(169,110),xy(109,109),xy(55,166),xy(42,188),xy(27,205),xy(20,222),xy(20,500)]).
midline(r1, [xy(43,189),xy(47,203),xy(49,203)]).
midline(r1, [xy(586,556),xy(615,585),xy(615,632),xy(608,635),xy(585,633)]).
midline(r1, [xy(332,355),xy(331,356)]).
midline(r1, [xy(330,147),xy(328,149)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(224,119),xy(188,153),xy(187,161),xy(179,180),xy(178,184),xy(180,184)]).
midline(r1, [xy(190,153),xy(222,121)]).
midline(r1, [xy(187,163),xy(188,165),xy(181,181)]).
midline(r1, [xy(371,262),xy(369,260),xy(358,271),xy(369,262),xy(360,273)]).
midline(r1, [xy(391,240),xy(370,259),xy(390,241),xy(372,261)]).
midline(r1, [xy(392,241),xy(391,238),xy(435,194),xy(393,238),xy(437,196)]).
midline(r1, [xy(367,342),xy(368,343)]).
...
midline(r2, [xy(65,322),xy(65,459),xy(68,469),xy(80,489),xy(43,524),xy(5,525),xy(5,585)]).
midline(r2, [xy(81,489),xy(100,489),xy(159,549),xy(116,594),xy(114,603),xy(115,615)]).
midline(r2, [xy(160,550),xy(178,550),xy(189,577),xy(191,577)]).
midline(r2, [xy(180,550),xy(215,535)]).
midline(r2, [xy(216,533),xy(225,525)]).
midline(r2, [xy(65,321),xy(64,254),xy(75,243),xy(80,229)]).
midline(r2, [xy(226,523),xy(229,511),xy(229,489),xy(264,455),xy(265,341),xy(257,331),xy(248,325),xy(164,325)]).
midline(r2, [xy(249,324),xy(251,322)]).
midline(r2, [xy(265,339),xy(266,340)]).
midline(r2, [xy(247,531),xy(238,525),xy(229,521),xy(229,523)]).
midline(r2, [xy(246,528),xy(248,530)]).
...
midline(r3, [xy(210,379),xy(190,380),xy(173,386),xy(153,376),xy(130,374),xy(118,369),xy(114,349),xy(114,300),xy(116,286),xy(121,274),xy(116,263),xy(115,244)]).
midline(r3, [xy(122,275),xy(200,274),xy(208,278),xy(224,280),xy(244,289),xy(250,289),xy(256,294),xy(265,295)]).
midline(r3, [xy(230,440),xy(223,444),xy(210,445),xy(204,443),xy(192,433),xy(172,427),xy(170,425),xy(169,410),xy(173,387)]).
midline(r3, [xy(170,427),xy(145,456),xy(145,494),xy(179,495),xy(184,493),xy(184,456),xy(171,440),xy(168,433)]).
...
region(r13, '#2ecc40', 4400, centroid(240,620)).
perimeter(r13, 480).
polygon(r13, [xy(349,630),xy(130,630),xy(130,610),xy(349,610),xy(349,630)]).
midline(r13, [xy(279,620),xy(139,620)]).
midline(r13, [xy(280,620),xy(340,620)]).
fillpoint(r13, xy(139,620), 10.0).
region(r14, '#5a5a5a', 4000, centroid(450,620)).
perimeter(r14, 440).
polygon(r14, [xy(549,630),xy(350,630),xy(350,610),xy(549,610),xy(549,630)]).
midline(r14, [xy(521,620),xy(359,620)]).
midline(r14, [xy(522,619),xy(540,620)]).
fillpoint(r14, xy(359,620), 10.0).
...
midline(r5, [xy(294,362),xy(295,383),xy(300,389),xy(300,450),xy(294,460),xy(294,483),xy(275,485),xy(275,525)]).
midline(r5, [xy(295,361),xy(295,344)]).
...
midline(r8, [xy(112,435),xy(104,435)]).
midline(r8, [xy(113,435),xy(125,435)]).
...
midline(r10, [xy(174,482),xy(175,471),xy(173,465),xy(155,465),xy(154,473),xy(155,484),xy(174,484)]).
...
adjacent(r1, r13).
shared_edge(r1, r13, 460).
adjacent(r1, r14).
shared_edge(r1, r14, 420).
adjacent(r1, r15).
