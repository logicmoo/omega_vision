...
midline(r1, [xy(512,127),xy(449,92),xy(388,65),xy(372,59),xy(353,56),xy(332,47),xy(301,40),xy(277,40),xy(249,34),xy(170,34),xy(142,40),xy(113,41),xy(80,49),xy(66,56),xy(57,57),xy(49,70),xy(27,123),xy(19,161),xy(19,376),xy(26,413),xy(33,426)]).
midline(r1, [xy(330,49),xy(307,72)]).
midline(r1, [xy(307,69),xy(327,48)]).
midline(r1, [xy(512,129),xy(516,148),xy(472,192),xy(453,197),xy(449,200),xy(442,200),xy(424,210),xy(422,209),xy(422,211)]).
midline(r1, [xy(474,192),xy(516,150)]).
midline(r1, [xy(442,202),xy(443,202)]).
midline(r1, [xy(516,152),xy(525,230),xy(524,330),xy(517,383),xy(480,348),xy(469,347),xy(465,344),xy(461,345),xy(440,336),xy(430,335),xy(427,332),xy(431,333)]).
midline(r1, [xy(464,346),xy(465,346)]).
midline(r1, [xy(441,339),xy(440,338)]).
midline(r1, [xy(472,348),xy(470,348)]).
midline(r1, [xy(33,428),xy(53,476),xy(61,487),xy(74,515),xy(87,534),xy(70,569),xy(74,573)]).
midline(r1, [xy(59,482),xy(100,439),xy(106,435),xy(115,435)]).
midline(r1, [xy(74,575),xy(79,582),xy(78,584),xy(81,585),xy(92,602),xy(126,634),xy(549,635),xy(555,632),xy(555,525),xy(496,466),xy(473,479),xy(392,398),xy(390,399),xy(470,479),xy(465,483),xy(389,513),xy(383,513),xy(359,522),xy(357,521),xy(356,523),xy(306,534),xy(294,534),xy(287,527),xy(288,533),xy(286,535),xy(244,540),xy(172,540),xy(147,538),xy(132,534),xy(88,535)]).
midline(r1, [xy(132,533),xy(131,531),xy(129,533)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,629),xy(584,633),xy(579,635),xy(560,635),xy(555,633)]).
midline(r1, [xy(124,533),xy(136,521),xy(135,518),xy(141,505),xy(139,502),xy(144,496),xy(148,484),xy(150,484)]).
midline(r1, [xy(135,524),xy(131,529),xy(133,531)]).
midline(r1, [xy(292,534),xy(289,534)]).
midline(r1, [xy(472,479),xy(471,480)]).
midline(r1, [xy(476,349),xy(515,388),xy(517,385)]).
midline(r1, [xy(586,556),xy(615,586),xy(615,632),xy(609,635),xy(585,633)]).
midline(r1, [xy(496,465),xy(506,436),xy(516,389)]).
midline(r1, [xy(287,526),xy(284,523),xy(279,509),xy(280,505),xy(277,502),xy(281,504)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(142,42),xy(144,42),xy(145,49),xy(147,49)]).
...
midline(r2, [xy(230,440),xy(223,444),xy(206,444),xy(192,433),xy(165,424),xy(156,429),xy(153,428),xy(133,444),xy(114,445)]).
midline(r2, [xy(165,423),xy(164,390),xy(144,381),xy(123,377),xy(116,363),xy(114,348),xy(115,290),xy(121,275),xy(116,263),xy(114,248),xy(115,190),xy(123,170),xy(145,143),xy(163,139),xy(164,137),xy(160,132),xy(161,126),xy(154,115),xy(156,115)]).
midline(r2, [xy(162,128),xy(163,133)]).
midline(r2, [xy(158,120),xy(161,124)]).
midline(r2, [xy(164,139),xy(179,139),xy(198,111),xy(193,102),xy(197,104),xy(197,107)]).
midline(r2, [xy(165,390),xy(185,381),xy(202,379),xy(210,379),xy(216,387),xy(224,405),xy(195,434)]).
midline(r2, [xy(225,405),xy(233,414),xy(235,420),xy(234,433),xy(230,438)]).
midline(r2, [xy(300,99),xy(286,94),xy(280,89),xy(250,90),xy(235,84),xy(217,93),xy(199,110)]).
midline(r2, [xy(310,129),xy(300,101)]).
midline(r2, [xy(312,129),xy(322,129),xy(348,141),xy(355,154),xy(355,166),xy(365,190),xy(365,223),xy(353,220),xy(333,205),xy(295,205),xy(295,243),xy(315,272),xy(312,275),xy(264,275)]).
midline(r2, [xy(314,275),xy(316,273)]).
midline(r2, [xy(364,225),xy(368,258),xy(361,278),xy(345,294),xy(316,275)]).
midline(r2, [xy(344,295),xy(327,314),xy(316,336),xy(314,350),xy(315,405),xy(307,417),xy(300,434),xy(300,440)]).
midline(r2, [xy(369,256),xy(369,263),xy(367,265)]).
midline(r2, [xy(370,262),xy(373,258),xy(372,255),xy(379,252),xy(380,255),xy(377,255),xy(376,258),xy(374,257)]).
midline(r2, [xy(372,261),xy(374,259)]).
midline(r2, [xy(362,278),xy(369,283),xy(375,283),xy(375,285)]).
midline(r2, [xy(122,274),xy(165,275)]).
midline(r2, [xy(152,431),xy(153,430)]).
midline(r2, [xy(381,254),xy(383,252)]).
midline(r2, [xy(122,377),xy(96,404),xy(94,410),xy(95,425)]).
midline(r2, [xy(173,441),xy(165,426),xy(158,437),xy(160,437)]).
...
midline(r3, [xy(263,210),xy(261,218),xy(249,224),xy(164,225)]).
midline(r3, [xy(264,209),xy(265,190),xy(271,175),xy(265,158),xy(265,124)]).
midline(r3, [xy(272,175),xy(315,175)]).
...
midline(r10, [xy(265,416),xy(265,351),xy(260,329),xy(239,324),xy(164,325)]).
midline(r10, [xy(265,417),xy(265,434),xy(240,459),xy(199,460)]).
...
midline(r4, [xy(62,360),xy(60,362)]).
midline(r4, [xy(84,119),xy(85,114)]).
midline(r4, [xy(84,120),xy(70,155),xy(69,167),xy(64,180),xy(65,356),xy(63,359),xy(67,365),xy(69,381),xy(79,404),xy(79,410),xy(84,416),xy(85,425)]).
...
region(r22, '#5a5a5a', 6000, centroid(400,620)).
perimeter(r22, 640).
polygon(r22, [xy(549,630),xy(250,630),xy(250,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(476,620),xy(259,620)]).
midline(r22, [xy(477,619),xy(540,620)]).
fillpoint(r22, xy(259,620), 10.0).
region(r21, '#2ecc40', 2400, centroid(190,620)).
perimeter(r21, 280).
polygon(r21, [xy(249,630),xy(130,630),xy(130,610),xy(249,610),xy(249,630)]).
midline(r21, [xy(151,620),xy(139,620)]).
midline(r21, [xy(152,619),xy(240,620)]).
...
midline(r9, [xy(210,285),xy(204,285)]).
midline(r9, [xy(211,284),xy(225,285)]).
...
midline(r6, [xy(305,227),xy(305,215),xy(324,215),xy(324,233),xy(310,235),xy(305,233),xy(304,228)]).
...
midline(r11, [xy(360,355),xy(385,355)]).
