...
midline(r1, [xy(184,422),xy(176,400),xy(177,398),xy(170,386),xy(172,386)]).
midline(r1, [xy(184,423),xy(188,431),xy(187,435),xy(190,436),xy(188,439),xy(229,480),xy(227,482),xy(198,484),xy(170,489),xy(120,490),xy(59,428),xy(42,401),xy(24,379),xy(19,359),xy(20,19)]).
midline(r1, [xy(187,427),xy(239,479),xy(234,480),xy(191,437),xy(232,480),xy(230,481)]).
midline(r1, [xy(240,479),xy(281,470),xy(342,451),xy(412,422),xy(439,407),xy(457,340),xy(360,243),xy(341,238),xy(326,230),xy(328,234)]).
midline(r1, [xy(439,409),xy(556,526),xy(554,530),xy(555,632),xy(553,634),xy(126,634),xy(91,601),xy(81,588),xy(71,568),xy(90,528),xy(119,491)]).
midline(r1, [xy(354,243),xy(355,243)]).
midline(r1, [xy(555,633),xy(560,635),xy(579,635),xy(583,634),xy(585,629),xy(585,556),xy(557,527)]).
midline(r1, [xy(458,339),xy(366,247),xy(370,246),xy(370,248)]).
midline(r1, [xy(458,337),xy(459,335),xy(372,248),xy(376,247),xy(459,333)]).
midline(r1, [xy(378,248),xy(460,328),xy(460,331)]).
midline(r1, [xy(461,327),xy(474,234),xy(474,164),xy(423,114),xy(388,89),xy(359,64),xy(328,45),xy(304,35),xy(284,22),xy(255,10),xy(249,10),xy(243,5),xy(224,5)]).
midline(r1, [xy(384,86),xy(379,91),xy(368,94),xy(364,93),xy(361,96),xy(356,94),xy(351,99),xy(346,98),xy(332,104),xy(332,106)]).
midline(r1, [xy(341,102),xy(340,103)]).
midline(r1, [xy(298,31),xy(287,42),xy(292,41),xy(300,33)]).
midline(r1, [xy(586,556),xy(615,585),xy(615,632),xy(609,635),xy(590,635),xy(585,633)]).
midline(r1, [xy(42,400),xy(44,391),xy(47,390),xy(45,395)]).
midline(r1, [xy(357,97),xy(354,98)]).
...
midline(r2, [xy(152,25),xy(80,25),xy(69,29),xy(66,36),xy(64,50),xy(64,335),xy(75,346),xy(80,360)]).
midline(r2, [xy(153,25),xy(200,24),xy(212,29),xy(222,29),xy(244,39),xy(250,39),xy(256,44),xy(265,45)]).
...
midline(r3, [xy(293,95),xy(286,94),xy(274,84),xy(249,74),xy(230,75),xy(207,85),xy(184,105),xy(135,56),xy(100,54),xy(95,55),xy(94,62),xy(95,93),xy(119,120),xy(139,119),xy(181,112),xy(183,106)]).
midline(r3, [xy(182,112),xy(188,130),xy(190,150)]).
midline(r3, [xy(294,95),xy(294,127),xy(295,133),xy(300,140)]).
...
midline(r9, [xy(170,275),xy(121,274),xy(115,258),xy(115,224)]).
midline(r9, [xy(121,275),xy(116,286),xy(114,300),xy(114,345),xy(126,355),xy(140,360),xy(150,354),xy(185,355)]).
...
midline(r6, [xy(272,175),xy(285,175)]).
...
midline(r13, [xy(344,619),xy(179,620)]).
midline(r13, [xy(345,620),xy(540,620)]).
...
midline(r11, [xy(212,316),xy(189,325),xy(164,325)]).
...
midline(r8, [xy(110,185),xy(104,185)]).
midline(r8, [xy(111,185),xy(125,185)]).
...
midline(r10, [xy(295,211),xy(295,245)]).
midline(r10, [xy(295,210),xy(295,205),xy(305,205)]).
