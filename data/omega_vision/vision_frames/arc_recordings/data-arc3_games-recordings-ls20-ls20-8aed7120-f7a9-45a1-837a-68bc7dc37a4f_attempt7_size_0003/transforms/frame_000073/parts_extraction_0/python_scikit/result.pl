...
midline(r1, [xy(429,635),xy(130,635),xy(120,630),xy(108,618),xy(102,622),xy(89,625),xy(70,625),xy(59,622),xy(49,625),xy(31,625),xy(17,621),xy(14,608),xy(15,583),xy(17,579),xy(14,568),xy(14,551),xy(19,533),xy(29,520),xy(81,468),xy(106,449),xy(96,419),xy(85,367),xy(86,351),xy(81,334),xy(79,309),xy(79,230),xy(81,205),xy(86,188),xy(86,164),xy(96,120),xy(102,102),xy(116,96)]).
midline(r1, [xy(18,579),xy(40,579),xy(40,580),xy(59,599),xy(60,621)]).
midline(r1, [xy(87,184),xy(93,190),xy(91,191),xy(87,187)]).
midline(r1, [xy(93,192),xy(97,193),xy(100,191),xy(99,193)]).
midline(r1, [xy(101,194),xy(115,194),xy(114,197),xy(108,196)]).
midline(r1, [xy(117,196),xy(118,198),xy(115,197)]).
midline(r1, [xy(120,197),xy(119,199)]).
midline(r1, [xy(117,94),xy(127,90)]).
midline(r1, [xy(128,88),xy(162,73),xy(164,74)]).
midline(r1, [xy(87,350),xy(105,344),xy(105,346)]).
midline(r1, [xy(107,344),xy(117,340),xy(118,342),xy(112,344)]).
midline(r1, [xy(122,199),xy(126,202),xy(130,200),xy(129,202)]).
midline(r1, [xy(120,340),xy(128,337),xy(130,338),xy(128,339)]).
midline(r1, [xy(131,337),xy(139,332),xy(139,334)]).
midline(r1, [xy(430,635),xy(549,635),xy(555,632),xy(555,526),xy(542,512),xy(469,532),xy(437,534),xy(415,539),xy(320,540),xy(297,538),xy(277,533),xy(263,534),xy(213,523),xy(186,513),xy(170,510),xy(107,450)]).
midline(r1, [xy(556,526),xy(585,556),xy(585,627),xy(584,633),xy(579,635),xy(560,635),xy(555,633)]).
midline(r1, [xy(119,459),xy(178,398),xy(117,458)]).
midline(r1, [xy(542,511),xy(571,445),xy(577,425),xy(577,417),xy(586,397),xy(559,368),xy(586,393),xy(594,362),xy(594,338),xy(581,334),xy(572,328),xy(572,330)]).
midline(r1, [xy(165,72),xy(178,68)]).
midline(r1, [xy(109,617),xy(110,602),xy(114,590),xy(151,544),xy(169,511)]).
midline(r1, [xy(161,529),xy(162,528)]).
midline(r1, [xy(438,533),xy(427,499),xy(422,490),xy(424,490)]).
midline(r1, [xy(436,525),xy(438,527)]).
midline(r1, [xy(428,500),xy(432,509)]).
midline(r1, [xy(586,556),xy(615,586),xy(615,632),xy(608,635),xy(585,633)]).
midline(r1, [xy(179,66),xy(197,59),xy(216,56),xy(237,47),xy(263,41),xy(291,39),xy(292,42),xy(300,37),xy(321,34),xy(410,35),xy(425,39),xy(425,46),xy(429,39),xy(451,40),xy(477,46),xy(478,48),xy(482,47),xy(503,56),xy(528,61),xy(564,77),xy(565,84),xy(569,89),xy(575,106),xy(577,122),xy(586,142),xy(585,145),xy(587,146),xy(594,177),xy(594,198),xy(576,209),xy(570,209),xy(567,212),xy(570,211)]).
midline(r1, [xy(591,202),xy(594,200)]).
midline(r1, [xy(585,205),xy(588,202)]).
midline(r1, [xy(294,42),xy(294,50),xy(296,48)]).
midline(r1, [xy(87,189),xy(89,191)]).
midline(r1, [xy(595,202),xy(600,232),xy(600,309),xy(595,337)]).
midline(r1, [xy(587,337),xy(585,338),xy(582,335)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(278,532),xy(285,524),xy(283,517),xy(290,507),xy(289,502),xy(295,495),xy(294,489),xy(299,486),xy(295,493)]).
midline(r1, [xy(291,506),xy(293,500)]).
midline(r1, [xy(286,518),xy(289,511)]).
midline(r1, [xy(101,113),xy(158,170)]).
midline(r1, [xy(136,205),xy(132,202),xy(132,204)]).
midline(r1, [xy(137,206),xy(134,202)]).
midline(r1, [xy(297,51),xy(296,53),xy(298,52)]).
midline(r1, [xy(282,533),xy(281,531),xy(283,532)]).
midline(r1, [xy(299,54),xy(300,55)]).
...
midline(r2, [xy(272,95),xy(264,95)]).
midline(r2, [xy(273,95),xy(283,94),xy(289,89),xy(295,90),xy(315,104),xy(319,120),xy(330,124),xy(349,125),xy(365,131),xy(365,216),xy(357,222),xy(333,205),xy(295,205),xy(294,239),xy(296,245),xy(309,261),xy(311,268),xy(307,275),xy(184,275)]).
midline(r2, [xy(365,218),xy(376,223),xy(399,225),xy(411,230),xy(415,256),xy(415,299),xy(409,323),xy(406,325),xy(322,325),xy(316,313),xy(313,286),xy(308,275)]).
midline(r2, [xy(321,325),xy(316,336),xy(314,351),xy(314,435),xy(325,446),xy(330,460)]).
midline(r2, [xy(312,267),xy(356,223)]).
midline(r2, [xy(316,103),xy(325,93),xy(330,79)]).
midline(r2, [xy(408,325),xy(414,340),xy(415,359),xy(418,369),xy(427,385),xy(437,396),xy(429,410),xy(432,410),xy(433,412),xy(431,412)]).
midline(r2, [xy(434,413),xy(432,414)]).
midline(r2, [xy(434,416),xy(435,415)]).
midline(r2, [xy(438,396),xy(453,391),xy(469,389)]).
midline(r2, [xy(470,387),xy(483,383)]).
midline(r2, [xy(484,381),xy(493,377)]).
midline(r2, [xy(494,375),xy(510,359),xy(516,347),xy(515,340),xy(520,327),xy(519,312),xy(522,294),xy(519,270),xy(521,255),xy(524,249),xy(520,239),xy(520,212),xy(515,199),xy(515,190),xy(505,166),xy(505,154),xy(500,145),xy(500,139),xy(495,133),xy(495,124)]).
midline(r2, [xy(523,294),xy(545,295)]).
midline(r2, [xy(366,130),xy(380,125),xy(399,124),xy(411,119),xy(412,117),xy(407,108),xy(395,93),xy(395,74)]).
midline(r2, [xy(413,116),xy(433,95),xy(435,84)]).
midline(r2, [xy(519,352),xy(516,349),xy(520,351)]).
...
midline(r5, [xy(469,328),xy(470,301),xy(464,279),xy(465,191),xy(461,170),xy(409,170)]).
midline(r5, [xy(461,168),xy(464,158),xy(465,134),xy(457,122),xy(450,105),xy(450,99)]).
midline(r5, [xy(469,330),xy(470,330)]).
...
midline(r6, [xy(264,142),xy(264,130),xy(269,120)]).
midline(r6, [xy(264,143),xy(265,159),xy(271,175),xy(266,186),xy(261,218),xy(253,223),xy(238,225),xy(194,224),xy(183,235),xy(169,240)]).
...
midline(r14, [xy(264,342),xy(261,330),xy(256,327),xy(238,324),xy(196,325),xy(175,306),xy(164,305)]).
midline(r14, [xy(264,343),xy(264,409),xy(274,435),xy(284,446),xy(285,455)]).
...
midline(r18, [xy(435,454),xy(400,454),xy(390,460),xy(376,455),xy(364,445),xy(365,384)]).
fillpoint(r18, xy(364,415), 25.0).
fillpoint(r18, xy(385,459), 11.0).
region(r21, '#2ecc40', 5600, centroid(270,620)).
perimeter(r21, 600).
polygon(r21, [xy(409,630),xy(130,630),xy(130,610),xy(409,610),xy(409,630)]).
midline(r21, [xy(304,619),xy(139,620)]).
midline(r21, [xy(305,619),xy(400,620)]).
...
midline(r16, [xy(219,372),xy(219,381),xy(229,404),xy(229,410),xy(234,416),xy(235,425)]).
...
region(r22, '#5a5a5a', 2800, centroid(480,620)).
perimeter(r22, 320).
polygon(r22, [xy(549,630),xy(410,630),xy(410,610),xy(549,610),xy(549,630)]).
midline(r22, [xy(431,620),xy(419,620)]).
midline(r22, [xy(432,620),xy(540,620)]).
fillpoint(r22, xy(419,620), 10.0).
...
midline(r3, [xy(367,84),xy(375,85)]).
...
midline(r9, [xy(305,227),xy(305,215),xy(324,215),xy(324,233),xy(310,235),xy(305,233),xy(304,228)]).
