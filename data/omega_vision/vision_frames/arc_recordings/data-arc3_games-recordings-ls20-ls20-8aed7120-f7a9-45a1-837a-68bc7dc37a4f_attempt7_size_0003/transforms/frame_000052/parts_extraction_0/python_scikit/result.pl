...
region(r1, '#aaaaaa', 298300, centroid(364,279)).
perimeter(r1, 5620).
...
midline(r1, [xy(324,582),xy(302,592),xy(289,595),xy(284,594),xy(258,605),xy(125,605),xy(123,615),xy(115,624),xy(103,624),xy(99,621),xy(100,550),xy(98,542),xy(89,539),xy(70,539),xy(59,543),xy(48,539),xy(24,540),xy(21,541),xy(19,555),xy(14,564),xy(14,608),xy(17,622),xy(31,625),xy(88,625),xy(99,623)]).
midline(r1, [xy(116,625),xy(124,633),xy(131,635),xy(553,634),xy(555,630),xy(555,525),xy(499,469),xy(475,490),xy(429,523),xy(392,488),xy(378,481),xy(378,483)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,632),xy(578,635),xy(560,635),xy(555,633)]).
midline(r1, [xy(427,524),xy(387,545),xy(360,518),xy(335,500),xy(320,499),xy(315,501),xy(300,499),xy(291,501),xy(289,513),xy(290,535),xy(296,545),xy(313,554),xy(334,573),xy(325,581)]).
midline(r1, [xy(386,546),xy(364,560),xy(342,538),xy(336,536),xy(315,515),xy(314,515),xy(314,502)]).
midline(r1, [xy(340,539),xy(362,561),xy(350,568),xy(335,573)]).
midline(r1, [xy(60,544),xy(60,580)]).
midline(r1, [xy(586,556),xy(615,585),xy(615,632),xy(607,635),xy(585,633)]).
midline(r1, [xy(499,468),xy(499,357),xy(491,292),xy(488,282),xy(429,341),xy(416,344),xy(411,342),xy(402,349),xy(380,357),xy(377,356),xy(378,358)]).
midline(r1, [xy(409,346),xy(411,344)]).
midline(r1, [xy(488,281),xy(485,269),xy(412,341)]).
midline(r1, [xy(486,268),xy(461,180),xy(444,171),xy(371,142),xy(281,118),xy(198,109),xy(110,110),xy(90,134),xy(81,149),xy(56,178),xy(34,216),xy(20,252),xy(20,500)]).
midline(r1, [xy(378,147),xy(288,237),xy(286,241),xy(288,241)]).
midline(r1, [xy(77,154),xy(81,158),xy(82,156),xy(79,153)]).
midline(r1, [xy(82,159),xy(83,165),xy(85,165)]).
midline(r1, [xy(275,119),xy(237,153),xy(237,162),xy(223,197),xy(226,195)]).
midline(r1, [xy(273,121),xy(239,155)]).
midline(r1, [xy(85,167),xy(84,169),xy(86,169)]).
midline(r1, [xy(86,171),xy(87,179),xy(90,180),xy(92,187),xy(91,191),xy(94,192),xy(94,200),xy(96,202),xy(96,198)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(238,151),xy(240,149)]).
midline(r1, [xy(98,204),xy(99,203)]).
...
midline(r4, [xy(233,563),xy(216,546),xy(189,550),xy(159,549),xy(99,489),xy(81,489),xy(69,471),xy(64,448),xy(65,282),xy(63,279),xy(67,274),xy(74,254),xy(84,243),xy(85,234)]).
midline(r4, [xy(234,563),xy(239,574),xy(238,576),xy(240,575)]).
midline(r4, [xy(236,564),xy(256,576),xy(258,574),xy(285,575)]).
midline(r4, [xy(240,578),xy(241,577)]).
midline(r4, [xy(159,550),xy(116,594),xy(115,605)]).
midline(r4, [xy(216,545),xy(228,516),xy(229,489),xy(264,455),xy(264,340),xy(261,330),xy(249,325),xy(164,325)]).
...
midline(r2, [xy(230,440),xy(223,444),xy(211,445),xy(199,439),xy(200,429),xy(195,423),xy(194,412),xy(196,404),xy(212,384),xy(209,378),xy(188,374),xy(122,375),xy(118,369),xy(114,349),xy(114,300),xy(116,286),xy(121,274),xy(114,254),xy(125,243),xy(130,229)]).
midline(r2, [xy(121,375),xy(118,381),xy(95,406),xy(95,444),xy(128,445),xy(134,443),xy(134,406),xy(125,396),xy(118,383)]).
midline(r2, [xy(122,274),xy(247,275),xy(249,273),xy(249,275)]).
midline(r2, [xy(251,275),xy(262,279),xy(272,279),xy(298,291),xy(305,304),xy(304,309),xy(307,322),xy(316,340),xy(314,351),xy(315,464),xy(295,483),xy(275,485),xy(274,492),xy(275,564),xy(295,565)]).
midline(r2, [xy(317,341),xy(319,339)]).
midline(r2, [xy(230,438),xy(235,428),xy(234,416),xy(224,404),xy(220,393),xy(213,384)]).
...
midline(r22, [xy(174,619),xy(139,620)]).
midline(r22, [xy(175,619),xy(400,620)]).
...
midline(r3, [xy(220,240),xy(194,239),xy(185,234),xy(154,235)]).
midline(r3, [xy(221,240),xy(230,239),xy(236,244),xy(255,245)]).
fillpoint(r3, xy(154,235), 15.0).
fillpoint(r3, xy(195,239), 11.0).
fillpoint(r3, xy(201,240), 10.0).
fillpoint(r3, xy(241,245), 5.0).
region(r21, '#7fdbff', 2800, centroid(60,582)).
perimeter(r21, 320).
polygon(r21, [xy(89,610),xy(30,609),xy(30,550),xy(50,550),xy(50,590),xy(70,589),xy(70,550),xy(90,550),xy(89,610)]).
midline(r21, [xy(40,585),xy(40,559)]).
midline(r21, [xy(40,586),xy(40,595),xy(44,599),xy(67,600),xy(77,598),xy(80,589),xy(80,559)]).
...
midline(r6, [xy(350,450),xy(350,389),xy(344,379),xy(345,364)]).
...
midline(r16, [xy(169,495),xy(150,495),xy(145,493),xy(145,455),xy(150,454),xy(184,455),xy(184,493),xy(170,495)]).
...
midline(r13, [xy(161,434),xy(175,435)]).
...
midline(r17, [xy(169,464),xy(155,465),xy(155,484),xy(166,485),xy(174,483),xy(174,466),xy(170,465)]).
