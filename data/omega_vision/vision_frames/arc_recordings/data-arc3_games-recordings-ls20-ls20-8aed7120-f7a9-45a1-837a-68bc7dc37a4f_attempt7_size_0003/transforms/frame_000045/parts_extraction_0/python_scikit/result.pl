...
midline(r1, [xy(90,549),xy(75,540),xy(66,539),xy(44,540),xy(29,549)]).
midline(r1, [xy(90,551),xy(89,570),xy(99,584),xy(100,607),xy(96,622),xy(89,625),xy(30,625),xy(17,621),xy(14,604),xy(19,595),xy(20,584),xy(30,570),xy(29,551)]).
midline(r1, [xy(95,624),xy(104,629),xy(119,630),xy(125,619),xy(125,605),xy(208,605),xy(234,594),xy(252,592),xy(307,567),xy(288,546),xy(309,565),xy(308,567)]).
midline(r1, [xy(310,565),xy(331,553),xy(349,539),xy(378,523),xy(342,487),xy(330,482),xy(331,485)]).
midline(r1, [xy(379,523),xy(435,482),xy(475,444),xy(474,355),xy(465,282),xy(461,262),xy(458,257),xy(373,342),xy(368,341),xy(351,349),xy(344,348),xy(341,351),xy(346,350)]).
midline(r1, [xy(459,256),xy(443,197),xy(394,171),xy(333,146),xy(241,120),xy(169,110),xy(109,109),xy(55,166),xy(43,186),xy(27,205),xy(20,222),xy(20,500)]).
midline(r1, [xy(41,190),xy(43,190),xy(42,188)]).
midline(r1, [xy(475,445),xy(555,525),xy(555,632),xy(553,634),xy(130,635),xy(121,630)]).
midline(r1, [xy(556,526),xy(586,556),xy(584,559),xy(584,633),xy(579,635),xy(555,633)]).
midline(r1, [xy(222,119),xy(188,153),xy(179,185),xy(174,194),xy(176,194)]).
midline(r1, [xy(184,172),xy(183,174)]).
midline(r1, [xy(458,259),xy(376,341)]).
midline(r1, [xy(43,192),xy(49,204),xy(48,207),xy(50,205)]).
midline(r1, [xy(188,157),xy(226,119)]).
midline(r1, [xy(180,184),xy(181,180),xy(183,180)]).
midline(r1, [xy(587,557),xy(615,585),xy(615,632),xy(608,635),xy(590,635),xy(585,633)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(368,215),xy(367,216)]).
midline(r1, [xy(400,181),xy(369,214),xy(403,180)]).
midline(r1, [xy(51,208),xy(52,209)]).
...
midline(r2, [xy(36,524),xy(5,525),xy(5,585)]).
midline(r2, [xy(37,524),xy(43,524),xy(49,520),xy(80,489),xy(68,469),xy(64,448),xy(64,254),xy(75,243),xy(80,229)]).
midline(r2, [xy(81,489),xy(100,489),xy(159,549),xy(116,594),xy(114,602),xy(115,615)]).
midline(r2, [xy(160,549),xy(179,549),xy(178,563),xy(181,564),xy(183,569),xy(185,565),xy(182,556),xy(180,557)]).
midline(r2, [xy(184,570),xy(186,570),xy(186,567)]).
midline(r2, [xy(181,549),xy(215,535)]).
midline(r2, [xy(216,533),xy(225,525)]).
midline(r2, [xy(226,523),xy(229,511),xy(229,489),xy(264,455),xy(264,340),xy(249,325),xy(164,325)]).
midline(r2, [xy(228,522),xy(234,525),xy(238,524),xy(239,527),xy(241,524),xy(245,528),xy(241,527)]).
midline(r2, [xy(246,528),xy(248,529),xy(245,530)]).
midline(r2, [xy(248,531),xy(249,530)]).
midline(r2, [xy(250,324),xy(250,320),xy(252,320)]).
midline(r2, [xy(189,576),xy(186,572),xy(190,575)]).
...
midline(r3, [xy(210,379),xy(190,380),xy(173,386),xy(153,376),xy(131,374),xy(119,370),xy(114,349),xy(114,300),xy(116,286),xy(121,274),xy(115,259),xy(115,244)]).
midline(r3, [xy(230,440),xy(223,444),xy(206,444),xy(194,434),xy(172,427),xy(169,416),xy(172,387)]).
midline(r3, [xy(170,427),xy(145,456),xy(145,494),xy(176,495),xy(184,493),xy(184,456),xy(171,440),xy(168,432)]).
midline(r3, [xy(122,274),xy(197,275),xy(200,273),xy(205,277),xy(222,279),xy(244,289),xy(250,289),xy(256,294),xy(265,295)]).
...
region(r14, '#5a5a5a', 5600, centroid(410,620)).
perimeter(r14, 600).
polygon(r14, [xy(549,630),xy(270,630),xy(270,610),xy(549,610),xy(549,630)]).
midline(r14, [xy(444,619),xy(279,620)]).
midline(r14, [xy(445,619),xy(540,620)]).
fillpoint(r14, xy(279,620), 10.0).
...
midline(r5, [xy(294,362),xy(295,344)]).
midline(r5, [xy(295,363),xy(294,379),xy(300,389),xy(300,450),xy(295,456),xy(294,483),xy(275,485),xy(275,525)]).
...
region(r13, '#2ecc40', 2800, centroid(200,620)).
perimeter(r13, 320).
polygon(r13, [xy(269,630),xy(130,630),xy(130,610),xy(269,610),xy(269,630)]).
midline(r13, [xy(184,620),xy(139,620)]).
midline(r13, [xy(185,620),xy(260,620)]).
fillpoint(r13, xy(139,620), 10.0).
region(r12, '#870c25', 2000, centroid(60,588)).
perimeter(r12, 240).
polygon(r12, [xy(89,610),xy(30,609),xy(30,590),xy(50,589),xy(50,550),xy(70,550),xy(70,589),xy(90,590),xy(89,610)]).
midline(r12, [xy(60,563),xy(60,559)]).
midline(r12, [xy(60,564),xy(60,596),xy(55,599),xy(39,600)]).
midline(r12, [xy(61,597),xy(70,600),xy(80,600)]).
...
midline(r8, [xy(110,435),xy(104,435)]).
midline(r8, [xy(111,434),xy(125,435)]).
...
midline(r6, [xy(110,410),xy(130,410)]).
...
midline(r10, [xy(169,464),xy(155,465),xy(155,484),xy(168,485),xy(174,483),xy(175,470),xy(174,466),xy(170,465)]).
...
midline(r9, [xy(214,434),xy(215,435)]).
...
adjacent(r1, r13).
shared_edge(r1, r13, 300).
adjacent(r1, r14).
shared_edge(r1, r14, 580).
adjacent(r1, r15).
