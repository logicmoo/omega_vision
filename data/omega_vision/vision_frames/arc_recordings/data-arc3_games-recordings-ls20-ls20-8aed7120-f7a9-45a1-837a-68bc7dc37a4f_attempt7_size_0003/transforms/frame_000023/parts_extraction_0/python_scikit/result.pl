...
region(r1, '#aaaaaa', 305600, centroid(257,326)).
perimeter(r1, 4240).
...
midline(r1, [xy(617,483),xy(607,501),xy(569,540),xy(520,540),xy(497,538),xy(481,533),xy(456,533),xy(420,525),xy(386,513),xy(370,510),xy(304,483),xy(279,470),xy(265,460),xy(260,460),xy(245,452),xy(191,418),xy(109,502),xy(84,538),xy(70,569),xy(81,585),xy(80,588),xy(83,589),xy(91,601),xy(126,634),xy(549,635),xy(555,632),xy(555,542)]).
midline(r1, [xy(182,182),xy(179,230),xy(180,335),xy(191,417)]).
midline(r1, [xy(184,182),xy(235,142),xy(286,110),xy(295,107)]).
midline(r1, [xy(296,105),xy(316,96)]).
midline(r1, [xy(317,94),xy(327,90)]).
midline(r1, [xy(570,540),xy(585,555),xy(585,631),xy(579,635),xy(555,633)]).
midline(r1, [xy(617,56),xy(612,45),xy(604,35),xy(509,35),xy(492,40),xy(468,40),xy(437,47),xy(416,56),xy(391,61),xy(328,88)]).
midline(r1, [xy(490,41),xy(491,43),xy(494,42),xy(492,44)]).
midline(r1, [xy(243,139),xy(294,192),xy(290,191),xy(240,141)]).
midline(r1, [xy(296,191),xy(302,192),xy(302,194)]).
midline(r1, [xy(404,60),xy(431,87),xy(430,89),xy(401,60)]).
midline(r1, [xy(586,556),xy(616,586),xy(614,588),xy(615,632),xy(607,635),xy(590,635),xy(585,633)]).
midline(r1, [xy(432,89),xy(431,90)]).
midline(r1, [xy(209,428),xy(289,348),xy(297,346),xy(214,431)]).
midline(r1, [xy(304,194),xy(310,194),xy(311,197),xy(314,196),xy(312,195)]).
midline(r1, [xy(314,194),xy(316,196),xy(319,195),xy(314,198)]).
midline(r1, [xy(317,198),xy(319,199),xy(322,196),xy(320,200)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(299,346),xy(308,343),xy(308,345)]).
midline(r1, [xy(310,343),xy(317,340),xy(314,343)]).
midline(r1, [xy(460,531),xy(493,496),xy(486,509),xy(483,510)]).
midline(r1, [xy(492,502),xy(488,509),xy(482,513),xy(484,515),xy(490,509),xy(490,506)]).
midline(r1, [xy(485,516),xy(485,525),xy(481,531),xy(483,531)]).
midline(r1, [xy(487,517),xy(489,512)]).
midline(r1, [xy(370,405),xy(299,478),xy(373,404)]).
midline(r1, [xy(302,427),xy(300,425),xy(266,459),xy(300,427),xy(268,461)]).
midline(r1, [xy(322,405),xy(301,424),xy(321,406),xy(303,426)]).
midline(r1, [xy(323,406),xy(322,403),xy(357,368),xy(325,404),xy(361,368)]).
midline(r1, [xy(346,210),xy(330,199),xy(323,199),xy(336,205)]).
midline(r1, [xy(347,210),xy(349,212)]).
fillpoint(r1, xy(191,418), 191.8).
fillpoint(r1, xy(190,414), 191.0).
fillpoint(r1, xy(189,408), 190.0).
fillpoint(r1, xy(188,401), 189.0).
...
midline(r3, [xy(558,103),xy(549,125),xy(538,138),xy(499,99),xy(495,93),xy(495,84)]).
midline(r3, [xy(540,139),xy(540,200),xy(522,222),xy(516,236),xy(514,250),xy(514,299),xy(516,313),xy(523,329),xy(540,349),xy(539,363),xy(532,389),xy(515,400),xy(501,399),xy(495,401),xy(474,393),xy(450,388),xy(426,375),xy(422,381),xy(426,377)]).
midline(r3, [xy(492,401),xy(487,402),xy(489,404),xy(488,408),xy(494,402)]).
midline(r3, [xy(514,401),xy(515,426),xy(506,441),xy(511,437)]).
midline(r3, [xy(512,432),xy(511,435)]).
midline(r3, [xy(516,427),xy(515,430),xy(518,431),xy(530,460)]).
midline(r3, [xy(428,375),xy(415,359),xy(414,340),xy(404,318),xy(404,299),xy(400,283),xy(398,281),xy(396,283),xy(398,283)]).
midline(r3, [xy(399,280),xy(400,259),xy(394,254),xy(389,253),xy(394,258),xy(396,257),xy(396,259)]).
midline(r3, [xy(399,257),xy(404,234),xy(384,213),xy(380,205),xy(379,199),xy(383,195),xy(385,188),xy(385,174)]).
...
midline(r4, [xy(596,453),xy(588,460),xy(549,460)]).
midline(r4, [xy(597,452),xy(615,434),xy(615,105),xy(596,85),xy(595,74)]).
...
midline(r5, [xy(469,309),xy(470,330)]).
midline(r5, [xy(470,308),xy(469,292),xy(464,279),xy(465,196),xy(461,170),xy(423,170),xy(417,168),xy(404,175)]).
midline(r5, [xy(461,168),xy(465,149),xy(464,129),xy(474,104),xy(484,93),xy(485,84)]).
...
midline(r14, [xy(152,619),xy(139,620)]).
midline(r14, [xy(153,620),xy(260,620)]).
...
midline(r8, [xy(559,260),xy(549,260)]).
midline(r8, [xy(560,259),xy(580,260)]).
...
midline(r7, [xy(410,195),xy(435,195)]).
...
midline(r10, [xy(445,317),xy(445,345)]).
midline(r10, [xy(445,316),xy(445,304)]).
