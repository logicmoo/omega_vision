...
midline(r1, [xy(69,570),xy(84,538),xy(101,512),xy(129,480),xy(163,446),xy(155,383),xy(154,283),xy(156,245),xy(167,167)]).
midline(r1, [xy(164,447),xy(182,459),xy(241,398),xy(182,456)]).
midline(r1, [xy(577,62),xy(548,59),xy(472,59),xy(398,68),xy(321,90),xy(263,114),xy(206,144),xy(169,168),xy(245,242),xy(172,167)]).
midline(r1, [xy(174,166),xy(249,243)]).
midline(r1, [xy(434,66),xy(436,68)]).
midline(r1, [xy(223,137),xy(311,223)]).
midline(r1, [xy(436,70),xy(435,77),xy(437,79),xy(437,76)]).
midline(r1, [xy(439,79),xy(442,86),xy(441,89),xy(443,89)]).
midline(r1, [xy(251,243),xy(277,251)]).
midline(r1, [xy(577,64),xy(583,73),xy(578,83),xy(580,86),xy(571,101),xy(573,101)]).
midline(r1, [xy(584,74),xy(602,94),xy(611,112),xy(620,123),xy(630,150)]).
midline(r1, [xy(610,530),xy(622,512),xy(630,489)]).
midline(r1, [xy(610,531),xy(599,549),xy(588,560),xy(579,559),xy(555,565),xy(470,565),xy(447,562),xy(439,558),xy(437,560),xy(416,559),xy(385,552),xy(382,549),xy(377,550),xy(322,532),xy(270,510),xy(220,483),xy(183,460),xy(244,397),xy(263,393),xy(267,390),xy(267,392)]).
midline(r1, [xy(590,560),xy(615,586),xy(615,632),xy(609,635),xy(590,635),xy(585,633),xy(561,635),xy(554,632),xy(548,635),xy(130,635),xy(120,630),xy(92,602),xy(78,583),xy(78,580),xy(71,571),xy(73,571)]).
midline(r1, [xy(585,558),xy(576,548),xy(576,544),xy(568,532),xy(570,532)]).
midline(r1, [xy(584,561),xy(585,632)]).
midline(r1, [xy(555,631),xy(554,566)]).
midline(r1, [xy(578,548),xy(578,544),xy(574,540)]).
midline(r1, [xy(440,557),xy(442,552),xy(440,550),xy(446,540),xy(445,536),xy(450,532),xy(447,539)]).
midline(r1, [xy(442,550),xy(443,549)]).
midline(r1, [xy(577,551),xy(579,557),xy(582,556),xy(580,554)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(385,546),xy(410,521),xy(388,545)]).
midline(r1, [xy(264,125),xy(257,120),xy(329,192)]).
midline(r1, [xy(348,533),xy(380,501),xy(351,532)]).
midline(r1, [xy(401,107),xy(370,78),xy(410,118)]).
...
midline(r3, [xy(439,400),xy(427,385),xy(418,369),xy(414,340),xy(407,322),xy(399,310),xy(379,289),xy(363,301),xy(349,307),xy(350,309),xy(329,333),xy(324,345),xy(330,360),xy(329,390),xy(334,396),xy(335,415)]).
midline(r3, [xy(379,288),xy(379,274),xy(363,267),xy(361,269)]).
midline(r3, [xy(380,273),xy(384,255),xy(380,250),xy(371,208),xy(369,207),xy(379,185),xy(379,179),xy(384,173),xy(385,164)]).
midline(r3, [xy(441,399),xy(503,400),xy(513,402),xy(515,406),xy(514,495),xy(503,505),xy(489,510),xy(479,510),xy(473,505),xy(466,504),xy(444,505)]).
midline(r3, [xy(540,400),xy(526,400),xy(515,403)]).
midline(r3, [xy(540,398),xy(556,379),xy(563,363),xy(565,317),xy(549,293),xy(536,285),xy(519,270),xy(524,246),xy(540,214),xy(540,178),xy(525,155)]).
midline(r3, [xy(565,314),xy(575,303),xy(579,295),xy(579,289),xy(584,283),xy(584,266),xy(579,260),xy(579,254),xy(575,246),xy(552,222),xy(541,214)]).
...
midline(r5, [xy(614,419),xy(615,184),xy(607,172),xy(600,155),xy(600,149)]).
midline(r5, [xy(615,420),xy(614,455),xy(599,470),xy(589,475),xy(564,475)]).
...
midline(r2, [xy(464,280),xy(465,194),xy(461,171),xy(458,169),xy(417,169),xy(404,175)]).
midline(r2, [xy(465,281),xy(470,300),xy(470,330)]).
midline(r2, [xy(460,169),xy(464,154),xy(475,143),xy(480,129)]).
...
midline(r14, [xy(391,463),xy(380,456),xy(369,432),xy(369,422),xy(364,409),xy(365,384)]).
midline(r14, [xy(392,464),xy(406,465),xy(430,476),xy(433,475),xy(435,479),xy(435,505)]).
midline(r14, [xy(435,475),xy(465,475)]).
...
region(r16, '#5a5a5a', 4800, centroid(430,620)).
perimeter(r16, 520).
polygon(r16, [xy(549,630),xy(310,630),xy(310,610),xy(549,610),xy(549,630)]).
midline(r16, [xy(459,620),xy(319,620)]).
midline(r16, [xy(460,619),xy(540,620)]).
fillpoint(r16, xy(319,620), 10.0).
region(r15, '#2ecc40', 3600, centroid(220,620)).
perimeter(r15, 400).
polygon(r15, [xy(309,630),xy(130,630),xy(130,610),xy(309,610),xy(309,630)]).
midline(r15, [xy(279,620),xy(139,620)]).
midline(r15, [xy(280,619),xy(300,620)]).
...
midline(r12, [xy(517,334),xy(525,335)]).
...
midline(r13, [xy(370,354),xy(344,355)]).
midline(r13, [xy(371,354),xy(385,355)]).
...
midline(r4, [xy(416,145),xy(433,144),xy(435,134)]).
