...
region(r1, '#aaaaaa', 276000, centroid(277,266)).
perimeter(r1, 5200).
...
midline(r1, [xy(429,635),xy(130,635),xy(120,630),xy(92,602),xy(70,569),xy(84,538),xy(98,516),xy(110,502),xy(105,479),xy(104,381),xy(111,311),xy(125,249),xy(141,198),xy(157,159),xy(186,146),xy(228,134),xy(227,136),xy(311,218)]).
midline(r1, [xy(430,635),xy(553,634),xy(555,627),xy(554,591),xy(546,594),xy(534,594),xy(509,605),xy(310,605),xy(285,594),xy(280,595),xy(267,592),xy(214,569),xy(202,560),xy(180,551),xy(149,532),xy(111,503)]).
midline(r1, [xy(555,591),xy(601,570),xy(615,585),xy(615,632),xy(613,634),xy(593,635),xy(584,633),xy(561,635),xy(555,633)]).
midline(r1, [xy(585,580),xy(585,632)]).
midline(r1, [xy(126,513),xy(144,497),xy(128,515)]).
midline(r1, [xy(113,314),xy(140,341),xy(143,342),xy(145,340),xy(114,309)]).
midline(r1, [xy(602,569),xy(606,546),xy(612,536),xy(613,521),xy(619,507),xy(619,478),xy(625,459),xy(625,380),xy(619,362),xy(619,332),xy(613,319),xy(613,306),xy(606,293),xy(600,264),xy(575,206),xy(573,205),xy(538,240)]).
midline(r1, [xy(538,237),xy(573,202),xy(555,171),xy(508,218),xy(555,173)]).
midline(r1, [xy(574,204),xy(573,203)]).
midline(r1, [xy(556,170),xy(538,140),xy(521,117),xy(478,111),xy(447,109),xy(350,110),xy(323,115),xy(293,117),xy(229,133)]).
midline(r1, [xy(291,120),xy(330,159),xy(331,157),xy(293,119)]).
midline(r1, [xy(331,160),xy(331,166),xy(334,170),xy(333,165)]).
midline(r1, [xy(297,119),xy(331,153),xy(333,160)]).
midline(r1, [xy(142,202),xy(141,205),xy(144,204),xy(143,207),xy(146,206),xy(145,209),xy(148,208),xy(147,211),xy(150,210),xy(149,213),xy(152,212),xy(151,215),xy(154,214),xy(153,217),xy(156,216),xy(155,219),xy(158,218),xy(157,221),xy(160,220),xy(159,223),xy(162,222),xy(161,225),xy(164,224),xy(163,227),xy(166,226),xy(165,229),xy(168,228),xy(167,231),xy(170,230),xy(169,233),xy(172,232),xy(171,235),xy(174,234),xy(173,237),xy(176,236),xy(175,239),xy(178,238),xy(177,241),xy(180,240),xy(179,243),xy(182,242),xy(181,245),xy(184,244),xy(183,247),xy(186,246),xy(185,249),xy(188,248),xy(187,251),xy(190,250),xy(189,253),xy(192,252),xy(191,255),xy(194,254),xy(193,257),xy(196,256),xy(195,259),xy(198,258),xy(197,261),xy(200,260),xy(199,263),xy(202,262),xy(201,265),xy(204,264),xy(203,267),xy(206,266),xy(205,269),xy(208,268),xy(207,271),xy(210,270),xy(209,273),xy(212,272),xy(211,275),xy(214,274),xy(213,277),xy(216,276),xy(215,279),xy(218,278),xy(217,281),xy(220,280),xy(219,283),xy(222,282),xy(221,285),xy(224,284),xy(223,287),xy(226,286),xy(225,289),xy(229,289),xy(227,291)]).
midline(r1, [xy(145,342),xy(153,343),xy(155,341),xy(115,301)]).
midline(r1, [xy(154,344),xy(158,343),xy(157,340),xy(115,298)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(146,497),xy(149,496),xy(149,498)]).
midline(r1, [xy(151,496),xy(155,494),xy(153,497)]).
midline(r1, [xy(157,494),xy(161,492),xy(161,494)]).
midline(r1, [xy(163,493),xy(168,490),xy(168,492)]).
midline(r1, [xy(170,490),xy(177,487),xy(177,489)]).
midline(r1, [xy(179,487),xy(183,486),xy(179,489)]).
midline(r1, [xy(158,341),xy(160,343),xy(158,345),xy(161,347),xy(165,346),xy(173,351),xy(175,350),xy(173,348)]).
midline(r1, [xy(175,351),xy(179,351),xy(173,344),xy(170,345),xy(164,341),xy(161,343)]).
midline(r1, [xy(163,343),xy(164,343)]).
midline(r1, [xy(177,348),xy(180,350),xy(182,348),xy(183,351),xy(184,349)]).
midline(r1, [xy(169,346),xy(168,345)]).
midline(r1, [xy(179,353),xy(183,354),xy(186,351),xy(185,354)]).
midline(r1, [xy(335,182),xy(335,171),xy(337,171)]).
midline(r1, [xy(337,173),xy(340,184),xy(338,186),xy(334,184),xy(339,188),xy(338,191),xy(340,193),xy(342,191),xy(340,186),xy(342,186)]).
midline(r1, [xy(343,191),xy(344,193),xy(341,194),xy(343,196),xy(345,194)]).
midline(r1, [xy(345,196),xy(347,202)]).
midline(r1, [xy(475,198),xy(473,198),xy(469,206),xy(471,206)]).
midline(r1, [xy(520,120),xy(487,153),xy(483,173),xy(474,195),xy(477,193)]).
midline(r1, [xy(521,119),xy(489,153)]).
midline(r1, [xy(481,180),xy(482,177)]).
midline(r1, [xy(484,177),xy(483,174)]).
midline(r1, [xy(479,186),xy(478,189)]).
midline(r1, [xy(203,161),xy(188,148),xy(282,242)]).
midline(r1, [xy(220,557),xy(219,558)]).
midline(r1, [xy(227,550),xy(226,551)]).
midline(r1, [xy(228,549),xy(227,548)]).
midline(r1, [xy(231,291),xy(232,292)]).
midline(r1, [xy(190,355),xy(191,356)]).
...
fillpoint(r1, xy(109,502), 109.8).
fillpoint(r1, xy(108,341), 109.0).
fillpoint(r1, xy(108,498), 109.0).
fillpoint(r1, xy(107,347), 108.0).
fillpoint(r1, xy(107,493), 108.0).
fillpoint(r1, xy(106,354), 107.0).
fillpoint(r1, xy(106,486), 107.0).
fillpoint(r1, xy(105,363), 106.0).
fillpoint(r1, xy(105,476), 106.0).
fillpoint(r1, xy(104,420), 105.0).
...
midline(r2, [xy(323,564),xy(280,565),xy(275,563),xy(274,490),xy(275,485),xy(295,483),xy(315,463),xy(315,340),xy(325,317),xy(345,294),xy(339,289),xy(334,290),xy(297,279),xy(275,289),xy(269,289),xy(263,294),xy(254,295)]).
midline(r2, [xy(324,565),xy(354,563),xy(355,491),xy(353,485),xy(334,483),xy(315,465)]).
midline(r2, [xy(346,293),xy(362,290),xy(364,287),xy(361,284),xy(362,282),xy(365,286)]).
midline(r2, [xy(364,289),xy(379,289),xy(398,261),xy(388,242),xy(390,242)]).
midline(r2, [xy(380,290),xy(402,314),xy(411,330),xy(415,359),xy(420,371),xy(459,378),xy(475,387),xy(489,400),xy(515,400),xy(515,517),xy(498,524),xy(464,525)]).
midline(r2, [xy(516,399),xy(531,391),xy(537,373),xy(540,349),xy(533,334),xy(528,310),xy(518,287),xy(507,272),xy(500,255),xy(500,249)]).
midline(r2, [xy(541,350),xy(558,344),xy(561,341),xy(560,344)]).
midline(r2, [xy(515,518),xy(523,520),xy(523,523),xy(544,543),xy(565,545)]).
midline(r2, [xy(525,521),xy(544,506),xy(551,504),xy(584,505),xy(585,515)]).
midline(r2, [xy(533,324),xy(535,322)]).
midline(r2, [xy(562,344),xy(565,341)]).
...
midline(r9, [xy(536,560),xy(525,565),xy(513,565),xy(489,575),xy(442,575),xy(418,570),xy(400,558),xy(400,490),xy(364,455),xy(365,384)]).
...
midline(r4, [xy(267,323),xy(262,334),xy(244,334),xy(235,343),xy(224,345)]).
midline(r4, [xy(262,335),xy(265,352),xy(264,455),xy(245,474),xy(225,456),xy(214,455)]).
midline(r4, [xy(245,475),xy(245,479),xy(240,480),xy(240,482)]).
midline(r4, [xy(245,481),xy(249,492),xy(249,502),xy(259,524),xy(259,540),xy(264,546),xy(265,555)]).
...
midline(r3, [xy(468,291),xy(464,279),xy(465,255),xy(446,235),xy(445,224)]).
...
midline(r6, [xy(599,392),xy(600,389),xy(594,379),xy(595,344)]).
midline(r6, [xy(600,393),xy(600,449),xy(575,474),xy(564,475)]).
fillpoint(r6, xy(564,475), 25.0).
fillpoint(r6, xy(599,419), 10.0).
fillpoint(r6, xy(599,450), 10.0).
region(r18, '#2ecc40', 4400, centroid(240,620)).
perimeter(r18, 480).
polygon(r18, [xy(349,630),xy(130,630),xy(130,610),xy(349,610),xy(349,630)]).
midline(r18, [xy(290,620),xy(139,620)]).
midline(r18, [xy(291,619),xy(340,620)]).
...
midline(r13, [xy(339,542),xy(339,525),xy(324,524),xy(314,514),xy(315,504),xy(313,500),xy(300,499),xy(291,501),xy(289,511),xy(290,535),xy(296,545),xy(310,550),xy(328,550),xy(337,548),xy(339,543)]).
midline(r13, [xy(315,500),xy(329,499),xy(338,501),xy(339,523)]).
...
region(r19, '#5a5a5a', 4000, centroid(450,620)).
perimeter(r19, 440).
polygon(r19, [xy(549,630),xy(350,630),xy(350,610),xy(549,610),xy(549,630)]).
midline(r19, [xy(499,620),xy(359,620)]).
midline(r19, [xy(500,619),xy(540,620)]).
fillpoint(r19, xy(359,620), 10.0).
...
midline(r10, [xy(409,410),xy(399,410)]).
midline(r10, [xy(410,409),xy(430,410)]).
...
midline(r16, [xy(555,524),xy(555,534),xy(565,535)]).
midline(r16, [xy(566,533),xy(575,524),xy(573,515),xy(555,515),xy(555,523)]).
...
midline(r8, [xy(360,354),xy(385,355)]).
...
adjacent(r1, r18).
shared_edge(r1, r18, 460).
adjacent(r1, r19).
shared_edge(r1, r19, 420).
adjacent(r1, r20).
