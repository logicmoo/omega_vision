...
region(r1, '#aaaaaa', 280900, centroid(361,268)).
perimeter(r1, 5380).
...
midline(r1, [xy(90,549),xy(75,540),xy(68,539),xy(44,540),xy(27,548),xy(22,544),xy(19,529),xy(19,310),xy(21,298),xy(26,287),xy(26,276),xy(49,220),xy(61,202),xy(70,181),xy(90,148),xy(115,115),xy(150,110),xy(248,109),xy(319,116),xy(320,118),xy(288,150),xy(287,159),xy(327,119),xy(326,117),xy(321,117)]).
midline(r1, [xy(27,288),xy(29,290),xy(26,290)]).
midline(r1, [xy(322,119),xy(290,151)]).
midline(r1, [xy(29,292),xy(30,291)]).
midline(r1, [xy(89,551),xy(89,570),xy(99,584),xy(100,605),xy(107,619),xy(89,625),xy(50,625),xy(37,622),xy(27,616),xy(17,602),xy(14,589),xy(14,570),xy(17,557),xy(23,548)]).
midline(r1, [xy(108,619),xy(124,633),xy(131,635),xy(553,634),xy(555,631),xy(555,525),xy(522,492),xy(494,513),xy(479,498),xy(460,493),xy(456,494),xy(425,480),xy(425,482)]).
midline(r1, [xy(556,526),xy(585,555),xy(585,631),xy(579,635),xy(555,633)]).
midline(r1, [xy(111,618),xy(124,606),xy(131,604),xy(309,605),xy(334,594),xy(339,595),xy(352,592),xy(386,576),xy(393,575),xy(417,560),xy(439,551),xy(484,522),xy(487,519),xy(463,496)]).
midline(r1, [xy(467,497),xy(488,518),xy(493,514),xy(479,500)]).
midline(r1, [xy(444,490),xy(436,487)]).
midline(r1, [xy(522,491),xy(525,459),xy(525,381),xy(517,304),xy(478,341),xy(468,342),xy(466,340),xy(463,343),xy(458,343),xy(453,348),xy(446,345),xy(435,355),xy(423,360),xy(421,359),xy(419,361),xy(422,361)]).
midline(r1, [xy(455,348),xy(462,344)]).
midline(r1, [xy(439,353),xy(447,347)]).
midline(r1, [xy(449,347),xy(446,350)]).
midline(r1, [xy(464,344),xy(466,342)]).
midline(r1, [xy(328,118),xy(284,165),xy(284,172),xy(275,193),xy(278,192),xy(278,189)]).
midline(r1, [xy(330,118),xy(378,129),xy(391,134),xy(309,218),xy(393,134),xy(433,146),xy(476,163)]).
midline(r1, [xy(476,165),xy(486,189),xy(504,246),xy(514,292),xy(467,339)]).
midline(r1, [xy(283,177),xy(280,189)]).
midline(r1, [xy(284,180),xy(283,181)]).
midline(r1, [xy(460,495),xy(458,495)]).
midline(r1, [xy(586,556),xy(615,585),xy(615,628),xy(614,633),xy(608,635),xy(585,633)]).
midline(r1, [xy(516,302),xy(515,293)]).
midline(r1, [xy(106,128),xy(132,155),xy(105,130)]).
midline(r1, [xy(615,633),xy(635,635)]).
midline(r1, [xy(64,221),xy(55,214),xy(81,240)]).
...
midline(r4, [xy(108,498),xy(100,490),xy(81,489),xy(77,485),xy(68,469),xy(64,449),xy(65,335),xy(63,329),xy(69,317),xy(70,309),xy(68,307),xy(79,285),xy(79,279),xy(84,273),xy(85,264)]).
...
midline(r4, [xy(217,544),xy(228,516),xy(229,489),xy(264,455),xy(265,350),xy(263,336),xy(260,329),xy(249,325),xy(164,325)]).
...
midline(r3, [xy(95,421),xy(94,410),xy(96,404),xy(122,377),xy(115,359),xy(114,300),xy(117,281),xy(125,273),xy(124,254),xy(133,245),xy(135,234)]).
midline(r3, [xy(125,274),xy(296,275),xy(300,268),xy(300,249)]).
midline(r3, [xy(298,275),xy(316,287),xy(329,310)]).
midline(r3, [xy(123,377),xy(144,381),xy(156,386),xy(180,375),xy(215,375)]).
midline(r3, [xy(157,387),xy(160,410),xy(159,427),xy(148,432),xy(135,443),xy(129,445),xy(96,444),xy(94,438),xy(95,422)]).
midline(r3, [xy(160,428),xy(162,433),xy(155,445),xy(145,456),xy(145,494),xy(178,495),xy(184,493),xy(184,456),xy(163,433)]).
midline(r3, [xy(336,484),xy(314,465),xy(295,483),xy(275,485),xy(274,559),xy(275,564),xy(281,565),xy(345,565)]).
midline(r3, [xy(346,563),xy(354,555),xy(355,552),xy(355,492),xy(353,485),xy(337,484)]).
midline(r3, [xy(315,464),xy(314,350),xy(318,330),xy(329,312),xy(338,317),xy(347,308),xy(340,317),xy(342,320),xy(375,334),xy(386,344),xy(394,345),xy(394,379),xy(400,389),xy(400,440)]).
...
midline(r6, [xy(365,389),xy(365,384)]).
midline(r6, [xy(365,390),xy(364,455),xy(380,468),xy(378,470),xy(380,482),xy(375,493),xy(375,505),xy(364,531),xy(365,545)]).
midline(r6, [xy(381,467),xy(394,456),xy(405,455)]).
...
region(r20, '#2ecc40', 6800, centroid(300,620)).
perimeter(r20, 720).
polygon(r20, [xy(469,630),xy(130,630),xy(130,610),xy(469,610),xy(469,630)]).
midline(r20, [xy(345,620),xy(139,620)]).
midline(r20, [xy(346,619),xy(460,620)]).
...
midline(r16, [xy(339,542),xy(339,526),xy(337,524),xy(326,525),xy(314,515),xy(314,500),xy(300,499),xy(291,501),xy(289,510),xy(290,535),xy(296,545),xy(304,549),xy(329,550),xy(337,548),xy(339,543)]).
midline(r16, [xy(316,500),xy(338,501),xy(339,524)]).
...
midline(r2, [xy(166,239),xy(175,239),xy(184,234),xy(235,234),xy(250,240),xy(280,240)]).
...
region(r19, '#7fdbff', 2000, centroid(60,584)).
perimeter(r19, 240).
polygon(r19, [xy(89,610),xy(50,610),xy(50,590),xy(30,589),xy(30,570),xy(49,570),xy(50,550),xy(70,550),xy(70,589),xy(90,590),xy(89,610)]).
midline(r19, [xy(44,579),xy(39,580)]).
midline(r19, [xy(45,580),xy(54,580),xy(58,577),xy(60,559)]).
midline(r19, [xy(57,580),xy(61,598),xy(80,600)]).
fillpoint(r19, xy(57,580), 12.8).
fillpoint(r19, xy(61,598), 12.0).
fillpoint(r19, xy(59,574), 11.0).
fillpoint(r19, xy(59,585), 11.0).
fillpoint(r19, xy(60,594), 11.0).
fillpoint(r19, xy(65,599), 11.0).
fillpoint(r19, xy(59,564), 10.0).
fillpoint(r19, xy(39,580), 10.0).
fillpoint(r19, xy(71,600), 10.0).
region(r21, '#5a5a5a', 1600, centroid(510,620)).
perimeter(r21, 200).
polygon(r21, [xy(549,630),xy(470,630),xy(470,610),xy(549,610),xy(549,630)]).
midline(r21, [xy(491,620),xy(479,620)]).
midline(r21, [xy(492,619),xy(540,620)]).
fillpoint(r21, xy(479,620), 10.0).
region(r12, '#870c25', 1500, centroid(214,434)).
perimeter(r12, 160).
polygon(r12, [xy(239,450),xy(190,450),xy(190,420),xy(239,420),xy(239,450)]).
midline(r12, [xy(222,435),xy(204,435)]).
midline(r12, [xy(223,434),xy(225,435)]).
...
midline(r7, [xy(210,410),xy(230,410)]).
