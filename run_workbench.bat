...
title MeTTa Workbench Launcher
set "WB_DIAG_BOOTSTRAP_SCRIPT=%~f0"
set "WB_DIAG_BOOTSTRAP_PURPOSE=launch the local workbench, or stop its selected ports."
set "WB_DIAG_TITLE=MeTTa Workbench Launcher"
set "WB_DIAG_TITLE_PORTS=KILL_WEB_PORT;KILL_API_PORT"
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\windows_launcher_diagnostics.ps1" -Bootstrap
