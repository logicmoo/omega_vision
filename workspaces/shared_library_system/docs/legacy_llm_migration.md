...
- Ordered `prompt_text` lists and old LLM transactions -> Prompt Profiles or direct Prompt IDs selected through Operation implementation `bindings` under `design/operations/`.
